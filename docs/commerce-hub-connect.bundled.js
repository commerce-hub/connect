...
const V$=e=>e??Py;var U$=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};const F$="jsonforms-layout jsonforms-layout-vertical",W$="jsonforms-layout jsonforms-layout-horizontal",H$="jsonforms-layout jsonforms-group";let K$=class extends T${render(){return this.renderLayout(F$)}renderLayout(e){const t=this.layoutProps;if(void 0===t||!1===t.visible)return Ry``;const r=t.uischema;return Ry`
    ...
    `}};K$=U$([tw("jsonforms-lit-vertical-layout")],K$);let G$=class extends K${render(){return this.renderLayout(W$)}};G$=U$([tw("jsonforms-lit-horizontal-layout")],G$);let J$=class extends K${render(){return this.renderLayout(H$)}};J$=U$([tw("jsonforms-lit-group-layout")],J$);let Z$=class extends R${render(){return void 0===this.labelProps||!1===this.labelProps.visible?Ry``:Ry`<span class="jsonforms-label">${this.labelProps.text}</span>`}};Z$=U$([tw("jsonforms-lit-label")],Z$);let Y$=class extends z${render(){const e=this.controlProps;if(void 0===e||!1===e.visible)return Ry``;const t=Array.isArray(e.errors)?e.errors.length>0:Boolean(e.errors),r=e.description?`${e.id}-description`:void 0,n=t?`${e.id}-error`:void 0,i=[r,n].filter(Boolean).join(" ");return Ry`
    ...
    `}renderLabel(e,t){return Ry`<label for=${this.controlProps?.id??""}>
      ${e}${t&&!e.endsWith("*")?"*":""}
          ...
          ${e}
        </div>`:Ry``}renderErrors(e,t){const r=Array.isArray(e)?e.join("\n"):e;return r?Ry`<div class="jsonforms-error" id=${V$(t)}>${r}</div>`:Ry``}};Y$=U$([tw("jsonforms-lit-text-control")],Y$);let Q$=class extends Y${render(){const e=this.controlProps;return void 0===e||!1===e.visible?Ry``:Ry`
      <div class="jsonforms-control">
        ${this.renderLabel(e.label,e.required)}
        <input
          id=${e.id}
    ...
    `}};Q$=U$([tw("jsonforms-lit-number-control")],Q$);let X$=class extends Y${render(){const e=this.controlProps;return void 0===e||!1===e.visible?Ry``:Ry`
    ...
    `}};X$=U$([tw("jsonforms-lit-boolean-control")],X$);let ek=class extends Y${render(){const e=this.controlProps;if(void 0===e||!1===e.visible)return Ry``;const t=e.schema.enum??[];return Ry`
      <div class="jsonforms-control">
        ${this.renderLabel(e.label,e.required)}
        <select
          id=${e.id}
...
`)({label:"Required document",requirements:rE(e),actionLabel:"Choose file",fileName:i,action:"open-required-info-file-picker",disabled:n})}
      ...
      `})}renderNoSavedPaymentMethods(){const e=Qx(this.designConfig),t="delete-payment-source"===this.pendingAction,r=cj(this.interactionResponse),n=Ej(this.interactionResponse,"ADD_ACCOUNT"),i=r.bankAccount&&Aj(this.interactionResponse);return this.renderWidgetShell({title:e.title,subtitle:e.subtitle,showClose:!1,showDivider:!1,content:jx({allowedTenderOptions:r,canAddPaymentSources:n,deletePending:t,copy:e,showTransferAction:i})})}shouldRenderTransferScreen(){const e=this.interactionResponse;return(this.transferFlowActive||Sj(e))&&jj(e?.status)}renderTransferScreen(){const e=bj(this.interactionResponse),t="transfer"===this.pendingAction,r=this.transferFlowActive?vx({label:"Back",action:"back-to-payment-methods",disabled:t}):void 0;if(e.length<2)return this.renderWidgetShell({title:"Transfer funds",headerAction:r,showClose:!1,showDivider:!1,content:Ry`
        ...
        `});const n=[{value:"",label:"Select account"},...e.map(e=>({value:pj(e),label:dj(e)}))],i=qk(this.transferDraft),o=e.find(e=>pj(e)===i.fromSourceId),a=e.find(e=>pj(e)===i.toSourceId);return"confirm"===this.transferFlowScreen&&o&&a&&Bk(i,e)?this.renderTransferConfirmationScreen(o,a,i,t):this.renderWidgetShell({title:"Transfer funds",headerAction:r,showClose:!1,showDivider:!1,busy:t,overlay:t?Vj({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ry`

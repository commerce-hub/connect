 ...
 */
const e=globalThis,t=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,i=Symbol(),r=new WeakMap;let n=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==i)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const i=this.t;if(t&&void 0===e){const t=void 0!==i&&1===i.length;t&&(e=r.get(i)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),t&&r.set(i,e))}return e}toString(){return this.cssText}};const o=t?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return(e=>new n("string"==typeof e?e:e+"",void 0,i))(t)})(e):e,{is:a,defineProperty:s,getOwnPropertyDescriptor:c,getOwnPropertyNames:d,getOwnPropertySymbols:l,getPrototypeOf:h}=Object,u=globalThis,m=u.trustedTypes,p=m?m.emptyScript:"",f=u.reactiveElementPolyfillSupport,v=(e,t)=>e,b={toAttribute(e,t){switch(t){case Boolean:e=e?p:null;break;case Object:case Array:e=null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){let i=e;switch(t){case Boolean:i=null!==e;break;case Number:i=null===e?null:Number(e);break;case Object:case Array:try{i=JSON.parse(e)}catch(e){i=null}}return i}},g=(e,t)=>!a(e,t),y={attribute:!0,type:String,converter:b,reflect:!1,useDefault:!1,hasChanged:g};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */Symbol.metadata??=Symbol("metadata"),u.litPropertyMetadata??=new WeakMap;let w=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=y){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const i=Symbol(),r=this.getPropertyDescriptor(e,i,t);void 0!==r&&s(this.prototype,e,r)}}static getPropertyDescriptor(e,t,i){const{get:r,set:n}=c(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};return{get:r,set(t){const o=r?.call(this);n?.call(this,t),this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??y}static _$Ei(){if(this.hasOwnProperty(v("elementProperties")))return;const e=h(this);e.finalize(),void 0!==e.l&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(v("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(v("properties"))){const e=this.properties,t=[...d(e),...l(e)];for(const i of t)this.createProperty(i,e[i])}const e=this[Symbol.metadata];if(null!==e){const t=litPropertyMetadata.get(e);if(void 0!==t)for(const[e,i]of t)this.elementProperties.set(e,i)}this._$Eh=new Map;for(const[e,t]of this.elementProperties){const i=this._$Eu(e,t);void 0!==i&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const e of i)t.unshift(o(e))}else void 0!==e&&t.push(o(e));return t}static _$Eu(e,t){const i=t.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof e?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),void 0!==this.renderRoot&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((i,r)=>{if(t)i.adoptedStyleSheets=r.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const t of r){const r=document.createElement("style"),n=e.litNonce;void 0!==n&&r.setAttribute("nonce",n),r.textContent=t.cssText,i.appendChild(r)}})(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){const i=this.constructor.elementProperties.get(e),r=this.constructor._$Eu(e,i);if(void 0!==r&&!0===i.reflect){const n=(void 0!==i.converter?.toAttribute?i.converter:b).toAttribute(t,i.type);this._$Em=e,null==n?this.removeAttribute(r):this.setAttribute(r,n),this._$Em=null}}_$AK(e,t){const i=this.constructor,r=i._$Eh.get(e);if(void 0!==r&&this._$Em!==r){const e=i.getPropertyOptions(r),n="function"==typeof e.converter?{fromAttribute:e.converter}:void 0!==e.converter?.fromAttribute?e.converter:b;this._$Em=r;const o=n.fromAttribute(t,e.type);this[r]=o??this._$Ej?.get(r)??o,this._$Em=null}}requestUpdate(e,t,i,r=!1,n){if(void 0!==e){const o=this.constructor;if(!1===r&&(n=this[e]),i??=o.getPropertyOptions(e),!((i.hasChanged??g)(n,t)||i.useDefault&&i.reflect&&n===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,i))))return;this.C(e,t,i)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:r,wrapped:n},o){i&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),!0!==n||void 0!==o)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),!0===r&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const e=this.scheduleUpdate();return null!=e&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[e,t]of this._$Ep)this[e]=t;this._$Ep=void 0}const e=this.constructor.elementProperties;if(e.size>0)for(const[t,i]of e){const{wrapped:e}=i,r=this[t];!0!==e||this._$AL.has(t)||void 0===r||this.C(t,void 0,i,r)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(e=>e.hostUpdate?.()),this.update(t)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(e){}firstUpdated(e){}};w.elementStyles=[],w.shadowRootOptions={mode:"open"},w[v("elementProperties")]=new Map,w[v("finalized")]=new Map,f?.({ReactiveElement:w}),(u.reactiveElementVersions??=[]).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const k=globalThis,$=e=>e,x=k.trustedTypes,C=x?x.createPolicy("lit-html",{createHTML:e=>e}):void 0,S="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,z="?"+E,A=`<${z}>`,I=document,q=()=>I.createComment(""),N=e=>null===e||"object"!=typeof e&&"function"!=typeof e,B=Array.isArray,R="[ \t\n\f\r]",T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,D=/-->/g,L=/>/g,M=RegExp(`>|${R}(?:([^\\s"'>=/]+)(${R}*=${R}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),O=/'/g,V=/"/g,F=/^(?:script|style|textarea|title)$/i,P=(e=>(t,...i)=>({_$litType$:e,strings:t,values:i}))(1),j=Symbol.for("lit-noChange"),U=Symbol.for("lit-nothing"),_=new WeakMap,H=I.createTreeWalker(I,129);function K(e,t){if(!B(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==C?C.createHTML(t):t}const W=(e,t)=>{const i=e.length-1,r=[];let n,o=2===t?"<svg>":3===t?"<math>":"",a=T;for(let t=0;t<i;t++){const i=e[t];let s,c,d=-1,l=0;for(;l<i.length&&(a.lastIndex=l,c=a.exec(i),null!==c);)l=a.lastIndex,a===T?"!--"===c[1]?a=D:void 0!==c[1]?a=L:void 0!==c[2]?(F.test(c[2])&&(n=RegExp("</"+c[2],"g")),a=M):void 0!==c[3]&&(a=M):a===M?">"===c[0]?(a=n??T,d=-1):void 0===c[1]?d=-2:(d=a.lastIndex-c[2].length,s=c[1],a=void 0===c[3]?M:'"'===c[3]?V:O):a===V||a===O?a=M:a===D||a===L?a=T:(a=M,n=void 0);const h=a===M&&e[t+1].startsWith("/>")?" ":"";o+=a===T?i+A:d>=0?(r.push(s),i.slice(0,d)+S+i.slice(d)+E+h):i+E+(-2===d?t:h)}return[K(e,o+(e[i]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),r]};class G{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let n=0,o=0;const a=e.length-1,s=this.parts,[c,d]=W(e,t);if(this.el=G.createElement(c,i),H.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(r=H.nextNode())&&s.length<a;){if(1===r.nodeType){if(r.hasAttributes())for(const e of r.getAttributeNames())if(e.endsWith(S)){const t=d[o++],i=r.getAttribute(e).split(E),a=/([.?@])?(.*)/.exec(t);s.push({type:1,index:n,name:a[2],strings:i,ctor:"."===a[1]?X:"?"===a[1]?ee:"@"===a[1]?te:Q}),r.removeAttribute(e)}else e.startsWith(E)&&(s.push({type:6,index:n}),r.removeAttribute(e));if(F.test(r.tagName)){const e=r.textContent.split(E),t=e.length-1;if(t>0){r.textContent=x?x.emptyScript:"";for(let i=0;i<t;i++)r.append(e[i],q()),H.nextNode(),s.push({type:2,index:++n});r.append(e[t],q())}}}else if(8===r.nodeType)if(r.data===z)s.push({type:2,index:n});else{let e=-1;for(;-1!==(e=r.data.indexOf(E,e+1));)s.push({type:7,index:n}),e+=E.length-1}n++}}static createElement(e,t){const i=I.createElement("template");return i.innerHTML=e,i}}function Y(e,t,i=e,r){if(t===j)return t;let n=void 0!==r?i._$Co?.[r]:i._$Cl;const o=N(t)?void 0:t._$litDirective$;return n?.constructor!==o&&(n?._$AO?.(!1),void 0===o?n=void 0:(n=new o(e),n._$AT(e,i,r)),void 0!==r?(i._$Co??=[])[r]=n:i._$Cl=n),void 0!==n&&(t=Y(e,n._$AS(e,t.values),n,r)),t}class J{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,r=(e?.creationScope??I).importNode(t,!0);H.currentNode=r;let n=H.nextNode(),o=0,a=0,s=i[0];for(;void 0!==s;){if(o===s.index){let t;2===s.type?t=new Z(n,n.nextSibling,this,e):1===s.type?t=new s.ctor(n,s.name,s.strings,this,e):6===s.type&&(t=new ie(n,this,e)),this._$AV.push(t),s=i[++a]}o!==s?.index&&(n=H.nextNode(),o++)}return H.currentNode=I,r}p(e){let t=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Z{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,r){this.type=2,this._$AH=U,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Y(this,e,t),N(e)?e===U||null==e||""===e?(this._$AH!==U&&this._$AR(),this._$AH=U):e!==this._$AH&&e!==j&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>B(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==U&&N(this._$AH)?this._$AA.nextSibling.data=e:this.T(I.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,r="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=G.createElement(K(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.p(t);else{const e=new J(r,this),i=e.u(this.options);e.p(t),this.T(i),this._$AH=e}}_$AC(e){let t=_.get(e.strings);return void 0===t&&_.set(e.strings,t=new G(e)),t}k(e){B(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,r=0;for(const n of e)r===t.length?t.push(i=new Z(this.O(q()),this.O(q()),this,this.options)):i=t[r],i._$AI(n),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=$(e).nextSibling;$(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class Q{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,r,n){this.type=1,this._$AH=U,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=n,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=U}_$AI(e,t=this,i,r){const n=this.strings;let o=!1;if(void 0===n)e=Y(this,e,t,0),o=!N(e)||e!==this._$AH&&e!==j,o&&(this._$AH=e);else{const r=e;let a,s;for(e=n[0],a=0;a<n.length-1;a++)s=Y(this,r[i+a],t,a),s===j&&(s=this._$AH[a]),o||=!N(s)||s!==this._$AH[a],s===U?e=U:e!==U&&(e+=(s??"")+n[a+1]),this._$AH[a]=s}o&&!r&&this.j(e)}j(e){e===U?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class X extends Q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===U?void 0:e}}class ee extends Q{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==U)}}class te extends Q{constructor(e,t,i,r,n){super(e,t,i,r,n),this.type=5}_$AI(e,t=this){if((e=Y(this,e,t,0)??U)===j)return;const i=this._$AH,r=e===U&&i!==U||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==U&&(i===U||r);r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class ie{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Y(this,e)}}const re=k.litHtmlPolyfillSupport;re?.(G,Z),(k.litHtmlVersions??=[]).push("3.3.2");const ne=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class oe extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,i)=>{const r=i?.renderBefore??t;let n=r._$litPart$;if(void 0===n){const e=i?.renderBefore??null;r._$litPart$=n=new Z(t.insertBefore(q(),e),e,void 0,i??{})}return n._$AI(e),n})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return j}}oe._$litElement$=!0,oe.finalized=!0,ne.litElementHydrateSupport?.({LitElement:oe});const ae=ne.litElementPolyfillSupport;ae?.({LitElement:oe}),(ne.litElementVersions??=[]).push("4.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const se={attribute:!0,type:String,converter:b,reflect:!1,hasChanged:g},ce=(e=se,t,i)=>{const{kind:r,metadata:n}=i;let o=globalThis.litPropertyMetadata.get(n);if(void 0===o&&globalThis.litPropertyMetadata.set(n,o=new Map),"setter"===r&&((e=Object.create(e)).wrapped=!0),o.set(i.name,e),"accessor"===r){const{name:r}=i;return{set(i){const n=t.get.call(this);t.set.call(this,i),this.requestUpdate(r,n,e,!0,i)},init(t){return void 0!==t&&this.C(r,void 0,e,t),t}}}if("setter"===r){const{name:r}=i;return function(i){const n=this[r];t.call(this,i),this.requestUpdate(r,n,e,!0,i)}}throw Error("Unsupported decorator location: "+r)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */,Le=e=>e??U,Me=(...e)=>e.filter(Boolean).join(" "),Oe=e=>{const t=e?.trim();return t||void 0},Ve=e=>{const t=(e=>"verified"===e?{label:"Verified",tone:"success"}:"under-review"===e?{label:"Under review",tone:"warning"}:"require-info"===e?{label:"Need More Information",tone:"warning"}:"declined"===e?{label:"Can't Use",tone:"danger"}:{label:"Action Required",tone:"warning"})(e);return P`
  ...
  `},Fe=e=>{const t=Oe(e.accountLabel)??(({label:e,brand:t,last4:i})=>{const r=Oe(e),n=Oe(t);return i&&n&&n!==r?`${n} •••• ${i}`:i?`•••• ${i}`:n??""})(e),i=Oe(e.label)??t,r=Boolean(t);return P`
    <span class="payment-method-copy">
      ...
      ${r?P`
            <span class="payment-method-meta-row">
              ...
              ${(e=>!1!==e.showVerificationStatus&&"verified"!==e.status)(e)?Ve(e.status):""}
            </span>
          `:""}
    </span>
  `},Pe=(e,t)=>P`
  <span class="payment-method-trailing">
    ${(({balanceLabel:e,balanceLoading:t})=>t?P`
      <span
        class="payment-method-balance-loading"
        role="status"
        aria-label="Loading balance"
      ></span>
    `:e?P`<span class="payment-method-balance">${e}</span>`:"")(e)}
    ${t?P`
...
`,je=(e,t)=>P`
  <span class="payment-method-icon-chip" aria-hidden="true">
    <img
      ...
      data-payment-method-icon=${Re(e)}
      src=${Te(e)}
      alt=""
    />
  </span>
  ${Fe(e)} ${t}
`,Ue=({label:e,variant:t="primary",action:i,type:r="button",icon:n,disabled:o=!1,loading:a=!1})=>P`
  <button
    class=${Me("button",`button-${t}`,a&&"button-loading")}
    type=${r}
    data-action=${Le(i)}
  ...
  >
    <span class="button-content">
      ${a?P`<span class="button-spinner" aria-hidden="true"></span>`:n?P`
            <span
...
`,_e=({id:e,label:t,name:i,value:r="",placeholder:n,type:o="text",span:a="default",variant:s="default",autocomplete:c,inputmode:d,disabled:l=!1,dataField:h,dataFieldScope:u="card",error:m})=>{const p=Me("field","full"===a&&"field-full","card-form"===s&&"field-card-form",m&&"field-invalid"),f=Me("field-label","card-form"===s&&"field-label-card-form"),v=Me("field-input","card-form"===s&&"field-input-card-form"),b=P`
    <input
      class=${v}
      id=${e}
      name=${Le(i)}
      ...
      autocomplete=${Le(c)}
      inputmode=${Le(d)}
      data-card-field=${Le("card"===u?h:void 0)}
      data-bank-account-field=${Le("bankAccount"===u?h:void 0)}
      aria-invalid=${m?"true":"false"}
      aria-describedby=${Le(m?`${e}-error`:void 0)}
      ?disabled=${l}
    />
  `;return P`
    <div class=${p}>
      ...
      ${"card-form"===s?P`
          ...
          `:b}
      ${m?P`<p class="field-error" id=${`${e}-error`}>${m}</p>`:""}
    </div>
  `},He=({id:e,label:t,name:i,value:r="",options:n,span:o="default",variant:a="default",disabled:s=!1,dataField:c,dataFieldScope:d="card",error:l})=>{const h=Me("field","card-form"!==a&&"field-with-select","full"===o&&"field-full","card-form"===a&&"field-card-form",l&&"field-invalid"),u=Me("field-label","card-form"===a&&"field-label-card-form"),m=Me("field-input","field-select","card-form"===a&&"field-input-card-form"),p=P`
    <select
      class=${m}
      id=${e}
      name=${Le(i)}
      .value=${r}
      data-card-field=${Le("card"===d?c:void 0)}
      data-bank-account-field=${Le("bankAccount"===d?c:void 0)}
      aria-invalid=${l?"true":"false"}
      aria-describedby=${Le(l?`${e}-error`:void 0)}
      ?disabled=${s}
    >
      ${n.map(e=>P`
  ...
  `;return P`
    <div class=${h}>
      ...
      ${"card-form"===a?P`
          ...
          `:p}
      ${l?P`<p class="field-error" id=${`${e}-error`}>${l}</p>`:""}
    </div>
  `},Ke=({label:e,value:t="",length:i=6,disabled:r=!1,error:n=!1})=>{const o=Array.from({length:i},(e,i)=>t[i]??"");return P`
    <fieldset
  ...
  `},We=({variant:e,message:t})=>P`
  <div class="alert alert-${e}" role="alert">
    <span class="alert-message">${t}</span>
  </div>
`,Ge=({label:e,action:t,disabled:i=!1,loading:r=!1})=>P`
  <button
    class=${Me("otp-resend",r&&"otp-resend-loading")}
    type="button"
    data-action=${t}
    aria-busy=${r?"true":"false"}
    ?disabled=${i||r}
  >
    ${r?P`<span class="otp-resend-spinner" aria-hidden="true"></span>`:""}
    <span class="otp-resend-label">${e}</span>
  </button>
`,Ye=({title:e,message:t})=>P`
  <div class="empty-state">
    <p class="empty-state-title">${e}</p>
    <p class="empty-state-message">${t}</p>
  </div>
`,Je=({id:e,label:t,status:i,type:r,eyebrow:n,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l,disabled:h=!1},{variant:u="default",deleteDisabled:m=!1,confirmingDelete:p=!1,selected:f=!1}={})=>{const v={id:e,label:t,status:i,type:r,eyebrow:n,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l,disabled:h};if("edit"===u){const i={...v,showVerificationStatus:!1};return P`
      <div
        class=${Me("payment-method-row","payment-method-row-edit",p&&"payment-method-row-delete-confirming")}
        aria-label=${t}
        data-payment-method-id=${e}
      >
        ${je(i,((e,t,i=!1,r=!1)=>{const n=`Delete ${t}`;return r?P`
  ...
  `})(e,t,m,p))}
    ...
    `}return(e=>{return"verified"===(t=e.status)||"require-info"===t||"not-verified"===t;var t})(v)?P`
      <button
        class=${Me("payment-method-row","payment-method-row-action",f&&"payment-method-row-selected")}
        type="button"
    ...
    `:P`
    <div
      class=${Me("payment-method-row","payment-method-row-static")}
      aria-label=${t}
      aria-disabled="true"
      data-payment-method-id=${e}
    >
  ...
  `},Ze=({id:e,label:t,status:i,type:r,eyebrow:n,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l})=>{const h={label:t,status:i,type:r,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l};return P`
    <div class="selected-payment-method" aria-label=${t}>
      ${je(h,Pe(h,!1))}
    </div>
  `},Qe=({label:e,subtitle:t,action:i,icon:r,variant:n="card",disabled:o=!1})=>"link"===n?P`
        <button
          ...
          ?disabled=${o}
        >
          <span class="source-action-icon" aria-hidden="true">+</span>
      ...
      `:P`
        ...
        >
          ...
          <span class="source-action-copy">
            ...
            ${t?P`<span class="source-action-subtitle">${t}</span>`:""}
          </span>
        </button>
      `,Xe=({count:e=3,label:t="Loading payment methods"}={})=>P`
  <div class="payment-method-skeletons" role="status" aria-live="polite">
    <span class="payment-method-skeleton-label">${t}</span>
    ${Array.from({length:e},()=>P`
...
`,et=({containerId:e,title:t,loadingLabel:i,loading:r=!1})=>P`
  <div
    class=${Me("provider-frame",r&&"provider-frame-loading")}
    aria-busy=${r?"true":"false"}
  >
    ${t?P`
          <div class="provider-frame-header">
            ${t?P`<p class="provider-frame-title">${t}</p>`:""}
            ${r?"":P`
                  <p
    ...
    <slot class="provider-frame-slot" name=${e}>
      <div
        class=${Me("provider-frame-container",r&&"provider-frame-container-loading")}
        id=${e}
      ></div>
    </slot>
    ${r?P`
...
`,tt=({variant:e,title:t,message:i,content:r,actions:n})=>P`
  <div class="outcome-shell outcome-${e}">
    <span class="outcome-icon" aria-hidden="true"></span>
    ${t?P`<p class="outcome-title">${t}</p>`:""}
    ${i?P`<p class="outcome-message">${i}</p>`:""}
    ${r?P`<div class="outcome-content">${r}</div>`:""}
    ${n?P`<div class="outcome-actions">${n}</div>`:""}
  </div>
`,it=({label:e,action:t,disabled:i=!1})=>P`
  <button
...
`,rt=e=>P` <div class="form-grid">${e}</div> `,nt=({title:e,subtitle:t,content:i,headerAction:r,width:n="default",ariaLabel:o="Commerce Hub Connect",closeAction:a="close",showClose:s=!0,showDivider:c=!1,showFooter:d=!0,busy:l=!1,overlay:h})=>P`
  <section
    class=${Me("widget-shell","wide"===n&&"widget-shell-wide",l&&"widget-shell-busy")}
    aria-label=${o}
  ...
  >
    ...
    <div class="widget-header">
      <h2 class="widget-title">${e}</h2>
      ${r?P`<div class="widget-header-action">${r}</div>`:""}
    </div>
    ${t?P`<p class="widget-subtitle">${t}</p>`:""}
    ${c?P`<div class="widget-divider" aria-hidden="true"></div>`:""}
    <div class="widget-content">${i}</div>
    ${h?P`<div class="widget-loading-overlay">${h}</div>`:""}
    ${d?P`
...
`;var ot=function(e,t,i,r){for(var n,o=arguments.length,a=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r,s=e.length-1;s>=0;s--)(n=e[s])&&(a=(o<3?n(a):o>3?n(t,i,a):n(t,i))||a);return o>3&&a&&Object.defineProperty(t,i,a),a};const at="onSuccess",st="onError",ct="commerce-hub-pbb-provider",dt="__new__",lt="OTP_VALIDATION_SUCCESS",ht=[{value:"",label:"Select country or region"},{value:"US",label:"United States"}],ut=[{value:"",label:"Select state"},...[["AL","Alabama"],["AK","Alaska"],["AZ","Arizona"],["AR","Arkansas"],["CA","California"],["CO","Colorado"],["CT","Connecticut"],["DE","Delaware"],["FL","Florida"],["GA","Georgia"],["HI","Hawaii"],["ID","Idaho"],["IL","Illinois"],["IN","Indiana"],["IA","Iowa"],["KS","Kansas"],["KY","Kentucky"],["LA","Louisiana"],["ME","Maine"],["MD","Maryland"],["MA","Massachusetts"],["MI","Michigan"],["MN","Minnesota"],["MS","Mississippi"],["MO","Missouri"],["MT","Montana"],["NE","Nebraska"],["NV","Nevada"],["NH","New Hampshire"],["NJ","New Jersey"],["NM","New Mexico"],["NY","New York"],["NC","North Carolina"],["ND","North Dakota"],["OH","Ohio"],["OK","Oklahoma"],["OR","Oregon"],["PA","Pennsylvania"],["RI","Rhode Island"],["SC","South Carolina"],["SD","South Dakota"],["TN","Tennessee"],["TX","Texas"],["UT","Utah"],["VT","Vermont"],["VA","Virginia"],["WA","Washington"],["WV","West Virginia"],["WI","Wisconsin"],["WY","Wyoming"],["DC","District of Columbia"]].map(([e,t])=>({value:e,label:t}))],mt={environment:"qa",locale:"en-US",paymentSdkUrl:"https://connect-qa.fiservapis.com/pbb/sdk/web/v2/js/PaymentSDK.js"},pt=[{id:"visa-1111",label:"James Anderson",type:"card",brand:"VISA",last4:"1111",status:"verified"},{id:"amex-8000",label:"James Anderson",type:"card",brand:"AMEX",last4:"8000",status:"not-verified"}];let ft=class extends oe{constructor(){super(...arguments),this.otpValue="",this.bankLinkLoading=!1,this.bankAccountDraft=bt(),this.bankAccountDraftErrors={},this.bankAccountEncryption=wt(),this.cardDraft=vt(),this.cardDraftErrors={},this.cardEncryption=yt(),this.billingAddresses=[],this.billingAddressSelectorExpanded=!1,this.nativeAccountBalances={},this.nativeBalanceLoadingSourceIds=[],this.paymentSourceEditMode=!1,this.savedSourceVerificationFailed=!1,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.minimumVerificationOverlayToken=0,this.handleClick=e=>{const t=rr(e,"action"),i=rr(e,"paymentMethodId");if(t)if("attach-payment-source"!==t){if("change-payment-source"===t)return this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("toggle-payment-source-edit-mode"===t)return this.clearDeletePaymentSourceConfirmation(),void(this.paymentSourceEditMode=!this.paymentSourceEditMode);if("verify-payment-source"!==t)if("delete-payment-source"!==t)if("cancel-delete-payment-source"!==t){if("done-payment-source-verification"===t)return this.resetSavedSourceVerification(),void this.showPaymentSourceList({refresh:!0});if("open-required-info-file-picker"===t)return this.pendingRequiredInfoDocKey=rr(e,"requiredInfoDocKey")??this.firstRequiredInfoDocKey(),void this.renderRoot.querySelector(".required-info-file-input")?.click();if("submit-required-info"!==t)if("verify-otp"!==t)if("resend-otp"!==t){if("add-bank-account"===t||"use-bank-account-instead"===t||"retry-bank-provider"===t||"back-to-bank-provider"===t||"use-different-bank-account"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),void this.startPayByBankFlow();if("add-ach-manually"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),void this.showManualBankAccountScreen();if("back-to-payment-methods"===t)return this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("continue-bank-outcome"===t||"done-bank-outcome"===t)return this.resetBankFlow(),void this.showPaymentSourceList({refresh:!0});if("add-card"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetRequiredInfo(),void this.showAddCardScreen();if("change-billing-address"!==t)if("save-card"!==t)if("save-ach-manual"!==t){if("edit-card-details"!==t)return"use-different-method"===t?(this.resetCardFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0})):void 0;this.cardFlowScreen="form"}else this.saveManualBankAccount();else this.saveCard();else this.billingAddressSelectorExpanded=!0}else this.resendOtp();else this.verifyOtp();else this.submitRequiredInfo()}else this.clearDeletePaymentSourceConfirmation();else i&&this.deletePaymentSource(i);else i&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.verifySavedPaymentSource(i))}else i&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.selectedPaymentSourceId=i,this.paymentSourceView="selected",this.attachPaymentSource(i))},this.handleInput=e=>{const t=xt(e);if(t)return void this.storeRequiredInfoSsnInput(t);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.cardField));if(i)return void this.updateCardDraftField(i.dataset.cardField,i.value);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.bankAccountField));if(r)return void this.updateBankAccountDraftField(r.dataset.bankAccountField,r.value);const n=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoDocKey));if(n)return void this.storeRequiredInfoValue(n.dataset.requiredInfoDocKey,n.value);const o=e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input"));if(!o)return;const a=this.getOtpInputs(),s=Number(o.dataset.otpIndex),c=kt(o.value);if(!c)return o.value="",void this.syncOtpValueFromInputs(a);if(1===c.length)return o.value=c,this.syncOtpValueFromInputs(a),void this.focusOtpInput(a,s+1);const d=this.writeOtpDigits(a,s,c);this.syncOtpValueFromInputs(a),this.focusOtpInput(a,Math.min(s+c.length,a.length-1),d)},this.handleKeyDown=e=>{const t=$t(e);if(!t)return;const i=this.getOtpInputs(),r=Number(t.dataset.otpIndex);return"ArrowLeft"===e.key?(e.preventDefault(),void this.focusOtpInput(i,r-1)):"ArrowRight"===e.key?(e.preventDefault(),void this.focusOtpInput(i,r+1)):"Backspace"===e.key?(e.preventDefault(),t.value?t.value="":r>0&&(i[r-1].value=""),this.syncOtpValueFromInputs(i),void this.focusOtpInput(i,Math.max(r-1,0))):"Delete"===e.key?(e.preventDefault(),t.value="",void this.syncOtpValueFromInputs(i)):void(e.ctrlKey||e.metaKey||e.altKey||1!==e.key.length||/\d/.test(e.key)||e.preventDefault())},this.handleChange=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoFileInput));if(t)return this.storeRequiredInfoSelectedFile(t.files?.[0]),void(t.value="");const i=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.cardField));if(i)return void this.updateCardDraftField(i.dataset.cardField,i.value);const r=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.bankAccountField));r&&this.updateBankAccountDraftField(r.dataset.bankAccountField,r.value)},this.handlePaste=e=>{const t=xt(e);if(t)return void this.pasteRequiredInfoSsnInput(e,t);const i=$t(e);if(!i)return;const r=e,n="function"==typeof r.clipboardData?.getData?r.clipboardData.getData("text"):"",o=kt(n);if(!o)return;e.preventDefault();const a=this.getOtpInputs(),s=Number(i.dataset.otpIndex),c=this.writeOtpDigits(a,s,o);this.syncOtpValueFromInputs(a),this.focusOtpInput(a,Math.min(s+o.length,a.length-1),c)},this.handleFocusIn=e=>{const t=$t(e);t&&t.value&&requestAnimationFrame(()=>{this.renderRoot.contains(t)&&t.select()})},this.handleFocusLost=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Et(e.dataset.cardField));if(t)return void this.encryptCardField(t.dataset.cardField,t.value);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&zt(e.dataset.bankAccountField));i&&this.encryptBankAccountField(i.dataset.bankAccountField,i.value)}}willUpdate(e){if(e.has("interactionResponse")&&this.interactionResponse){const t=e.get("interactionResponse");t?.interactionId!==this.interactionResponse.interactionId&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceView=void 0,this.paymentSourceEditMode=!1,this.interactionRefreshInteractionId=void 0,this.interactionRefreshPromise=void 0,this.nativeBalanceFetchKey=void 0,this.nativeBalanceQueuedFetchKey=void 0,this.nativeAccountBalances={},this.nativeBalanceLoadingSourceIds=[],this.billingAddresses=[],this.resetSavedSourceVerification(),this.resetRequiredInfo()),this.interactionResponse.paymentSources?.length||this.interactionResponse.selectedSource||(this.paymentSourceEditMode=!1),this.syncBillingAddressesFromInteractionResponse(this.interactionResponse),this.selectedPaymentSourceId=Ji(this.interactionResponse,this.selectedPaymentSourceId)}}updated(e){e.has("designConfig")&&this.syncDesignConfigStyles(),e.has("interactionResponse")&&this.deleteConfirmationPaymentSourceId&&!this.findPaymentSourceById(this.deleteConfirmationPaymentSourceId)&&this.clearDeletePaymentSourceConfirmation(),e.has("interactionResponse")&&this.refreshPaymentSourcesFromInteraction()}render(){return P`
      <div
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.clearDeletePaymentSourceConfirmation(),this.removePayByBankProviderContainer(),Mr()}renderWidgetShell({busy:e=!1,overlay:t,...i}){const r=mr(this.minimumVerificationOverlayAction);return nt({...i,busy:e||Boolean(r),overlay:t??r})}showMinimumVerificationOverlay(e){const t=this.minimumVerificationOverlayToken+=1;this.minimumVerificationOverlayAction=e,window.setTimeout(()=>{this.minimumVerificationOverlayToken===t&&(this.minimumVerificationOverlayAction=void 0)},2e3)}renderCurrentScreen(){if("provider"===this.bankFlowScreen)return this.renderBankProviderScreen();if("outcome"===this.bankFlowScreen)return this.renderBankOutcomeScreen();if("manual"===this.bankFlowScreen)return this.renderManualBankAccountScreen();if("form"===this.cardFlowScreen)return this.renderAddCardScreen();if("error"===this.cardFlowScreen)return this.renderCardErrorScreen();if(this.requiredInfoSource)return this.renderRequiredInfoScreen();if(this.savedSourceVerificationSource)return this.renderSavedSourceVerificationOutcomeScreen();const e=this.interactionResponse?.status;return"OTP_VALIDATION_PENDING"===e||"OTP_VALIDATION_FAILED"===e?this.renderOtpScreen(e):this.renderPaymentSourceScreen()}renderOtpScreen(e){const t=$i(this.designConfig),i="OTP_VALIDATION_FAILED"===e,r="verify-otp"===this.pendingAction,n="resend-otp"===this.pendingAction,o=ki(this.interactionResponse);return this.renderWidgetShell({title:t.title,subtitle:t.subtitle??wi(o),showClose:!1,showDivider:!1,busy:r||n,overlay:r?ur({title:"Verifying code",helper:"Verifying your code, please wait."}):n?ur({title:"Sending code",helper:"Sending a new code, please wait."}):void 0,content:P`
        <div class="otp-flow">
          ${i?We({variant:"danger",message:this.otpErrorMessage??t.failedMessage}):""}
          ${Ke({label:"Verification code",value:this.otpValue,length:6,disabled:r,error:i})}
          <div class="primitive-footer">
            ${Ue({label:r?t.verifyingButton:i?t.tryAgainButton:t.verifyButton,icon:r||i?void 0:"check",variant:"primary",action:"verify-otp",loading:r,disabled:r||this.otpValue.length<6})}
          </div>
          <div class="otp-support">
            <p class="otp-support-copy otp-resend-prefix">
              ${t.resendPrefix}
            </p>
            <div class="otp-support-actions">
              ${Ge({label:n?t.resendPendingButton:t.resendButton,action:"resend-otp",loading:n,disabled:r||n})}
            </div>
          </div>
        </div>
      `})}renderPaymentSourceScreen(){const e=xi(this.designConfig),t=Ti(this.interactionResponse,{nativeBalances:this.nativeAccountBalances,nativeBalanceLoadingSourceIds:this.nativeBalanceLoadingSourceIds}),i=Di(this.interactionResponse),r=i.card||i.bankAccount,n="attach-payment-source"===this.pendingAction||"verify-payment-source"===this.pendingAction||"delete-payment-source"===this.pendingAction,o=this.paymentSourceEditMode&&t.length>0;return this.shouldRenderPaymentSourceRefreshSkeleton()?this.renderWidgetShell({title:e.title,showClose:!1,content:P`
          <div class="payment-flow">
            ${Xe({count:3,label:"Loading payment methods"})}
          </div>
        `}):t.length?this.shouldRenderSelectedPaymentSourceScreen()?this.renderSelectedPaymentSourceScreen():(this.queueNativeAccountBalanceRefresh(),this.renderWidgetShell({title:e.title,headerAction:it({label:o?"Done":"Edit",action:"toggle-payment-source-edit-mode",disabled:n}),showClose:!1,busy:n,overlay:pr(this.pendingAction),content:P`
        <div class="payment-flow">
          <div class="primitive-stack" aria-label="Payment methods">
            ${t.map(e=>Je({...e,disabled:e.disabled||n},{variant:o?"edit":"default",deleteDisabled:n,confirmingDelete:e.id===this.deleteConfirmationPaymentSourceId,selected:e.id===this.selectedPaymentSourceId}))}
          </div>
          ${o?"":r?P`
                <div class="payment-action-links">
                  ${i.card?Qe({label:e.addCardTitle,action:"add-card",icon:"card",variant:"link",disabled:n}):""}
                  ${i.bankAccount?Qe({label:e.addBankAccountTitle,action:"add-bank-account",icon:"bank",variant:"link",disabled:n}):""}
                </div>
              `:""}
        </div>
      `})):this.renderNoSavedPaymentMethods()}renderSelectedPaymentSourceScreen(){const e=Zi(this.interactionResponse,this.selectedPaymentSourceId);return e?this.renderWidgetShell({title:"Payment method saved",headerAction:it({label:"Change",action:"change-payment-source",disabled:"attach-payment-source"===this.pendingAction}),showClose:!1,showDivider:!1,busy:"attach-payment-source"===this.pendingAction,overlay:"attach-payment-source"===this.pendingAction?ur({title:Nr(e)?"Saving bank account":"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,content:P`
        <div class="payment-flow">
          ${Ze(Li(e,{selected:!0,nativeBalances:this.nativeAccountBalances,nativeBalanceLoadingSourceIds:this.nativeBalanceLoadingSourceIds}))}
        </div>
      `}):(this.paymentSourceView="list",this.renderPaymentSourceScreen())}shouldRenderSelectedPaymentSourceScreen(){return"list"!==this.paymentSourceView&&("PAYMENT_SOURCE_ATTACHED"===this.interactionResponse?.status||"selected"===this.paymentSourceView)}shouldRenderPaymentSourceRefreshSkeleton(){const e=this.interactionResponse,t=e?.interactionId;return!!t&&(!!this.interactionRefreshPromise||this.shouldRefreshPaymentSourcesFromInteraction()&&void 0===e?.paymentSources)}renderSavedSourceVerificationOutcomeScreen(){const e=this.savedSourceVerificationSource,t=vr(e,this.savedSourceVerificationFailed),i="declined"===t.kind||"pending"===t.kind;return this.renderWidgetShell({title:t.title,headerAction:i?it({label:"Back",action:"done-payment-source-verification"}):void 0,showClose:!1,showDivider:!1,content:P`
        <div class="verification-outcome-flow">
          ${We({variant:t.variant,message:t.message})}
          ${e?Ar(e):""}
          ${i?"":P`
                <div class="primitive-footer">
                  ${Ue({label:"Back to payment methods",action:"done-payment-source-verification"})}
                </div>
              `}
        </div>
      `})}renderRequiredInfoScreen(){const e=this.requiredInfoSource;if(!e)return this.renderPaymentSourceScreen();const t=gr(e),i=Cr(t),r="submit-required-info"===this.pendingAction,n=this.canSubmitRequiredInfo();return this.renderWidgetShell({title:"Complete account verification",headerAction:it({label:"Back",action:"back-to-payment-methods",disabled:r}),showClose:!1,showDivider:!1,busy:r,overlay:r?ur({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,content:P`
        <div class="required-info-flow">
          ${Ar(e)}
          ${this.requiredInfoSubmitError?We({variant:"danger",message:this.requiredInfoSubmitError}):""}
          ...
          <div class="required-info-documents">
            ...
            <div class="primitive-stack">
              ${t.map((e,t)=>{const i=yr(e,t),n=wr(e)?this.requiredInfoValues[i]:this.requiredInfoFileNames[i];return wr(e)?Sr({doc:e,key:i,value:n??""}):P`
                  <div
                    class="required-info-document required-document-text-row"
                    data-required-info-doc-key=${i}
                    data-required-info-requirement=${$r(e)}
                  >
                    ...
                    ${(({label:e,requirements:t,actionLabel:i,fileName:r,action:n,error:o=!1,disabled:a=!1})=>P`
  <button
...
`)({label:"Required document",requirements:zr(e),actionLabel:"Choose file",fileName:n,action:"open-required-info-file-picker",disabled:r})}
                  </div>
                `})}
            </div>
          </div>
          ...
          <div
            ...
            data-required-info-doc-key=${i??""}
          >
            ${Ue({label:r?"Verifying...":"Verify",action:"submit-required-info",loading:r,disabled:r||!n})}
          </div>
        </div>
      `})}renderNoSavedPaymentMethods(){const e=Ci(this.designConfig),t=Boolean(e.emptyTitle||e.emptyMessage),i="delete-payment-source"===this.pendingAction,r=Di(this.interactionResponse),n=r.card||r.bankAccount;return this.renderWidgetShell({title:e.title,subtitle:e.subtitle,showClose:!1,showDivider:!1,content:P`
        <div class="payment-flow">
          ${t?Ye({title:e.emptyTitle,message:e.emptyMessage}):""}
          ${n?P`
                <div class="payment-action-links">
                  ${r.card?Qe({label:e.addCardTitle,subtitle:e.addCardSubtitle,action:"add-card",icon:"card",variant:"link",disabled:i}):""}
                  ${r.bankAccount?Qe({label:e.addBankAccountTitle,subtitle:e.addBankAccountSubtitle,action:"add-bank-account",icon:"bank",variant:"link",disabled:i}):""}
                </div>
              `:""}
        </div>
      `})}renderAddCardScreen(){const e="save-card"===this.pendingAction,t="encrypting"===this.cardEncryption.cardNumber.status||"encrypting"===this.cardEncryption.cvv.status,i=[...this.billingAddresses.map(e=>({value:e.id??"",label:hi(e)})),{value:dt,label:"Add new billing address"}],r=this.billingAddresses.find(e=>e.id===this.cardDraft.billingAddressValue),n=Boolean(r)&&!this.billingAddressSelectorExpanded,o=!n&&this.cardDraft.billingAddressValue===dt,a=[];return r&&n?a.push(P`
        <div class="billing-address-summary field field-full">
          <div class="billing-address-summary-heading">
            ...
            >
            ${it({label:"Change",action:"change-billing-address",disabled:e})}
          </div>
          <p class="billing-address-summary-value">
            ${hi(r)}
          </p>
        </div>
      `):a.push(He({id:"billing-address",name:"billingAddress",label:"Billing address",value:this.cardDraft.billingAddressValue,options:i,span:"full",variant:"card-form",dataField:"billingAddressValue",error:this.cardDraftErrors.billingAddressValue,disabled:e})),o&&a.push(He({id:"billing-country",name:"country",label:"Country or region",value:this.cardDraft.country,options:ht,span:"full",variant:"card-form",dataField:"country",error:this.cardDraftErrors.country,disabled:e}),_e({id:"billing-address-line-1",name:"addressLine1",label:"Address",value:this.cardDraft.addressLine1,placeholder:"Street address",span:"full",variant:"card-form",autocomplete:"address-line1",dataField:"addressLine1",error:this.cardDraftErrors.addressLine1,disabled:e}),_e({id:"billing-address-line-2",name:"addressLine2",label:"Address line 2",value:this.cardDraft.addressLine2,placeholder:"Apartment, suite, unit",span:"full",variant:"card-form",autocomplete:"address-line2",dataField:"addressLine2",error:this.cardDraftErrors.addressLine2,disabled:e}),_e({id:"billing-city",name:"city",label:"City",value:this.cardDraft.city,span:"full",variant:"card-form",autocomplete:"address-level2",dataField:"city",error:this.cardDraftErrors.city,disabled:e}),He({id:"billing-state",name:"state",label:"State",value:this.cardDraft.state,options:ut,span:"full",variant:"card-form",dataField:"state",error:this.cardDraftErrors.state,disabled:e}),_e({id:"billing-zip",name:"zip",label:"ZIP code",value:this.cardDraft.zip,placeholder:"ZIP code",span:"full",variant:"card-form",autocomplete:"postal-code",inputmode:"numeric",dataField:"zip",error:this.cardDraftErrors.zip,disabled:e})),this.renderWidgetShell({title:"Add card",headerAction:it({label:"Back",action:"back-to-payment-methods",disabled:e}),showClose:!1,showDivider:!1,busy:e,overlay:e?ur({title:"Saving card",helper:"Securely saving your card, please wait."}):void 0,content:P`
        <div class="payment-flow card-form-screen">
          ${this.cardSubmitError?We({variant:"danger",message:this.cardSubmitError}):""}
          ${rt([_e({id:"card-label",name:"name",label:"Card Name",value:this.cardDraft.name,placeholder:"Corporate card",span:"full",variant:"card-form",dataField:"name",error:this.cardDraftErrors.name,disabled:e}),_e({id:"card-number",name:"cardNumber",label:"Card number",value:this.cardDraft.cardNumber,placeholder:"1234 1234 1234 1234",span:"full",variant:"card-form",autocomplete:"cc-number",inputmode:"numeric",dataField:"cardNumber",error:this.cardDraftErrors.cardNumber,disabled:e}),_e({id:"expiration-date",name:"expirationDate",label:"Expiration",value:this.cardDraft.expirationDate,placeholder:"MM / YY",variant:"card-form",autocomplete:"cc-exp",inputmode:"numeric",dataField:"expirationDate",error:this.cardDraftErrors.expirationDate,disabled:e}),_e({id:"card-cvv",name:"cvv",label:"CVC",value:this.cardDraft.cvv,placeholder:"3 or 4 digits",variant:"card-form",autocomplete:"cc-csc",inputmode:"numeric",dataField:"cvv",error:this.cardDraftErrors.cvv,disabled:e}),_e({id:"name-on-card",name:"fullName",label:"Full name",value:this.cardDraft.fullName,placeholder:"Name on card",span:"full",variant:"card-form",autocomplete:"cc-name",dataField:"fullName",error:this.cardDraftErrors.fullName,disabled:e}),...a])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ue({label:e?"Saving payment method":"Save card",action:"save-card",loading:e,disabled:e||t||!Yt(this.cardDraft,this.cardEncryption)})}
            </div>
          </div>
        </div>
      `})}renderCardErrorScreen(){return this.renderWidgetShell({title:"Credit card not saved",subtitle:"We could not save this card. Check the card details or use a different payment method.",showClose:!1,showDivider:!1,content:tt({variant:"danger",content:this.cardSubmitError?We({variant:"danger",message:this.cardSubmitError}):void 0,actions:P`
          ${Ue({label:"Edit card details",action:"edit-card-details"})}
          ${it({label:"Use a different method",action:"use-different-method"})}
        `})})}renderBankProviderScreen(){return this.renderWidgetShell({title:"Connect your bank",headerAction:it({label:"Back",action:"back-to-payment-methods",disabled:this.bankLinkLoading}),showClose:!1,showDivider:!1,busy:this.bankLinkLoading,overlay:this.bankLinkLoading?ur({title:"Connecting to your bank",helper:"Securely opening your bank connection, please wait."}):void 0,content:P`
        <div class="bank-provider-flow">
          ${et({containerId:ct,loading:this.bankLinkLoading,loadingLabel:"Connecting to your bank"})}
          <div class="bank-provider-manual-link">
            ${it({label:"Connect another way",action:"add-ach-manually",disabled:this.bankLinkLoading})}
          </div>
        </div>
      `})}renderManualBankAccountScreen(){const e="save-ach-manual"===this.pendingAction,t="encrypting"===this.bankAccountEncryption.routingNumber.status||"encrypting"===this.bankAccountEncryption.accountNumber.status||"encrypting"===this.bankAccountEncryption.accountNumberReEntered.status;return this.renderWidgetShell({title:"Enter bank details",headerAction:it({label:"Back",action:"back-to-bank-provider",disabled:e}),showClose:!1,showDivider:!1,busy:e,overlay:e?ur({title:"Saving bank account",helper:"Securely saving your bank account, please wait."}):void 0,content:P`
        <div class="payment-flow card-form-screen">
          ${this.bankAccountSubmitError?We({variant:"danger",message:this.bankAccountSubmitError}):""}
          ${rt([_e({id:"ach-routing-number",name:"routingNumber",label:"Routing number",value:this.bankAccountDraft.routingNumber,span:"full",variant:"card-form",autocomplete:"off",inputmode:"numeric",dataField:"routingNumber",dataFieldScope:"bankAccount",error:this.bankAccountDraftErrors.routingNumber,disabled:e}),_e({id:"ach-account-number",name:"accountNumber",label:"Account number",value:this.bankAccountDraft.accountNumber,type:Ft("accountNumber",this.bankAccountDraft,this.bankAccountEncryption),span:"full",variant:"card-form",autocomplete:"off",inputmode:"numeric",dataField:"accountNumber",dataFieldScope:"bankAccount",error:this.bankAccountDraftErrors.accountNumber,disabled:e}),_e({id:"ach-account-number-confirm",name:"accountNumberReEntered",label:"Confirm account number",value:this.bankAccountDraft.accountNumberReEntered,type:Ft("accountNumberReEntered",this.bankAccountDraft,this.bankAccountEncryption),span:"full",variant:"card-form",autocomplete:"off",inputmode:"numeric",dataField:"accountNumberReEntered",dataFieldScope:"bankAccount",error:this.bankAccountDraftErrors.accountNumberReEntered,disabled:e})])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ue({label:e?"Saving bank account":"Save bank account",action:"save-ach-manual",loading:e,disabled:e||t||!Wt(this.bankAccountDraft,this.bankAccountEncryption)})}
            </div>
          </div>
        </div>
      `})}renderBankOutcomeScreen(){const e=fr(this.bankOutcomeSource),t="declined"===e.kind||"pending"===e.kind;return this.renderWidgetShell({title:e.title,headerAction:t?it({label:"Done",action:"done-bank-outcome"}):void 0,showClose:!1,showDivider:!1,content:P`
        <div class="verification-outcome-flow">
          ${We({variant:e.variant,message:e.message})}
          ${this.bankOutcomeSource?Ar(this.bankOutcomeSource):""}
          ${t?"":P`
                <div class="primitive-footer">
                  ${"verified"===e.kind?Ue({label:"Continue",action:"continue-bank-outcome"}):"pending"===e.kind?Ue({label:"Done",action:"done-bank-outcome"}):P`
                        ${Ue({label:this.bankLinkLoading?"Retrying":"Try again",action:"retry-bank-provider",loading:this.bankLinkLoading,disabled:this.bankLinkLoading})}
                        ${it({label:"Use a different account",action:"use-different-bank-account",disabled:this.bankLinkLoading})}
                      `}
                </div>
              `}
        </div>
      `})}getOtpInputs(){return[...this.renderRoot.querySelectorAll(".otp-input")]}getRequiredInfoSsnInputs(e){return[...this.renderRoot.querySelectorAll(".required-info-ssn-input")].filter(t=>t.dataset.requiredInfoDocKey===e)}storeRequiredInfoSsnInput(e){const t=e.dataset.requiredInfoDocKey;if(!t)return;const i=this.getRequiredInfoSsnInputs(t),r=i.indexOf(e),n=St(e),o=Ct(e.value);if(!(r<0)){if(o.length>n){const e=this.writeRequiredInfoSsnDigits(i,r,o);return this.syncRequiredInfoSsnValue(t,i),void this.focusRequiredInfoSsnInput(i,e)}e.value=o.slice(0,n),this.syncRequiredInfoSsnValue(t,i),e.value.length>=n&&this.focusRequiredInfoSsnInput(i,r+1)}}pasteRequiredInfoSsnInput(e,t){const i=t.dataset.requiredInfoDocKey;if(!i)return;const r=e,n="function"==typeof r.clipboardData?.getData?r.clipboardData.getData("text"):"",o=Ct(n);if(!o)return;e.preventDefault();const a=this.getRequiredInfoSsnInputs(i),s=a.indexOf(t);if(s<0)return;const c=this.writeRequiredInfoSsnDigits(a,s,o);this.syncRequiredInfoSsnValue(i,a),this.focusRequiredInfoSsnInput(a,c)}writeRequiredInfoSsnDigits(e,t,i){let r=0,n=t;return e.forEach((e,o)=>{if(o<t)return;const a=St(e),s=i.slice(r,r+a);e.value=s,s&&(n=o),r+=a}),n}syncRequiredInfoSsnValue(e,t){this.storeRequiredInfoValue(e,Ct(t.map(e=>e.value).join("")))}focusRequiredInfoSsnInput(e,t){e[Math.min(t,e.length-1)]?.focus()}syncOtpValueFromInputs(e=this.getOtpInputs()){this.otpValue=e.map(e=>e.value).join("").slice(0,6),this.otpErrorMessage=void 0}writeOtpDigits(e,t,i){const r=kt(i);let n=t;return r.slice(0,Math.max(e.length-t,0)).split("").forEach((i,r)=>{const o=t+r,a=e[o];a&&(a.value=i,n=o)}),n}focusOtpInput(e,t,i=t){const r=e[t]??e[Math.max(0,Math.min(i,e.length-1))];r&&r.focus()}async showAddCardScreen(){this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow(),this.cardFlowScreen="form",this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===dt||!this.billingAddresses.length;const e=this.interactionResponse?.interactionId,t=Boolean(this.interactionResponse?.selectedSource||this.interactionResponse?.paymentSources?.length);if(e&&t&&!this.billingAddresses.length&&void 0===this.interactionResponse?.billerAddress)try{await this.fetchInteraction(e)}catch(e){}}showManualBankAccountScreen(){this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow(),this.bankFlowScreen="manual",this.bankAccountDraft=bt(),this.bankAccountDraftErrors={},this.bankAccountEncryption=wt(),this.bankAccountSubmitError=void 0}updateBankAccountDraftField(e,t){if(zt(e)&&Ot(t,this.bankAccountEncryption[e])){const i={...this.bankAccountDraft,[e]:t};return this.bankAccountDraft=i,this.bankAccountDraftErrors=Kt(jt(i,this.bankAccountEncryption)),void(this.bankAccountSubmitError=void 0)}const i=Pt(e,t),r={...this.bankAccountDraft,[e]:i};let n=this.bankAccountEncryption;if(zt(e)){if(Ot(i,this.bankAccountEncryption[e]))return;n={...this.bankAccountEncryption,[e]:Xt(this.bankAccountEncryption[e],Mt(i))}}this.bankAccountDraft=r,this.bankAccountEncryption=n,this.bankAccountDraftErrors=Kt(jt(r,n)),this.bankAccountSubmitError=void 0}updateCardDraftField(e,t){const i=It(e,t);this.cardDraft={...this.cardDraft,[e]:i},"billingAddressValue"===e&&(this.billingAddressSelectorExpanded=i===dt),this.cardSubmitError=void 0,Et(e)&&(this.cardEncryption={...this.cardEncryption,[e]:Xt(this.cardEncryption[e],Dt(e,i))})}async encryptCardField(e,t){this.updateCardDraftField(e,t);const i=Dt(e,t),r=Jt(e,t);if(!i)return this.cardDraftErrors=ei(this.cardDraftErrors,e),void(this.cardEncryption={...this.cardEncryption,[e]:gt()});if(r)return this.cardDraftErrors={...ei(this.cardDraftErrors,e),[e]:r},void(this.cardEncryption={...this.cardEncryption,[e]:Xt(this.cardEncryption[e],i)});const n=this.cardEncryption[e];if("encrypting"!==n.status&&"encrypted"!==n.status||n.normalizedValue!==i){this.cardDraftErrors=ei(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypting",normalizedValue:i}};try{const t=await this.maskSensitiveCardValue(e,i);if(Dt(e,this.cardDraft[e])!==i)return;this.cardDraftErrors=ei(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypted",normalizedValue:i,encryptedValue:t}}}catch(t){if(Dt(e,this.cardDraft[e])!==i)return;this.cardDraftErrors={...ei(this.cardDraftErrors,e),[e]:Zt(e)},this.cardEncryption={...this.cardEncryption,[e]:{status:"failed",normalizedValue:i}}}}}async encryptBankAccountField(e,t){const i=this.bankAccountEncryption[e];if(Ot(t,i))return this.bankAccountDraft={...this.bankAccountDraft,[e]:t},void(this.bankAccountSubmitError=void 0);this.updateBankAccountDraftField(e,t);const r=Mt(t);if(!r){const t={...this.bankAccountEncryption,[e]:gt()};return this.bankAccountEncryption=t,void(this.bankAccountDraftErrors=Kt(jt(this.bankAccountDraft,t)))}if("encrypting"!==i.status&&"encrypted"!==i.status||i.normalizedValue!==r){this.bankAccountDraftErrors=ti(this.bankAccountDraftErrors,e),this.bankAccountEncryption={...this.bankAccountEncryption,[e]:{status:"encrypting",normalizedValue:r}};try{const t=await this.maskSensitiveBankAccountValue(e,r);if(Mt(this.bankAccountDraft[e])!==r)return;const i={...this.bankAccountDraft,[e]:Vt(r)},n={...this.bankAccountEncryption,[e]:{status:"encrypted",normalizedValue:r,encryptedValue:t}};this.bankAccountDraft=i,this.bankAccountEncryption=n,this.bankAccountDraftErrors=Kt(jt(i,n))}catch(t){if(Mt(this.bankAccountDraft[e])!==r)return;const i={...this.bankAccountEncryption,[e]:{status:"failed",normalizedValue:r}};this.bankAccountEncryption=i,this.bankAccountDraftErrors={...Kt(jt(this.bankAccountDraft,i)),[e]:Qt(e)}}}}async maskSensitiveCardValue(e,t){const i=this.requireInteractionId();if(!i)throw new Error("An interaction id is required to encrypt card details.");const r="cardNumber"===e?"card":"cvv",n=await this.requestCommerceHubJson(`/interaction/source/mask/${r}`,i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t}),credentials:"include"}),o=n.value?.trim();if(!o)throw new Error("The card encryption response did not include a value.");return o}async maskSensitiveBankAccountValue(e,t){const i=this.requireInteractionId();if(!i)throw new Error("An interaction id is required to encrypt ACH details.");const r="routingNumber"===e?"rt":"bn",n=await this.requestCommerceHubJson(`/interaction/source/mask/${r}`,i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t}),credentials:"include"}),o=n.value?.trim();if(!o)throw new Error("The ACH encryption response did not include a value.");return o}async saveCard(){if("save-card"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=Lt(this.cardDraft),i={...Gt(t),...ii(t,this.cardEncryption)};if(Object.keys(i).length>0)return this.cardDraft=t,this.cardDraftErrors=i,void(this.cardSubmitError=void 0);this.pendingAction="save-card",this.cardDraft=t,this.cardDraftErrors={},this.cardSubmitError=void 0;try{const i=ri("cardNumber",t.cardNumber,this.cardEncryption),r=ri("cvv",t.cvv,this.cardEncryption),n=ci(t.expirationDate);if(!n)return void(this.cardDraftErrors={expirationDate:"Enter a valid expiration date."});const o=await this.resolveBillingAddressId(e,t),a={id:"",tenderType:"CARD",name:t.name,billingAddressId:o,card:{nameOnCard:t.fullName,cardNumber:i,cvv:r,cardNumberEncrypted:i,cvvEncrypted:r,expirationMonth:n.month,expirationYear:n.year,network:di(t.cardNumber)}},s=await this.requestCommerceHubJson("/interaction/source/card",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a),credentials:"include"}),c=this.sourceWithVerificationResponse(fi(a,t.cardNumber),s),d=gi(s,"The card creation response did not include a source id."),l=this.interactionResponseWithAddedSource(e,c);if(this.cardFlowScreen=void 0,this.cardDraft=vt(),this.cardDraftErrors={},this.cardEncryption=yt(),this.cardSubmitError=void 0,this.setInteractionResponseFromSdk(l),"VERIFIED"===c.verificationInfo?.status)return void await this.attachPaymentSource(d);this.showAddedPaymentSourceStatus(c)}catch(e){this.cardSubmitError=ir(e),this.cardFlowScreen="error"}finally{this.pendingAction=void 0}}async saveManualBankAccount(){if("save-ach-manual"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=jt(this.bankAccountDraft,this.bankAccountEncryption),i=Kt(t);if(Object.keys(i).length>0)return this.bankAccountDraft=_t(this.bankAccountDraft,this.bankAccountEncryption),this.bankAccountDraftErrors=i,void(this.bankAccountSubmitError=void 0);this.pendingAction="save-ach-manual",this.bankAccountDraft=_t(this.bankAccountDraft,this.bankAccountEncryption),this.bankAccountDraftErrors={},this.bankAccountSubmitError=void 0;try{await this.encryptChangedBankAccountFields();const t=jt(this.bankAccountDraft,this.bankAccountEncryption),i=Kt(t);if(Object.keys(i).length>0)return this.bankAccountDraftErrors=i,void(this.bankAccountSubmitError=void 0);const r=ni("routingNumber",this.bankAccountDraft,this.bankAccountEncryption),n=ni("accountNumber",this.bankAccountDraft,this.bankAccountEncryption),o=ni("accountNumberReEntered",this.bankAccountDraft,this.bankAccountEncryption),a=oi("accountNumber",this.bankAccountEncryption,t),s={id:"",tenderType:"BANK_ACCOUNT",bankAccount:{routingNumber:r,accountNumber:n,accountNumberReEntered:o,routingNumberEncrypted:r,accountNumberEncrypted:n}},c=await this.requestCommerceHubJson("/interaction/source/ach",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s),credentials:"include"}),d=this.sourceWithVerificationResponse(vi(s,a),c),l=gi(c,"The bank account creation response did not include a source id."),h=this.interactionResponseWithAddedSource(e,d);if(this.bankFlowScreen=void 0,this.bankAccountDraft=bt(),this.bankAccountDraftErrors={},this.bankAccountEncryption=wt(),this.bankAccountSubmitError=void 0,this.setInteractionResponseFromSdk(h),"VERIFIED"===d.verificationInfo?.status)return void await this.attachPaymentSource(l);this.showAddedPaymentSourceStatus(d)}catch(e){this.bankAccountSubmitError=ir(e)}finally{this.pendingAction=void 0}}async encryptChangedBankAccountFields(){for(const e of["routingNumber","accountNumber","accountNumberReEntered"]){const t=this.bankAccountDraft[e],i=this.bankAccountEncryption[e];if(Ot(t,i))continue;const r=Mt(t);if(!r)continue;"encrypted"===i.status&&i.normalizedValue===r&&Boolean(i.encryptedValue)||await this.encryptBankAccountField(e,t)}}async resolveBillingAddressId(e,t){if(t.billingAddressValue!==dt)return t.billingAddressValue;const i=ui(t),r=await this.requestCommerceHubJson("/interaction/billing-address",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i),credentials:"include"}),n=r.value?.trim();if(!n)throw new Error("The billing address response did not include an id.");return n}async verifyOtp(){if("verify-otp"===this.pendingAction)return;if(this.otpValue.length<6)return;const e=this.requireInteractionId();if(e){this.pendingAction="verify-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/validate",{body:{otp:this.otpValue,channel:"EMAIL"}}),i=tr(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(i)}catch(e){this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk({...this.interactionResponse,status:"OTP_VALIDATION_FAILED"})}finally{this.pendingAction=void 0}}}async resendOtp(){if("resend-otp"===this.pendingAction)return;const e=this.requireInteractionId();if(e){this.pendingAction="resend-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/send/email"),i=tr(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(i)}catch(e){}finally{this.pendingAction=void 0}}}async attachPaymentSource(e){if("attach-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),i=this.findPaymentSourceById(e);if(t&&i&&"VERIFIED"===i.verificationInfo?.status){this.selectedPaymentSourceId=e,this.paymentSourceView="selected",this.pendingAction="attach-payment-source";try{const r=await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}/attach`,t,{method:"POST",credentials:"include"}),n=Xi(this.interactionResponse??{interactionId:t},r,e),o=Zi(n,e)??n.paymentSources?.find(t=>t.id===e)??i;this.selectedPaymentSourceId=o.id,this.setInteractionResponseFromSdk(n),this.paymentSourceView="selected",this.dispatchEvent(new CustomEvent(at,{detail:o}))}catch(e){}finally{this.pendingAction=void 0}}}async verifySavedPaymentSource(e){if("verify-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),i=this.findPaymentSourceById(e);if(t&&i){if(Ir(i))return this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(i);if("NOT_VERIFIED"===i.verificationInfo?.status){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",this.pendingAction="verify-payment-source";try{const r=await this.verifyPaymentSourceStep1(t,{...i,id:e}),n=dr({...this.interactionResponse??{interactionId:t},selectedSource:this.interactionResponse?.selectedSource,status:lt},r);if(this.setInteractionResponseFromSdk(n),Ir(r))return void this.showRequiredInfoSource(r);if("VERIFIED"===r.verificationInfo?.status){const t=r.id?.trim()||e;return this.pendingAction=void 0,void await this.attachPaymentSource(t)}this.savedSourceVerificationSource=r,this.savedSourceVerificationFailed=!1}catch(e){this.savedSourceVerificationSource=i,this.savedSourceVerificationFailed=!0}finally{"verify-payment-source"===this.pendingAction&&(this.pendingAction=void 0)}}}}async deletePaymentSource(e){if("delete-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),i=this.findPaymentSourceById(e);if(t&&i)if(this.deleteConfirmationPaymentSourceId===e){this.clearDeletePaymentSourceConfirmation(),this.pendingAction="delete-payment-source";try{await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}`,t,{method:"DELETE",credentials:"include"});const i=er(this.interactionResponse??{interactionId:t},e);i.paymentSources?.length||(this.paymentSourceEditMode=!1),this.setInteractionResponseFromSdk(i)}catch(e){}finally{this.pendingAction=void 0}}else this.armDeletePaymentSourceConfirmation(e)}armDeletePaymentSourceConfirmation(e){this.clearDeletePaymentSourceConfirmation(),this.deleteConfirmationPaymentSourceId=e,this.deleteConfirmationTimeoutId=window.setTimeout(()=>{this.deleteConfirmationPaymentSourceId===e&&this.clearDeletePaymentSourceConfirmation()},5e3)}clearDeletePaymentSourceConfirmation(){void 0!==this.deleteConfirmationTimeoutId&&(window.clearTimeout(this.deleteConfirmationTimeoutId),this.deleteConfirmationTimeoutId=void 0),this.deleteConfirmationPaymentSourceId=void 0}findPaymentSourceById(e){return(this.interactionResponse?.paymentSources??[]).find(t=>t.id===e)??(this.interactionResponse?.selectedSource?.id===e?this.interactionResponse.selectedSource:void 0)}resetSavedSourceVerification(){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1}showPaymentSourceList({refresh:e=!1}={}){this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.paymentSourceView="list",e&&this.refreshPaymentSourcesForList()}async refreshPaymentSourcesForList(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}interactionResponseWithAddedSource(e,t){const i=t.id?.trim(),r=Boolean(i)&&hr(t),n={...this.interactionResponse??{interactionId:e},status:lt};return r?cr(n,t):dr({...n,selectedSource:this.interactionResponse?.selectedSource},t)}showAddedPaymentSourceStatus(e){const t=e.id?.trim();return this.resetSavedSourceVerification(),this.resetRequiredInfo(),Ir(e)?(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(e)):"VERIFIED"===e.verificationInfo?.status?(this.selectedPaymentSourceId=t,void(this.paymentSourceView="selected")):(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",Nr(e)?(this.bankOutcomeSource=e,void(this.bankFlowScreen="outcome")):(this.savedSourceVerificationSource=e,void(this.savedSourceVerificationFailed=!1)))}showRequiredInfoSource(e){this.requiredInfoSource=e,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}resetRequiredInfo(){this.requiredInfoSource=void 0,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}firstRequiredInfoDocKey(){return Cr(gr(this.requiredInfoSource))??yr(gr(this.requiredInfoSource)[0],0)}storeRequiredInfoValue(e,t){this.requiredInfoValues={...this.requiredInfoValues,[e]:t},this.requiredInfoSubmitError=void 0}storeRequiredInfoSelectedFile(e){if(!this.requiredInfoSource||!e)return void(this.pendingRequiredInfoDocKey=void 0);const t=this.pendingRequiredInfoDocKey??this.firstRequiredInfoDocKey();this.requiredInfoFiles={...this.requiredInfoFiles,[t]:e},this.requiredInfoFileNames={...this.requiredInfoFileNames,[t]:e.name},this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}canSubmitRequiredInfo(){const e=this.requiredInfoSource;return!!e?.id?.trim()&&gr(e).some((e,t)=>{const i=yr(e,t);return wr(e)?Boolean(this.requiredInfoValues[i]?.trim()):Boolean(this.requiredInfoFiles[i])})}async submitRequiredInfo(){if("submit-required-info"===this.pendingAction)return;const e=this.requireInteractionId(),t=this.requiredInfoSource,i=t?.id?.trim();if(e&&t&&i)if(this.canSubmitRequiredInfo()){this.pendingAction="submit-required-info",this.requiredInfoSubmitError=void 0;try{const r=gr(t),n=this.providedRequiredInfoEntries(r,!0),o=this.providedRequiredInfoEntries(r,!1);let a=t;n.length>0?(await this.uploadRequiredInfoEntries(e,i,n),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,i)),Ir(a)&&o.length>0&&(await this.uploadRequiredInfoEntries(e,i,o),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,i)))):(await this.uploadRequiredInfoEntries(e,i,o),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,i)));const s=dr({...this.interactionResponse??{interactionId:e},selectedSource:this.interactionResponse?.selectedSource,status:lt},a);if(this.setInteractionResponseFromSdk(s),"VERIFIED"===a.verificationInfo?.status){const e=a.id?.trim()||i;return this.resetRequiredInfo(),this.pendingAction=void 0,void await this.attachPaymentSource(e)}if(Ir(a))return this.requiredInfoSource=a,this.requiredInfoValues={},this.requiredInfoFileNames={},void(this.requiredInfoFiles={});this.resetRequiredInfo(),this.savedSourceVerificationSource=a,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=a.id,this.paymentSourceView="list"}catch(e){this.requiredInfoSubmitError=ir(e)||"We could not submit the required information. Please try again."}finally{"submit-required-info"===this.pendingAction&&(this.pendingAction=void 0)}}else this.requiredInfoSubmitError="Add required or optional information before verifying."}providedRequiredInfoEntries(e,t){return e.map((e,t)=>({doc:e,index:t})).filter(({doc:e,index:i})=>(t?!0===e.mandatory:!0!==e.mandatory)&&this.hasRequiredInfoValue(e,i))}hasRequiredInfoValue(e,t){const i=yr(e,t);return wr(e)?Boolean(this.requiredInfoValues[i]?.trim()):Boolean(this.requiredInfoFiles[i])}async uploadRequiredInfoEntries(e,t,i){for(const{doc:r,index:n}of i){const i=r.docType;if(!i)continue;const o=yr(r,n);if(wr(r)){const r=this.requiredInfoValues[o]?.trim();r&&await this.uploadRequiredInfoField(e,t,i,r);continue}const a=this.requiredInfoFiles[o];a&&await this.uploadRequiredInfoDocument(e,t,i,a)}}async verifyRequiredInfoStep2(e,t){return this.showMinimumVerificationOverlay("submit-required-info"),this.requestCommerceHubJson("/interaction/verify/step2",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t}),credentials:"include"})}sourceWithVerificationResponse(e,t){const{sourceId:i,...r}=t,n=i?.trim();return{...e,id:n||e.id,verificationInfo:{...e.verificationInfo,...r}}}async uploadRequiredInfoField(e,t,i,r){await this.requestCommerceHubJson("/interaction/verify/uploadField",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({docType:i,value:t,docValue:r}),credentials:"include"})}async uploadRequiredInfoDocument(e,t,i,r){const n=new FormData;n.set("file",r),await this.requestCommerceHubJson(`/interaction/doc/upload/${encodeURIComponent(t)}/${encodeURIComponent(i)}`,e,{method:"POST",body:n,credentials:"include"})}async startPayByBankFlow(){if(this.bankLinkLoading)return;const e=this.requireInteractionId();if(e){this.bankFlowScreen="provider",this.bankOutcomeSource=void 0,this.bankLinkLoading=!0,this.ensurePayByBankProviderContainer(ct),await this.updateComplete;try{await this.launchPayByBankProvider(e,ct)}catch(e){this.resetBankFlow(),this.showPaymentSourceList({refresh:!0})}finally{this.bankLinkLoading=!1}}}async launchPayByBankProvider(e,t){const i=await this.requestCommerceHubJson("/interaction/source/pbb/session",e,{method:"GET",credentials:"include"}),{aggregatorSessionId:r,accessToken:n,pToken:o,publicKey:a}=ar(i),s=Si(this.designConfig?.payByBank),c=Ei(s.apiKey,"apiKey"),d=Ei(s.configId,"configId");await Lr(s.paymentSdkUrl);const l=window.PaymentSDK;if(!l?.init)throw new Error("PaymentSDK.js loaded but PaymentSDK.init is not available on window.");await new Promise((i,h)=>{let u=!1;Mr(),l.init({apiKey:c,accessToken:n,configId:d,environment:s.environment,locale:s.locale,appearance:zi(this.designConfig),publicKey:a,pToken:o,aggregatorSessionId:r,containerId:t,onEvent:async t=>{if(!u&&sr(t)){if(Mr(),"success"!==t.type)return u=!0,this.resetBankFlow(),this.showPaymentSourceList({refresh:!0}),void i();try{const t=await this.finalizePayByBankSession(e,r,o),n=bi(t),a=n.id?.trim();if(!a)throw new Error("Connect your bank completed but the resolved bank payment source did not include an id.");const s=this.interactionResponseWithAddedSource(e,n);if(this.setInteractionResponseFromSdk(s),this.resetBankFlow(),"VERIFIED"===n.verificationInfo?.status)return await this.attachPaymentSource(a),u=!0,void i();this.showAddedPaymentSourceStatus(n),u=!0,i()}catch(e){u=!0,h(e)}}}}),this.bankLinkLoading=!1})}async refreshPaymentSourcesFromInteraction(){const e=this.interactionResponse?.interactionId;if(e&&this.shouldRefreshPaymentSourcesFromInteraction()){this.interactionRefreshInteractionId=e;try{await this.fetchInteraction(e)}catch(e){}}}queueNativeAccountBalanceRefresh(){const e=this.interactionResponse?.interactionId,t=_i(this.interactionResponse);if(!e||0===t.length){const e=void 0!==this.nativeBalanceFetchKey||void 0!==this.nativeBalanceQueuedFetchKey||Object.keys(this.nativeAccountBalances).length>0||this.nativeBalanceLoadingSourceIds.length>0;if(this.nativeBalanceQueuedFetchKey=void 0,!e)return;return void queueMicrotask(()=>{0===_i(this.interactionResponse).length&&(this.nativeBalanceFetchKey=void 0,this.nativeAccountBalances={},this.nativeBalanceLoadingSourceIds=[])})}const i=Hi(e,t);this.nativeBalanceFetchKey!==i&&this.nativeBalanceQueuedFetchKey!==i&&(this.nativeBalanceQueuedFetchKey=i,queueMicrotask(()=>{if(this.nativeBalanceQueuedFetchKey!==i)return;this.nativeBalanceQueuedFetchKey=void 0;const e=this.interactionResponse?.interactionId,t=_i(this.interactionResponse);e&&0!==t.length&&Hi(e,t)===i&&this.refreshNativeAccountBalances()}))}async refreshNativeAccountBalances(){const e=this.interactionResponse?.interactionId,t=_i(this.interactionResponse);if(!e||0===t.length)return this.nativeBalanceFetchKey=void 0,this.nativeBalanceQueuedFetchKey=void 0,this.nativeAccountBalances={},void(this.nativeBalanceLoadingSourceIds=[]);const i=Hi(e,t);if(this.nativeBalanceFetchKey!==i){this.nativeBalanceFetchKey=i,this.nativeAccountBalances={},this.nativeBalanceLoadingSourceIds=t.map(ji);try{const t=await this.createSdkClient(e).GET("/interaction/source/native/balances");if(this.nativeBalanceFetchKey!==i)return;this.nativeAccountBalances=t.data??{}}catch(e){this.nativeBalanceFetchKey===i&&(this.nativeAccountBalances={})}finally{this.nativeBalanceFetchKey===i&&(this.nativeBalanceLoadingSourceIds=[])}}}shouldRefreshPaymentSourcesFromInteraction(){const e=this.interactionResponse,t=e?.interactionId;return!!t&&(this.interactionRefreshInteractionId!==t&&((Qi(e.status)||"PAYMENT_SOURCE_ATTACHED"===e.status)&&void 0===e.paymentSources))}async fetchInteraction(e){return this.interactionRefreshInteractionId===e&&this.interactionRefreshPromise||(this.interactionRefreshInteractionId=e,this.interactionRefreshPromise=this.createSdkClient(e).GET("/interaction").then(e=>tr(e)).then(t=>{const i=Xi(this.interactionResponse??{interactionId:e},t,this.selectedPaymentSourceId);return this.setInteractionResponseFromSdk(i),i}).finally(()=>{this.interactionRefreshPromise=void 0,this.requestUpdate()})),this.interactionRefreshPromise}syncBillingAddressesFromInteractionResponse(e){e.billerAddress&&(this.billingAddresses=e.billerAddress.filter(e=>Boolean(e.id?.trim())),this.cardDraft=li(this.cardDraft,this.billingAddresses),this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===dt)}async finalizePayByBankSession(e,t,i){return this.requestCommerceHubJson(`/interaction/source/pbb/session/${encodeURIComponent(t)}/${encodeURIComponent(i)}`,e,{method:"PUT",credentials:"include"})}async verifyPaymentSourceStep1(e,t){this.showMinimumVerificationOverlay("verify-payment-source");const i=await this.requestCommerceHubJson("/interaction/verify/step1",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t.id}),credentials:"include"});return this.sourceWithVerificationResponse(t,i)}async requestCommerceHubJson(e,t,i){const r=this.createInteractionHeaders(t,i.headers);r.has("Accept")||r.set("Accept","application/json");const n=new Request(`${xe(this.baseURL)}${e}`,{...i,headers:r}),o=await fetch(n),a=o.headers.get("content-type")??"",s=204===o.status?void 0:a.includes("application/json")?await o.json():await o.text();if(!o.ok)throw new Error(ir(s)||o.statusText);return s}resetBankFlow(){this.bankFlowScreen=void 0,this.bankOutcomeSource=void 0,this.bankLinkLoading=!1,this.bankAccountDraft=bt(),this.bankAccountDraftErrors={},this.bankAccountEncryption=wt(),this.bankAccountSubmitError=void 0,this.removePayByBankProviderContainer()}resetCardFlow(){this.cardFlowScreen=void 0,this.cardDraft=vt(),this.cardDraftErrors={},this.cardEncryption=yt(),this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=!1}ensurePayByBankProviderContainer(e){const t=[...this.children].find(t=>t instanceof HTMLElement&&t.id===e),i=t??document.createElement("div");return i.id=e,i.slot=e,i.className="provider-frame-container",i.replaceChildren(),t||this.appendChild(i),i}removePayByBankProviderContainer(){[...this.children].filter(e=>e instanceof HTMLElement&&e.id===ct).forEach(e=>e.remove())}requireInteractionId(){const e=this.interactionResponse?.interactionId;if(e)return e}createSdkClient(e){return Ce({baseURL:this.baseURL,getHeaders:()=>this.createInteractionHeaders(e)})}createInteractionHeaders(e,t){const i=new Headers(t),r=this.interactionResponse?.oauth?.access_token?.trim();return i.set("x-interaction-id",e),r&&!i.has("Authorization")&&i.set("Authorization",`Bearer ${r}`),i}setInteractionResponseFromSdk(e){this.interactionResponse=this.interactionResponseWithPreservedGatewayOAuth(e)}interactionResponseWithPreservedGatewayOAuth(e){if(e.oauth)return e;const t=this.interactionResponse;return!t?.oauth||t.interactionId&&e.interactionId&&t.interactionId!==e.interactionId?e:{...e,oauth:t.oauth}}syncDesignConfigStyles(){for(const e of Ri)this.style.removeProperty(e);const e=this.designConfig?.colors;if(e)for(const{field:t,property:i}of qi){const r=e[t];r&&this.style.setProperty(i,r)}const t=this.designConfig?.baseFontSize;t?this.style.fontSize=t:this.style.removeProperty("font-size");const i=this.designConfig?.baseFontWeight?.trim();i?this.style.setProperty(Ni,i):this.style.removeProperty(Ni);const r=this.designConfig?.shellPadding?.trim();r?this.style.setProperty(Bi,r):this.style.removeProperty(Bi)}};ft.styles=De,ot([de({attribute:!1})],ft.prototype,"interactionResponse",void 0),ot([de({attribute:!1})],ft.prototype,"designConfig",void 0),ot([de({attribute:"base-url"})],ft.prototype,"baseURL",void 0),ot([le()],ft.prototype,"selectedPaymentSourceId",void 0),ot([le()],ft.prototype,"otpValue",void 0),ot([le()],ft.prototype,"pendingAction",void 0),ot([le()],ft.prototype,"minimumVerificationOverlayAction",void 0),ot([le()],ft.prototype,"otpErrorMessage",void 0),ot([le()],ft.prototype,"bankFlowScreen",void 0),ot([le()],ft.prototype,"bankLinkLoading",void 0),ot([le(),le()],ft.prototype,"bankOutcomeSource",void 0),ot([le()],ft.prototype,"bankAccountDraft",void 0),ot([le()],ft.prototype,"bankAccountDraftErrors",void 0),ot([le()],ft.prototype,"bankAccountEncryption",void 0),ot([le()],ft.prototype,"bankAccountSubmitError",void 0),ot([le(),le()],ft.prototype,"cardFlowScreen",void 0),ot([le()],ft.prototype,"cardDraft",void 0),ot([le()],ft.prototype,"cardDraftErrors",void 0),ot([le()],ft.prototype,"cardEncryption",void 0),ot([le()],ft.prototype,"cardSubmitError",void 0),ot([le()],ft.prototype,"billingAddresses",void 0),ot([le()],ft.prototype,"billingAddressSelectorExpanded",void 0),ot([le()],ft.prototype,"nativeAccountBalances",void 0),ot([le()],ft.prototype,"nativeBalanceLoadingSourceIds",void 0),ot([le()],ft.prototype,"paymentSourceView",void 0),ot([le()],ft.prototype,"paymentSourceEditMode",void 0),ot([le()],ft.prototype,"deleteConfirmationPaymentSourceId",void 0),ot([le()],ft.prototype,"savedSourceVerificationSource",void 0),ot([le()],ft.prototype,"savedSourceVerificationFailed",void 0),ot([le()],ft.prototype,"requiredInfoSource",void 0),ot([le()],ft.prototype,"requiredInfoValues",void 0),ot([le()],ft.prototype,"requiredInfoFileNames",void 0),ot([le()],ft.prototype,"requiredInfoSubmitError",void 0),ft=ot([(e=>(t,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)})("commerce-hub-connect")],ft);const vt=()=>({name:"",fullName:"",cardNumber:"",expirationDate:"",cvv:"",billingAddressValue:dt,country:"",addressLine1:"",addressLine2:"",city:"",state:"",zip:""}),bt=()=>({routingNumber:"",accountNumber:"",accountNumberReEntered:""}),gt=()=>({status:"idle",normalizedValue:""}),yt=()=>({cardNumber:gt(),cvv:gt()}),wt=()=>({routingNumber:gt(),accountNumber:gt(),accountNumberReEntered:gt()}),kt=e=>e.replace(/\D/g,""),$t=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input")),xt=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("required-info-ssn-input")),Ct=e=>e.replace(/\D/g,"").slice(0,9),St=e=>{const t=Number(e.dataset.requiredInfoSsnSegment);return br[t]??0},Et=e=>"cardNumber"===e||"cvv"===e,zt=e=>"routingNumber"===e||"accountNumber"===e||"accountNumberReEntered"===e,At=e=>e.replace(/\D/g,""),It=(e,t)=>"cardNumber"===e?qt(t):"expirationDate"===e?Tt(t):"cvv"===e?Rt(t).slice(0,4):t,qt=e=>{const t=At(e).slice(0,19);return Bt(t,Nt(t))},Nt=e=>/^3[47]/.test(e)?[4,6,5]:/^3(?:0[0-5]|[68])/.test(e)?[4,6,4]:[4,4,4,4,3],Bt=(e,t)=>{const i=[];let r=0;for(const n of t){if(r>=e.length)break;i.push(e.slice(r,r+n)),r+=n}return r<e.length&&i.push(e.slice(r)),i.join(" ")},Rt=e=>e.replace(/\D/g,""),Tt=e=>{const t=e.replace(/\D/g,"").slice(0,6);return t.length<=2?2===t.length?`${t} / `:t:`${t.slice(0,2)} / ${t.slice(2)}`},Dt=(e,t)=>"cardNumber"===e?At(t):Rt(t),Lt=e=>({name:e.name.trim(),fullName:e.fullName.trim(),cardNumber:e.cardNumber.trim(),expirationDate:e.expirationDate.trim(),cvv:e.cvv.trim(),billingAddressValue:e.billingAddressValue.trim()||dt,country:e.country.trim(),addressLine1:e.addressLine1.trim(),addressLine2:e.addressLine2.trim(),city:e.city.trim(),state:e.state.trim(),zip:e.zip.trim()}),Mt=e=>e.replace(/\D/g,""),Ot=(e,t)=>"encrypted"===t.status&&Boolean(t.normalizedValue)&&e===Vt(t.normalizedValue),Vt=e=>e.length<=4?e:`${"•".repeat(e.length-4)}${nr(e)}`,Ft=(e,t,i)=>"routingNumber"===e||Ot(t[e],i[e])?"text":"password",Pt=(e,t)=>"routingNumber"===e?Mt(t).slice(0,9):"accountNumber"===e||"accountNumberReEntered"===e?Mt(t).slice(0,17):t,jt=(e,t)=>({routingNumber:Ut("routingNumber",e,t),accountNumber:Ut("accountNumber",e,t),accountNumberReEntered:Ut("accountNumberReEntered",e,t)}),Ut=(e,t,i)=>{const r=t[e],n=i[e];return Ot(r,n)?n.normalizedValue:Mt(r)},_t=(e,t)=>({routingNumber:Ht("routingNumber",e,t),accountNumber:Ht("accountNumber",e,t),accountNumberReEntered:Ht("accountNumberReEntered",e,t)}),Ht=(e,t,i)=>{const r=t[e];return Ot(r,i[e])?r:Mt(r)},Kt=e=>{const t={},i=Mt(e.routingNumber),r=Mt(e.accountNumber),n=Mt(e.accountNumberReEntered);return i?9!==i.length&&(t.routingNumber="Enter a 9-digit routing number."):t.routingNumber="Enter a routing number.",r||(t.accountNumber="Enter an account number."),n?r&&n!==r&&(t.accountNumberReEntered="Account numbers must match."):t.accountNumberReEntered="Confirm the account number.",t},Wt=(e,t)=>{const i=jt(e,t);return 0===Object.keys(Kt(i)).length&&["routingNumber","accountNumber","accountNumberReEntered"].every(e=>{const r=t[e],n=i[e];return"encrypted"===r.status&&r.normalizedValue===n&&Boolean(r.encryptedValue)})},Gt=e=>{const t={};return e.name||(t.name="Enter a card name."),e.fullName||(t.fullName="Enter the full name."),ai(e.cardNumber)||(t.cardNumber="Enter a valid card number."),ci(e.expirationDate)||(t.expirationDate="Enter a valid expiration date."),si(e.cvv)||(t.cvv="Enter a valid CVC."),e.billingAddressValue||(t.billingAddressValue="Select a billing address."),e.billingAddressValue===dt&&(e.country||(t.country="Select a country or region."),e.addressLine1||(t.addressLine1="Enter an address."),e.city||(t.city="Enter a city."),e.state||(t.state="Select a state."),/^\d{5}(?:-\d{4})?$/.test(e.zip)||(t.zip="Enter a valid ZIP code.")),t},Yt=(e,t)=>0===Object.keys(Gt(Lt(e))).length&&0===Object.keys(ii(e,t)).length,Jt=(e,t)=>"cardNumber"===e?ai(t)?void 0:"Enter a valid card number.":si(t)?void 0:"Enter a valid CVC.",Zt=e=>"cardNumber"===e?"Unable to encrypt the card number. Try again.":"Unable to encrypt the CVC. Try again.",Qt=e=>"routingNumber"===e?"Unable to encrypt the routing number. Try again.":"Unable to encrypt the account number. Try again.",Xt=(e,t)=>t?e.normalizedValue!==t||"encrypting"!==e.status&&"encrypted"!==e.status?{status:"dirty",normalizedValue:t}:e:gt(),ei=(e,t)=>{const i={...e};return delete i[t],i},ti=(e,t)=>{const i={...e};return delete i[t],i},ii=(e,t)=>{const i={};for(const r of["cardNumber","cvv"]){const n=Dt(r,e[r]),o=t[r];if(!n)continue;"encrypted"===o.status&&o.normalizedValue===n&&Boolean(o.encryptedValue)||(i[r]="failed"===o.status?Zt(r):"cardNumber"===r?"Encrypt the card number before saving.":"Encrypt the CVC before saving.")}return i},ri=(e,t,i)=>{const r=Dt(e,t),n=i[e];if("encrypted"!==n.status||n.normalizedValue!==r||!n.encryptedValue)throw new Error("cardNumber"===e?"Card number encryption must complete before saving.":"CVC encryption must complete before saving.");return n.encryptedValue},ni=(e,t,i)=>{const r=t[e],n=Mt(r),o=i[e],a=Ot(r,o)||n===o.normalizedValue;if("encrypted"===o.status&&o.encryptedValue&&a)return o.encryptedValue;if(!n)return"";throw new Error("ACH detail encryption must complete before saving.")},oi=(e,t,i)=>nr(t[e].normalizedValue||i[e]),ai=e=>{const t=At(e);if(t.length<12||t.length>19)return!1;let i=0,r=!1;for(let e=t.length-1;e>=0;e-=1){let n=Number(t[e]);r&&(n*=2,n>9&&(n-=9)),i+=n,r=!r}return i%10==0},si=e=>/^\d{3,4}$/.test(Rt(e)),ci=e=>{const t=e.replace(/\D/g,""),i=t.slice(0,2),r=t.slice(2),n=Number(i);if(!(2!==i.length||n<1||n>12))return 2===r.length?{month:i,year:`20${r}`}:4===r.length?{month:i,year:r}:void 0},di=e=>{const t=At(e);return/^4/.test(t)?"Visa":/^(5[1-5]|2[2-7])/.test(t)?"Mastercard":/^3[47]/.test(t)?"AmericanExpress":/^(6011|65|64[4-9])/.test(t)?"Discover":void 0},li=(e,t)=>{const i=t.map(e=>e.id?.trim()).filter(e=>Boolean(e));if(!i.length)return{...e,billingAddressValue:dt};if(i.includes(e.billingAddressValue))return e;const r=[e.country,e.addressLine1,e.addressLine2,e.city,e.state,e.zip].some(e=>e.trim());return e.billingAddressValue===dt&&r?e:{...e,billingAddressValue:i[0]}},hi=e=>{const t=[e.stateOrProvince,e.postalCode].filter(Boolean).join(" "),i=[e.city,t].filter(Boolean).join(", ");return[e.street,i].filter(Boolean).join(", ")||e.id||"Saved billing address"},ui=e=>({id:pi(),recipientNameOrAddress:e.fullName,country:e.country,street:e.addressLine1,houseNumberOrName:e.addressLine2||void 0,city:e.city,stateOrProvince:e.state,postalCode:e.zip});let mi=0;const pi=()=>(mi+=1,`billing-address-${Date.now().toString(36)}-${mi.toString(36)}`),fi=(e,t)=>{const i=At(t??"").slice(-4);return{...e,tenderType:"Card",card:{...e.card,...i?{cardNumber:i}:{}}}},vi=(e,t)=>{const i=Mt(t??"").slice(-4);return{...e,tenderType:"BankAccount",bankAccount:{...e.bankAccount,...i?{accountNumber:i}:{}}}},bi=e=>({id:gi(e,"Connect your bank completed but the verification response did not include a source id."),tenderType:"BankAccount",verificationInfo:yi(e),bankAccount:{}}),gi=(e,t)=>{const i=e.sourceId?.trim();if(!i)throw new Error(t);return i},yi=e=>{const{sourceId:t,...i}=e;return i},wi=e=>`We sent a one-time code to ${e??"your contact method"}.`,ki=e=>{const t=e?.email?.trim();if(t)return t;const i=e?.phone?.countryCode?.trim(),r=e?.phone?.phoneNumber?.trim();return[i,r].filter(Boolean).join(" ")||void 0},$i=e=>{const t=e?.copy?.otp;return{title:t?.title??"Enter verification code",subtitle:t?.subtitle,failedMessage:t?.failedMessage??"The code does not match. Try again.",resendPrefix:t?.resendPrefix??"Didn't receive the code?",resendButton:t?.resendButton??"Resend code",resendPendingButton:t?.resendPendingButton??"Sending code...",verifyButton:t?.verifyButton??"Verify",verifyingButton:t?.verifyingButton??"Verifying...",tryAgainButton:t?.tryAgainButton??"Try again"}},xi=e=>{const t=e?.copy?.paymentMethods;return{title:t?.title??"Pay with",subtitle:t?.subtitle??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??"",continueButton:t?.continueButton??"Confirm",continuingButton:t?.continuingButton??"Confirming..."}},Ci=e=>{const t=e?.copy?.noSavedPaymentMethods;return{title:t?.title??"Add payment method",subtitle:t?.subtitle??"",emptyTitle:t?.emptyTitle??"",emptyMessage:t?.emptyMessage??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??""}},Si=e=>{const t=Object.fromEntries(Object.entries(e??{}).filter(([,e])=>void 0!==e));return{...mt,...t}},Ei=(e,t)=>{const i=e?.trim();if(!i)throw new Error(`designConfig.payByBank.${t} is required.`);return i},zi=e=>{const t=e?.colors,i={};return Ii(i,"backgroundColor",Ai(t?.widgetBackground,t?.surface)),Ii(i,"primaryColor",t?.primary),Ii(i,"buttonColor",t?.primary),Ii(i,"primaryTextColor",t?.text),Ii(i,"secondaryTextColor",Ai(t?.copy,t?.muted)),Ii(i,"dangerColor",t?.danger),Ii(i,"successColor",t?.success),Ii(i,"borderColor",Ai(t?.border,t?.widgetBorder,t?.borderBackground)),Ii(i,"placeholderColor",t?.placeholder),{branding:i}},Ai=(...e)=>e.map(e=>e?.trim()).find(e=>Boolean(e)),Ii=(e,t,i)=>{const r=i?.trim();r&&(e[t]=r)},qi=[{field:"primary",property:"--chc-primary"},{field:"text",property:"--chc-text"},{field:"copy",property:"--chc-copy"},{field:"muted",property:"--chc-muted"},{field:"placeholder",property:"--chc-placeholder"},{field:"surface",property:"--chc-surface"},{field:"widgetBackground",property:"--chc-widget-background"},{field:"borderBackground",property:"--chc-border"},{field:"widgetBorder",property:"--chc-border"},{field:"softSurface",property:"--chc-soft-surface"},{field:"paymentSelectionBackground",property:"--chc-payment-method-background"},{field:"paymentMethodBackground",property:"--chc-payment-method-background"},{field:"border",property:"--chc-border"},{field:"borderStrong",property:"--chc-border-strong"},{field:"success",property:"--chc-success"},{field:"successBackground",property:"--chc-success-bg"},{field:"successBorder",property:"--chc-success-border"},{field:"danger",property:"--chc-danger"},{field:"dangerBackground",property:"--chc-danger-bg"},{field:"dangerBorder",property:"--chc-danger-border"},{field:"warning",property:"--chc-warning"},{field:"warningBackground",property:"--chc-warning-bg"},{field:"warningBorder",property:"--chc-warning-border"},{field:"disabledText",property:"--chc-disabled-text"},{field:"disabledSurface",property:"--chc-disabled-surface"}],Ni="--chc-font-weight",Bi="--chc-shell-padding",Ri=[...qi.map(({property:e})=>e),Ni,Bi],Ti=(e,t={})=>{const i=e?.paymentSources;if(!i?.length){const i=Zi(e);return i?[Li(i,{...t,selected:!0})]:Qi(e?.status)?[]:pt}return i.map(e=>Li(e,t))},Di=e=>{const t=e?.allowedTenderTypes;return t?{card:t.includes("CARD"),bankAccount:t.includes("BANK_ACCOUNT"),nativeAccount:t.includes("NATIVE_ACCOUNT")}:{card:!0,bankAccount:!0,nativeAccount:!0}},Li=(e,{selected:t=!1,nativeBalances:i={},nativeBalanceLoadingSourceIds:r=[]}={})=>{const n=ji(e),o=Rr(e)?Ki(e,i):void 0,a=void 0===o?.balance?void 0:Gi(o.balance);return{id:n,label:Mi(e,{selected:t}),type:Ui(e),brand:Vi(e),accountLabel:Fi(e),balanceLabel:a,balanceLoading:Rr(e)&&r.includes(n),last4:Pi(e),status:or(e.verificationInfo?.status),showVerificationStatus:Boolean(e.verificationInfo?.status)}},Mi=(e,{selected:t=!1}={})=>Br(e)?t?e.name?.trim()||e.card?.nameOnCard?.trim()||Oi(e):e.card?.nameOnCard?.trim()||e.name?.trim()||Oi(e):Nr(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||Oi(e):Rr(e)?e.account?.nickName?.trim()||e.name?.trim()||Oi(e):e.name?.trim()||Oi(e),Oi=e=>Br(e)?"Saved card":Nr(e)?e.bankAccount?.bankName??"Saved bank account":Rr(e)?"Native account":"Dynamic session card",Vi=e=>Br(e)?e.card?.network??"Card":Nr(e)?e.bankAccount?.bankName??"Bank account":Rr(e)?e.account?.product??"Native account":"DSC",Fi=e=>{const t=`•••• ${Pi(e)}`;if(Rr(e)){const i=e.account?.product?.trim();return i?`${i} ${t}`:t}return t},Pi=e=>Br(e)?nr(e.card?.cardNumber):Nr(e)?nr(e.bankAccount?.accountNumber):Rr(e)?nr(e.account?.maskedValue??e.account?.handle?.posnAcctNbr??e.account?.tenderId):nr(e.id),ji=e=>e.id?.trim()||e.name?.trim()||e.tenderType,Ui=e=>Nr(e)?"bank":Rr(e)?"native":"card",_i=e=>(e?.paymentSources??[]).filter(Rr),Hi=(e,t)=>`${e}:${t.map(e=>Wi(e).join(",")).join("|")}`,Ki=(e,t)=>{for(const i of Wi(e)){const e=t[i];if(e)return e}},Wi=e=>[e.id,e.account?.tenderId,e.account?.handle?.posnAcctNbr,e.account?.token].map(e=>e?.trim()).filter(e=>Boolean(e)),Gi=e=>Yi.format(e),Yi=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}),Ji=(e,t)=>{const i=e?.paymentSources;if(i?.length)return t&&i.some(e=>e.id===t)?t:e?.selectedSource?.id},Zi=(e,t)=>{if(t){const i=e?.paymentSources?.find(e=>e.id===t);if(i)return i}return e?.selectedSource},Qi=e=>e===lt||"PAYMENT_SOURCE_REQUESTED"===e,Xi=(e,t,i)=>{const r={...e,...t},n=t.paymentSources??e.paymentSources??[],o=((e,t)=>{if(t){const i=e.find(e=>e.id===t);if(i)return i}})(n,i??t.selectedSource?.id)??t.selectedSource??e.selectedSource;return{...r,selectedSource:o,paymentSources:n}},er=(e,t)=>{const i=(e.paymentSources??[]).filter(e=>e.id!==t),r=e.selectedSource?.id===t?void 0:e.selectedSource;return{...e,status:"PAYMENT_SOURCE_ATTACHED"!==e.status||r?e.status:lt,selectedSource:r,paymentSources:i}},tr=e=>{if(e.data)return e.data;throw new Error(ir(e.error))},ir=e=>"string"==typeof e?e:e&&"object"==typeof e&&"message"in e&&"string"==typeof e.message?e.message:"CommerceHub API request failed.",rr=(e,t)=>{const i=e.composedPath().find(e=>e instanceof HTMLElement&&Boolean(e.dataset[t]));return i?.dataset[t]},nr=e=>e&&e.length>=4?e.slice(-4):"----",or=e=>"VERIFIED"===e?"verified":"UNDER_REVIEW"===e?"under-review":"REQUIRE_INFO"===e?"require-info":"DECLINED"===e?"declined":"not-verified",ar=e=>{const t=e.aggregatorSessionId?.trim(),i=e.tokenID?.trim()||e.accessToken?.trim(),r=e.pToken?.trim(),n=e.publicKey?.trim();if(!(t&&i&&r&&n))throw new Error("The /interaction/source/pbb/session response is missing one or more required values.");return{aggregatorSessionId:t,accessToken:i,pToken:r,publicKey:n}},sr=e=>"success"===e.type||"cancel"===e.type||"failure"===e.type||"error"===e.type,cr=(e,t)=>{const i=lr(e.paymentSources??[],t);return{...e,selectedSource:t,paymentSources:i}},dr=(e,t)=>({...e,paymentSources:lr(e.paymentSources??[],t)}),lr=(e,t)=>e.some(e=>e.id===t.id)?e.map(e=>e.id===t.id?t:e):[t,...e],hr=e=>"VERIFIED"===e.verificationInfo?.status,ur=({title:e,helper:t})=>P`
...
`,mr=e=>"verify-payment-source"===e?ur({title:"Verifying payment method",helper:"Verifying your payment method, please wait."}):"submit-required-info"===e?ur({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,pr=e=>"verify-payment-source"===e?mr(e):"delete-payment-source"===e?ur({title:"Deleting payment method",helper:"Deleting your payment method, please wait."}):"attach-payment-source"===e?ur({title:"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,fr=e=>{const t=e?.verificationInfo?.status;return"VERIFIED"===t?{kind:"verified",variant:"success",title:"Bank account verified",message:"Your bank account is connected and ready to use."}:"UNDER_REVIEW"===t?{kind:"pending",variant:"warning",title:"Bank account pending review",message:"We will update this bank account after review is complete."}:"REQUIRE_INFO"===t?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:"Additional information is required before this bank account can be verified."}:"DECLINED"===t?{kind:"declined",variant:"danger",title:"Bank account verification failed",message:"This bank account could not be verified."}:{kind:"failed",variant:"danger",title:"Bank account not verified",message:"This bank account is not verified yet."}},vr=(e,t=!1)=>{const i=qr(e),r=i.toLowerCase(),n=e?.verificationInfo?.status;return t?{kind:"failed",variant:"danger",title:"Bank account"===i?"Bank account verification failed":`${i} not verified`,message:`We could not verify this ${r} right now.`}:"VERIFIED"===n?{kind:"verified",variant:"success",title:"Bank account"===i?"Bank account verified":`${i} saved`,message:`This ${r} is verified and ready to use.`}:"UNDER_REVIEW"===n?{kind:"pending",variant:"warning",title:"Bank account"===i?"Bank account pending review":"Verification pending review",message:`We will update this ${r} after review is complete.`}:"REQUIRE_INFO"===n?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:`Additional information is required before this ${r} can be verified.`}:"DECLINED"===n?{kind:"declined",variant:"danger",title:"Bank account"===i?"Bank account verification failed":`${i} declined`,message:`This ${r} could not be verified.`}:{kind:"failed",variant:"danger",title:"Bank account"===i?"Bank account not verified":`${i} not verified`,message:`This ${r} is not verified yet.`}},br=[3,2,4],gr=e=>{const t=e?.verificationInfo?.docs??[];return t.length>0?t:[{}]},yr=(e,t=0)=>`${e?.docType??"DOCUMENT"}-${t}`,wr=e=>"DRIVER_LICENSE_NUMBER"===e.docType||"SOCIAL_SECURITY_NUMBER"===e.docType,kr=e=>!1!==e.mandatory,$r=e=>kr(e)?"required":"optional",xr=e=>P`
  <span
    class="required-info-requirement-badge required-info-requirement-badge-${$r(e)}"
  >
    ${(e=>kr(e)?"Required":"Optional")(e)}
  </span>
`,Cr=e=>{const t=e.findIndex(e=>!wr(e));return t>=0?yr(e[t],t):void 0},Sr=({doc:e,key:t,value:i})=>{if("SOCIAL_SECURITY_NUMBER"===e.docType)return Er({doc:e,key:t,value:i});const r=`required-info-${t}`;return P`
    <div
  ...
  `},Er=({doc:e,key:t,value:i})=>{const r=zr(e),n=(e=>{const t=Ct(e);return[t.slice(0,3),t.slice(3,5),t.slice(5,9)]})(i),o=`required-info-${t}-ssn-0`;return P`
    <div
    ...
    >
      <div class="field field-full">
        <div class="field-label-row">
          <label class="field-label" for=${o}>${r}</label>
          ${xr(e)}
        </div>
  ...
  `},zr=e=>"BANK_STATEMENT"===e.docType?"Bank statement":"BANK_LETTER"===e.docType?"Bank letter":"BANK_CHECK"===e.docType?"Bank check":"DRIVER_LICENSE_PHOTO"===e.docType?"Driver license photo":"DRIVER_LICENSE_NUMBER"===e.docType?"Driver license number":"SOCIAL_SECURITY_NUMBER"===e.docType?"Social Security number":"Required document",Ar=e=>{const t=(e=>({type:Ui(e),brand:Vi(e)}))(e),i=Re(t),r=(e=>{if(!Br(e))return;const t=e.card?.expirationMonth?.trim(),i=e.card?.expirationYear?.trim();if(!t||!i)return;return`${t.padStart(2,"0")}/${i.slice(-2)}`})(e);return P`
    <div
      ...
      <div class="required-info-card-top">
        <div class="required-info-card-heading">
          <span class="required-info-card-label"
            >${(e=>Nr(e)?"Bank account":Br(e)?"Card":Rr(e)?"Native account":"Dynamic session card")(e)}</span
          >
          <span
            class="required-info-card-field required-info-card-name"
            data-required-info-card-field="name"
            >${(e=>Br(e)?e.card?.nameOnCard?.trim()||e.name?.trim()||Oi(e):Nr(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||Oi(e):Rr(e)?e.account?.nickName?.trim()||e.name?.trim()||Oi(e):e.name?.trim()||Oi(e))(e)}</span
          >
        </div>
      ...
      <div class="required-info-card-bottom">
        <div class="required-info-card-detail">
          ...
          <span class="required-info-card-status">
            ${Ve(or(e.verificationInfo?.status))}
          </span>
        </div>
        ${r?P`
              <div class="required-info-card-detail">
  ...
  `},Ir=e=>"REQUIRE_INFO"===e.verificationInfo?.status,qr=e=>e&&Nr(e)?"Bank account":e&&Rr(e)?"Native account":"Payment method",Nr=e=>"BankAccount"===e.tenderType||"BANK_ACCOUNT"===e.tenderType,Br=e=>"Card"===e.tenderType||"CARD"===e.tenderType,Rr=e=>"NativeAccount"===e.tenderType||"NATIVE_ACCOUNT"===e.tenderType;let Tr,Dr;const Lr=async e=>{if(!window.PaymentSDK?.init)if(Tr&&Dr===e)await Tr;else if(Dr=e,Tr=new Promise((t,i)=>{const r=document.querySelector(`script[data-commerce-hub-pay-by-bank-sdk="true"][src="${e}"]`),n=r??document.createElement("script"),o=()=>{n.removeEventListener("load",a),n.removeEventListener("error",s)},a=()=>{o(),t()},s=()=>{o(),Tr=void 0,Dr=void 0,i(new Error(`Unable to load Connect your bank script: ${e}`))};n.addEventListener("load",a,{once:!0}),n.addEventListener("error",s,{once:!0}),r||(n.src=e,n.async=!0,n.dataset.commerceHubPayByBankSdk="true",document.head.appendChild(n))}),await Tr,!window.PaymentSDK?.init)throw new Error(`Connect your bank script loaded but window.PaymentSDK.init is unavailable: ${e}`)},Mr=()=>{try{window.PaymentSDK?.destroy?.()}catch{}};export{$e as COMMERCE_HUB_BASE_URLS,ft as CommerceHubConnect,ke as DEFAULT_COMMERCE_HUB_BASE_URL,st as ON_ERROR_EVENT,at as ON_SUCCESS_EVENT,Ce as createCommerceHubClient,Se as createCommerceHubMerchantClient,xe as resolveCommerceHubBaseURL};

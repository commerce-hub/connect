...
`,gx=(...e)=>e.filter(Boolean).join(" "),yx=e=>{const t=e?.trim();return t||void 0},wx=(e,t)=>{const r=((e,t)=>"verified"===e?{label:t??"Ready",tone:"success"}:"under-review"===e?{label:"Needs review",tone:"warning"}:"require-info"===e?{label:"Needs info",tone:"warning"}:"declined"===e?{label:"Can't use",tone:"danger"}:{label:"Action required",tone:"warning"})(e,t);return Ty`
    <span
  ...
  `},$x=e=>{return"require-info"===(t=e.status)||"not-verified"===t;var t},kx=e=>e.selectionEligible??"verified"===e.status,xx=e=>{const t=yx(e.accountLabel)??(({label:e,brand:t,last4:r})=>{const n=yx(e),i=yx(t);return r&&i&&i!==n?`${i} •••• ${r}`:r?`•••• ${r}`:i??""})(e),r=yx(e.label)??t,n=Boolean(t)||e.isDefault;return Ty`
  ...
  `},Cx=({balanceLabel:e,balanceLoading:t})=>t?Ty`
      <span
        class="payment-method-balance-loading"
        role="status"
        aria-label="Loading balance"
      ></span>
    `:e?Ty`<span class="payment-method-balance">${e}</span>`:"",jx=(e,t)=>Ty`
...
`,Ex=(e,t)=>Ty`
  ...
  ${xx(e)} ${t}
`,Sx=(e,t=$x(e))=>{const r=Ex(e,jx(e));return t?Ty`
      <button
    ...
    `:Ty`<span class="payment-method-row-main">${r}</span>`},Ax=e=>`payment-method-radio-${e.replace(/[^a-zA-Z0-9_-]/g,"-")}`,Ox=(e,t)=>{const r=t&&!e.isDefault&&kx(e),n=!e.isDefault;return r||n},Ix=({label:e,variant:t="primary",action:r,type:n="button",icon:i,disabled:o=!1,loading:a=!1})=>Ty`
  <button
...
`,_x=({id:e,label:t,name:r,value:n="",placeholder:i,type:o="text",span:a="default",variant:s="default",autocomplete:c,inputmode:d,disabled:u=!1,dataField:l,dataFieldScope:h="card",error:f,maskable:m=!1,revealed:p=!1,onToggleReveal:v,maskReveal:b})=>{const g=gx("field","full"===a&&"field-full","card-form"===s&&"field-card-form",f&&"field-invalid"),y=gx("field-label","card-form"===s&&"field-label-card-form"),w=gx("field-input","card-form"===s&&"field-input-card-form"),$=m&&void 0!==b,k=m,x=k?"off":c,C=$?"text":m&&!p?"password":o,j=Ty`
    <input
...
`,Tx=({id:e,label:t,status:r,type:n,eyebrow:i,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:u,verificationLabel:l,selectionEligible:h,isDefault:f,disabled:m=!1},{deleteDisabled:p=!1,confirmingDelete:v=!1,menuOpen:b=!1,menuPlacement:g="below",selected:y=!1,selectable:w=!1,showMarkAsDefault:$=!1}={})=>{const k={id:e,label:t,status:r,type:n,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:u,verificationLabel:l,selectionEligible:h,isDefault:f,disabled:m};if(v&&!k.isDefault)return Ty`
  ...
  `)(e,t,p)}
    ...
    `;const x=w&&kx(k),C=Ox(k,$),j=x||$x(k);return Ty`
    <div
      class=${gx("payment-method-row",x||$x(k)?"payment-method-row-action":"payment-method-row-static",x&&"payment-method-row-radio",C&&"payment-method-row-has-overflow",j&&"payment-method-row-has-affordance",y&&x&&"payment-method-row-selected",k.isDefault&&"payment-method-row-default",b&&!k.isDefault&&"payment-method-row-menu-open")}
      part="payment-method-row"
      aria-label=${t}
...
`)(k,Ax(k.id)):Sx(k)}
      ${((e,{menuOpen:t,menuPlacement:r,showMarkAsDefault:n})=>{const i=`payment-method-menu-${e.id}`,o=n&&!e.isDefault&&kx(e),a=!e.isDefault;return Ox(e,n)?Ty`
  ...
  `:Ty``})(k,{menuOpen:b,menuPlacement:g,showMarkAsDefault:$})}
      ...
      <span class="payment-method-row-affordance payment-method-row-affordance-radio">
        <input
    ...
    `:$x(e)?Ty`
      <span class="payment-method-row-affordance payment-method-row-affordance-chevron">
...
`,Bx=({containerId:e,title:t,loadingLabel:r,loading:n=!1})=>Ty`
  <div
...
`,qx=({variant:e,title:t,message:r,content:n,actions:i})=>Ty`
...
`,Vx=({label:e,action:t,icon:r,variant:n="default",disabled:i=!1})=>Ty`
  <button
...
`,Fx=e=>Ty` <div class="form-grid">${e}</div> `,Ux=e=>`We sent a one-time code to ${e??"your contact method"}.`,Hx=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input")),Wx=({status:e,value:t,length:r,failedMessage:n,copy:i,submitting:o=!1,resending:a=!1})=>{const s="OTP_VALIDATION_FAILED"===e;return Ty`
    <form class="otp-flow" data-submit-action="verify-otp">
      ${s?Nx({variant:"danger",message:n??i.failedMessage}):""}
  ...
  `})({label:"Verification code",value:t,length:r,disabled:o,error:s})}
      <div class="primitive-footer">
        ${Ix({label:o?i.verifyingButton:s?i.tryAgainButton:i.verifyButton,icon:o||s?void 0:"check",variant:"primary",action:"verify-otp",type:"submit",loading:o,disabled:o||t.length<r})}
      </div>
...
`,Gx=({methods:e,canAddPaymentSources:t,canSelectPaymentSources:r,actionPending:n,selectedPaymentSourceId:i,openPaymentSourceMenuId:o,paymentSourceMenuPlacement:a="below",deleteConfirmationPaymentSourceId:s})=>{const c=e.some(e=>e.id===o&&!e.isDefault);return Ty`
    <div class="payment-flow">
      <div
        class=${c?"primitive-stack primitive-stack-menu-open":"primitive-stack"}
        aria-label="Payment methods"
      >
        ${e.map(e=>Tx({...e,disabled:e.disabled||n},{deleteDisabled:n,confirmingDelete:e.id===s,menuOpen:e.id===o,menuPlacement:a,selected:e.id===i,selectable:r,showMarkAsDefault:r||t}))}
      </div>
    </div>
  `},Yx=({allowedTenderOptions:e,canAddPaymentSources:t,deletePending:r=!1,copy:n,showTransferAction:i=!1})=>{const o=Boolean(n.emptyTitle||n.emptyMessage),a=t&&(e.card||e.bankAccount);return Ty`
    <div class="payment-flow">
      ${o?Rx({title:n.emptyTitle,message:n.emptyMessage}):""}
      ${a?Ty`
  ...
  `};var Jx=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};const Zx="onSelect",Qx="onAddPaymentMethod",Xx="onVerifyPaymentMethod",eC="onDeletePaymentMethod",tC="onListPaymentMethods",rC="onTransfer",nC="onError",iC="commerce-hub-pbb-provider",oC=bb(o$,"VerticalLayout");let aC=class extends dk{createRenderRoot(){return this}};aC=Jx([tw("commerce-hub-bank-account-jsonforms")],aC);const sC="OTP_VALIDATION_SUCCESS",cC=[{value:"",label:"Select country or region"},{value:"US",label:"United States"}],dC=[{value:"",label:"Select state"},...[["AL","Alabama"],["AK","Alaska"],["AZ","Arizona"],["AR","Arkansas"],["CA","California"],["CO","Colorado"],["CT","Connecticut"],["DE","Delaware"],["FL","Florida"],["GA","Georgia"],["HI","Hawaii"],["ID","Idaho"],["IL","Illinois"],["IN","Indiana"],["IA","Iowa"],["KS","Kansas"],["KY","Kentucky"],["LA","Louisiana"],["ME","Maine"],["MD","Maryland"],["MA","Massachusetts"],["MI","Michigan"],["MN","Minnesota"],["MS","Mississippi"],["MO","Missouri"],["MT","Montana"],["NE","Nebraska"],["NV","Nevada"],["NH","New Hampshire"],["NJ","New Jersey"],["NM","New Mexico"],["NY","New York"],["NC","North Carolina"],["ND","North Dakota"],["OH","Ohio"],["OK","Oklahoma"],["OR","Oregon"],["PA","Pennsylvania"],["RI","Rhode Island"],["SC","South Carolina"],["SD","South Dakota"],["TN","Tennessee"],["TX","Texas"],["UT","Utah"],["VT","Vermont"],["VA","Virginia"],["WA","Washington"],["WV","West Virginia"],["WI","Wisconsin"],["WY","Wyoming"],["DC","District of Columbia"]].map(([e,t])=>({value:e,label:t}))],uC={apiKey:"YqIvg89urE1WsAdgWwM1EiQTRM1ajSYCaLhnDvimvmHeB78A",configId:"cce84049-0940-4926-9a54-9eaca0c09830",environment:"qa",locale:"en-US",paymentSdkUrl:"https://connect-qa.fiservapis.com/pbb/sdk/web/v2/js/PaymentSDK.js"};let lC=class extends Xy{constructor(){super(...arguments),this.otpValue="",this.bankLinkLoading=!1,this.bankAccountInstrumentSchemas=[],this.selectedBankCurrencyCode="",this.selectedBankAccountType="",this.selectedBankPaymentType="",this.bankAccountFormData={},this.bankAccountFormValid=!1,this.bankAccountValidationAttempted=!1,this.bankBillingAddressValue="",this.bankBillingAddressSelectorExpanded=!1,this.legacyBankAccountDraft={accountNickname:"",routingNumber:"",accountNumber:"",confirmAccountNumber:""},this.legacyBankAccountDraftErrors={},this.legacyBankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},confirmAccountNumber:{status:"idle",normalizedValue:""}},this.bankAccountConfigRequestToken=0,this.bankProviderRequestToken=0,this.transferDraft={fromSourceId:"",toSourceId:"",amount:""},this.transferDraftErrors={},this.transferValidationAttempted=!1,this.transferSubmitSuccess=!1,this.transferFlowActive=!1,this.transferFlowScreen="form",this.cardDraft=Mw(),this.cardDraftErrors={},this.cardValidationAttempted=!1,this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.cardEncryptionTasks={},this.revealedCardFields=new Set,this.cardFieldsRevealingLastChar=new Set,this.cardRevealTimeoutIds={},this.billingAddresses=[],this.billingAddressSelectorExpanded=!1,this.paymentSourceMenuPlacement="below",this.addLauncherActive=!1,this.savedSourceVerificationFailed=!1,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoValidationAttempted=!1,this.requiredInfoFiles={},this.interactionRefresh=new Aw(this),this.nativeBalance=new Ow(this),this.minimumVerificationOverlayToken=0,this.handleSubmit=e=>{e.preventDefault();const t=sj(e,"submitAction");"verify-otp"===t?this.verifyOtp():"submit-required-info"===t?this.submitRequiredInfo():"transfer"===t?this.reviewTransfer():"confirm-transfer"===t?this.submitTransfer():"save-card"===t?this.saveCard():"save-bank-account"===t&&this.saveManualBankAccount()},this.handleClick=e=>{const t=sj(e,"action"),r=sj(e,"paymentMethodId");if(!t){const t=e.composedPath().some(e=>e instanceof HTMLElement&&e.classList.contains("payment-method-overflow"));return void(this.openPaymentSourceMenuId&&!t&&(this.openPaymentSourceMenuId=void 0))}if("toggle-payment-source-menu"!==t)if(this.openPaymentSourceMenuId=void 0,"mark-payment-source-default"!==t){if("attach-payment-source"===t){const e=r??this.selectedPaymentSourceId;return void(e&&(this.clearDeletePaymentSourceConfirmation(),this.attachPaymentSource(e)))}if("open-add-payment-source"===t){const e=TC(this.interactionResponse);return this.attachmentError=void 0,void(e.card&&e.bankAccount?(this.addLauncherActive=!0,this.focusAfterUpdate('[data-action="close-add-payment-source"]')):e.card?this.showAddCardScreen():e.bankAccount&&this.startBankAccountFlow())}if("close-add-payment-source"!==t){if("change-payment-source"===t)return this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("retry-interaction-refresh"!==t)if("verify-payment-source"!==t)if("delete-payment-source"!==t){if("done-payment-source-verification"===t)return this.resetSavedSourceVerification(),void this.showPaymentSourceList({refresh:!0});if("open-required-info-file-picker"===t)return this.pendingRequiredInfoDocKey=sj(e,"requiredInfoDocKey")??this.firstRequiredInfoDocKey(),void this.renderRoot.querySelector(".required-info-file-input")?.click();if("submit-required-info"!==t){if("open-transfer"===t)return this.paymentSourceView="list",this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),this.resetTransferFlow(),void(this.transferFlowActive=!0);if("transfer"!==t)if("edit-transfer"!==t)if("confirm-transfer"!==t)if("verify-otp"!==t)if("resend-otp"!==t)if("select-instrument-schema"!==t)if("save-bank-account"!==t){if("back-to-instrument-schema-selection"===t)return this.clearManualBankAccountForm(),void(this.bankFlowScreen="manual-schema-selection");if("add-bank-account"===t||"use-bank-account-instead"===t||"retry-bank-provider"===t||"use-different-bank-account"===t)return this.addLauncherActive=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),this.resetBankFlow(),void this.startBankAccountFlow();if("back-to-bank-provider"===t)return this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),this.resetBankFlow(),void this.startPayByBankFlow();if("add-ach-manually"===t)return this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),void this.showManualBankAccountScreen();if("back-to-payment-methods"===t)return this.addLauncherActive=!1,this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("continue-bank-outcome"===t||"done-bank-outcome"===t)return this.resetBankFlow(),void this.showPaymentSourceList({refresh:!0});if("add-card"===t)return this.addLauncherActive=!1,this.paymentSourceView="list",this.resetRequiredInfo(),void this.showAddCardScreen();if("change-billing-address"!==t)if("change-bank-billing-address"!==t)if("save-card"!==t){if("edit-card-details"!==t)return"use-different-method"===t?(this.resetCardFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0})):void 0;this.cardFlowScreen="form"}else this.saveCard();else this.bankBillingAddressSelectorExpanded=!0;else this.billingAddressSelectorExpanded=!0}else this.saveManualBankAccount();else this.initializeManualBankAccountScreen();else this.resendOtp();else this.verifyOtp();else this.submitTransfer();else this.transferFlowScreen="form";else this.reviewTransfer()}else this.submitRequiredInfo()}else r&&this.deletePaymentSource(r);else r&&(this.clearDeletePaymentSourceConfirmation(),this.verifySavedPaymentSource(r));else this.retryInteractionRefresh()}else this.closeAddPaymentSourceSheet()}else r&&(this.clearDeletePaymentSourceConfirmation(),this.attachPaymentSource(r,"mark-default"));else if(r){const t=this.openPaymentSourceMenuId!==r,n=e.composedPath().find(e=>e instanceof HTMLElement&&"toggle-payment-source-menu"===e.dataset.action);this.clearDeletePaymentSourceConfirmation(),this.paymentSourceMenuPlacement=t&&this.shouldOpenPaymentSourceMenuAbove(n)?"above":"below",this.openPaymentSourceMenuId=t?r:void 0}},this.handleInput=e=>{const t=hC(e);if(t)return void this.storeRequiredInfoSsnInput(t);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.cardField));if(r){const e=r.dataset.cardField;return this.updateCardDraftField(e,r.value),void(Lw(e)&&this.armCardFieldLastCharReveal(e))}const n=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.bankAccountField));if(n)return void this.updateLegacyBankAccountDraftField(n.dataset.bankAccountField,n.value);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.transferField));if(i)return void this.updateTransferDraftField(i.dataset.transferField,i.value);const o=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoDocKey));if(o)return void this.storeRequiredInfoValue(o.dataset.requiredInfoDocKey,o.value);const a=e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input"));if(!a)return;const s=this.getOtpInputs(),c=Number(a.dataset.otpIndex),d=Yk(a.value);if(!d)return a.value="",void this.syncOtpValueFromInputs(s);if(1===d.length)return a.value=d,this.syncOtpValueFromInputs(s),void this.focusOtpInput(s,c+1);const u=this.writeOtpDigits(s,c,d);this.syncOtpValueFromInputs(s),this.focusOtpInput(s,Math.min(c+d.length,s.length-1),u)},this.handleKeyDown=e=>{if("Escape"===e.key&&this.openPaymentSourceMenuId&&!this.pendingAction){const t=this.openPaymentSourceMenuId;return e.preventDefault(),this.openPaymentSourceMenuId=void 0,void this.updateComplete.then(()=>{this.renderRoot.querySelector(`[data-action="toggle-payment-source-menu"][data-payment-method-id="${CSS.escape(t)}"]`)?.focus()})}if(this.addLauncherActive&&"Tab"===e.key){const t=[...this.renderRoot.querySelectorAll(".add-payment-sheet button:not(:disabled)")],r=t[0],n=t[t.length-1],i=this.shadowRoot?.activeElement;if(!r||!n)return;return void(e.shiftKey&&i===r?(e.preventDefault(),n.focus()):(e.shiftKey||i!==n)&&t.includes(i)||(e.preventDefault(),r.focus()))}if(this.addLauncherActive&&"Escape"===e.key&&!this.pendingAction)return e.preventDefault(),void this.closeAddPaymentSourceSheet();if("Escape"===e.key&&!this.pendingAction&&(this.addLauncherActive||this.cardFlowScreen||this.bankFlowScreen||this.requiredInfoSource||this.savedSourceVerificationSource||this.transferFlowActive))return e.preventDefault(),this.addLauncherActive=!1,this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),this.resetSavedSourceVerification(),void this.showPaymentSourceList();const t=e.composedPath().find(e=>e instanceof HTMLButtonElement&&"tab"===e.getAttribute("role"));if(t&&("ArrowLeft"===e.key||"ArrowRight"===e.key||"Home"===e.key||"End"===e.key)){const r=[...this.renderRoot.querySelectorAll('[role="tab"]')],n=r.indexOf(t),i=r["Home"===e.key?0:"End"===e.key?r.length-1:(n+("ArrowRight"===e.key?1:-1)+r.length)%r.length];return e.preventDefault(),void(i&&i!==t&&(i.focus(),i.click()))}const r=Hx(e);if(!r)return;const n=this.getOtpInputs(),i=Number(r.dataset.otpIndex);return"ArrowLeft"===e.key?(e.preventDefault(),void this.focusOtpInput(n,i-1)):"ArrowRight"===e.key?(e.preventDefault(),void this.focusOtpInput(n,i+1)):"Backspace"===e.key?(e.preventDefault(),r.value?r.value="":i>0&&(n[i-1].value=""),this.syncOtpValueFromInputs(n),void this.focusOtpInput(n,Math.max(i-1,0))):"Delete"===e.key?(e.preventDefault(),r.value="",void this.syncOtpValueFromInputs(n)):void(e.ctrlKey||e.metaKey||e.altKey||1!==e.key.length||/\d/.test(e.key)||e.preventDefault())},this.handleChange=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.paymentMethodRadio));if(t)return this.selectedPaymentSourceId=t.value,void(this.attachmentError=void 0);const r=e.composedPath().find(e=>e instanceof HTMLSelectElement&&["instrumentSchemaCurrency","instrumentSchemaAccountType","instrumentSchemaPaymentType"].includes(e.name));if("instrumentSchemaCurrency"===r?.name)return this.selectedBankCurrencyCode=r.value,this.selectedBankAccountType="",this.selectedBankPaymentType="",void(this.selectedBankAccountInstrumentSchemaCode=void 0);if("instrumentSchemaAccountType"===r?.name)return this.selectedBankAccountType="BUSINESS"===r.value||"PERSONAL"===r.value?r.value:"",this.selectedBankPaymentType="",void(this.selectedBankAccountInstrumentSchemaCode=void 0);if("instrumentSchemaPaymentType"===r?.name){this.selectedBankPaymentType=r.value;const e=((e,t,r,n)=>{const i=e.filter(e=>e.currencyCode===t&&e.accountType===r&&e.paymentType===n);return 1===i.length?i[0].schema:void 0})(Vk(this.bankAccountInstrumentSchemas),this.selectedBankCurrencyCode,this.selectedBankAccountType,this.selectedBankPaymentType);return void(this.selectedBankAccountInstrumentSchemaCode=e?.bavSupportedCode)}const n=e.composedPath().find(e=>e instanceof HTMLSelectElement&&"bankBillingAddress"===e.name);if(n)return void this.updateBankBillingAddress(n.value);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoFileInput));if(i)return this.storeRequiredInfoSelectedFile(i.files?.[0]),void(i.value="");const o=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.cardField));if(o)return void this.updateCardDraftField(o.dataset.cardField,o.value);const a=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.transferField));a&&this.updateTransferDraftField(a.dataset.transferField,a.value)},this.handleBankAccountFormDataChange=e=>{const t=e.detail.data;this.bankAccountFormData="object"!=typeof t||null===t||Array.isArray(t)?{}:t,this.bankAccountFormValid=0===(e.detail.errors?.length??0),this.bankAccountSubmitError=void 0},this.handleBankAccountFormErrorsChange=e=>{this.bankAccountFormValid=0===(e.detail.errors?.length??0)},this.handlePaste=e=>{const t=hC(e);if(t)return void this.pasteRequiredInfoSsnInput(e,t);const r=Hx(e);if(!r)return;const n=e,i="function"==typeof n.clipboardData?.getData?n.clipboardData.getData("text"):"",o=Yk(i);if(!o)return;e.preventDefault();const a=this.getOtpInputs(),s=Number(r.dataset.otpIndex),c=this.writeOtpDigits(a,s,o);this.syncOtpValueFromInputs(a),this.focusOtpInput(a,Math.min(s+o.length,a.length-1),c)},this.handleFocusIn=e=>{const t=Hx(e);t&&t.value&&requestAnimationFrame(()=>{this.renderRoot.contains(t)&&t.select()})},this.handleFocusLost=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Lw(e.dataset.cardField));if(t){const e=t.dataset.cardField;return this.clearCardFieldLastCharReveal(e),void this.trackCardFieldEncryption(e,t.value)}const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&c$(e.dataset.bankAccountField));r&&this.encryptLegacyBankAccountField(r.dataset.bankAccountField,r.value)}}willUpdate(e){if(e.has("interactionResponse")&&this.interactionResponse){const t=e.get("interactionResponse");t?.interactionId!==this.interactionResponse.interactionId&&(this.pendingAction=void 0,this.clearDeletePaymentSourceConfirmation(),this.paymentSourceView=void 0,this.openPaymentSourceMenuId=void 0,this.interactionRefresh.reset({requestUpdate:!1}),this.nativeBalance.reset({requestUpdate:!1}),this.billingAddresses=[],this.resetBankFlow(),this.resetTransferFlow(),this.resetSavedSourceVerification(),this.resetRequiredInfo()),this.interactionResponse.paymentSources?.length||this.interactionResponse.selectedSource||(this.openPaymentSourceMenuId=void 0),this.syncBillingAddressesFromInteractionResponse(this.interactionResponse),this.selectedPaymentSourceId=JC(this.interactionResponse,this.selectedPaymentSourceId)}}updated(e){e.has("designConfig")&&this.syncDesignConfigStyles(),e.has("interactionResponse")&&this.deleteConfirmationPaymentSourceId&&!this.findPaymentSourceById(this.deleteConfirmationPaymentSourceId)&&this.clearDeletePaymentSourceConfirmation(),e.has("interactionResponse")&&this.refreshPaymentSourcesFromInteraction()}render(){return Ty`
      ...
      >
        <span class="screen-reader-status" role="status" aria-live="polite"
          >${yj(this.pendingAction)}</span
        >
        ${this.renderCurrentScreen()}
        ${this.addLauncherActive?this.renderAddPaymentSourceSheet():""}
      </div>
    `}disconnectedCallback(){super.disconnectedCallback(),this.clearDeletePaymentSourceConfirmation(),this.clearAllCardFieldLastCharReveal(),this.resetBankFlow()}emitSdkEvent(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t}))}focusAfterUpdate(...e){this.updateComplete.then(()=>{for(const t of e){const e=this.renderRoot.querySelector(t);if(e)return void e.focus()}})}renderWidgetShell({busy:e=!1,overlay:t,...r}){const n=bj(this.minimumVerificationOverlayAction);return(({title:e,subtitle:t,content:r,backAction:n,backDisabled:i=!1,titleAction:o,headerAction:a,footer:s,width:c="default",layout:d="default",ariaLabel:u="Commerce Hub Connect",closeAction:l="close",showClose:h=!0,showDivider:f=!1,showFooter:m=!0,busy:p=!1,overlay:v})=>Ty`
  <section
...
`)({...r,busy:e||Boolean(n),overlay:t??n})}showMinimumVerificationOverlay(e){const t=this.minimumVerificationOverlayToken+=1;this.minimumVerificationOverlayAction=e,window.setTimeout(()=>{this.minimumVerificationOverlayToken===t&&(this.minimumVerificationOverlayAction=void 0)},2e3)}renderCurrentScreen(){if(!this.interactionResponse)return this.renderMissingInteractionResponseScreen();if("provider"===this.bankFlowScreen)return this.renderBankProviderScreen();if("outcome"===this.bankFlowScreen)return this.renderBankOutcomeScreen();if("manual-config-loading"===this.bankFlowScreen)return this.renderManualBankAccountConfigLoadingScreen();if("manual-config-error"===this.bankFlowScreen)return this.renderManualBankAccountConfigErrorScreen();if("manual-schema-selection"===this.bankFlowScreen)return this.renderManualBankAccountSchemaSelectionScreen();if("manual"===this.bankFlowScreen)return this.renderManualBankAccountScreen();if("form"===this.cardFlowScreen)return this.renderAddCardScreen();if("error"===this.cardFlowScreen)return this.renderCardErrorScreen();if(this.requiredInfoSource)return this.renderRequiredInfoScreen();if(this.savedSourceVerificationSource)return this.renderSavedSourceVerificationOutcomeScreen();const e=this.interactionResponse?.status;return"OTP_VALIDATION_PENDING"===e||"OTP_VALIDATION_FAILED"===e?this.renderOtpScreen(e):this.shouldRenderTransferScreen()?this.renderTransferScreen():this.renderPaymentSourceScreen()}renderMissingInteractionResponseScreen(){return this.renderWidgetShell({title:"Configuration required",showClose:!1,showDivider:!1,content:Ty`
        <div class="payment-flow">
          ${Nx({variant:"danger",message:"CommerceHub Connect requires an interaction response before it can load payment methods."})}
        </div>
      `})}renderOtpScreen(e){const t=xC(this.designConfig),r="verify-otp"===this.pendingAction,n="resend-otp"===this.pendingAction,i=kC(this.interactionResponse);let o;return r?o=vj({title:"Verifying code",helper:"Verifying your code, please wait."}):n&&(o=vj({title:"Sending code",helper:"Sending a new code, please wait."})),this.renderWidgetShell({title:t.title,subtitle:t.subtitle??Ux(i),showClose:!1,showDivider:!1,busy:r||n,overlay:o,content:Wx({status:e,value:this.otpValue,length:6,failedMessage:this.otpErrorMessage,copy:t,submitting:r,resending:n})})}renderPaymentSourceScreen(){const e=CC(this.designConfig),t=RC(this.interactionResponse,{nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}),r=TC(this.interactionResponse),n=tj(this.interactionResponse,"ADD_ACCOUNT")&&(r.card||r.bankAccount),i=tj(this.interactionResponse,"SELECT"),o=tj(this.interactionResponse,"TRANSFER")&&HC(this.interactionResponse).length>=2,a="attach-payment-source"===this.pendingAction||"verify-payment-source"===this.pendingAction||"delete-payment-source"===this.pendingAction;if(this.shouldRenderPaymentSourceRefreshSkeleton())return this.renderWidgetShell({title:e.title,layout:"payment-methods",headerAction:Ty`
          <div
        ...
        `,showClose:!1,content:Kx()});if(this.shouldRenderPaymentSourceRefreshError())return this.renderPaymentSourceRefreshErrorScreen();if(!t.length)return this.renderNoSavedPaymentMethods();if(this.shouldRenderSelectedPaymentSourceScreen())return this.renderSelectedPaymentSourceScreen();this.queueNativeAccountBalanceRefresh();const s=o?Ty`
          <div class="widget-toolbar" aria-label="Payment method actions">
            ${Vx({label:"Transfer",action:"open-transfer",icon:"transfer",disabled:a})}
          </div>
        `:void 0;return this.renderWidgetShell({title:e.title,layout:"payment-methods",headerAction:s,showClose:!1,busy:a,overlay:gj(this.pendingAction),content:Ty`
        ${this.attachmentError?Nx({variant:"danger",message:this.attachmentError}):""}
      ...
      `,footer:n||i?Ty`
              ...
              >
                ${i?Ix({label:"attach-payment-source"===this.pendingAction?e.continuingButton:e.continueButton,action:"attach-payment-source",loading:"attach-payment-source"===this.pendingAction,disabled:!this.selectedPaymentSourceId||a}):""}
                ${n?Ix({label:"Add payment method",action:"open-add-payment-source",icon:"plus",disabled:a}):""}
              </div>
        ...
        >
          ...
          <div class="required-info-documents">
            ...
            <div class="primitive-stack">
              ${t.map((e,t)=>{const r=xj(e,t),i=Cj(e)?this.requiredInfoValues[r]:this.requiredInfoFileNames[r],o=this.visibleRequiredInfoError(e,t);return Cj(e)?Oj({doc:e,key:r,value:i??"",error:o}):Ty`
                  <div
                    class="required-info-document required-document-text-row"
                    data-required-info-doc-key=${r}
                    data-required-info-requirement=${Ej(e)}
                  >
...
`)({label:"Required document",requirements:_j(e),actionLabel:"Choose file",fileName:i,action:"open-required-info-file-picker",disabled:n})}
          ...
          <div
            ...
            data-required-info-doc-key=${r??""}
          >
            ${Ix({label:n?"Verifying...":"Verify",action:"submit-required-info",type:"submit",loading:n,disabled:n||!i||this.hasBlockingRequiredInfoValidationErrors()})}
          </div>
        </form>
      `})}renderNoSavedPaymentMethods(){const e=jC(this.designConfig),t="delete-payment-source"===this.pendingAction,r=TC(this.interactionResponse),n=tj(this.interactionResponse,"ADD_ACCOUNT")&&(r.card||r.bankAccount);return this.renderWidgetShell({title:e.title,subtitle:e.subtitle,showClose:!1,showDivider:!1,content:Yx({allowedTenderOptions:r,canAddPaymentSources:n,deletePending:t,copy:e})})}shouldRenderTransferScreen(){const e=this.interactionResponse;return(this.transferFlowActive||rj(e))&&ej(e?.status)}renderTransferScreen(){const e=HC(this.interactionResponse),t="transfer"===this.pendingAction,r=this.transferFlowActive?"back-to-payment-methods":void 0;if(e.length<2)return this.renderWidgetShell({title:"Transfer funds",backAction:r,backDisabled:t,showClose:!1,showDivider:!1,content:Ty`
          <div class="payment-flow">
            ${Rx({title:"Transfer unavailable",message:"At least two verified bank or native accounts are required to transfer funds."})}
          </div>
        `});const n=[{value:"",label:"Select account"},...e.map(e=>({value:FC(e),label:PC(e)}))],i=Xk(this.transferDraft),o=e.find(e=>FC(e)===i.fromSourceId),a=e.find(e=>FC(e)===i.toSourceId);return"confirm"===this.transferFlowScreen&&o&&a&&(s=i,c=e,0===Object.keys(ex(Xk(s),c)).length)?this.renderTransferConfirmationScreen(o,a,i,t):this.renderWidgetShell({title:"Transfer funds",backAction:r,backDisabled:t,showClose:!1,showDivider:!1,busy:t,overlay:t?vj({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ty`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="transfer"
        >
          ${this.transferSubmitError?Nx({variant:"danger",message:this.transferSubmitError}):""}
          ${this.transferSubmitSuccess?Nx({variant:"success",message:"Transfer initiated."}):""}
          ${Fx([zx({id:"transfer-from-source",name:"fromSourceId",label:"From",value:this.transferDraft.fromSourceId,options:n,span:"full",variant:"card-form",dataField:"fromSourceId",dataFieldScope:"transfer",error:this.transferValidationAttempted?this.transferDraftErrors.fromSourceId:void 0,disabled:t}),zx({id:"transfer-to-source",name:"toSourceId",label:"To",value:this.transferDraft.toSourceId,options:n,span:"full",variant:"card-form",dataField:"toSourceId",dataFieldScope:"transfer",error:this.transferValidationAttempted?this.transferDraftErrors.toSourceId:void 0,disabled:t}),_x({id:"transfer-amount",name:"amount",label:"Amount",value:this.transferDraft.amount,variant:"card-form",inputmode:"decimal",dataField:"amount",dataFieldScope:"transfer",error:this.transferValidationAttempted?this.transferDraftErrors.amount:void 0,disabled:t})])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ix({label:t?"Transferring":"Transfer",action:"transfer",type:"submit",loading:t,disabled:t||!tx(this.transferDraft)||this.hasBlockingTransferValidationErrors()})}
            </div>
          </div>
        </form>
      `});var s,c}renderTransferConfirmationScreen(e,t,r,n){return this.renderWidgetShell({title:"Confirm transfer",backAction:"edit-transfer",backDisabled:n,showClose:!1,showDivider:!1,busy:n,overlay:n?vj({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ty`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="confirm-transfer"
        >
          ${this.transferSubmitError?Nx({variant:"danger",message:this.transferSubmitError}):""}
          ${Dx([{label:"From",value:PC(e)},{label:"To",value:PC(t)},{label:"Amount",value:rx(r)}])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ix({label:n?"Transferring":"Confirm transfer",action:"confirm-transfer",type:"submit",loading:n,disabled:n})}
            </div>
            <div class="card-form-primary">
      ...
      `):a.push(zx({id:"billing-address",name:"billingAddress",label:"Billing address",value:this.cardDraft.billingAddressValue,options:r,span:"full",variant:"card-form",dataField:"billingAddressValue",error:this.visibleCardDraftError("billingAddressValue"),disabled:e})),o&&a.push(zx({id:"billing-country",name:"country",label:"Country or region",value:this.cardDraft.country,options:cC,span:"full",variant:"card-form",dataField:"country",error:this.visibleCardDraftError("country"),disabled:e}),_x({id:"billing-address-line-1",name:"addressLine1",label:"Address",value:this.cardDraft.addressLine1,placeholder:"Street address",span:"full",variant:"card-form",autocomplete:"address-line1",dataField:"addressLine1",error:this.visibleCardDraftError("addressLine1"),disabled:e}),_x({id:"billing-address-line-2",name:"addressLine2",label:"Address line 2",value:this.cardDraft.addressLine2,placeholder:"Apartment, suite, unit",span:"full",variant:"card-form",autocomplete:"address-line2",dataField:"addressLine2",error:this.visibleCardDraftError("addressLine2"),disabled:e}),_x({id:"billing-city",name:"city",label:"City",value:this.cardDraft.city,span:"full",variant:"card-form",autocomplete:"address-level2",dataField:"city",error:this.visibleCardDraftError("city"),disabled:e}),zx({id:"billing-state",name:"state",label:"State",value:this.cardDraft.state,options:dC,span:"full",variant:"card-form",dataField:"state",error:this.visibleCardDraftError("state"),disabled:e}),_x({id:"billing-zip",name:"zip",label:"ZIP code",value:this.cardDraft.zip,placeholder:"ZIP code",span:"full",variant:"card-form",autocomplete:"postal-code",inputmode:"numeric",dataField:"zip",error:this.visibleCardDraftError("zip"),disabled:e})),this.renderWidgetShell({title:"Add card",backAction:"back-to-payment-methods",backDisabled:e,showClose:!1,showDivider:!1,busy:e,overlay:e?vj({title:"Saving card",helper:"Securely saving your card, please wait."}):void 0,content:Ty`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="save-card"
        >
          ${this.cardSubmitError?Nx({variant:"danger",message:this.cardSubmitError}):""}
          ${Fx([_x({id:"card-label",name:"name",label:"Card Name",value:this.cardDraft.name,placeholder:"Corporate card",span:"full",variant:"card-form",dataField:"name",error:this.visibleCardDraftError("name"),disabled:e}),_x({id:"card-number",name:"cardNumber",label:"Card number",value:this.cardDraft.cardNumber,placeholder:"1234 1234 1234 1234",span:"full",variant:"card-form",autocomplete:"cc-number",inputmode:"numeric",dataField:"cardNumber",error:this.visibleCardDraftError("cardNumber"),disabled:e,maskable:!0,revealed:this.revealedCardFields.has("cardNumber"),onToggleReveal:()=>this.toggleCardFieldReveal("cardNumber"),maskReveal:U$(this.cardDraft.cardNumber,this.cardFieldsRevealingLastChar.has("cardNumber"))}),_x({id:"expiration-date",name:"expirationDate",label:"Expiration",value:this.cardDraft.expirationDate,placeholder:"MM / YY",variant:"card-form",autocomplete:"cc-exp",inputmode:"numeric",dataField:"expirationDate",error:this.visibleCardDraftError("expirationDate"),disabled:e}),_x({id:"card-cvv",name:"cvv",label:"CVC",value:this.cardDraft.cvv,placeholder:"3 or 4 digits",variant:"card-form",autocomplete:"cc-csc",inputmode:"numeric",dataField:"cvv",error:this.visibleCardDraftError("cvv"),disabled:e,maskable:!0,revealed:this.revealedCardFields.has("cvv"),onToggleReveal:()=>this.toggleCardFieldReveal("cvv"),maskReveal:U$(this.cardDraft.cvv,this.cardFieldsRevealingLastChar.has("cvv"))}),_x({id:"name-on-card",name:"fullName",label:"Full name",value:this.cardDraft.fullName,placeholder:"Name on card",span:"full",variant:"card-form",autocomplete:"cc-name",dataField:"fullName",error:this.visibleCardDraftError("fullName"),disabled:e}),...a])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ix({label:e?"Saving payment method":"Save card",action:"save-card",type:"submit",loading:e,disabled:e||t||!Kw(this.cardDraft)||this.hasBlockingCardValidationErrors()})}
            </div>
          </div>
        </form>
      `})}renderCardErrorScreen(){return this.renderWidgetShell({title:"Credit card not saved",subtitle:"We could not save this card. Check the card details or use a different payment method.",showClose:!1,showDivider:!1,content:qx({variant:"danger",content:this.cardSubmitError?Nx({variant:"danger",message:this.cardSubmitError}):void 0,actions:Ty`
          ${Ix({label:"Edit card details",action:"edit-card-details"})}
          ${Vx({label:"Use a different method",action:"use-different-method"})}
        `})})}renderBankProviderScreen(){return this.renderWidgetShell({title:"Connect your bank",backAction:"back-to-payment-methods",backDisabled:this.bankLinkLoading,showClose:!1,showDivider:!1,busy:this.bankLinkLoading,overlay:this.bankLinkLoading?vj({title:"Connecting to your bank",helper:"Securely opening your bank connection, please wait."}):void 0,content:Bx({containerId:iC,loading:this.bankLinkLoading,loadingLabel:"Connecting to your bank"}),footer:Ty`
        <div class="bank-provider-manual-link">
          ${Vx({label:"Connect another way",action:"add-ach-manually",disabled:this.bankLinkLoading})}
        </div>
      `})}renderManualBankAccountConfigLoadingScreen(){return this.renderWidgetShell({title:"Select bank account type",backAction:this.manualBankAccountExitAction(),backDisabled:!0,showClose:!1,showDivider:!1,busy:!0,overlay:vj({title:"Loading instrument schemas",helper:"Loading the available bank account options, please wait."}),content:Ty`<div class="payment-flow card-form-screen"></div>`})}renderManualBankAccountConfigErrorScreen(){return this.renderWidgetShell({title:"Select bank account type",backAction:this.manualBankAccountExitAction(),showClose:!1,showDivider:!1,content:Ty`
        <div class="payment-flow card-form-screen">
          ${Nx({variant:"danger",message:this.bankAccountConfigError??"Unable to load instrument schemas. Try again."})}
          <div class="primitive-footer card-form-primary">
      ...
      `})}renderManualBankAccountSchemaSelectionScreen(){const e=Vk(this.bankAccountInstrumentSchemas),t=(e=>Fk(e.map(({currencyCode:e,currencyName:t})=>({value:e,label:t})),({label:e})=>e))(e),r=this.selectedBankCurrencyCode?((e,t)=>Fk(e.filter(e=>e.currencyCode===t).map(({accountType:e})=>({value:e,label:"BUSINESS"===e?"Business":"Personal"}))))(e,this.selectedBankCurrencyCode):[],n=this.selectedBankAccountType?((e,t,r)=>Fk(e.filter(e=>e.currencyCode===t&&e.accountType===r).map(({paymentType:e,schema:t})=>({value:e,label:t.productId}))))(e,this.selectedBankCurrencyCode,this.selectedBankAccountType):[];return this.renderWidgetShell({title:"Select bank account type",backAction:this.manualBankAccountExitAction(),showClose:!1,showDivider:!1,content:Ty`
        <div class="instrument-schema-selection payment-flow card-form-screen">
          ${zx({id:"instrument-schema-currency",name:"instrumentSchemaCurrency",label:"Currency",value:this.selectedBankCurrencyCode,options:[{value:"",label:"Select currency"},...t],span:"full",variant:"card-form"})}
          ${this.selectedBankCurrencyCode?zx({id:"instrument-schema-account-type",name:"instrumentSchemaAccountType",label:"Account type",value:this.selectedBankAccountType,options:[{value:"",label:"Select account type"},...r],span:"full",variant:"card-form"}):""}
          ${this.selectedBankAccountType?zx({id:"instrument-schema-payment-type",name:"instrumentSchemaPaymentType",label:"Payment type",value:this.selectedBankPaymentType,options:[{value:"",label:"Select payment type"},...n],span:"full",variant:"card-form"}):""}
          <div class="primitive-footer card-form-primary">
      ...
      `})}renderManualBankAccountScreen(){if("legacy"===this.manualBankAccountFormMode)return this.renderLegacyManualBankAccountScreen();const e=this.bankAccountFormSchema,t=this.bankAccountFormUiSchema;if(!e||!t)return this.renderManualBankAccountConfigErrorScreen();const r="save-bank-account"===this.pendingAction;return this.renderWidgetShell({title:"Enter bank details",backAction:"back-to-instrument-schema-selection",showClose:!1,showDivider:!1,content:Ty`
        ...
        >
          ...
          ></commerce-hub-bank-account-jsonforms>
          ${this.bankAccountSubmitError?Nx({variant:"danger",message:this.bankAccountSubmitError}):""}
          <div class="primitive-footer card-form-primary">
            ${Ix({label:r?"Saving bank account":"Save bank account",action:"save-bank-account",type:"submit",loading:r,disabled:r||this.hasBlockingConfigBankValidationErrors()||!Rk(e,this.bankAccountFormData)})}
          </div>
        </form>
      ...
      `:zx({id:"bank-billing-address",name:"bankBillingAddress",label:"Billing address",value:this.bankBillingAddressValue,options:t,span:"full",variant:"card-form",disabled:e})}renderLegacyManualBankAccountScreen(){const e="save-bank-account"===this.pendingAction,t=Object.values(this.legacyBankAccountEncryption).some(e=>"encrypting"===e.status);return this.renderWidgetShell({title:"Enter bank details",backAction:this.manualBankAccountExitAction(),backDisabled:e,showClose:!1,showDivider:!1,busy:e,overlay:e?vj({title:"Saving bank account",helper:"Securely saving your bank account, please wait."}):void 0,content:Ty`
        ...
        >
          ...
          ></commerce-hub-bank-account-jsonforms>
          <div class="primitive-footer card-form-primary">
            ${Ix({label:e?"Saving bank account":"Save bank account",action:"save-bank-account",type:"submit",loading:e,disabled:e||t||this.hasBlockingLegacyBankValidationErrors()||(r=this.legacyBankAccountDraft,n=o$,!(n.required??[]).every(e=>!s$(e)||Boolean(r[e].trim())))})}
          </div>
        </form>
      `});var r,n}renderBankOutcomeScreen(){const e=wj(this.bankOutcomeSource),t="declined"===e.kind||"pending"===e.kind;return this.renderWidgetShell({title:e.title,headerAction:t?Vx({label:"Done",action:"done-bank-outcome"}):void 0,showClose:!1,showDivider:!1,content:Ty`
        <div class="verification-outcome-flow">
          ${Nx({variant:e.variant,message:e.message})}
          ${this.bankOutcomeSource?Nj(this.bankOutcomeSource):""}
          ${t?"":Ty`
                <div class="primitive-footer">
                  ${"verified"===e.kind?Ix({label:"Continue",action:"continue-bank-outcome"}):"pending"===e.kind?Ix({label:"Done",action:"done-bank-outcome"}):Ty`
...
`,bj=e=>"verify-payment-source"===e?vj({title:"Verifying payment method",helper:"Verifying your payment method, please wait."}):"submit-required-info"===e?vj({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,gj=e=>"verify-payment-source"===e?bj(e):"delete-payment-source"===e?vj({title:"Deleting payment method",helper:"Deleting your payment method, please wait."}):"attach-payment-source"===e?vj({title:"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,yj=e=>{switch(e){case"attach-payment-source":return"Saving the selected payment method.";case"verify-payment-source":case"submit-required-info":return"Verifying the payment method.";case"delete-payment-source":return"Deleting the payment method.";case"verify-otp":return"Verifying the code.";case"resend-otp":return"Sending a new code.";case"save-card":return"Saving the card.";case"save-bank-account":return"Saving the bank account.";case"transfer":return"Submitting the transfer.";default:return""}},wj=e=>{const t=e?.verificationInfo?.status;return"VERIFIED"===t?{kind:"verified",variant:"success",title:"Bank account verified",message:"Your bank account is connected and ready to use."}:"UNDER_REVIEW"===t?{kind:"pending",variant:"warning",title:"Bank account pending review",message:"We will update this bank account after review is complete."}:"REQUIRE_INFO"===t?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:"Additional information is required before this bank account can be verified."}:"DECLINED"===t?{kind:"declined",variant:"danger",title:"Bank account verification failed",message:"This bank account could not be verified."}:{kind:"failed",variant:"danger",title:"Bank account not verified",message:"This bank account is not verified yet."}},$j=(e,t=!1)=>{const r=Tj(e),n=r.toLowerCase(),i=e?.verificationInfo?.status;return t?{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} not verified`,message:`We could not verify this ${n} right now.`}:"VERIFIED"===i?{kind:"verified",variant:"success",title:"Bank account"===r?"Bank account verified":`${r} saved`,message:`This ${n} is verified and ready to use.`}:"UNDER_REVIEW"===i?{kind:"pending",variant:"warning",title:"Bank account"===r?"Bank account pending review":"Verification pending review",message:`We will update this ${n} after review is complete.`}:"REQUIRE_INFO"===i?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:`Additional information is required before this ${n} can be verified.`}:"DECLINED"===i?{kind:"declined",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} declined`,message:`This ${n} could not be verified.`}:{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account not verified":`${r} not verified`,message:`This ${n} is not verified yet.`}},kj=e=>{const t=e?.verificationInfo?.docs??[];return t.length>0?t:[{}]},xj=(e,t=0)=>`${e?.docType??"DOCUMENT"}-${t}`,Cj=e=>"DRIVER_LICENSE_NUMBER"===e.docType||"SOCIAL_SECURITY_NUMBER"===e.docType,jj=e=>!1!==e.mandatory,Ej=e=>jj(e)?"required":"optional",Sj=e=>Ty`
  <span
    class="required-info-requirement-badge required-info-requirement-badge-${Ej(e)}"
  >
    ${(e=>jj(e)?"Required":"Optional")(e)}
  </span>
`,Aj=e=>{const t=e.findIndex(e=>!Cj(e));return t>=0?xj(e[t],t):void 0},Oj=({doc:e,key:t,value:r,error:n})=>{if("SOCIAL_SECURITY_NUMBER"===e.docType)return Ij({doc:e,key:t,value:r,error:n});const i=`required-info-${t}`,o=`${i}-error`;return Ty`
    <div
  ...
  `},Ij=({doc:e,key:t,value:r,error:n})=>{const i=_j(e),o=(e=>{const t=Zk(e);return[t.slice(0,3),t.slice(3,5),t.slice(5,9)]})(r),a=`required-info-${t}-ssn-0`,s=`required-info-${t}-error`;return Ty`
    <div
  ...
  `},_j=e=>"BANK_STATEMENT"===e.docType?"Bank statement":"BANK_LETTER"===e.docType?"Bank letter":"BANK_CHECK"===e.docType?"Bank check":"DRIVER_LICENSE_PHOTO"===e.docType?"Driver license photo":"DRIVER_LICENSE_NUMBER"===e.docType?"Driver license number":"SOCIAL_SECURITY_NUMBER"===e.docType?"Social Security number":"Required document",zj=e=>{const t=_j(e);return"SOCIAL_SECURITY_NUMBER"===e.docType?"Enter a Social Security number.":Cj(e)?`Enter a ${t.toLowerCase()}.`:`Choose a ${t.toLowerCase()}.`},Nj=e=>{const t=(e=>({type:UC(e),brand:BC(e)}))(e),r=ax(t),n=(e=>{if(!Lj(e))return;const t=e.card?.expirationMonth?.trim(),r=e.card?.expirationYear?.trim();if(!t||!r)return;return`${t.padStart(2,"0")}/${r.slice(-2)}`})(e);return Ty`
    <div
      ...
      <div class="required-info-card-top">
        <div class="required-info-card-heading">
          <span class="required-info-card-label"
            >${(e=>Mj(e)?"Bank account":Lj(e)?"Card":Pj(e)?"Native account":"Dynamic session card")(e)}</span
          >
          <span
            class="required-info-card-field required-info-card-name"
            data-required-info-card-field="name"
            >${(e=>Lj(e)?e.card?.nameOnCard?.trim()||e.name?.trim()||DC(e):Mj(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||DC(e):Pj(e)?e.account?.nickName?.trim()||e.name?.trim()||DC(e):e.name?.trim()||DC(e))(e)}</span
          >
        </div>
      ...
      <div class="required-info-card-bottom">
        <div class="required-info-card-detail">
          ...
          <span class="required-info-card-status">
            ${wx(dj(e.verificationInfo?.status))}
          </span>
        </div>
        ${n?Ty`
              <div class="required-info-card-detail">
  ...
  `},Rj=e=>"REQUIRE_INFO"===e.verificationInfo?.status,Tj=e=>e&&Mj(e)?"Bank account":e&&Pj(e)?"Native account":"Payment method",Mj=e=>"BankAccount"===e.tenderType||"BANK_ACCOUNT"===e.tenderType,Lj=e=>"Card"===e.tenderType||"CARD"===e.tenderType,Pj=e=>"NativeAccount"===e.tenderType||"NATIVE_ACCOUNT"===e.tenderType;let Dj,Bj;const qj=async e=>{if(!window.PaymentSDK?.init)if(Dj&&Bj===e)await Dj;else if(Bj=e,Dj=new Promise((t,r)=>{const n=document.querySelector(`script[data-commerce-hub-pay-by-bank-sdk="true"][src="${e}"]`),i=n??document.createElement("script"),o=()=>{i.removeEventListener("load",a),i.removeEventListener("error",s)},a=()=>{o(),t()},s=()=>{o(),Dj=void 0,Bj=void 0,r(new Error(`Unable to load Connect your bank script: ${e}`))};i.addEventListener("load",a,{once:!0}),i.addEventListener("error",s,{once:!0}),n||(i.src=e,i.async=!0,i.dataset.commerceHubPayByBankSdk="true",document.head.appendChild(i))}),await Dj,!window.PaymentSDK?.init)throw new Error(`Connect your bank script loaded but window.PaymentSDK.init is unavailable: ${e}`)},Vj=()=>{try{window.PaymentSDK?.destroy?.()}catch{}};export{gw as COMMERCE_HUB_BASE_URLS,lC as CommerceHubConnect,bw as DEFAULT_COMMERCE_HUB_BASE_URL,Qx as ON_ADD_PAYMENT_METHOD_EVENT,eC as ON_DELETE_PAYMENT_METHOD_EVENT,nC as ON_ERROR_EVENT,tC as ON_LIST_PAYMENT_METHODS_EVENT,Zx as ON_SELECT_EVENT,rC as ON_TRANSFER_EVENT,Xx as ON_VERIFY_PAYMENT_METHOD_EVENT,ww as createCommerceHubClient,kw as createCommerceHubConfigClient,$w as createCommerceHubMerchantClient,yw as resolveCommerceHubBaseURL};

 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const py=globalThis,vy=e=>e,by=py.trustedTypes,gy=by?by.createPolicy("lit-html",{createHTML:e=>e}):void 0,yy="$lit$",wy=`lit$${Math.random().toFixed(9).slice(2)}$`,$y="?"+wy,ky=`<${$y}>`,xy=document,jy=()=>xy.createComment(""),Ey=e=>null===e||"object"!=typeof e&&"function"!=typeof e,Sy=Array.isArray,Ay="[ \t\n\f\r]",Cy=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Oy=/-->/g,Iy=/>/g,_y=RegExp(`>|${Ay}(?:([^\\s"'>=/]+)(${Ay}*=${Ay}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),Ny=/'/g,zy=/"/g,Ty=/^(?:script|style|textarea|title)$/i,Ry=(e=>(t,...r)=>({_$litType$:e,strings:t,values:r}))(1),My=Symbol.for("lit-noChange"),Py=Symbol.for("lit-nothing"),Dy=new WeakMap,By=xy.createTreeWalker(xy,129);function qy(e,t){if(!Sy(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==gy?gy.createHTML(t):t}const Ly=(e,t)=>{const r=e.length-1,n=[];let i,o=2===t?"<svg>":3===t?"<math>":"",a=Cy;for(let t=0;t<r;t++){const r=e[t];let s,c,d=-1,u=0;for(;u<r.length&&(a.lastIndex=u,c=a.exec(r),null!==c);)u=a.lastIndex,a===Cy?"!--"===c[1]?a=Oy:void 0!==c[1]?a=Iy:void 0!==c[2]?(Ty.test(c[2])&&(i=RegExp("</"+c[2],"g")),a=_y):void 0!==c[3]&&(a=_y):a===_y?">"===c[0]?(a=i??Cy,d=-1):void 0===c[1]?d=-2:(d=a.lastIndex-c[2].length,s=c[1],a=void 0===c[3]?_y:'"'===c[3]?zy:Ny):a===zy||a===Ny?a=_y:a===Oy||a===Iy?a=Cy:(a=_y,i=void 0);const l=a===_y&&e[t+1].startsWith("/>")?" ":"";o+=a===Cy?r+ky:d>=0?(n.push(s),r.slice(0,d)+yy+r.slice(d)+wy+l):r+wy+(-2===d?t:l)}return[qy(e,o+(e[r]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),n]};class Vy{constructor({strings:e,_$litType$:t},r){let n;this.parts=[];let i=0,o=0;const a=e.length-1,s=this.parts,[c,d]=Ly(e,t);if(this.el=Vy.createElement(c,r),By.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(n=By.nextNode())&&s.length<a;){if(1===n.nodeType){if(n.hasAttributes())for(const e of n.getAttributeNames())if(e.endsWith(yy)){const t=d[o++],r=n.getAttribute(e).split(wy),a=/([.?@])?(.*)/.exec(t);s.push({type:1,index:i,name:a[2],strings:r,ctor:"."===a[1]?Ky:"?"===a[1]?Gy:"@"===a[1]?Jy:Wy}),n.removeAttribute(e)}else e.startsWith(wy)&&(s.push({type:6,index:i}),n.removeAttribute(e));if(Ty.test(n.tagName)){const e=n.textContent.split(wy),t=e.length-1;if(t>0){n.textContent=by?by.emptyScript:"";for(let r=0;r<t;r++)n.append(e[r],jy()),By.nextNode(),s.push({type:2,index:++i});n.append(e[t],jy())}}}else if(8===n.nodeType)if(n.data===$y)s.push({type:2,index:i});else{let e=-1;for(;-1!==(e=n.data.indexOf(wy,e+1));)s.push({type:7,index:i}),e+=wy.length-1}i++}}static createElement(e,t){const r=xy.createElement("template");return r.innerHTML=e,r}}function Uy(e,t,r=e,n){if(t===My)return t;let i=void 0!==n?r._$Co?.[n]:r._$Cl;const o=Ey(t)?void 0:t._$litDirective$;return i?.constructor!==o&&(i?._$AO?.(!1),void 0===o?i=void 0:(i=new o(e),i._$AT(e,r,n)),void 0!==n?(r._$Co??=[])[n]=i:r._$Cl=i),void 0!==i&&(t=Uy(e,i._$AS(e,t.values),i,n)),t}class Fy{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:r}=this._$AD,n=(e?.creationScope??xy).importNode(t,!0);By.currentNode=n;let i=By.nextNode(),o=0,a=0,s=r[0];for(;void 0!==s;){if(o===s.index){let t;2===s.type?t=new Hy(i,i.nextSibling,this,e):1===s.type?t=new s.ctor(i,s.name,s.strings,this,e):6===s.type&&(t=new Yy(i,this,e)),this._$AV.push(t),s=r[++a]}o!==s?.index&&(i=By.nextNode(),o++)}return By.currentNode=xy,n}p(e){let t=0;for(const r of this._$AV)void 0!==r&&(void 0!==r.strings?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}}class Hy{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,r,n){this.type=2,this._$AH=Py,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Uy(this,e,t),Ey(e)?e===Py||null==e||""===e?(this._$AH!==Py&&this._$AR(),this._$AH=Py):e!==this._$AH&&e!==My&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>Sy(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==Py&&Ey(this._$AH)?this._$AA.nextSibling.data=e:this.T(xy.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:r}=e,n="number"==typeof r?this._$AC(e):(void 0===r.el&&(r.el=Vy.createElement(qy(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===n)this._$AH.p(t);else{const e=new Fy(n,this),r=e.u(this.options);e.p(t),this.T(r),this._$AH=e}}_$AC(e){let t=Dy.get(e.strings);return void 0===t&&Dy.set(e.strings,t=new Vy(e)),t}k(e){Sy(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,n=0;for(const i of e)n===t.length?t.push(r=new Hy(this.O(jy()),this.O(jy()),this,this.options)):r=t[n],r._$AI(i),n++;n<t.length&&(this._$AR(r&&r._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=vy(e).nextSibling;vy(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class Wy{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,r,n,i){this.type=1,this._$AH=Py,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=i,r.length>2||""!==r[0]||""!==r[1]?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Py}_$AI(e,t=this,r,n){const i=this.strings;let o=!1;if(void 0===i)e=Uy(this,e,t,0),o=!Ey(e)||e!==this._$AH&&e!==My,o&&(this._$AH=e);else{const n=e;let a,s;for(e=i[0],a=0;a<i.length-1;a++)s=Uy(this,n[r+a],t,a),s===My&&(s=this._$AH[a]),o||=!Ey(s)||s!==this._$AH[a],s===Py?e=Py:e!==Py&&(e+=(s??"")+i[a+1]),this._$AH[a]=s}o&&!n&&this.j(e)}j(e){e===Py?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Ky extends Wy{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Py?void 0:e}}class Gy extends Wy{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==Py)}}class Jy extends Wy{constructor(e,t,r,n,i){super(e,t,r,n,i),this.type=5}_$AI(e,t=this){if((e=Uy(this,e,t,0)??Py)===My)return;const r=this._$AH,n=e===Py&&r!==Py||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,i=e!==Py&&(r===Py||n);n&&this.element.removeEventListener(this.name,this,r),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class Yy{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){Uy(this,e)}}const Zy=py.litHtmlPolyfillSupport;Zy?.(Vy,Hy),(py.litHtmlVersions??=[]).push("3.3.3");const Qy=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const V$=e=>e??Py;var U$=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};const F$="jsonforms-layout jsonforms-layout-vertical",H$="jsonforms-layout jsonforms-layout-horizontal",W$="jsonforms-layout jsonforms-group";let K$=class extends T${render(){return this.renderLayout(F$)}renderLayout(e){const t=this.layoutProps;if(void 0===t||!1===t.visible)return Ry``;const r=t.uischema;return Ry`
  ...
  *::after {
  ...
  .text-link-button-icon-edit::before {
    content: '';
    width: 0.3125rem;
    height: 0.75rem;
  ...
  .tender-tab:hover,
  .tender-tab:focus-visible {
    border-color: var(--chc-primary);
    outline: none;
  }

  .tender-tab[aria-selected='true'] {
    border-color: var(--chc-primary);
    background: var(--chc-primary);
    color: #fff;
  }
...
`,ex=(...e)=>e.filter(Boolean).join(" "),tx=e=>{const t=e?.trim();return t||void 0},rx=e=>{const t=(e=>"verified"===e?{label:"Ready",tone:"success"}:"under-review"===e?{label:"Needs review",tone:"warning"}:"require-info"===e?{label:"Needs info",tone:"warning"}:"declined"===e?{label:"Can't use",tone:"danger"}:{label:"Action required",tone:"warning"})(e);return Ry`
    <span
  ...
  `},nx=e=>{const t=tx(e.accountLabel)??(({label:e,brand:t,last4:r})=>{const n=tx(e),i=tx(t);return r&&i&&i!==n?`${i} •••• ${r}`:r?`•••• ${r}`:i??""})(e),r=tx(e.label)??t,n=Boolean(t);return Ry`
    <span class="payment-method-copy">
      <span class="payment-method-title-row">
        <span class="payment-method-title">${r}</span>
        ${(e=>!1!==e.showVerificationStatus)(e)?rx(e.status):""}
      </span>
      ${n?Ry`
  ...
  `},ix=({balanceLabel:e,balanceLoading:t})=>t?Ry`
      ...
      ></span>
    `:e?Ry`<span class="payment-method-balance">${e}</span>`:"",ox=(e,t)=>Ry`
...
`,ax=(e,t)=>Ry`
  <span class="payment-method-icon-chip" aria-hidden="true">
    <img
      ...
      data-payment-method-icon=${Gk(e)}
      src=${Jk(e)}
      alt=""
    />
  </span>
  ${nx(e)} ${t}
`,sx=({label:e,variant:t="primary",action:r,type:n="button",icon:i,disabled:o=!1,loading:a=!1})=>Ry`
  <button
    class=${ex("button",`button-${t}`,a&&"button-loading")}
...
`,cx=({id:e,label:t,name:r,value:n="",placeholder:i,type:o="text",span:a="default",variant:s="default",autocomplete:c,inputmode:d,disabled:u=!1,dataField:l,dataFieldScope:h="card",error:f})=>{const m=ex("field","full"===a&&"field-full","card-form"===s&&"field-card-form",f&&"field-invalid"),p=ex("field-label","card-form"===s&&"field-label-card-form"),v=ex("field-input","card-form"===s&&"field-input-card-form"),b=Ry`
    <input
      class=${v}
      id=${e}
      name=${V$(r)}
  ...
  `},dx=({id:e,label:t,name:r,value:n="",options:i,span:o="default",variant:a="default",disabled:s=!1,dataField:c,dataFieldScope:d="card",error:u})=>{const l=ex("field","card-form"!==a&&"field-with-select","full"===o&&"field-full","card-form"===a&&"field-card-form",u&&"field-invalid"),h=ex("field-label","card-form"===a&&"field-label-card-form"),f=ex("field-input","field-select","card-form"===a&&"field-input-card-form"),m=Ry`
    <select
      class=${f}
      id=${e}
      name=${V$(r)}
      .value=${n}
      data-card-field=${V$("card"===d?c:void 0)}
      data-bank-account-field=${V$("bankAccount"===d?c:void 0)}
      data-transfer-field=${V$("transfer"===d?c:void 0)}
      aria-invalid=${u?"true":"false"}
      aria-describedby=${V$(u?`${e}-error`:void 0)}
      ?disabled=${s}
    >
      ${i.map(e=>Ry`
  ...
  `},ux=({variant:e,message:t})=>Ry`
  <div class="alert alert-${e}" part="alert" role="alert">
    <span class="alert-message">${t}</span>
  </div>
`,lx=({title:e,message:t})=>Ry`
  <div class="empty-state">
    <p class="empty-state-title">${e}</p>
    <p class="empty-state-message">${t}</p>
  </div>
`,hx=({id:e,label:t,status:r,type:n,eyebrow:i,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:u,disabled:l=!1},{variant:h="default",deleteDisabled:f=!1,confirmingDelete:m=!1,selected:p=!1,selectable:v=!0}={})=>{const b={id:e,label:t,status:r,type:n,eyebrow:i,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:u,disabled:l};if("edit"===h){const r={...b,showVerificationStatus:!1};return Ry`
      <div
        class=${ex("payment-method-row","payment-method-row-edit",m&&"payment-method-row-delete-confirming")}
        part="payment-method-row"
        aria-label=${t}
        data-payment-method-id=${e}
      >
        ${ax(r,((e,t,r=!1,n=!1)=>{const i=`Delete ${t}`;return n?Ry`
  ...
  `})(e,t,f,m))}
    ...
    `}return v&&(e=>{return"verified"===(t=e.status)||"require-info"===t||"not-verified"===t;var t})(b)?"verified"===r?Ry`
        <label
          class=${ex("payment-method-row","payment-method-row-action","payment-method-row-radio",p&&"payment-method-row-selected")}
          part="payment-method-row"
          data-payment-method-id=${e}
        >
          ${ax(b,Ry`<span class="payment-method-trailing">
              ${ix(b)}
              <input
      ...
      `:Ry`
      <button
        class=${ex("payment-method-row","payment-method-row-action",p&&"payment-method-row-selected")}
        part="payment-method-row"
        type="button"
    ...
    `:Ry`
    <div
      class=${ex("payment-method-row","payment-method-row-static")}
      part="payment-method-row"
      aria-label=${t}
      aria-disabled="true"
      data-payment-method-id=${e}
  ...
  `},fx=({id:e,label:t,status:r,type:n,eyebrow:i,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:u})=>{const l={label:t,status:r,type:n,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:u};return Ry`
    <div
...
`,px=({containerId:e,title:t,loadingLabel:r,loading:n=!1})=>Ry`
  <div
    class=${ex("provider-frame",n&&"provider-frame-loading")}
    part="provider-frame"
  ...
  >
    ...
    <slot class="provider-frame-slot" name=${e}>
      <div
        class=${ex("provider-frame-container",n&&"provider-frame-container-loading")}
        id=${e}
      ></div>
    </slot>
    ${n?Ry`
...
`,vx=({variant:e,title:t,message:r,content:n,actions:i})=>Ry`
...
`,bx=({label:e,action:t,icon:r,variant:n="default",disabled:i=!1})=>Ry`
  <button
    class=${ex("text-link-button",`text-link-button-${n}`,r&&`text-link-button-${r}`)}
    type="button"
    data-action=${t}
    ?disabled=${i}
  >
...
`,gx=e=>Ry` <div class="form-grid">${e}</div> `,yx=e=>`We sent a one-time code to ${e??"your contact method"}.`,wx=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input")),$x=({status:e,value:t,length:r,failedMessage:n,copy:i,submitting:o=!1,resending:a=!1})=>{const s="OTP_VALIDATION_FAILED"===e;return Ry`
    <form class="otp-flow" data-submit-action="verify-otp">
      ${s?ux({variant:"danger",message:n??i.failedMessage}):""}
  ...
  `})({label:"Verification code",value:t,length:r,disabled:o,error:s})}
      <div class="primitive-footer">
        ${sx({label:o?i.verifyingButton:s?i.tryAgainButton:i.verifyButton,icon:o||s?void 0:"check",variant:"primary",action:"verify-otp",type:"submit",loading:o,disabled:o||t.length<r})}
      </div>
  ...
  <button
    class=${ex("otp-resend",n&&"otp-resend-loading")}
    type="button"
    data-action=${t}
    aria-busy=${n?"true":"false"}
    ?disabled=${r||n}
...
`,xx=({methods:e,canSelectPaymentSources:t,editing:r,actionPending:n,selectedPaymentSourceId:i,deleteConfirmationPaymentSourceId:o})=>Ry`
    <div class="payment-flow">
      <div class="primitive-stack" aria-label="Payment methods">
        ${e.map(e=>hx({...e,disabled:e.disabled||n},{variant:r?"edit":"default",deleteDisabled:n,confirmingDelete:e.id===o,selected:e.id===i,selectable:t}))}
      </div>
    </div>
  `,jx=({allowedTenderOptions:e,canAddPaymentSources:t,deletePending:r=!1,copy:n,showTransferAction:i=!1})=>{const o=Boolean(n.emptyTitle||n.emptyMessage);return Ry`
    <div class="payment-flow">
      ${o?lx({title:n.emptyTitle,message:n.emptyMessage}):""}
      ${""}
    </div>
  `};var Ex=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};const Sx="onSelect",Ax="onAddPaymentMethod",Cx="onVerifyPaymentMethod",Ox="onDeletePaymentMethod",Ix="onListPaymentMethods",_x="onTransfer",Nx="onError",zx="commerce-hub-pbb-provider",Tx="__bankBillingAddress",Rx=bb(r$,"VerticalLayout");let Mx=class extends ik{createRenderRoot(){return this}};Mx=Ex([tw("commerce-hub-bank-account-jsonforms")],Mx);const Px="OTP_VALIDATION_SUCCESS",Dx=[{value:"",label:"Select country or region"},{value:"US",label:"United States"}],Bx=[{value:"",label:"Select state"},...[["AL","Alabama"],["AK","Alaska"],["AZ","Arizona"],["AR","Arkansas"],["CA","California"],["CO","Colorado"],["CT","Connecticut"],["DE","Delaware"],["FL","Florida"],["GA","Georgia"],["HI","Hawaii"],["ID","Idaho"],["IL","Illinois"],["IN","Indiana"],["IA","Iowa"],["KS","Kansas"],["KY","Kentucky"],["LA","Louisiana"],["ME","Maine"],["MD","Maryland"],["MA","Massachusetts"],["MI","Michigan"],["MN","Minnesota"],["MS","Mississippi"],["MO","Missouri"],["MT","Montana"],["NE","Nebraska"],["NV","Nevada"],["NH","New Hampshire"],["NJ","New Jersey"],["NM","New Mexico"],["NY","New York"],["NC","North Carolina"],["ND","North Dakota"],["OH","Ohio"],["OK","Oklahoma"],["OR","Oregon"],["PA","Pennsylvania"],["RI","Rhode Island"],["SC","South Carolina"],["SD","South Dakota"],["TN","Tennessee"],["TX","Texas"],["UT","Utah"],["VT","Vermont"],["VA","Virginia"],["WA","Washington"],["WV","West Virginia"],["WI","Wisconsin"],["WY","Wyoming"],["DC","District of Columbia"]].map(([e,t])=>({value:e,label:t}))],qx={apiKey:"YqIvg89urE1WsAdgWwM1EiQTRM1ajSYCaLhnDvimvmHeB78A",configId:"cce84049-0940-4926-9a54-9eaca0c09830",environment:"qa",locale:"en-US",paymentSdkUrl:"https://connect-qa.fiservapis.com/pbb/sdk/web/v2/js/PaymentSDK.js"};let Lx=class extends Xy{constructor(){super(...arguments),this.otpValue="",this.bankLinkLoading=!1,this.bankAccountInstrumentSchemas=[],this.bankAccountFormData={},this.bankAccountFormValid=!1,this.bankBillingAddressValue="",this.bankBillingAddressSelectorExpanded=!1,this.legacyBankAccountDraft={accountNickname:"",routingNumber:"",accountNumber:"",confirmAccountNumber:""},this.legacyBankAccountDraftErrors={},this.legacyBankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},confirmAccountNumber:{status:"idle",normalizedValue:""}},this.bankAccountConfigRequestToken=0,this.bankProviderRequestToken=0,this.transferDraft={fromSourceId:"",toSourceId:"",amount:""},this.transferDraftErrors={},this.transferSubmitSuccess=!1,this.transferFlowActive=!1,this.transferFlowScreen="form",this.cardDraft=Tw(),this.cardDraftErrors={},this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.billingAddresses=[],this.billingAddressSelectorExpanded=!1,this.paymentSourceEditMode=!1,this.addLauncherActive=!1,this.savedSourceVerificationFailed=!1,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.interactionRefresh=new Sw(this),this.nativeBalance=new Aw(this),this.minimumVerificationOverlayToken=0,this.handleSubmit=e=>{e.preventDefault();const t=Tj(e,"submitAction");"verify-otp"===t?this.verifyOtp():"submit-required-info"===t?this.submitRequiredInfo():"transfer"===t?this.reviewTransfer():"confirm-transfer"===t?this.submitTransfer():"save-card"===t?this.saveCard():"save-bank-account"===t&&this.saveManualBankAccount()},this.handleClick=e=>{const t=Tj(e,"action"),r=Tj(e,"paymentMethodId");if(t){if("attach-payment-source"===t){const e=r??this.selectedPaymentSourceId;return void(e&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.attachPaymentSource(e)))}if("open-add-payment-source"===t){const e=dj(this.interactionResponse);return this.attachmentError=void 0,void(e.card&&e.bankAccount?(this.addLauncherActive=!0,this.focusAfterUpdate(".tender-tab")):e.card?this.showAddCardScreen():e.bankAccount&&this.startPayByBankFlow())}if("change-payment-source"===t)return this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("retry-interaction-refresh"!==t){if("toggle-payment-source-edit-mode"===t)return this.clearDeletePaymentSourceConfirmation(),void(this.paymentSourceEditMode=!this.paymentSourceEditMode);if("verify-payment-source"!==t)if("delete-payment-source"!==t)if("cancel-delete-payment-source"!==t){if("done-payment-source-verification"===t)return this.resetSavedSourceVerification(),void this.showPaymentSourceList({refresh:!0});if("open-required-info-file-picker"===t)return this.pendingRequiredInfoDocKey=Tj(e,"requiredInfoDocKey")??this.firstRequiredInfoDocKey(),void this.renderRoot.querySelector(".required-info-file-input")?.click();if("submit-required-info"!==t){if("open-transfer"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),this.resetTransferFlow(),void(this.transferFlowActive=!0);if("transfer"!==t)if("edit-transfer"!==t)if("confirm-transfer"!==t)if("verify-otp"!==t)if("resend-otp"!==t)if("select-instrument-schema"!==t)if("save-bank-account"!==t){if("back-to-instrument-schema-selection"===t)return this.clearManualBankAccountForm(),void(this.bankFlowScreen="manual-schema-selection");if("add-bank-account"===t||"use-bank-account-instead"===t||"retry-bank-provider"===t||"use-different-bank-account"===t)return this.addLauncherActive=!1,this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),this.resetBankFlow(),void this.startBankAccountFlow();if("back-to-bank-provider"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),this.resetBankFlow(),void this.startPayByBankFlow();if("add-ach-manually"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),void this.showManualBankAccountScreen();if("back-to-payment-methods"===t)return this.addLauncherActive=!1,this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("continue-bank-outcome"===t||"done-bank-outcome"===t)return this.resetBankFlow(),void this.showPaymentSourceList({refresh:!0});if("add-card"===t)return this.addLauncherActive=!1,this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetRequiredInfo(),void this.showAddCardScreen();if("change-billing-address"!==t)if("change-bank-billing-address"!==t)if("save-card"!==t){if("edit-card-details"!==t)return"use-different-method"===t?(this.resetCardFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0})):void 0;this.cardFlowScreen="form"}else this.saveCard();else this.bankBillingAddressSelectorExpanded=!0;else this.billingAddressSelectorExpanded=!0}else this.saveManualBankAccount();else this.initializeManualBankAccountScreen();else this.resendOtp();else this.verifyOtp();else this.submitTransfer();else this.transferFlowScreen="form";else this.reviewTransfer()}else this.submitRequiredInfo()}else this.clearDeletePaymentSourceConfirmation();else r&&this.deletePaymentSource(r);else r&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.verifySavedPaymentSource(r))}else this.retryInteractionRefresh()}},this.handleInput=e=>{const t=Vx(e);if(t)return void this.storeRequiredInfoSsnInput(t);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.cardField));if(r)return void this.updateCardDraftField(r.dataset.cardField,r.value);const n=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.bankAccountField));if(n)return void this.updateLegacyBankAccountDraftField(n.dataset.bankAccountField,n.value);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.transferField));if(i)return void this.updateTransferDraftField(i.dataset.transferField,i.value);const o=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoDocKey));if(o)return void this.storeRequiredInfoValue(o.dataset.requiredInfoDocKey,o.value);const a=e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input"));if(!a)return;const s=this.getOtpInputs(),c=Number(a.dataset.otpIndex),d=Rk(a.value);if(!d)return a.value="",void this.syncOtpValueFromInputs(s);if(1===d.length)return a.value=d,this.syncOtpValueFromInputs(s),void this.focusOtpInput(s,c+1);const u=this.writeOtpDigits(s,c,d);this.syncOtpValueFromInputs(s),this.focusOtpInput(s,Math.min(c+d.length,s.length-1),u)},this.handleKeyDown=e=>{if("Escape"===e.key&&!this.pendingAction&&(this.addLauncherActive||this.cardFlowScreen||this.bankFlowScreen||this.requiredInfoSource||this.savedSourceVerificationSource||this.transferFlowActive))return e.preventDefault(),this.addLauncherActive=!1,this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),this.resetSavedSourceVerification(),void this.showPaymentSourceList();const t=e.composedPath().find(e=>e instanceof HTMLButtonElement&&"tab"===e.getAttribute("role"));if(t&&("ArrowLeft"===e.key||"ArrowRight"===e.key||"Home"===e.key||"End"===e.key)){const r=[...this.renderRoot.querySelectorAll('[role="tab"]')],n=r.indexOf(t),i=r["Home"===e.key?0:"End"===e.key?r.length-1:(n+("ArrowRight"===e.key?1:-1)+r.length)%r.length];return e.preventDefault(),void(i&&i!==t&&(i.focus(),i.click()))}const r=wx(e);if(!r)return;const n=this.getOtpInputs(),i=Number(r.dataset.otpIndex);return"ArrowLeft"===e.key?(e.preventDefault(),void this.focusOtpInput(n,i-1)):"ArrowRight"===e.key?(e.preventDefault(),void this.focusOtpInput(n,i+1)):"Backspace"===e.key?(e.preventDefault(),r.value?r.value="":i>0&&(n[i-1].value=""),this.syncOtpValueFromInputs(n),void this.focusOtpInput(n,Math.max(i-1,0))):"Delete"===e.key?(e.preventDefault(),r.value="",void this.syncOtpValueFromInputs(n)):void(e.ctrlKey||e.metaKey||e.altKey||1!==e.key.length||/\d/.test(e.key)||e.preventDefault())},this.handleChange=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.paymentMethodRadio));if(t)return this.selectedPaymentSourceId=t.value,void(this.attachmentError=void 0);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&"instrument-schema"===e.name&&Boolean(e.dataset.instrumentSchemaCode));if(r)return void(this.selectedBankAccountInstrumentSchemaCode=r.dataset.instrumentSchemaCode);const n=e.composedPath().find(e=>e instanceof HTMLSelectElement&&"bankBillingAddress"===e.name);if(n)return void this.updateBankBillingAddress(n.value);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoFileInput));if(i)return this.storeRequiredInfoSelectedFile(i.files?.[0]),void(i.value="");const o=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.cardField));if(o)return void this.updateCardDraftField(o.dataset.cardField,o.value);const a=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.transferField));a&&this.updateTransferDraftField(a.dataset.transferField,a.value)},this.handleBankAccountFormDataChange=e=>{const t=e.detail.data;this.bankAccountFormData="object"!=typeof t||null===t||Array.isArray(t)?{}:t,this.bankAccountFormValid=0===(e.detail.errors?.length??0),this.bankAccountSubmitError=void 0},this.handleBankAccountFormErrorsChange=e=>{this.bankAccountFormValid=0===(e.detail.errors?.length??0)},this.handlePaste=e=>{const t=Vx(e);if(t)return void this.pasteRequiredInfoSsnInput(e,t);const r=wx(e);if(!r)return;const n=e,i="function"==typeof n.clipboardData?.getData?n.clipboardData.getData("text"):"",o=Rk(i);if(!o)return;e.preventDefault();const a=this.getOtpInputs(),s=Number(r.dataset.otpIndex),c=this.writeOtpDigits(a,s,o);this.syncOtpValueFromInputs(a),this.focusOtpInput(a,Math.min(s+o.length,a.length-1),c)},this.handleFocusIn=e=>{const t=wx(e);t&&t.value&&requestAnimationFrame(()=>{this.renderRoot.contains(t)&&t.select()})},this.handleFocusLost=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Rw(e.dataset.cardField));if(t)return void this.encryptCardField(t.dataset.cardField,t.value);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&o$(e.dataset.bankAccountField));r&&this.encryptLegacyBankAccountField(r.dataset.bankAccountField,r.value)}}willUpdate(e){if(e.has("interactionResponse")&&this.interactionResponse){const t=e.get("interactionResponse");t?.interactionId!==this.interactionResponse.interactionId&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceView=void 0,this.paymentSourceEditMode=!1,this.interactionRefresh.reset({requestUpdate:!1}),this.nativeBalance.reset({requestUpdate:!1}),this.billingAddresses=[],this.resetBankFlow(),this.resetTransferFlow(),this.resetSavedSourceVerification(),this.resetRequiredInfo()),this.interactionResponse.paymentSources?.length||this.interactionResponse.selectedSource||(this.paymentSourceEditMode=!1),this.syncBillingAddressesFromInteractionResponse(this.interactionResponse),this.selectedPaymentSourceId=jj(this.interactionResponse,this.selectedPaymentSourceId)}}updated(e){e.has("designConfig")&&this.syncDesignConfigStyles(),e.has("interactionResponse")&&this.deleteConfirmationPaymentSourceId&&!this.findPaymentSourceById(this.deleteConfirmationPaymentSourceId)&&this.clearDeletePaymentSourceConfirmation(),e.has("interactionResponse")&&this.refreshPaymentSourcesFromInteraction()}render(){return Ry`
      <div
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow()}emitSdkEvent(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t}))}focusAfterUpdate(...e){this.updateComplete.then(()=>{for(const t of e){const e=this.renderRoot.querySelector(t);if(e)return void e.focus()}})}renderWidgetShell({busy:e=!1,overlay:t,...r}){const n=Fj(this.minimumVerificationOverlayAction);return(({title:e,subtitle:t,content:r,headerAction:n,footer:i,width:o="default",layout:a="default",ariaLabel:s="Commerce Hub Connect",closeAction:c="close",showClose:d=!0,showDivider:u=!1,showFooter:l=!0,busy:h=!1,overlay:f})=>Ry`
  <section
    class=${ex("widget-shell","wide"===o&&"widget-shell-wide","payment-methods"===a&&"widget-shell-payment-methods",h&&"widget-shell-busy")}
    part="shell"
    aria-label=${s}
  ...
  >
    ...
    ${u?Ry`<div class="widget-divider" aria-hidden="true"></div>`:""}
    <div class="widget-content" part="content">${r}</div>
    ${i&&l?Ry`<div class="widget-action-footer" part="footer">${i}</div>`:""}
    ${f?Ry`<div class="widget-loading-overlay">${f}</div>`:""}
  </section>
`)({...r,busy:e||Boolean(n),overlay:t??n})}showMinimumVerificationOverlay(e){const t=this.minimumVerificationOverlayToken+=1;this.minimumVerificationOverlayAction=e,window.setTimeout(()=>{this.minimumVerificationOverlayToken===t&&(this.minimumVerificationOverlayAction=void 0)},2e3)}renderCurrentScreen(){if(!this.interactionResponse)return this.renderMissingInteractionResponseScreen();if("provider"===this.bankFlowScreen)return this.renderBankProviderScreen();if(this.addLauncherActive)return this.renderAddPaymentSourceLauncher();if("outcome"===this.bankFlowScreen)return this.renderBankOutcomeScreen();if("manual-config-loading"===this.bankFlowScreen)return this.renderManualBankAccountConfigLoadingScreen();if("manual-config-error"===this.bankFlowScreen)return this.renderManualBankAccountConfigErrorScreen();if("manual-schema-selection"===this.bankFlowScreen)return this.renderManualBankAccountSchemaSelectionScreen();if("manual"===this.bankFlowScreen)return this.renderManualBankAccountScreen();if("form"===this.cardFlowScreen)return this.renderAddCardScreen();if("error"===this.cardFlowScreen)return this.renderCardErrorScreen();if(this.requiredInfoSource)return this.renderRequiredInfoScreen();if(this.savedSourceVerificationSource)return this.renderSavedSourceVerificationOutcomeScreen();const e=this.interactionResponse?.status;return"OTP_VALIDATION_PENDING"===e||"OTP_VALIDATION_FAILED"===e?this.renderOtpScreen(e):this.shouldRenderTransferScreen()?this.renderTransferScreen():this.renderPaymentSourceScreen()}renderMissingInteractionResponseScreen(){return this.renderWidgetShell({title:"Configuration required",showClose:!1,showDivider:!1,content:Ry`
        <div class="payment-flow">
          ${ux({variant:"danger",message:"CommerceHub Connect requires an interaction response before it can load payment methods."})}
        </div>
      `})}renderOtpScreen(e){const t=Zx(this.designConfig),r="verify-otp"===this.pendingAction,n="resend-otp"===this.pendingAction,i=Yx(this.interactionResponse);let o;return r?o=Uj({title:"Verifying code",helper:"Verifying your code, please wait."}):n&&(o=Uj({title:"Sending code",helper:"Sending a new code, please wait."})),this.renderWidgetShell({title:t.title,subtitle:t.subtitle??yx(i),showClose:!1,showDivider:!1,busy:r||n,overlay:o,content:$x({status:e,value:this.otpValue,length:6,failedMessage:this.otpErrorMessage,copy:t,submitting:r,resending:n})})}renderPaymentSourceScreen(){const e=Qx(this.designConfig),t=cj(this.interactionResponse,{nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}),r=dj(this.interactionResponse),n=Aj(this.interactionResponse,"ADD_ACCOUNT")&&(r.card||r.bankAccount),i=Aj(this.interactionResponse,"SELECT"),o=Aj(this.interactionResponse,"TRANSFER")&&yj(this.interactionResponse).length>=2,a="attach-payment-source"===this.pendingAction||"verify-payment-source"===this.pendingAction||"delete-payment-source"===this.pendingAction,s=this.paymentSourceEditMode&&t.length>0;if(this.shouldRenderPaymentSourceRefreshSkeleton())return this.renderWidgetShell({title:e.title,layout:"payment-methods",headerAction:Ry`
          <div
        ...
        `,showClose:!1,content:kx()});if(this.shouldRenderPaymentSourceRefreshError())return this.renderPaymentSourceRefreshErrorScreen();if(!t.length)return this.renderNoSavedPaymentMethods();if(this.shouldRenderSelectedPaymentSourceScreen())return this.renderSelectedPaymentSourceScreen();this.queueNativeAccountBalanceRefresh();const c=s?bx({label:"Done",action:"toggle-payment-source-edit-mode",disabled:a}):Ry`
          <div class="widget-toolbar" aria-label="Payment method actions">
            ${bx({label:"Edit",action:"toggle-payment-source-edit-mode",icon:"edit",disabled:a})}
            ${n?bx({label:"Add",action:"open-add-payment-source",icon:"add",variant:"primary",disabled:a}):""}
            ${o?bx({label:"Transfer",action:"open-transfer",icon:"transfer",disabled:a}):""}
          </div>
        `;return this.renderWidgetShell({title:e.title,layout:"payment-methods",headerAction:c,showClose:!1,busy:a&&"attach-payment-source"!==this.pendingAction,overlay:"attach-payment-source"===this.pendingAction?void 0:Hj(this.pendingAction),content:xx({methods:t,canSelectPaymentSources:i,editing:s,actionPending:a,selectedPaymentSourceId:this.selectedPaymentSourceId,deleteConfirmationPaymentSourceId:this.deleteConfirmationPaymentSourceId}),footer:s||!i?void 0:Ry`
              ${this.attachmentError?ux({variant:"danger",message:this.attachmentError}):""}
              ${sx({label:"attach-payment-source"===this.pendingAction?e.continuingButton:e.continueButton,action:"attach-payment-source",loading:"attach-payment-source"===this.pendingAction,disabled:!this.selectedPaymentSourceId||"attach-payment-source"===this.pendingAction})}
            `})}renderAddPaymentSourceLauncher(){const e=dj(this.interactionResponse);return this.renderWidgetShell({title:"Add a payment method",headerAction:bx({label:"Back",action:"back-to-payment-methods"}),showClose:!1,content:Ry`
        <div class="add-method-launcher">
          <p class="launcher-copy">Choose the type of payment method to add.</p>
          <div
            class="tender-tabs"
            role="tablist"
          ...
          >
            ${e.card?Ry`<button
                  ...
                  type="button"
                  role="tab"
                  aria-controls="add-card-tab-panel"
                  aria-selected="true"
                  tabindex="0"
            ...
            ${e.bankAccount?Ry`<button
                  class="tender-tab"
                  id="add-bank-account-tab"
                  type="button"
                  role="tab"
                  aria-controls="add-bank-account-tab-panel"
                  aria-selected="false"
                  tabindex="-1"
                  data-action="add-bank-account"
                >
                  Bank
                </button>`:""}
          </div>
          ${e.card?Ry`<div
                ...
                id="add-card-tab-panel"
                role="tabpanel"
                aria-labelledby="add-card-tab"
              >
                Add a card.
              </div>`:""}
          ${e.bankAccount?Ry`<div
                id="add-bank-account-tab-panel"
                role="tabpanel"
                aria-labelledby="add-bank-account-tab"
                hidden
              >
                Add a bank account.
              </div>`:""}
      ...
      `})}renderPaymentSourceRefreshErrorScreen(){return this.renderWidgetShell({title:"Payment methods unavailable",showClose:!1,content:Ry`
        <div class="payment-flow">
          ${ux({variant:"danger",message:this.interactionRefresh.errorMessage??"We couldn't load payment methods. Try again."})}
          <div class="primitive-footer">
            ${sx({label:"Try again",variant:"primary",action:"retry-interaction-refresh"})}
          </div>
        </div>
      `})}renderSelectedPaymentSourceScreen(){const e=Ej(this.interactionResponse,this.selectedPaymentSourceId);return e?this.renderWidgetShell({title:"Payment method saved",headerAction:bx({label:"Change",action:"change-payment-source",disabled:"attach-payment-source"===this.pendingAction}),showClose:!1,showDivider:!1,busy:"attach-payment-source"===this.pendingAction,overlay:"attach-payment-source"===this.pendingAction?Uj({title:cE(e)?"Saving bank account":"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,content:Ry`
        <div class="payment-flow">
          ${fx(lj(e,{selected:!0,nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}))}
        </div>
      `}):(this.paymentSourceView="list",this.renderPaymentSourceScreen())}shouldRenderSelectedPaymentSourceScreen(){return"list"!==this.paymentSourceView&&("PAYMENT_SOURCE_ATTACHED"===this.interactionResponse?.status||"selected"===this.paymentSourceView)}shouldRenderPaymentSourceRefreshSkeleton(){return this.interactionRefresh.shouldRenderSkeleton(this.interactionResponse)}shouldRenderPaymentSourceRefreshError(){return this.interactionRefresh.shouldRenderError(this.interactionResponse)}renderSavedSourceVerificationOutcomeScreen(){const e=this.savedSourceVerificationSource,t=Gj(e,this.savedSourceVerificationFailed),r="declined"===t.kind||"pending"===t.kind;return this.renderWidgetShell({title:t.title,headerAction:r?bx({label:"Back",action:"done-payment-source-verification"}):void 0,showClose:!1,showDivider:!1,content:Ry`
        <div class="verification-outcome-flow">
          ${ux({variant:t.variant,message:t.message})}
          ${e?oE(e):""}
          ${r?"":Ry`
                <div class="primitive-footer">
                  ${sx({label:"Back to payment methods",action:"done-payment-source-verification"})}
                </div>
              `}
        </div>
      `})}renderRequiredInfoScreen(){const e=this.requiredInfoSource;if(!e)return this.renderPaymentSourceScreen();const t=Jj(e),r=tE(t),n="submit-required-info"===this.pendingAction,i=this.canSubmitRequiredInfo();return this.renderWidgetShell({title:"Complete account verification",headerAction:bx({label:"Back",action:"back-to-payment-methods",disabled:n}),showClose:!1,showDivider:!1,busy:n,overlay:n?Uj({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,content:Ry`
        <form
          class="required-info-flow"
          data-submit-action="submit-required-info"
        >
          ${oE(e)}
          ${this.requiredInfoSubmitError?ux({variant:"danger",message:this.requiredInfoSubmitError}):""}
          ...
          <div class="required-info-documents">
            ...
            <div class="primitive-stack">
              ${t.map((e,t)=>{const r=Yj(e,t),i=Zj(e)?this.requiredInfoValues[r]:this.requiredInfoFileNames[r];return Zj(e)?rE({doc:e,key:r,value:i??""}):Ry`
                  <div
                    class="required-info-document required-document-text-row"
                    data-required-info-doc-key=${r}
                    data-required-info-requirement=${Xj(e)}
                  >
...
`)({label:"Required document",requirements:iE(e),actionLabel:"Choose file",fileName:i,action:"open-required-info-file-picker",disabled:n})}
                  </div>
                `})}
            </div>
          </div>
          ...
          <div
            ...
            data-required-info-doc-key=${r??""}
          >
            ${sx({label:n?"Verifying...":"Verify",action:"submit-required-info",type:"submit",loading:n,disabled:n||!i})}
          </div>
        </form>
      `})}renderNoSavedPaymentMethods(){const e=Xx(this.designConfig),t="delete-payment-source"===this.pendingAction,r=dj(this.interactionResponse),n=Aj(this.interactionResponse,"ADD_ACCOUNT")&&(r.card||r.bankAccount);return this.renderWidgetShell({title:e.title,subtitle:e.subtitle,headerAction:n?bx({label:"Add",action:"open-add-payment-source",disabled:t}):void 0,showClose:!1,showDivider:!1,content:jx({allowedTenderOptions:r,canAddPaymentSources:!1,deletePending:t,copy:e})})}shouldRenderTransferScreen(){const e=this.interactionResponse;return(this.transferFlowActive||Cj(e))&&Sj(e?.status)}renderTransferScreen(){const e=yj(this.interactionResponse),t="transfer"===this.pendingAction,r=this.transferFlowActive?bx({label:"Back",action:"back-to-payment-methods",disabled:t}):void 0;if(e.length<2)return this.renderWidgetShell({title:"Transfer funds",headerAction:r,showClose:!1,showDivider:!1,content:Ry`
          <div class="payment-flow">
            ${lx({title:"Transfer unavailable",message:"At least two verified bank or native accounts are required to transfer funds."})}
          </div>
        `});const n=[{value:"",label:"Select account"},...e.map(e=>({value:bj(e),label:hj(e)}))],i=Lk(this.transferDraft),o=e.find(e=>bj(e)===i.fromSourceId),a=e.find(e=>bj(e)===i.toSourceId);return"confirm"===this.transferFlowScreen&&o&&a&&Uk(i,e)?this.renderTransferConfirmationScreen(o,a,i,t):this.renderWidgetShell({title:"Transfer funds",headerAction:r,showClose:!1,showDivider:!1,busy:t,overlay:t?Uj({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="transfer"
        >
          ${this.transferSubmitError?ux({variant:"danger",message:this.transferSubmitError}):""}
          ${this.transferSubmitSuccess?ux({variant:"success",message:"Transfer initiated."}):""}
          ${gx([dx({id:"transfer-from-source",name:"fromSourceId",label:"From",value:this.transferDraft.fromSourceId,options:n,span:"full",variant:"card-form",dataField:"fromSourceId",dataFieldScope:"transfer",error:this.transferDraftErrors.fromSourceId,disabled:t}),dx({id:"transfer-to-source",name:"toSourceId",label:"To",value:this.transferDraft.toSourceId,options:n,span:"full",variant:"card-form",dataField:"toSourceId",dataFieldScope:"transfer",error:this.transferDraftErrors.toSourceId,disabled:t}),cx({id:"transfer-amount",name:"amount",label:"Amount",value:this.transferDraft.amount,variant:"card-form",inputmode:"decimal",dataField:"amount",dataFieldScope:"transfer",error:this.transferDraftErrors.amount,disabled:t})])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${sx({label:t?"Transferring":"Transfer",action:"transfer",type:"submit",loading:t,disabled:t||!Uk(this.transferDraft,e)})}
            </div>
          </div>
        </form>
      `})}renderTransferConfirmationScreen(e,t,r,n){return this.renderWidgetShell({title:"Confirm transfer",headerAction:bx({label:"Back",action:"edit-transfer",disabled:n}),showClose:!1,showDivider:!1,busy:n,overlay:n?Uj({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="confirm-transfer"
        >
          ${this.transferSubmitError?ux({variant:"danger",message:this.transferSubmitError}):""}
          ${mx([{label:"From",value:hj(e)},{label:"To",value:hj(t)},{label:"Amount",value:Fk(r)}])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${sx({label:n?"Transferring":"Confirm transfer",action:"confirm-transfer",type:"submit",loading:n,disabled:n})}
            </div>
            <div class="card-form-primary">
              ${sx({label:"Edit",variant:"secondary",action:"edit-transfer",disabled:n})}
            </div>
          </div>
        </form>
      `})}renderAddCardScreen(){const e="save-card"===this.pendingAction,t="encrypting"===this.cardEncryption.cardNumber.status||"encrypting"===this.cardEncryption.cvv.status,r=[...this.billingAddresses.map(e=>({value:e.id??"",label:Ux(e)})),{value:zw,label:"Add new billing address"}],n=this.billingAddresses.find(e=>e.id===this.cardDraft.billingAddressValue),i=Boolean(n)&&!this.billingAddressSelectorExpanded,o=!i&&this.cardDraft.billingAddressValue===zw,a=[];return n&&i?a.push(Ry`
        <div class="billing-address-summary field field-full">
          <div class="billing-address-summary-heading">
            ...
            >
            ${bx({label:"Change",action:"change-billing-address",disabled:e})}
          </div>
          <p class="billing-address-summary-value">
            ${Ux(n)}
          </p>
        </div>
      `):a.push(dx({id:"billing-address",name:"billingAddress",label:"Billing address",value:this.cardDraft.billingAddressValue,options:r,span:"full",variant:"card-form",dataField:"billingAddressValue",error:this.cardDraftErrors.billingAddressValue,disabled:e})),o&&a.push(dx({id:"billing-country",name:"country",label:"Country or region",value:this.cardDraft.country,options:Dx,span:"full",variant:"card-form",dataField:"country",error:this.cardDraftErrors.country,disabled:e}),cx({id:"billing-address-line-1",name:"addressLine1",label:"Address",value:this.cardDraft.addressLine1,placeholder:"Street address",span:"full",variant:"card-form",autocomplete:"address-line1",dataField:"addressLine1",error:this.cardDraftErrors.addressLine1,disabled:e}),cx({id:"billing-address-line-2",name:"addressLine2",label:"Address line 2",value:this.cardDraft.addressLine2,placeholder:"Apartment, suite, unit",span:"full",variant:"card-form",autocomplete:"address-line2",dataField:"addressLine2",error:this.cardDraftErrors.addressLine2,disabled:e}),cx({id:"billing-city",name:"city",label:"City",value:this.cardDraft.city,span:"full",variant:"card-form",autocomplete:"address-level2",dataField:"city",error:this.cardDraftErrors.city,disabled:e}),dx({id:"billing-state",name:"state",label:"State",value:this.cardDraft.state,options:Bx,span:"full",variant:"card-form",dataField:"state",error:this.cardDraftErrors.state,disabled:e}),cx({id:"billing-zip",name:"zip",label:"ZIP code",value:this.cardDraft.zip,placeholder:"ZIP code",span:"full",variant:"card-form",autocomplete:"postal-code",inputmode:"numeric",dataField:"zip",error:this.cardDraftErrors.zip,disabled:e})),this.renderWidgetShell({title:"Add card",headerAction:bx({label:"Back",action:"back-to-payment-methods",disabled:e}),showClose:!1,showDivider:!1,busy:e,overlay:e?Uj({title:"Saving card",helper:"Securely saving your card, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="save-card"
        >
          ${this.cardSubmitError?ux({variant:"danger",message:this.cardSubmitError}):""}
          ${gx([cx({id:"card-label",name:"name",label:"Card Name",value:this.cardDraft.name,placeholder:"Corporate card",span:"full",variant:"card-form",dataField:"name",error:this.cardDraftErrors.name,disabled:e}),cx({id:"card-number",name:"cardNumber",label:"Card number",value:this.cardDraft.cardNumber,placeholder:"1234 1234 1234 1234",span:"full",variant:"card-form",autocomplete:"cc-number",inputmode:"numeric",dataField:"cardNumber",error:this.cardDraftErrors.cardNumber,disabled:e}),cx({id:"expiration-date",name:"expirationDate",label:"Expiration",value:this.cardDraft.expirationDate,placeholder:"MM / YY",variant:"card-form",autocomplete:"cc-exp",inputmode:"numeric",dataField:"expirationDate",error:this.cardDraftErrors.expirationDate,disabled:e}),cx({id:"card-cvv",name:"cvv",label:"CVC",value:this.cardDraft.cvv,placeholder:"3 or 4 digits",variant:"card-form",autocomplete:"cc-csc",inputmode:"numeric",dataField:"cvv",error:this.cardDraftErrors.cvv,disabled:e}),cx({id:"name-on-card",name:"fullName",label:"Full name",value:this.cardDraft.fullName,placeholder:"Name on card",span:"full",variant:"card-form",autocomplete:"cc-name",dataField:"fullName",error:this.cardDraftErrors.fullName,disabled:e}),...a])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${sx({label:e?"Saving payment method":"Save card",action:"save-card",type:"submit",loading:e,disabled:e||t||(s=this.cardDraft,c=this.cardEncryption,!(0===Object.keys(Fw(Uw(s))).length&&0===Object.keys(Gw(s,c)).length))})}
            </div>
          </div>
        </form>
      `});var s,c}renderCardErrorScreen(){return this.renderWidgetShell({title:"Credit card not saved",subtitle:"We could not save this card. Check the card details or use a different payment method.",showClose:!1,showDivider:!1,content:vx({variant:"danger",content:this.cardSubmitError?ux({variant:"danger",message:this.cardSubmitError}):void 0,actions:Ry`
          ${sx({label:"Edit card details",action:"edit-card-details"})}
          ${bx({label:"Use a different method",action:"use-different-method"})}
        `})})}renderBankProviderScreen(){return this.renderWidgetShell({title:"Connect your bank",headerAction:bx({label:"Back",action:"back-to-payment-methods",disabled:this.bankLinkLoading}),showClose:!1,showDivider:!1,busy:this.bankLinkLoading,overlay:this.bankLinkLoading?Uj({title:"Connecting to your bank",helper:"Securely opening your bank connection, please wait."}):void 0,content:px({containerId:zx,loading:this.bankLinkLoading,loadingLabel:"Connecting to your bank"}),footer:Ry`
        <div class="bank-provider-manual-link">
          ${bx({label:"Connect another way",action:"add-ach-manually",disabled:this.bankLinkLoading})}
        </div>
      `})}renderManualBankAccountConfigLoadingScreen(){return this.renderWidgetShell({title:"Select an instrument schema",headerAction:bx({label:"Back",action:this.manualBankAccountExitAction(),disabled:!0}),showClose:!1,showDivider:!1,busy:!0,overlay:Uj({title:"Loading instrument schemas",helper:"Loading the available bank account options, please wait."}),content:Ry`<div class="payment-flow card-form-screen"></div>`})}renderManualBankAccountConfigErrorScreen(){return this.renderWidgetShell({title:"Select an instrument schema",headerAction:bx({label:"Back",action:this.manualBankAccountExitAction()}),showClose:!1,showDivider:!1,content:Ry`
        <div class="payment-flow card-form-screen">
          ${ux({variant:"danger",message:this.bankAccountConfigError??"Unable to load instrument schemas. Try again."})}
          <div class="primitive-footer card-form-primary">
            ${sx({label:"Try again",action:"add-ach-manually"})}
          </div>
        </div>
      `})}renderManualBankAccountSchemaSelectionScreen(){return this.renderWidgetShell({title:"Select an instrument schema",headerAction:bx({label:"Back",action:this.manualBankAccountExitAction()}),showClose:!1,showDivider:!1,content:Ry`
        <div class="instrument-schema-selection">
          ...
          <div class="primitive-footer card-form-primary">
            ${sx({label:"Continue",action:"select-instrument-schema",disabled:!this.selectedBankAccountInstrumentSchemaCode})}
          </div>
        </div>
      `})}renderManualBankAccountScreen(){if("legacy"===this.manualBankAccountFormMode)return this.renderLegacyManualBankAccountScreen();const e=this.bankAccountFormSchema,t=this.bankAccountFormUiSchema;if(!e||!t)return this.renderManualBankAccountConfigErrorScreen();const r="save-bank-account"===this.pendingAction;return this.renderWidgetShell({title:"Enter bank details",headerAction:bx({label:"Back",action:this.bankAccountInstrumentSchemas.length>1?"back-to-instrument-schema-selection":this.manualBankAccountExitAction()}),showClose:!1,showDivider:!1,content:Ry`
        <form
          class="payment-flow card-form-screen"
        ...
        >
          ...
          ></commerce-hub-bank-account-jsonforms>
          ${this.bankAccountSubmitError?ux({variant:"danger",message:this.bankAccountSubmitError}):""}
          <div class="primitive-footer card-form-primary">
            ${sx({label:r?"Saving bank account":"Save bank account",action:"save-bank-account",type:"submit",loading:r,disabled:!this.bankAccountFormValid||r})}
          </div>
        </form>
      `})}renderBankBillingAddressControl(e){const t=[...this.billingAddresses.map(e=>({value:e.id??"",label:Ux(e)})),{value:zw,label:"Add new billing address"}],r=this.billingAddresses.find(e=>e.id===this.bankBillingAddressValue);return r&&!this.bankBillingAddressSelectorExpanded?Ry`
        <div class="billing-address-summary field field-full">
          <div class="billing-address-summary-heading">
            <span class="billing-address-summary-label field-label"
              >Billing address</span
            >
            ${bx({label:"Change",action:"change-bank-billing-address",disabled:e})}
          </div>
          <p class="billing-address-summary-value">
            ${Ux(r)}
          </p>
        </div>
      `:dx({id:"bank-billing-address",name:"bankBillingAddress",label:"Billing address",value:this.bankBillingAddressValue,options:t,span:"full",variant:"card-form",disabled:e})}renderLegacyManualBankAccountScreen(){const e="save-bank-account"===this.pendingAction,t=Object.values(this.legacyBankAccountEncryption).some(e=>"encrypting"===e.status);return this.renderWidgetShell({title:"Enter bank details",headerAction:bx({label:"Back",action:this.manualBankAccountExitAction(),disabled:e}),showClose:!1,showDivider:!1,busy:e,overlay:e?Uj({title:"Saving bank account",helper:"Securely saving your bank account, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="save-bank-account"
        >
          ...
          ></commerce-hub-bank-account-jsonforms>
          <div class="primitive-footer card-form-primary">
            ${sx({label:e?"Saving bank account":"Save bank account",action:"save-bank-account",type:"submit",loading:e,disabled:e||t||!b$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption,r$)})}
          </div>
        </form>
      `})}renderBankOutcomeScreen(){const e=Kj(this.bankOutcomeSource),t="declined"===e.kind||"pending"===e.kind;return this.renderWidgetShell({title:e.title,headerAction:t?bx({label:"Done",action:"done-bank-outcome"}):void 0,showClose:!1,showDivider:!1,content:Ry`
        <div class="verification-outcome-flow">
          ${ux({variant:e.variant,message:e.message})}
          ${this.bankOutcomeSource?oE(this.bankOutcomeSource):""}
          ${t?"":Ry`
                <div class="primitive-footer">
                  ${"verified"===e.kind?sx({label:"Continue",action:"continue-bank-outcome"}):"pending"===e.kind?sx({label:"Done",action:"done-bank-outcome"}):Ry`
                        ${sx({label:this.bankLinkLoading?"Retrying":"Try again",action:"retry-bank-provider",loading:this.bankLinkLoading,disabled:this.bankLinkLoading})}
                        ${bx({label:"Use a different account",action:"use-different-bank-account",disabled:this.bankLinkLoading})}
                      `}
                </div>
              `}
        </div>
      `})}getOtpInputs(){return[...this.renderRoot.querySelectorAll(".otp-input")]}getRequiredInfoSsnInputs(e){return[...this.renderRoot.querySelectorAll(".required-info-ssn-input")].filter(t=>t.dataset.requiredInfoDocKey===e)}storeRequiredInfoSsnInput(e){const t=e.dataset.requiredInfoDocKey;if(!t)return;const r=this.getRequiredInfoSsnInputs(t),n=r.indexOf(e),i=Dk(Number(e.dataset.requiredInfoSsnSegment)),o=Pk(e.value);if(!(n<0)){if(o.length>i){const e=this.writeRequiredInfoSsnDigits(r,n,o);return this.syncRequiredInfoSsnValue(t,r),void this.focusRequiredInfoSsnInput(r,e)}e.value=o.slice(0,i),this.syncRequiredInfoSsnValue(t,r),e.value.length>=i&&this.focusRequiredInfoSsnInput(r,n+1)}}pasteRequiredInfoSsnInput(e,t){const r=t.dataset.requiredInfoDocKey;if(!r)return;const n=e,i="function"==typeof n.clipboardData?.getData?n.clipboardData.getData("text"):"",o=Pk(i);if(!o)return;e.preventDefault();const a=this.getRequiredInfoSsnInputs(r),s=a.indexOf(t);if(s<0)return;const c=this.writeRequiredInfoSsnDigits(a,s,o);this.syncRequiredInfoSsnValue(r,a),this.focusRequiredInfoSsnInput(a,c)}writeRequiredInfoSsnDigits(e,t,r){let n=0,i=t;return e.forEach((e,o)=>{if(o<t)return;const a=Dk(Number(e.dataset.requiredInfoSsnSegment)),s=r.slice(n,n+a);e.value=s,s&&(i=o),n+=a}),i}syncRequiredInfoSsnValue(e,t){this.storeRequiredInfoValue(e,Pk(t.map(e=>e.value).join("")))}focusRequiredInfoSsnInput(e,t){e[Math.min(t,e.length-1)]?.focus()}syncOtpValueFromInputs(e=this.getOtpInputs()){this.otpValue=((e,t=6)=>Rk(e.join("")).slice(0,t))(e.map(e=>e.value)),this.otpErrorMessage=void 0}writeOtpDigits(e,t,r){const n=(({values:e,startIndex:t,value:r})=>{const n=[...e],i=Rk(r);let o=t;return i.slice(0,Math.max(n.length-t,0)).split("").forEach((e,r)=>{const i=t+r;i>=n.length||(n[i]=e,o=i)}),{values:n,lastWrittenIndex:o}})({values:e.map(e=>e.value),startIndex:t,value:r});return n.values.forEach((t,r)=>{e[r].value=t}),n.lastWrittenIndex}focusOtpInput(e,t,r=t){const n=e[t]??e[Math.max(0,Math.min(r,e.length-1))];n&&n.focus()}async showAddCardScreen(){this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow(),this.cardFlowScreen="form",this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===zw||!this.billingAddresses.length;const e=this.interactionResponse?.interactionId,t=Boolean(this.interactionResponse?.selectedSource||this.interactionResponse?.paymentSources?.length);if(e&&t&&!this.billingAddresses.length&&void 0===this.interactionResponse?.billerAddress)try{await this.fetchInteraction(e)}catch(e){}this.focusAfterUpdate("#card-label")}async showManualBankAccountScreen(){const e=this.requireInteractionId(),t=this.interactionResponse?.country?.trim();this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow();const r=++this.bankAccountConfigRequestToken;if(this.bankFlowScreen="manual-config-loading",!e)return this.bankAccountConfigError="CommerceHub Connect requires an interaction response before bank details can load.",void(this.bankFlowScreen="manual-config-error");if(!t)return this.bankAccountConfigError="Bank account details are not available because the interaction response is missing a country.",void(this.bankFlowScreen="manual-config-error");var n;if(uj(t))this.initializeLegacyManualBankAccountScreen();else try{const i=await this.fetchManualBankAccountCountryConfig(e,t);if(!this.isCurrentManualBankAccountConfigRequest(r,e,t))return void(r===this.bankAccountConfigRequestToken&&this.resetBankFlow());const o=i.instrumentSchemas;if(void 0===o||Array.isArray(o)&&0===o.length)return void this.initializeLegacyManualBankAccountScreen();const a=(n=o,(Array.isArray(n)?n:fk(n)&&Array.isArray(n.instrumentSchemas)?n.instrumentSchemas:[]).filter(xk));if(0===a.length)return this.bankAccountConfigError="No instrument schemas are available for this country. Try again.",void(this.bankFlowScreen="manual-config-error");if(this.bankAccountInstrumentSchemas=a,this.bankAccountConfigError=void 0,1===a.length)return this.selectedBankAccountInstrumentSchemaCode=a[0].bavSupportedCode,void this.initializeManualBankAccountScreen();this.bankFlowScreen="manual-schema-selection"}catch(n){if(!this.isCurrentManualBankAccountConfigRequest(r,e,t))return void(r===this.bankAccountConfigRequestToken&&this.resetBankFlow());this.bankAccountConfigError=Nj(n),this.bankFlowScreen="manual-config-error"}}manualBankAccountExitAction(){return uj(this.interactionResponse?.country)?"back-to-bank-provider":"back-to-payment-methods"}isCurrentManualBankAccountConfigRequest(e,t,r){return e===this.bankAccountConfigRequestToken&&Boolean(t)&&Boolean(r)&&this.interactionResponse?.interactionId===t&&this.interactionResponse?.country?.trim()===r}initializeManualBankAccountScreen(){const e=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);e&&(this.reconcileBankBillingAddressSelection(),this.manualBankAccountFormMode="instrument-schema",this.bankFlowScreen="manual",this.configureManualBankAccountForm(e,!0),this.bankAccountSubmitError=void 0,this.bankAccountFormI18n={translateError:Ok(e)},this.bankAccountConfigError=void 0)}configureManualBankAccountForm(e,t){const r=this.bankBillingAddressValue===zw?e:(e=>{const t=Object.fromEntries(Object.entries(e.properties).filter(([e])=>"address"!==e&&!e.startsWith("address."))),r=e.required.filter(e=>"address"!==e&&!e.startsWith("address."));return{...e,properties:t,required:r}})(e),n=(e=>{kk(e);const t={};for(const r of Object.keys(e.properties)){let e=t;for(const t of yk(r).slice(0,-1)){const r=mk(e,t)?e[t]:void 0,n=fk(r)?r:{};e[t]=n,e=n}}return t})(r);var i;this.bankAccountFormSchema=this.instrumentSchemaWithBillingAddressControl((e=>{kk(e);const t={type:"object",properties:{}};for(const[r,n]of Object.entries(e.properties))Ek(t,yk(r),n);for(const r of e.required)Sk(t,yk(r));return t})(r)),this.bankAccountFormUiSchema=((e,t)=>{const r=e,n=r.elements??[],i=e=>e.scope??"",o=n.filter(e=>i(e).startsWith("#/properties/address/")),a=n.filter(e=>!o.includes(e)),s=a.findIndex(e=>i(e).endsWith("/accountNumber")),c=s>=0?s+1:a.length,d={type:"Control",scope:t};return{...r,elements:[...a.slice(0,c),d,...o,...a.slice(c)]}})((kk(i=r),{type:"VerticalLayout",elements:Object.keys(i.properties).map(e=>({type:"Control",scope:`#/properties/${yk(e).map(Ak).join("/properties/")}`}))}),"#/properties/__bankBillingAddress"),this.bankAccountFormData=t?{...n,[Tx]:this.bankBillingAddressValue}:{...n,...this.bankAccountFormData,[Tx]:this.bankBillingAddressValue},this.bankAccountFormValid=!1}instrumentSchemaWithBillingAddressControl(e){return{...e,properties:{...e.properties??{},[Tx]:{type:"string",title:"Billing address"}}}}updateBankBillingAddress(e){if(!(e===zw||this.billingAddresses.some(t=>t.id===e)))return;this.bankBillingAddressValue=e,this.bankBillingAddressSelectorExpanded=e===zw,this.bankAccountSubmitError=void 0;const t=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);t&&"instrument-schema"===this.manualBankAccountFormMode&&this.configureManualBankAccountForm(t,!1)}reconcileBankBillingAddressSelection(){if(this.bankBillingAddressValue===zw)return void(this.bankBillingAddressSelectorExpanded=!0);this.billingAddresses.some(e=>e.id===this.bankBillingAddressValue)||(this.bankBillingAddressValue=this.billingAddresses[0]?.id??zw,this.bankBillingAddressSelectorExpanded=this.bankBillingAddressValue===zw)}initializeLegacyManualBankAccountScreen(){this.manualBankAccountFormMode="legacy",this.bankFlowScreen="manual",this.legacyBankAccountDraft={accountNickname:"",routingNumber:"",accountNumber:"",confirmAccountNumber:""},this.legacyBankAccountDraftErrors={},this.legacyBankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},confirmAccountNumber:{status:"idle",normalizedValue:""}},this.bankAccountSubmitError=void 0,this.bankAccountConfigError=void 0}clearManualBankAccountForm(){this.manualBankAccountFormMode=void 0,this.bankAccountFormSchema=void 0,this.bankAccountFormUiSchema=void 0,this.bankAccountFormData={},this.bankAccountFormValid=!1,this.bankAccountSubmitError=void 0,this.bankAccountFormI18n=void 0,this.legacyBankAccountDraft={accountNickname:"",routingNumber:"",accountNumber:"",confirmAccountNumber:""},this.legacyBankAccountDraftErrors={},this.legacyBankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},confirmAccountNumber:{status:"idle",normalizedValue:""}}}updateTransferDraftField(e,t){const r=Lk({...this.transferDraft,[e]:t});this.transferDraft=r,this.transferDraftErrors=Vk(r,yj(this.interactionResponse)),this.transferFlowScreen="form",this.transferSubmitError=void 0,this.transferSubmitSuccess=!1}updateLegacyBankAccountDraftField(e,t){if("legacy"!==this.manualBankAccountFormMode)return;const r=y$({draft:this.legacyBankAccountDraft,errors:this.legacyBankAccountDraftErrors,encryption:this.legacyBankAccountEncryption,schema:r$,field:e,value:t});this.legacyBankAccountDraft=r.draft,this.legacyBankAccountEncryption=r.encryption,this.legacyBankAccountDraftErrors=r.errors,this.bankAccountSubmitError=void 0}updateCardDraftField(e,t){const r=((e,t)=>"cardNumber"===e?Bw(t):"expirationDate"===e?Vw(t):"cvv"===e?Pw(t).slice(0,4):t)(e,t);this.cardDraft={...this.cardDraft,[e]:r},"billingAddressValue"===e&&(this.billingAddressSelectorExpanded=r===zw),this.cardSubmitError=void 0,Rw(e)&&(this.cardEncryption={...this.cardEncryption,[e]:Ww(this.cardEncryption[e],Dw(e,r))})}async encryptCardField(e,t){this.updateCardDraftField(e,t);const r=Dw(e,t),n=((e,t)=>"cardNumber"===e?Yw(t)?void 0:"Enter a valid card number.":Zw(t)?void 0:"Enter a valid CVC.")(e,t);if(!r)return this.cardDraftErrors=Kw(this.cardDraftErrors,e),void(this.cardEncryption={...this.cardEncryption,[e]:{status:"idle",normalizedValue:""}});if(n)return this.cardDraftErrors={...Kw(this.cardDraftErrors,e),[e]:n},void(this.cardEncryption={...this.cardEncryption,[e]:Ww(this.cardEncryption[e],r)});const i=this.cardEncryption[e];if("encrypting"!==i.status&&"encrypted"!==i.status||i.normalizedValue!==r){this.cardDraftErrors=Kw(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypting",normalizedValue:r}};try{const t=await this.encryptSensitiveSourceValue(r);if(Dw(e,this.cardDraft[e])!==r)return;this.cardDraftErrors=Kw(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypted",normalizedValue:r,encryptedValue:t}}}catch(t){if(Dw(e,this.cardDraft[e])!==r)return;this.cardDraftErrors={...Kw(this.cardDraftErrors,e),[e]:Hw(e)},this.cardEncryption={...this.cardEncryption,[e]:{status:"failed",normalizedValue:r}}}}}async encryptLegacyBankAccountField(e,t){if("legacy"!==this.manualBankAccountFormMode)return;const r=this.legacyBankAccountEncryption[e];if(s$(t,r))return this.legacyBankAccountDraft={...this.legacyBankAccountDraft,[e]:t},void(this.bankAccountSubmitError=void 0);this.updateLegacyBankAccountDraftField(e,t);const n=a$(t);if(!n){const t={...this.legacyBankAccountEncryption,[e]:{status:"idle",normalizedValue:""}};return this.legacyBankAccountEncryption=t,void(this.legacyBankAccountDraftErrors=f$(d$(this.legacyBankAccountDraft,t),r$))}if("encrypting"!==r.status&&"encrypted"!==r.status||r.normalizedValue!==n){this.legacyBankAccountDraftErrors=((e,t)=>{const r={...e};return delete r[t],r})(this.legacyBankAccountDraftErrors,e),this.legacyBankAccountEncryption={...this.legacyBankAccountEncryption,[e]:{status:"encrypting",normalizedValue:n}};try{const t=await this.encryptSensitiveSourceValue(n);if("legacy"!==this.manualBankAccountFormMode||a$(this.legacyBankAccountDraft[e])!==n)return;const r={...this.legacyBankAccountDraft,[e]:c$(n)},i={...this.legacyBankAccountEncryption,[e]:{status:"encrypted",normalizedValue:n,encryptedValue:t}};this.legacyBankAccountDraft=r,this.legacyBankAccountEncryption=i,this.legacyBankAccountDraftErrors=f$(d$(r,i),r$)}catch(t){if("legacy"!==this.manualBankAccountFormMode||a$(this.legacyBankAccountDraft[e])!==n)return;const r={...this.legacyBankAccountEncryption,[e]:{status:"failed",normalizedValue:n}};this.legacyBankAccountEncryption=r,this.legacyBankAccountDraftErrors={...f$(d$(this.legacyBankAccountDraft,r),r$),[e]:g$(e)}}}}async encryptSensitiveSourceValue(e){const t=this.requireSourceCreateContext();return Yk(e,t.publicKey)}async saveCard(){if("save-card"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=Uw(this.cardDraft),r={...Fw(t),...Gw(t,this.cardEncryption)};if(Object.keys(r).length>0)return this.cardDraft=t,this.cardDraftErrors=r,void(this.cardSubmitError=void 0);let n;try{n=this.requireSourceCreateContext()}catch(e){return this.cardDraft=t,this.cardDraftErrors={},void(this.cardSubmitError=Nj(e))}this.pendingAction="save-card",this.cardDraft=t,this.cardDraftErrors={},this.cardSubmitError=void 0;try{const r=Jw("cardNumber",t.cardNumber,this.cardEncryption),i=Jw("cvv",t.cvv,this.cardEncryption),o=Qw(t.expirationDate);if(!o)return void(this.cardDraftErrors={expirationDate:"Enter a valid expiration date."});const a=await this.resolveBillingAddressId(e,t),s={id:"",tenderType:"CARD",name:t.name,billingAddressId:a,card:{nameOnCard:t.fullName,cardNumber:r,cvv:i,cardNumberEncrypted:r,cvvEncrypted:i,expirationMonth:o.month,expirationYear:o.year,network:Xw(t.cardNumber)}},c=await this.requestCommerceHubJson("/interaction/source/card",e,{method:"POST",headers:this.createSourceCreateHeaders(e,n,{"Content-Type":"application/json"}),body:JSON.stringify(s),credentials:"include"}),d=this.sourceWithVerificationResponse(Fx(s,t.cardNumber),c);Gx(c,"The card creation response did not include a source id.");const u=this.interactionResponseWithAddedSource(e,d);this.cardFlowScreen=void 0,this.cardDraft=Tw(),this.cardDraftErrors={},this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.cardSubmitError=void 0,this.setInteractionResponseFromSdk(u),this.emitSdkEvent(Ax,d),this.showAddedPaymentSourceStatus(d)}catch(e){this.cardSubmitError=Nj(e),this.cardFlowScreen="error"}finally{this.pendingAction=void 0}}async saveManualBankAccount(){if("legacy"===this.manualBankAccountFormMode)return void await this.saveLegacyManualBankAccount();if("save-bank-account"===this.pendingAction||!this.bankAccountFormValid)return;const e=this.requireInteractionId(),t=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);if(!e||!t)return;let r;try{r=this.requireSourceCreateContext()}catch(e){return void(this.bankAccountSubmitError=Nj(e))}this.pendingAction="save-bank-account",this.bankAccountSubmitError=void 0;try{const n=await this.resolveManualBankBillingAddressId(e),i=Tk(this.bankAccountFormData,t,n,zj()),o=await(async(e,t)=>{const{accountNumber:r,accountNumberReEntered:n,routingNumber:i}=e.bankAccount;if(!r||!n)throw new Error("Bank account details are required for encryption.");const[o,a,s]=await Promise.all([t(r),t(n),i?t(i):Promise.resolve(void 0)]);return{...e,bankAccount:{...e.bankAccount,...s?{routingNumber:s,routingNumberEncrypted:s}:{},accountNumber:o,accountNumberEncrypted:o,accountNumberReEntered:a}}})(i,e=>Yk(e,r.publicKey)),a=await this.requestCommerceHubJson("/interaction/source/ach",e,{method:"POST",headers:this.createSourceCreateHeaders(e,r,{"Content-Type":"application/json"}),body:JSON.stringify(o),credentials:"include"});Gx(a,"The bank account creation response did not include a source id.");const s=this.sourceWithVerificationResponse(Wx(i),a),c=this.interactionResponseWithAddedSource(e,s);this.setInteractionResponseFromSdk(c),this.emitSdkEvent(Ax,s),this.resetBankFlow(),this.showAddedPaymentSourceStatus(s)}catch(e){this.bankAccountSubmitError=Nj(e)}finally{this.pendingAction=void 0}}async saveLegacyManualBankAccount(){if("save-bank-account"===this.pendingAction)return;const e=this.requireInteractionId();if(!e||"legacy"!==this.manualBankAccountFormMode)return;const t=d$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),r=f$(t,r$);if(Object.keys(r).length>0)return this.legacyBankAccountDraft=l$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),this.legacyBankAccountDraftErrors=r,void(this.bankAccountSubmitError=void 0);let n;try{n=this.requireSourceCreateContext()}catch(e){return this.legacyBankAccountDraft=l$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),this.legacyBankAccountDraftErrors={},void(this.bankAccountSubmitError=Nj(e))}this.pendingAction="save-bank-account",this.legacyBankAccountDraft=l$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),this.legacyBankAccountDraftErrors={},this.bankAccountSubmitError=void 0;try{await this.encryptChangedLegacyBankAccountFields();const t=d$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),r=f$(t,r$);if(Object.keys(r).length>0)return void(this.legacyBankAccountDraftErrors=r);const s=w$("routingNumber",this.legacyBankAccountDraft,this.legacyBankAccountEncryption),c=w$("accountNumber",this.legacyBankAccountDraft,this.legacyBankAccountEncryption),d=w$("confirmAccountNumber",this.legacyBankAccountDraft,this.legacyBankAccountEncryption),u=(i="accountNumber",o=this.legacyBankAccountEncryption,a=t,k$(o[i].normalizedValue||a[i])),l={id:"",tenderType:"BANK_ACCOUNT",productCode:"POACH",name:$$(this.legacyBankAccountDraft.accountNickname,u),bankAccount:{routingNumber:s,accountNumber:c,accountNumberReEntered:d,routingNumberEncrypted:s,accountNumberEncrypted:c,asset:{type:"CURRENCY",id:"USD"}}},h=await this.requestCommerceHubJson("/interaction/source/ach",e,{method:"POST",headers:this.createSourceCreateHeaders(e,n,{"Content-Type":"application/json"}),body:JSON.stringify(l),credentials:"include"}),f=this.sourceWithVerificationResponse(Kx(l,u),h);Gx(h,"The bank account creation response did not include a source id.");const m=this.interactionResponseWithAddedSource(e,f);this.setInteractionResponseFromSdk(m),this.emitSdkEvent(Ax,f),this.resetBankFlow(),this.showAddedPaymentSourceStatus(f)}catch(e){this.bankAccountSubmitError=Nj(e)}finally{this.pendingAction=void 0}var i,o,a}async encryptChangedLegacyBankAccountFields(){for(const e of["routingNumber","accountNumber","confirmAccountNumber"]){const t=this.legacyBankAccountDraft[e],r=this.legacyBankAccountEncryption[e];if(s$(t,r))continue;const n=a$(t);if(!n)continue;"encrypted"===r.status&&r.normalizedValue===n&&Boolean(r.encryptedValue)||await this.encryptLegacyBankAccountField(e,t)}}reviewTransfer(){if("transfer"===this.pendingAction)return;const e=yj(this.interactionResponse),t=Lk(this.transferDraft),r=Vk(t,e);if(Object.keys(r).length>0)return this.transferDraft=t,this.transferDraftErrors=r,this.transferSubmitError=void 0,void(this.transferSubmitSuccess=!1);this.transferDraft=t,this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1,this.transferFlowScreen="confirm"}async submitTransfer(){if("transfer"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=yj(this.interactionResponse),r=Lk(this.transferDraft),n=Vk(r,t);if(Object.keys(n).length>0)return this.transferDraft=r,this.transferDraftErrors=n,this.transferFlowScreen="form",this.transferSubmitError=void 0,void(this.transferSubmitSuccess=!1);this.pendingAction="transfer",this.transferDraft=r,this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1;try{const t=await this.requestCommerceHubJson("/interaction/source/native/transfer",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({fromSourceId:r.fromSourceId,toSourceId:r.toSourceId,amount:Number(r.amount),asset:{type:"CURRENCY",id:"USD"}}),credentials:"include"});this.transferFlowScreen="form",this.transferSubmitSuccess=!0,this.emitSdkEvent(_x,t)}catch(e){this.transferSubmitError=Nj(e)}finally{this.pendingAction=void 0}}async resolveBillingAddressId(e,t){if(t.billingAddressValue!==zw)return t.billingAddressValue;const r=(e=>({id:t$(),recipientNameOrAddress:e.fullName,country:e.country,street:e.addressLine1,houseNumberOrName:e.addressLine2||void 0,city:e.city,stateOrProvince:e.state,postalCode:e.zip}))(t),n=await this.requestCommerceHubJson("/interaction/billing-address",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r),credentials:"include"}),i=n.value?.trim();if(!i)throw new Error("The billing address response did not include an id.");return i}async resolveManualBankBillingAddressId(e){if(this.bankBillingAddressValue!==zw){const e=this.billingAddresses.find(e=>e.id===this.bankBillingAddressValue),t=e?.id?.trim();if(!t)throw new Error("Select a billing address.");return t}const t=zk(this.bankAccountFormData,zj()),r=await this.requestCommerceHubJson("/interaction/billing-address",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"include"}),n=r.value?.trim();if(!n)throw new Error("The billing address response did not include an id.");return n}async verifyOtp(){if("verify-otp"===this.pendingAction)return;if(this.otpValue.length<6)return;const e=this.requireInteractionId();if(e){this.pendingAction="verify-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/validate",{body:{otp:this.otpValue,channel:"EMAIL"}}),r=_j(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(r)}catch(e){this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk({...this.interactionResponse,status:"OTP_VALIDATION_FAILED"})}finally{this.pendingAction=void 0}}}async resendOtp(){if("resend-otp"===this.pendingAction)return;const e=this.requireInteractionId();if(e){this.pendingAction="resend-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/send/email"),r=_j(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(r)}catch(e){}finally{this.pendingAction=void 0}}}async attachPaymentSource(e){if("attach-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),r=this.findPaymentSourceById(e);if(t&&r&&"VERIFIED"===r.verificationInfo?.status){this.selectedPaymentSourceId=e,this.paymentSourceView="list",this.attachmentError=void 0,this.pendingAction="attach-payment-source";try{const n=await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}/attach`,t,{method:"POST",credentials:"include"}),i=Oj(this.interactionResponse??{interactionId:t},n,e),o=Ej(i,e)??i.paymentSources?.find(t=>t.id===e)??r;this.selectedPaymentSourceId=o.id,this.setInteractionResponseFromSdk(i),this.paymentSourceView="selected",this.emitSdkEvent(Sx,o),this.focusAfterUpdate('[data-action="change-payment-source"]')}catch(e){this.paymentSourceView="list",this.attachmentError=Nj(e)||"We couldn't save this payment method. Please try again."}finally{this.pendingAction=void 0}}}async verifySavedPaymentSource(e){if("verify-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),r=this.findPaymentSourceById(e);if(t&&r){if(aE(r))return this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(r);if("NOT_VERIFIED"===r.verificationInfo?.status){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",this.pendingAction="verify-payment-source";try{const n=await this.verifyPaymentSourceStep1(t,{...r,id:e}),i=qj({...this.interactionResponse??{interactionId:t},selectedSource:this.interactionResponse?.selectedSource,status:Px},n);if(this.setInteractionResponseFromSdk(i),this.emitSdkEvent(Cx,n),aE(n))return void this.showRequiredInfoSource(n);if("VERIFIED"===n.verificationInfo?.status){const t=n.id?.trim()||e;return this.pendingAction=void 0,this.selectedPaymentSourceId=t,void(this.paymentSourceView="list")}this.savedSourceVerificationSource=n,this.savedSourceVerificationFailed=!1}catch(e){this.savedSourceVerificationSource=r,this.savedSourceVerificationFailed=!0}finally{"verify-payment-source"===this.pendingAction&&(this.pendingAction=void 0)}}}}async deletePaymentSource(e){if("delete-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),r=this.findPaymentSourceById(e);if(t&&r)if(this.deleteConfirmationPaymentSourceId===e){this.clearDeletePaymentSourceConfirmation(),this.pendingAction="delete-payment-source";try{await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}`,t,{method:"DELETE",credentials:"include"});const r=Ij(this.interactionResponse??{interactionId:t},e);r.paymentSources?.length||(this.paymentSourceEditMode=!1),this.setInteractionResponseFromSdk(r),this.emitSdkEvent(Ox,e)}catch(e){}finally{this.pendingAction=void 0}}else this.armDeletePaymentSourceConfirmation(e)}armDeletePaymentSourceConfirmation(e){this.clearDeletePaymentSourceConfirmation(),this.deleteConfirmationPaymentSourceId=e,this.deleteConfirmationTimeoutId=window.setTimeout(()=>{this.deleteConfirmationPaymentSourceId===e&&this.clearDeletePaymentSourceConfirmation()},5e3)}clearDeletePaymentSourceConfirmation(){void 0!==this.deleteConfirmationTimeoutId&&(window.clearTimeout(this.deleteConfirmationTimeoutId),this.deleteConfirmationTimeoutId=void 0),this.deleteConfirmationPaymentSourceId=void 0}findPaymentSourceById(e){return(this.interactionResponse?.paymentSources??[]).find(t=>t.id===e)??(this.interactionResponse?.selectedSource?.id===e?this.interactionResponse.selectedSource:void 0)}resetSavedSourceVerification(){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1}showPaymentSourceList({refresh:e=!1}={}){this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.addLauncherActive=!1,this.resetTransferFlow(),this.focusAfterUpdate('[data-action="open-add-payment-source"]',".payment-method-radio",'[data-action="toggle-payment-source-edit-mode"]'),e&&this.refreshPaymentSourcesForList()}async refreshPaymentSourcesForList(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}interactionResponseWithAddedSource(e,t){const r=t.id?.trim(),n=Boolean(r)&&Vj(t),i={...this.interactionResponse??{interactionId:e},status:Px};return n?Bj(i,t):qj({...i,selectedSource:this.interactionResponse?.selectedSource},t)}showAddedPaymentSourceStatus(e){const t=e.id?.trim();return this.resetSavedSourceVerification(),this.resetRequiredInfo(),aE(e)?(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(e)):"VERIFIED"===e.verificationInfo?.status?(this.selectedPaymentSourceId=t,void(this.paymentSourceView="list")):(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",cE(e)?(this.bankOutcomeSource=e,void(this.bankFlowScreen="outcome")):(this.savedSourceVerificationSource=e,void(this.savedSourceVerificationFailed=!1)))}showRequiredInfoSource(e){this.requiredInfoSource=e,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}resetRequiredInfo(){this.requiredInfoSource=void 0,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}firstRequiredInfoDocKey(){return tE(Jj(this.requiredInfoSource))??Yj(Jj(this.requiredInfoSource)[0],0)}storeRequiredInfoValue(e,t){this.requiredInfoValues=((e,t,r)=>({...e,[t]:r}))(this.requiredInfoValues,e,t),this.requiredInfoSubmitError=void 0}storeRequiredInfoSelectedFile(e){if(!this.requiredInfoSource||!e)return void(this.pendingRequiredInfoDocKey=void 0);const t=this.pendingRequiredInfoDocKey??this.firstRequiredInfoDocKey(),r=(({files:e,fileNames:t,key:r,file:n})=>({files:{...e,[r]:n},fileNames:{...t,[r]:n.name}}))({files:this.requiredInfoFiles,fileNames:this.requiredInfoFileNames,key:t,file:e});this.requiredInfoFiles=r.files,this.requiredInfoFileNames=r.fileNames,this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}canSubmitRequiredInfo(){const e=this.requiredInfoSource;return!!e?.id?.trim()&&Jj(e).some((e,t)=>{const r=Yj(e,t);return Zj(e)?Bk(this.requiredInfoValues,r):qk(this.requiredInfoFiles,r)})}async submitRequiredInfo(){if("submit-required-info"===this.pendingAction)return;const e=this.requireInteractionId(),t=this.requiredInfoSource,r=t?.id?.trim();if(e&&t&&r)if(this.canSubmitRequiredInfo()){this.pendingAction="submit-required-info",this.requiredInfoSubmitError=void 0;try{const n=Jj(t),i=this.providedRequiredInfoEntries(n,!0),o=this.providedRequiredInfoEntries(n,!1);let a=t;i.length>0?(await this.uploadRequiredInfoEntries(e,r,i),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,r)),this.emitSdkEvent(Cx,a),aE(a)&&o.length>0&&(await this.uploadRequiredInfoEntries(e,r,o),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,r)),this.emitSdkEvent(Cx,a))):(await this.uploadRequiredInfoEntries(e,r,o),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,r)),this.emitSdkEvent(Cx,a));const s=qj({...this.interactionResponse??{interactionId:e},selectedSource:this.interactionResponse?.selectedSource,status:Px},a);if(this.setInteractionResponseFromSdk(s),"VERIFIED"===a.verificationInfo?.status){const e=a.id?.trim()||r;return this.resetRequiredInfo(),this.pendingAction=void 0,this.selectedPaymentSourceId=e,void(this.paymentSourceView="list")}if(aE(a))return this.requiredInfoSource=a,this.requiredInfoValues={},this.requiredInfoFileNames={},void(this.requiredInfoFiles={});this.resetRequiredInfo(),this.savedSourceVerificationSource=a,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=a.id,this.paymentSourceView="list"}catch(e){this.requiredInfoSubmitError=Nj(e)||"We could not submit the required information. Please try again."}finally{"submit-required-info"===this.pendingAction&&(this.pendingAction=void 0)}}else this.requiredInfoSubmitError="Add required or optional information before verifying."}providedRequiredInfoEntries(e,t){return e.map((e,t)=>({doc:e,index:t})).filter(({doc:e,index:r})=>(t?!0===e.mandatory:!0!==e.mandatory)&&this.hasRequiredInfoValue(e,r))}hasRequiredInfoValue(e,t){const r=Yj(e,t);return Zj(e)?Bk(this.requiredInfoValues,r):qk(this.requiredInfoFiles,r)}async uploadRequiredInfoEntries(e,t,r){for(const{doc:n,index:i}of r){const r=n.docType;if(!r)continue;const o=Yj(n,i);if(Zj(n)){const n=this.requiredInfoValues[o]?.trim();n&&await this.uploadRequiredInfoField(e,t,r,n);continue}const a=this.requiredInfoFiles[o];a&&await this.uploadRequiredInfoDocument(e,t,r,a)}}async verifyRequiredInfoStep2(e,t){return this.showMinimumVerificationOverlay("submit-required-info"),this.requestCommerceHubJson("/interaction/verify/step2",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t}),credentials:"include"})}sourceWithVerificationResponse(e,t){const{sourceId:r,...n}=t,i=r?.trim();return{...e,id:i||e.id,verificationInfo:{...e.verificationInfo,...n}}}async uploadRequiredInfoField(e,t,r,n){await this.requestCommerceHubJson("/interaction/verify/uploadField",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({docType:r,value:t,docValue:n}),credentials:"include"})}async uploadRequiredInfoDocument(e,t,r,n){const i=new FormData;i.set("file",n),await this.requestCommerceHubJson(`/interaction/doc/upload/${encodeURIComponent(t)}/${encodeURIComponent(r)}`,e,{method:"POST",body:i,credentials:"include"})}async startPayByBankFlow(){if(this.bankLinkLoading)return;const e=this.requireInteractionId();if(!e)return;const t=++this.bankProviderRequestToken;this.bankFlowScreen="provider",this.bankOutcomeSource=void 0,this.bankLinkLoading=!0,this.ensurePayByBankProviderContainer(zx),await this.updateComplete;try{await this.launchPayByBankProvider(e,zx,t)}catch(r){if(!this.isCurrentPayByBankProviderRequest(t,e))return;console.error("CommerceHub Connect Pay by Bank failed",r),this.resetBankFlow(),this.showPaymentSourceList({refresh:!0})}finally{t===this.bankProviderRequestToken&&(this.cancelPayByBankLaunch=void 0,this.bankLinkLoading=!1)}}async startBankAccountFlow(){uj(this.interactionResponse?.country)?await this.startPayByBankFlow():await this.showManualBankAccountScreen()}isCurrentPayByBankProviderRequest(e,t){return this.isConnected&&e===this.bankProviderRequestToken&&this.interactionResponse?.interactionId===t&&"provider"===this.bankFlowScreen}async launchPayByBankProvider(e,t,r){const n=await this.requestCommerceHubJson("/interaction/source/pbb/session",e,{method:"GET",credentials:"include"});if(!this.isCurrentPayByBankProviderRequest(r,e))return;const{aggregatorSessionId:i,accessToken:o,pToken:a,publicKey:s}=Pj(n),c=ej(this.designConfig?.payByBank);if(await fE(c.paymentSdkUrl),!this.isCurrentPayByBankProviderRequest(r,e))return;const d=window.PaymentSDK;if(!d?.init)throw new Error("PaymentSDK.js loaded but PaymentSDK.init is not available on window.");await new Promise((n,u)=>{let l=!1;this.cancelPayByBankLaunch=()=>{l=!0,n()},mE(),d.init({apiKey:c.apiKey,accessToken:o,configId:c.configId,environment:c.environment,locale:c.locale,appearance:tj(this.designConfig),publicKey:s,pToken:a,aggregatorSessionId:i,containerId:t,onEvent:async t=>{if(!l&&Dj(t)&&this.isCurrentPayByBankProviderRequest(r,e)){if(l=!0,this.bankLinkLoading=!0,mE(),"success"!==t.type)return this.resetBankFlow(),this.showPaymentSourceList({refresh:!0}),void n();try{const t=await this.finalizePayByBankSession(e,i,a);if(!this.isCurrentPayByBankProviderRequest(r,e))return void n();const o=Hx(t),s=o.id?.trim();if(!s)throw new Error("Connect your bank completed but the resolved bank payment source did not include an id.");const c=this.interactionResponseWithAddedSource(e,o);this.setInteractionResponseFromSdk(c),this.emitSdkEvent(Ax,o),this.resetBankFlow(),this.showAddedPaymentSourceStatus(o),n()}catch(t){if(!this.isCurrentPayByBankProviderRequest(r,e))return void n();u(t)}}}}),!l&&this.isCurrentPayByBankProviderRequest(r,e)&&(this.bankLinkLoading=!1)})}async refreshPaymentSourcesFromInteraction(){await this.interactionRefresh.refreshFromInteraction(this.interactionRefreshOptions())}queueNativeAccountBalanceRefresh(){this.nativeBalance.queueRefresh(()=>this.interactionResponse,e=>this.fetchNativeAccountBalances(e))}async fetchNativeAccountBalances(e){return(await this.createSdkClient(e).GET("/interaction/source/native/balances")).data??{}}async fetchInteraction(e){return this.interactionRefresh.fetch(e,this.interactionRefreshOptions())}async retryInteractionRefresh(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}interactionRefreshOptions(){return{getCurrentInteractionResponse:()=>this.interactionResponse,getSelectedPaymentSourceId:()=>this.selectedPaymentSourceId,requestInteraction:e=>this.createSdkClient(e).GET("/interaction").then(e=>_j(e)),mergeInteractionResponse:Oj,setInteractionResponse:e=>this.setInteractionResponseFromSdk(e),emitListPaymentMethods:e=>this.emitSdkEvent(Ix,e)}}syncBillingAddressesFromInteractionResponse(e){if(!e.billerAddress)return;this.billingAddresses=e.billerAddress.filter(e=>Boolean(e.id?.trim())),this.cardDraft=((e,t)=>{const r=t.map(e=>e.id?.trim()).filter(e=>Boolean(e));if(!r.length)return{...e,billingAddressValue:zw};if(r.includes(e.billingAddressValue))return e;const n=[e.country,e.addressLine1,e.addressLine2,e.city,e.state,e.zip].some(e=>e.trim());return e.billingAddressValue===zw&&n?e:{...e,billingAddressValue:r[0]}})(this.cardDraft,this.billingAddresses),this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===zw,this.reconcileBankBillingAddressSelection();const t=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);t&&"instrument-schema"===this.manualBankAccountFormMode&&this.configureManualBankAccountForm(t,!1)}async finalizePayByBankSession(e,t,r){return this.requestCommerceHubJson(`/interaction/source/pbb/session/${encodeURIComponent(t)}/${encodeURIComponent(r)}`,e,{method:"PUT",credentials:"include"})}async verifyPaymentSourceStep1(e,t){this.showMinimumVerificationOverlay("verify-payment-source");const r=await this.requestCommerceHubJson("/interaction/verify/step1",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t.id}),credentials:"include"});return this.sourceWithVerificationResponse(t,r)}async requestCommerceHubJson(e,t,r){const n=this.createInteractionHeaders(t,r.headers);n.has("Accept")||n.set("Accept","application/json");const i=new Request(`${gw(this.baseURL)}${e}`,{...r,headers:n}),o=await fetch(i),a=o.headers.get("content-type")??"",s=204===o.status?void 0:a.includes("application/json")?await o.json():await o.text();if(!o.ok)throw new Error(Nj(s)||o.statusText);return s}async fetchManualBankAccountCountryConfig(e,t){return this.requestCommerceHubJson("/party/configuration-inquiry",e,{method:"POST",headers:{"Client-Id":zj(),"Content-Type":"application/json","User-Id":zj()},body:JSON.stringify({configurationType:"COUNTRY_TENDER",country:"USA"===t?"AAA":t}),credentials:"include"})}resetBankFlow(){this.bankAccountConfigRequestToken+=1,this.cancelPayByBankProvider(),this.bankFlowScreen=void 0,this.bankOutcomeSource=void 0,this.bankLinkLoading=!1,this.bankAccountInstrumentSchemas=[],this.selectedBankAccountInstrumentSchemaCode=void 0,this.bankBillingAddressValue="",this.bankBillingAddressSelectorExpanded=!1,this.clearManualBankAccountForm(),this.bankAccountConfigError=void 0,this.removePayByBankProviderContainer()}cancelPayByBankProvider(){this.bankProviderRequestToken+=1,this.cancelPayByBankLaunch?.(),this.cancelPayByBankLaunch=void 0,mE()}resetCardFlow(){this.cardFlowScreen=void 0,this.cardDraft=Tw(),this.cardDraftErrors={},this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=!1}resetTransferFlow(){this.transferFlowActive=!1,this.transferFlowScreen="form",this.transferDraft={fromSourceId:"",toSourceId:"",amount:""},this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1}ensurePayByBankProviderContainer(e){const t=[...this.children].find(t=>t instanceof HTMLElement&&t.id===e),r=t??document.createElement("div");return r.id=e,r.slot=e,r.className="provider-frame-container",r.replaceChildren(),t||this.appendChild(r),r}removePayByBankProviderContainer(){[...this.children].filter(e=>e instanceof HTMLElement&&e.id===zx).forEach(e=>e.remove())}requireInteractionId(){const e=this.interactionResponse?.interactionId;if(e)return e}createSdkClient(e){return yw({baseURL:this.baseURL,getHeaders:()=>this.createInteractionHeaders(e)})}createInteractionHeaders(e,t){const r=new Headers(t),n=this.interactionResponse?.oauth?.access_token?.trim();return r.set("x-interaction-id",e),n&&!r.has("Authorization")&&r.set("Authorization",`Bearer ${n}`),r}createSourceCreateHeaders(e,t,r){const n=this.createInteractionHeaders(e,r);return n.set("Api-Key",t.clientId),n.set("Auth-Token-Type",t.tokenType),n.set("x-key-id",t.keyId),n}requireSourceCreateContext(){const e=this.interactionResponse?.publicKey?.trim(),t=this.interactionResponse?.keyId?.trim(),r=this.interactionResponse?.oauth,n=r?.client_id?.trim(),i=r?.token_type?.trim(),o=r?.access_token?.trim();if(!(e&&t&&n&&i&&o))throw new Error("Payment source encryption is not configured. Try again later.");return{publicKey:e,keyId:t,clientId:n,tokenType:i,accessToken:o}}setInteractionResponseFromSdk(e){this.interactionResponse=this.interactionResponseWithPreservedGatewayOAuth(e)}interactionResponseWithPreservedGatewayOAuth(e){if(e.oauth&&e.features)return e;const t=this.interactionResponse;return!t||t.interactionId&&e.interactionId&&t.interactionId!==e.interactionId?e:{...e,oauth:e.oauth??t.oauth,features:e.features??t.features}}syncDesignConfigStyles(){for(const e of sj)this.style.removeProperty(e);const e=this.designConfig?.colors;if(e)for(const{field:t,property:r}of ij){const n=e[t];n&&this.style.setProperty(r,n)}const t=this.designConfig?.baseFontSize;t?this.style.fontSize=t:this.style.removeProperty("font-size");const r=this.designConfig?.baseFontWeight?.trim();r?this.style.setProperty(oj,r):this.style.removeProperty(oj);const n=this.designConfig?.shellPadding?.trim();n?this.style.setProperty(aj,n):this.style.removeProperty(aj)}};Lx.styles=Xk,Ex([iw({attribute:!1})],Lx.prototype,"interactionResponse",void 0),Ex([iw({attribute:!1})],Lx.prototype,"designConfig",void 0),Ex([iw({attribute:"base-url"})],Lx.prototype,"baseURL",void 0),Ex([ow()],Lx.prototype,"selectedPaymentSourceId",void 0),Ex([ow()],Lx.prototype,"otpValue",void 0),Ex([ow()],Lx.prototype,"pendingAction",void 0),Ex([ow()],Lx.prototype,"minimumVerificationOverlayAction",void 0),Ex([ow()],Lx.prototype,"otpErrorMessage",void 0),Ex([ow()],Lx.prototype,"bankFlowScreen",void 0),Ex([ow()],Lx.prototype,"bankLinkLoading",void 0),Ex([ow(),ow()],Lx.prototype,"bankOutcomeSource",void 0),Ex([ow()],Lx.prototype,"bankAccountInstrumentSchemas",void 0),Ex([ow()],Lx.prototype,"manualBankAccountFormMode",void 0),Ex([ow()],Lx.prototype,"selectedBankAccountInstrumentSchemaCode",void 0),Ex([ow()],Lx.prototype,"bankAccountFormSchema",void 0),Ex([ow()],Lx.prototype,"bankAccountFormUiSchema",void 0),Ex([ow()],Lx.prototype,"bankAccountFormData",void 0),Ex([ow()],Lx.prototype,"bankAccountFormValid",void 0),Ex([ow()],Lx.prototype,"bankBillingAddressValue",void 0),Ex([ow()],Lx.prototype,"bankBillingAddressSelectorExpanded",void 0),Ex([ow()],Lx.prototype,"bankAccountSubmitError",void 0),Ex([ow()],Lx.prototype,"legacyBankAccountDraft",void 0),Ex([ow()],Lx.prototype,"legacyBankAccountDraftErrors",void 0),Ex([ow()],Lx.prototype,"legacyBankAccountEncryption",void 0),Ex([ow()],Lx.prototype,"bankAccountConfigError",void 0),Ex([ow()],Lx.prototype,"transferDraft",void 0),Ex([ow()],Lx.prototype,"transferDraftErrors",void 0),Ex([ow()],Lx.prototype,"transferSubmitError",void 0),Ex([ow()],Lx.prototype,"transferSubmitSuccess",void 0),Ex([ow()],Lx.prototype,"transferFlowActive",void 0),Ex([ow()],Lx.prototype,"transferFlowScreen",void 0),Ex([ow(),ow()],Lx.prototype,"cardFlowScreen",void 0),Ex([ow()],Lx.prototype,"cardDraft",void 0),Ex([ow()],Lx.prototype,"cardDraftErrors",void 0),Ex([ow()],Lx.prototype,"cardEncryption",void 0),Ex([ow()],Lx.prototype,"cardSubmitError",void 0),Ex([ow()],Lx.prototype,"billingAddresses",void 0),Ex([ow()],Lx.prototype,"billingAddressSelectorExpanded",void 0),Ex([ow()],Lx.prototype,"paymentSourceView",void 0),Ex([ow()],Lx.prototype,"paymentSourceEditMode",void 0),Ex([ow()],Lx.prototype,"addLauncherActive",void 0),Ex([ow()],Lx.prototype,"attachmentError",void 0),Ex([ow()],Lx.prototype,"deleteConfirmationPaymentSourceId",void 0),Ex([ow()],Lx.prototype,"savedSourceVerificationSource",void 0),Ex([ow()],Lx.prototype,"savedSourceVerificationFailed",void 0),Ex([ow()],Lx.prototype,"requiredInfoSource",void 0),Ex([ow()],Lx.prototype,"requiredInfoValues",void 0),Ex([ow()],Lx.prototype,"requiredInfoFileNames",void 0),Ex([ow()],Lx.prototype,"requiredInfoSubmitError",void 0),Lx=Ex([tw("commerce-hub-connect")],Lx);const Vx=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("required-info-ssn-input")),Ux=e=>{const t=[e.stateOrProvince,e.postalCode].filter(Boolean).join(" "),r=[e.city,t].filter(Boolean).join(", ");return[e.street,r].filter(Boolean).join(", ")||e.id||"Saved billing address"},Fx=(e,t)=>{const r=Mw(t??"").slice(-4);return{...e,tenderType:"Card",card:{...e.card,...r?{cardNumber:r}:{}}}},Hx=e=>({id:Gx(e,"Connect your bank completed but the verification response did not include a source id."),tenderType:"BankAccount",verificationInfo:Jx(e),bankAccount:{}}),Wx=e=>({id:e.id,name:e.name,tenderType:"BankAccount",billingAddressId:e.billingAddressId,accountHolderType:e.accountHolderType,bankAccount:{bankName:e.bankAccount.bankName,accountType:e.bankAccount.accountType,accountNumber:Rj(e.bankAccount.accountNumber),asset:e.bankAccount.asset,country:e.bankAccount.country}}),Kx=(e,t)=>{const r=a$(t??"").slice(-4);return{...e,tenderType:"BankAccount",bankAccount:{...e.bankAccount,...r?{accountNumber:r}:{}}}},Gx=(e,t)=>{const r=e.sourceId?.trim();if(!r)throw new Error(t);return r},Jx=e=>{const{sourceId:t,...r}=e;return r},Yx=e=>{const t=e?.email?.trim();if(t)return t;const r=e?.phone?.countryCode?.trim(),n=e?.phone?.phoneNumber?.trim();return[r,n].filter(Boolean).join(" ")||void 0},Zx=e=>{const t=e?.copy?.otp;return{title:t?.title??"Enter verification code",subtitle:t?.subtitle,failedMessage:t?.failedMessage??"The code does not match. Try again.",resendPrefix:t?.resendPrefix??"Didn't receive the code?",resendButton:t?.resendButton??"Resend code",resendPendingButton:t?.resendPendingButton??"Sending code...",verifyButton:t?.verifyButton??"Verify",verifyingButton:t?.verifyingButton??"Verifying...",tryAgainButton:t?.tryAgainButton??"Try again"}},Qx=e=>{const t=e?.copy?.paymentMethods;return{title:t?.title??"Choose a payment method",subtitle:t?.subtitle??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??"",continueButton:t?.continueButton??"Use selected method",continuingButton:t?.continuingButton??"Saving..."}},Xx=e=>{const t=e?.copy?.noSavedPaymentMethods;return{title:t?.title??"Add payment method",subtitle:t?.subtitle??"",emptyTitle:t?.emptyTitle??"",emptyMessage:t?.emptyMessage??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??""}},ej=e=>{const t=Object.fromEntries(Object.entries(e??{}).filter(([,e])=>void 0!==e));return{...qx,...t}},tj=e=>{const t=e?.colors,r={};return nj(r,"backgroundColor",rj(t?.widgetBackground,t?.surface)),nj(r,"primaryColor",t?.primary),nj(r,"buttonColor",t?.primary),nj(r,"primaryTextColor",t?.text),nj(r,"secondaryTextColor",rj(t?.copy,t?.muted)),nj(r,"dangerColor",t?.danger),nj(r,"successColor",t?.success),nj(r,"borderColor",rj(t?.border,t?.widgetBorder,t?.borderBackground)),nj(r,"placeholderColor",t?.placeholder),{branding:r}},rj=(...e)=>e.map(e=>e?.trim()).find(e=>Boolean(e)),nj=(e,t,r)=>{const n=r?.trim();n&&(e[t]=n)},ij=[{field:"primary",property:"--chc-primary"},{field:"text",property:"--chc-text"},{field:"copy",property:"--chc-copy"},{field:"muted",property:"--chc-muted"},{field:"placeholder",property:"--chc-placeholder"},{field:"surface",property:"--chc-surface"},{field:"widgetBackground",property:"--chc-widget-background"},{field:"borderBackground",property:"--chc-border"},{field:"widgetBorder",property:"--chc-border"},{field:"softSurface",property:"--chc-soft-surface"},{field:"paymentSelectionBackground",property:"--chc-payment-method-background"},{field:"paymentMethodBackground",property:"--chc-payment-method-background"},{field:"border",property:"--chc-border"},{field:"borderStrong",property:"--chc-border-strong"},{field:"success",property:"--chc-success"},{field:"successBackground",property:"--chc-success-bg"},{field:"successBorder",property:"--chc-success-border"},{field:"danger",property:"--chc-danger"},{field:"dangerBackground",property:"--chc-danger-bg"},{field:"dangerBorder",property:"--chc-danger-border"},{field:"warning",property:"--chc-warning"},{field:"warningBackground",property:"--chc-warning-bg"},{field:"warningBorder",property:"--chc-warning-border"},{field:"disabledText",property:"--chc-disabled-text"},{field:"disabledSurface",property:"--chc-disabled-surface"}],oj="--chc-font-weight",aj="--chc-shell-padding",sj=[...ij.map(({property:e})=>e),oj,aj],cj=(e,t={})=>{const r=e?.paymentSources;if(!r?.length){const r=Ej(e);return r?[lj(r,{...t,selected:!0})]:[]}return r.map(e=>lj(e,t))},dj=e=>{const t=e?.allowedTenderTypes;return t?{card:t.includes("CARD"),bankAccount:t.includes("BANK_ACCOUNT"),nativeAccount:t.includes("NATIVE_ACCOUNT")}:{card:!0,bankAccount:!0,nativeAccount:!0}},uj=e=>{const t=e?.trim().toUpperCase();return"US"===t||"USA"===t},lj=(e,{selected:t=!1,nativeBalances:r={},nativeBalanceLoadingSourceIds:n=[]}={})=>{const i=bj(e),o=uE(e)?wj(e,r):void 0,a=void 0===o?.balance?void 0:kj(o.balance);return{id:i,label:hj(e,{selected:t}),type:gj(e),brand:mj(e),accountLabel:pj(e),balanceLabel:a,balanceLoading:uE(e)&&n.includes(i),last4:vj(e),status:Mj(e.verificationInfo?.status),showVerificationStatus:Boolean(e.verificationInfo?.status)}},hj=(e,{selected:t=!1}={})=>dE(e)?t?e.name?.trim()||e.card?.nameOnCard?.trim()||fj(e):e.card?.nameOnCard?.trim()||e.name?.trim()||fj(e):cE(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||fj(e):uE(e)?e.account?.nickName?.trim()||e.name?.trim()||fj(e):e.name?.trim()||fj(e),fj=e=>dE(e)?"Saved card":cE(e)?e.bankAccount?.bankName??"Saved bank account":uE(e)?"Native account":"Dynamic session card",mj=e=>dE(e)?e.card?.network??"Card":cE(e)?e.bankAccount?.bankName??"Bank account":uE(e)?e.account?.productType??"Native account":"DSC",pj=e=>{const t=vj(e);if(dE(e))return`${e.card?.network?.trim()||"Card"} ending ${t}`;if(cE(e))return`${e.bankAccount?.accountType?.trim()||"Bank account"} ending ${t}`;if(uE(e)){const r=e.account?.productType?.trim();return`${r||"Native account"} ending ${t}`}return`Card ending ${t}`},vj=e=>dE(e)?Rj(e.card?.cardNumber):cE(e)?Rj(e.bankAccount?.accountNumber):uE(e)?Rj(e.account?.positionId??e.account?.token):Rj(e.id),bj=e=>e.id?.trim()||e.name?.trim()||e.tenderType,gj=e=>cE(e)?"bank":uE(e)?"native":"card",yj=e=>(e?.paymentSources??[]).filter(e=>(cE(e)||uE(e))&&"VERIFIED"===e.verificationInfo?.status&&Boolean(bj(e))),wj=(e,t)=>{for(const r of $j(e)){const e=t[r];if(e)return e}},$j=e=>[e.id,e.account?.positionId,e.account?.token].map(e=>e?.trim()).filter(e=>Boolean(e)),kj=e=>xj.format(e),xj=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}),jj=(e,t)=>{const r=e?.paymentSources;if(!r?.length)return;const n=r.filter(e=>"VERIFIED"===e.verificationInfo?.status);if(t&&n.some(e=>e.id===t))return t;const i=e?.selectedSource?.id;return i&&n.some(e=>e.id===i)?i:n[0]?.id},Ej=(e,t)=>{if(t){const r=e?.paymentSources?.find(e=>e.id===t);if(r)return r}return e?.selectedSource},Sj=e=>e===Px||"PAYMENT_SOURCE_REQUESTED"===e,Aj=(e,t)=>Boolean(e?.features?.includes(t)),Cj=e=>Boolean(Aj(e,"TRANSFER")&&!Aj(e,"ADD_ACCOUNT")&&!Aj(e,"SELECT")),Oj=(e,t,r)=>{const n={...e,...t},i=t.paymentSources??e.paymentSources??[],o=((e,t)=>{if(t){const r=e.find(e=>e.id===t);if(r)return r}})(i,r??t.selectedSource?.id)??t.selectedSource??e.selectedSource;return{...n,selectedSource:o,paymentSources:i}},Ij=(e,t)=>{const r=(e.paymentSources??[]).filter(e=>e.id!==t),n=e.selectedSource?.id===t?void 0:e.selectedSource;return{...e,status:"PAYMENT_SOURCE_ATTACHED"!==e.status||n?e.status:Px,selectedSource:n,paymentSources:r}},_j=e=>{if(e.data)return e.data;throw new Error(Nj(e.error))},Nj=e=>"string"==typeof e?e:e&&"object"==typeof e&&"message"in e&&"string"==typeof e.message&&e.message.trim()?e.message:"CommerceHub API request failed.",zj=()=>{if(globalThis.crypto?.randomUUID)return globalThis.crypto.randomUUID();const e=new Uint8Array(16);globalThis.crypto?.getRandomValues(e),e[6]=15&e[6]|64,e[8]=63&e[8]|128;const t=[...e].map(e=>e.toString(16).padStart(2,"0"));return`${t.slice(0,4).join("")}-${t.slice(4,6).join("")}-${t.slice(6,8).join("")}-${t.slice(8,10).join("")}-${t.slice(10,16).join("")}`},Tj=(e,t)=>{const r=e.composedPath().find(e=>e instanceof HTMLElement&&Boolean(e.dataset[t]));return r?.dataset[t]},Rj=e=>e&&e.length>=4?e.slice(-4):"----",Mj=e=>"VERIFIED"===e?"verified":"UNDER_REVIEW"===e?"under-review":"REQUIRE_INFO"===e?"require-info":"DECLINED"===e?"declined":"not-verified",Pj=e=>{const t=e.aggregatorSessionId?.trim(),r=e.tokenID?.trim()||e.accessToken?.trim(),n=e.pToken?.trim(),i=e.publicKey?.trim();if(!(t&&r&&n&&i))throw new Error("The /interaction/source/pbb/session response is missing one or more required values.");return{aggregatorSessionId:t,accessToken:r,pToken:n,publicKey:i}},Dj=e=>"success"===e.type||"cancel"===e.type||"failure"===e.type||"error"===e.type,Bj=(e,t)=>{const r=Lj(e.paymentSources??[],t);return{...e,selectedSource:t,paymentSources:r}},qj=(e,t)=>({...e,paymentSources:Lj(e.paymentSources??[],t)}),Lj=(e,t)=>e.some(e=>e.id===t.id)?e.map(e=>e.id===t.id?t:e):[t,...e],Vj=e=>"VERIFIED"===e.verificationInfo?.status,Uj=({title:e,helper:t})=>Ry`
...
`,Fj=e=>"verify-payment-source"===e?Uj({title:"Verifying payment method",helper:"Verifying your payment method, please wait."}):"submit-required-info"===e?Uj({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,Hj=e=>"verify-payment-source"===e?Fj(e):"delete-payment-source"===e?Uj({title:"Deleting payment method",helper:"Deleting your payment method, please wait."}):"attach-payment-source"===e?Uj({title:"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,Wj=e=>{switch(e){case"attach-payment-source":return"Saving the selected payment method.";case"verify-payment-source":case"submit-required-info":return"Verifying the payment method.";case"delete-payment-source":return"Deleting the payment method.";case"verify-otp":return"Verifying the code.";case"resend-otp":return"Sending a new code.";case"save-card":return"Saving the card.";case"save-bank-account":return"Saving the bank account.";case"transfer":return"Submitting the transfer.";default:return""}},Kj=e=>{const t=e?.verificationInfo?.status;return"VERIFIED"===t?{kind:"verified",variant:"success",title:"Bank account verified",message:"Your bank account is connected and ready to use."}:"UNDER_REVIEW"===t?{kind:"pending",variant:"warning",title:"Bank account pending review",message:"We will update this bank account after review is complete."}:"REQUIRE_INFO"===t?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:"Additional information is required before this bank account can be verified."}:"DECLINED"===t?{kind:"declined",variant:"danger",title:"Bank account verification failed",message:"This bank account could not be verified."}:{kind:"failed",variant:"danger",title:"Bank account not verified",message:"This bank account is not verified yet."}},Gj=(e,t=!1)=>{const r=sE(e),n=r.toLowerCase(),i=e?.verificationInfo?.status;return t?{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} not verified`,message:`We could not verify this ${n} right now.`}:"VERIFIED"===i?{kind:"verified",variant:"success",title:"Bank account"===r?"Bank account verified":`${r} saved`,message:`This ${n} is verified and ready to use.`}:"UNDER_REVIEW"===i?{kind:"pending",variant:"warning",title:"Bank account"===r?"Bank account pending review":"Verification pending review",message:`We will update this ${n} after review is complete.`}:"REQUIRE_INFO"===i?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:`Additional information is required before this ${n} can be verified.`}:"DECLINED"===i?{kind:"declined",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} declined`,message:`This ${n} could not be verified.`}:{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account not verified":`${r} not verified`,message:`This ${n} is not verified yet.`}},Jj=e=>{const t=e?.verificationInfo?.docs??[];return t.length>0?t:[{}]},Yj=(e,t=0)=>`${e?.docType??"DOCUMENT"}-${t}`,Zj=e=>"DRIVER_LICENSE_NUMBER"===e.docType||"SOCIAL_SECURITY_NUMBER"===e.docType,Qj=e=>!1!==e.mandatory,Xj=e=>Qj(e)?"required":"optional",eE=e=>Ry`
  <span
    class="required-info-requirement-badge required-info-requirement-badge-${Xj(e)}"
  >
    ${(e=>Qj(e)?"Required":"Optional")(e)}
  </span>
`,tE=e=>{const t=e.findIndex(e=>!Zj(e));return t>=0?Yj(e[t],t):void 0},rE=({doc:e,key:t,value:r})=>{if("SOCIAL_SECURITY_NUMBER"===e.docType)return nE({doc:e,key:t,value:r});const n=`required-info-${t}`;return Ry`
    <div
  ...
  `},nE=({doc:e,key:t,value:r})=>{const n=iE(e),i=(e=>{const t=Pk(e);return[t.slice(0,3),t.slice(3,5),t.slice(5,9)]})(r),o=`required-info-${t}-ssn-0`;return Ry`
    <div
  ...
  `},iE=e=>"BANK_STATEMENT"===e.docType?"Bank statement":"BANK_LETTER"===e.docType?"Bank letter":"BANK_CHECK"===e.docType?"Bank check":"DRIVER_LICENSE_PHOTO"===e.docType?"Driver license photo":"DRIVER_LICENSE_NUMBER"===e.docType?"Driver license number":"SOCIAL_SECURITY_NUMBER"===e.docType?"Social Security number":"Required document",oE=e=>{const t=(e=>({type:gj(e),brand:mj(e)}))(e),r=Gk(t),n=(e=>{if(!dE(e))return;const t=e.card?.expirationMonth?.trim(),r=e.card?.expirationYear?.trim();if(!t||!r)return;return`${t.padStart(2,"0")}/${r.slice(-2)}`})(e);return Ry`
    <div
      ...
      <div class="required-info-card-top">
        <div class="required-info-card-heading">
          <span class="required-info-card-label"
            >${(e=>cE(e)?"Bank account":dE(e)?"Card":uE(e)?"Native account":"Dynamic session card")(e)}</span
          >
          <span
            class="required-info-card-field required-info-card-name"
            data-required-info-card-field="name"
            >${(e=>dE(e)?e.card?.nameOnCard?.trim()||e.name?.trim()||fj(e):cE(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||fj(e):uE(e)?e.account?.nickName?.trim()||e.name?.trim()||fj(e):e.name?.trim()||fj(e))(e)}</span
          >
        </div>
      ...
      <div class="required-info-card-bottom">
        <div class="required-info-card-detail">
          ...
          <span class="required-info-card-status">
            ${rx(Mj(e.verificationInfo?.status))}
          </span>
        </div>
        ${n?Ry`
              <div class="required-info-card-detail">
  ...
  `},aE=e=>"REQUIRE_INFO"===e.verificationInfo?.status,sE=e=>e&&cE(e)?"Bank account":e&&uE(e)?"Native account":"Payment method",cE=e=>"BankAccount"===e.tenderType||"BANK_ACCOUNT"===e.tenderType,dE=e=>"Card"===e.tenderType||"CARD"===e.tenderType,uE=e=>"NativeAccount"===e.tenderType||"NATIVE_ACCOUNT"===e.tenderType;let lE,hE;const fE=async e=>{if(!window.PaymentSDK?.init)if(lE&&hE===e)await lE;else if(hE=e,lE=new Promise((t,r)=>{const n=document.querySelector(`script[data-commerce-hub-pay-by-bank-sdk="true"][src="${e}"]`),i=n??document.createElement("script"),o=()=>{i.removeEventListener("load",a),i.removeEventListener("error",s)},a=()=>{o(),t()},s=()=>{o(),lE=void 0,hE=void 0,r(new Error(`Unable to load Connect your bank script: ${e}`))};i.addEventListener("load",a,{once:!0}),i.addEventListener("error",s,{once:!0}),n||(i.src=e,i.async=!0,i.dataset.commerceHubPayByBankSdk="true",document.head.appendChild(i))}),await lE,!window.PaymentSDK?.init)throw new Error(`Connect your bank script loaded but window.PaymentSDK.init is unavailable: ${e}`)},mE=()=>{try{window.PaymentSDK?.destroy?.()}catch{}};export{bw as COMMERCE_HUB_BASE_URLS,Lx as CommerceHubConnect,vw as DEFAULT_COMMERCE_HUB_BASE_URL,Ax as ON_ADD_PAYMENT_METHOD_EVENT,Ox as ON_DELETE_PAYMENT_METHOD_EVENT,Nx as ON_ERROR_EVENT,Ix as ON_LIST_PAYMENT_METHODS_EVENT,Sx as ON_SELECT_EVENT,_x as ON_TRANSFER_EVENT,Cx as ON_VERIFY_PAYMENT_METHOD_EVENT,yw as createCommerceHubClient,$w as createCommerceHubConfigClient,ww as createCommerceHubMerchantClient,gw as resolveCommerceHubBaseURL};

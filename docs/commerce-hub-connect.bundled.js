 ...
 */,Vt=e=>e??j,Lt=(...e)=>e.filter(Boolean).join(" "),Pt=e=>{const t=e?.trim();return t||void 0},Ft=e=>{const t=(e=>"verified"===e?{label:"Verified",tone:"success"}:"under-review"===e?{label:"Under review",tone:"warning"}:"require-info"===e?{label:"Need More Information",tone:"warning"}:"declined"===e?{label:"Can't Use",tone:"danger"}:{label:"Action Required",tone:"warning"})(e);return F`
  ...
  `},Ut=e=>{const t=Pt(e.accountLabel)??(({label:e,brand:t,last4:i})=>{const r=Pt(e),n=Pt(t);return i&&n&&n!==r?`${n} •••• ${i}`:i?`•••• ${i}`:n??""})(e),i=Pt(e.label)??t,r=Boolean(t);return F`
...
`,Ht=({label:e,variant:t="primary",action:i,type:r="button",icon:n,disabled:a=!1,loading:o=!1})=>F`
  <button
    class=${Lt("button",`button-${t}`,o&&"button-loading")}
    part=${Vt("primary"===t?"primary-action":void 0)}
    type=${r}
    data-action=${Vt(i)}
...
`,Wt=({id:e,label:t,name:i,value:r="",placeholder:n,type:a="text",span:o="default",variant:s="default",autocomplete:c,inputmode:d,disabled:l=!1,dataField:h,dataFieldScope:u="card",error:m})=>{const p=Lt("field","full"===o&&"field-full","card-form"===s&&"field-card-form",m&&"field-invalid"),f=Lt("field-label","card-form"===s&&"field-label-card-form"),v=Lt("field-input","card-form"===s&&"field-input-card-form"),b=F`
    <input
      class=${v}
      id=${e}
      name=${Vt(i)}
      ...
      autocomplete=${Vt(c)}
      inputmode=${Vt(d)}
      data-card-field=${Vt("card"===u?h:void 0)}
      data-bank-account-field=${Vt("bankAccount"===u?h:void 0)}
      data-transfer-field=${Vt("transfer"===u?h:void 0)}
      aria-invalid=${m?"true":"false"}
      aria-describedby=${Vt(m?`${e}-error`:void 0)}
      ?disabled=${l}
    />
  `;return F`
    <div class=${p}>
  ...
  `},Kt=({id:e,label:t,name:i,value:r="",options:n,span:a="default",variant:o="default",disabled:s=!1,dataField:c,dataFieldScope:d="card",error:l})=>{const h=Lt("field","card-form"!==o&&"field-with-select","full"===a&&"field-full","card-form"===o&&"field-card-form",l&&"field-invalid"),u=Lt("field-label","card-form"===o&&"field-label-card-form"),m=Lt("field-input","field-select","card-form"===o&&"field-input-card-form"),p=F`
    <select
      class=${m}
      id=${e}
      name=${Vt(i)}
      .value=${r}
      data-card-field=${Vt("card"===d?c:void 0)}
      data-bank-account-field=${Vt("bankAccount"===d?c:void 0)}
      data-transfer-field=${Vt("transfer"===d?c:void 0)}
      aria-invalid=${l?"true":"false"}
      aria-describedby=${Vt(l?`${e}-error`:void 0)}
      ?disabled=${s}
    >
      ${n.map(e=>F`
...
`,Jt=({id:e,label:t,status:i,type:r,eyebrow:n,brand:a,accountLabel:o,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l,disabled:h=!1},{variant:u="default",deleteDisabled:m=!1,confirmingDelete:p=!1,selected:f=!1,selectable:v=!0}={})=>{const b={id:e,label:t,status:i,type:r,eyebrow:n,brand:a,accountLabel:o,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l,disabled:h};if("edit"===u){const i={...b,showVerificationStatus:!1};return F`
      <div
        class=${Lt("payment-method-row","payment-method-row-edit",p&&"payment-method-row-delete-confirming")}
  ...
  `})(e,t,m,p))}
    ...
    `}return v&&(e=>{return"verified"===(t=e.status)||"require-info"===t||"not-verified"===t;var t})(b)?F`
      <button
        class=${Lt("payment-method-row","payment-method-row-action",f&&"payment-method-row-selected")}
        part="payment-method-row"
        type="button"
    ...
    `:F`
    <div
      class=${Lt("payment-method-row","payment-method-row-static")}
      part="payment-method-row"
      aria-label=${t}
      aria-disabled="true"
      data-payment-method-id=${e}
  ...
  <div
    class=${Lt("provider-frame",r&&"provider-frame-loading")}
    part="provider-frame"
  ...
  >
    ...
    <slot class="provider-frame-slot" name=${e}>
      <div
        class=${Lt("provider-frame-container",r&&"provider-frame-container-loading")}
        id=${e}
      ></div>
    </slot>
    ${r?F`
...
`,ri=e=>F` <div class="form-grid">${e}</div> `,ni=({title:e,subtitle:t,content:i,headerAction:r,width:n="default",ariaLabel:a="Commerce Hub Connect",closeAction:o="close",showClose:s=!0,showDivider:c=!1,showFooter:d=!0,busy:l=!1,overlay:h})=>F`
  <section
    class=${Lt("widget-shell","wide"===n&&"widget-shell-wide",l&&"widget-shell-busy")}
    part="shell"
    aria-label=${a}
...
`,ai=e=>`We sent a one-time code to ${e??"your contact method"}.`,oi=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input")),si=({status:e,value:t,length:i,failedMessage:r,copy:n,submitting:a=!1,resending:o=!1})=>{const s="OTP_VALIDATION_FAILED"===e;return F`
  ...
  <button
    class=${Lt("otp-resend",r&&"otp-resend-loading")}
    type="button"
    data-action=${t}
    aria-busy=${r?"true":"false"}
    ?disabled=${i||r}
...
`)({label:"Required document",requirements:Vr(e),actionLabel:"Choose file",fileName:n,action:"open-required-info-file-picker",disabled:r})}
                  </div>
                `})}
            </div>
          </div>
...
`}
      ...
      `});var n}renderAddCardScreen(){const e="save-card"===this.pendingAction,t="encrypting"===this.cardEncryption.cardNumber.status||"encrypting"===this.cardEncryption.cvv.status,i=[...this.billingAddresses.map(e=>({value:e.id??"",label:Ei(e)})),{value:Me,label:"Add new billing address"}],r=this.billingAddresses.find(e=>e.id===this.cardDraft.billingAddressValue),n=Boolean(r)&&!this.billingAddressSelectorExpanded,a=!n&&this.cardDraft.billingAddressValue===Me,o=[];return r&&n?o.push(F`
      ...
      `})}renderBankOutcomeScreen(){const e=zr(this.bankOutcomeSource),t="declined"===e.kind||"pending"===e.kind;return this.renderWidgetShell({title:e.title,headerAction:t?ii({label:"Done",action:"done-bank-outcome"}):void 0,showClose:!1,showDivider:!1,content:F`
        <div class="verification-outcome-flow">
          ...
          ${this.bankOutcomeSource?Lr(this.bankOutcomeSource):""}
          ${t?"":F`
                <div class="primitive-footer">
...
`,Dr=e=>{const t=e.findIndex(e=>!Tr(e));return t>=0?Nr(e[t],t):void 0},Or=({doc:e,key:t,value:i})=>{if("SOCIAL_SECURITY_NUMBER"===e.docType)return Mr({doc:e,key:t,value:i});const r=`required-info-${t}`;return F`
    <div
  ...
  `},Mr=({doc:e,key:t,value:i})=>{const r=Vr(e),n=(e=>{const t=St(e);return[t.slice(0,3),t.slice(3,5),t.slice(5,9)]})(i),a=`required-info-${t}-ssn-0`;return F`
    <div
  ...
  `},Vr=e=>"BANK_STATEMENT"===e.docType?"Bank statement":"BANK_LETTER"===e.docType?"Bank letter":"BANK_CHECK"===e.docType?"Bank check":"DRIVER_LICENSE_PHOTO"===e.docType?"Driver license photo":"DRIVER_LICENSE_NUMBER"===e.docType?"Driver license number":"SOCIAL_SECURITY_NUMBER"===e.docType?"Social Security number":"Required document",Lr=e=>{const t=(e=>({type:Xi(e),brand:Gi(e)}))(e),i=Dt(t),r=(e=>{if(!jr(e))return;const t=e.card?.expirationMonth?.trim(),i=e.card?.expirationYear?.trim();if(!t||!i)return;return`${t.padStart(2,"0")}/${i.slice(-2)}`})(e);return F`
    <div
      ...
      <div class="required-info-card-top">
        <div class="required-info-card-heading">
          <span class="required-info-card-label"
            >${(e=>Ur(e)?"Bank account":jr(e)?"Card":_r(e)?"Native account":"Dynamic session card")(e)}</span
          >
          <span
            class="required-info-card-field required-info-card-name"
            data-required-info-card-field="name"
            >${(e=>jr(e)?e.card?.nameOnCard?.trim()||e.name?.trim()||Yi(e):Ur(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||Yi(e):_r(e)?e.account?.nickName?.trim()||e.name?.trim()||Yi(e):e.name?.trim()||Yi(e))(e)}</span
          >
        </div>

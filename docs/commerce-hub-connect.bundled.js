...
`,Qk=(...e)=>e.filter(Boolean).join(" "),Xk=e=>{const t=e?.trim();return t||void 0},ex=e=>{const t=(e=>"verified"===e?{label:"Ready",tone:"success"}:"under-review"===e?{label:"Needs review",tone:"warning"}:"require-info"===e?{label:"Needs info",tone:"warning"}:"declined"===e?{label:"Can't use",tone:"danger"}:{label:"Action required",tone:"warning"})(e);return Ry`
    <span
  ...
  `},tx=e=>{const t=Xk(e.accountLabel)??(({label:e,brand:t,last4:r})=>{const n=Xk(e),i=Xk(t);return r&&i&&i!==n?`${i} •••• ${r}`:r?`•••• ${r}`:i??""})(e),r=Xk(e.label)??t,n=Boolean(t);return Ry`
    <span class="payment-method-copy">
      <span class="payment-method-title-row">
        ...
        ${(e=>!1!==e.showVerificationStatus)(e)?ex(e.status):""}
      </span>
      ${n?Ry`
  ...
  `},rx=({balanceLabel:e,balanceLoading:t})=>t?Ry`
      <span
        class="payment-method-balance-loading"
        role="status"
        aria-label="Loading balance"
      ></span>
    `:e?Ry`<span class="payment-method-balance">${e}</span>`:"",nx=(e,t)=>Ry`
...
`,ix=(e,t)=>Ry`
  <span class="payment-method-icon-chip" aria-hidden="true">
    <img
      ...
      data-payment-method-icon=${Wk(e)}
      src=${Kk(e)}
      alt=""
    />
  </span>
  ${tx(e)} ${t}
`,ox=({label:e,variant:t="primary",action:r,type:n="button",icon:i,disabled:o=!1,loading:a=!1})=>Ry`
  <button
...
`,dx=({id:e,label:t,status:r,type:n,eyebrow:i,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:u,showVerificationStatus:d,disabled:l=!1},{variant:h="default",deleteDisabled:f=!1,confirmingDelete:m=!1,selected:p=!1,selectable:v=!0}={})=>{const b={id:e,label:t,status:r,type:n,eyebrow:i,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:u,showVerificationStatus:d,disabled:l};if("edit"===h){const r={...b,showVerificationStatus:!1};return Ry`
      ...
      >
        ${ix(r,((e,t,r=!1,n=!1)=>{const i=`Delete ${t}`;return n?Ry`
  ...
  `})(e,t,f,m))}
    ...
    `}return v&&(e=>{return"verified"===(t=e.status)||"require-info"===t||"not-verified"===t;var t})(b)?"verified"===r?Ry`
        <label
          class=${Qk("payment-method-row","payment-method-row-action","payment-method-row-radio",p&&"payment-method-row-selected")}
          part="payment-method-row"
          data-payment-method-id=${e}
        >
          ${ix(b,Ry`<span class="payment-method-trailing">
              ${rx(b)}
              <input
  ...
  `},lx=({id:e,label:t,status:r,type:n,eyebrow:i,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:u,showVerificationStatus:d})=>{const l={label:t,status:r,type:n,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:u,showVerificationStatus:d};return Ry`
    <div
...
`,fx=({containerId:e,title:t,loadingLabel:r,loading:n=!1})=>Ry`
  <div
...
`,mx=({variant:e,title:t,message:r,content:n,actions:i})=>Ry`
...
`,px=({label:e,action:t,icon:r,variant:n="default",disabled:i=!1})=>Ry`
  <button
    class=${Qk("text-link-button",`text-link-button-${n}`,r&&`text-link-button-${r}`)}
    type="button"
    data-action=${t}
    ?disabled=${i}
  >
...
`,vx=e=>Ry` <div class="form-grid">${e}</div> `,bx=e=>`We sent a one-time code to ${e??"your contact method"}.`,gx=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input")),yx=({status:e,value:t,length:r,failedMessage:n,copy:i,submitting:o=!1,resending:a=!1})=>{const s="OTP_VALIDATION_FAILED"===e;return Ry`
    <form class="otp-flow" data-submit-action="verify-otp">
      ${s?cx({variant:"danger",message:n??i.failedMessage}):""}
...
`,$x=({methods:e,canSelectPaymentSources:t,editing:r,actionPending:n,selectedPaymentSourceId:i,deleteConfirmationPaymentSourceId:o})=>Ry`
  ...
  `};var xx=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};const jx="onSelect",Ex="onAddPaymentMethod",Sx="onVerifyPaymentMethod",Ax="onDeletePaymentMethod",Cx="onListPaymentMethods",Ox="onTransfer",Ix="onError",_x="commerce-hub-pbb-provider",Nx=bb(r$,"VerticalLayout");let zx=class extends ik{createRenderRoot(){return this}};zx=xx([tw("commerce-hub-bank-account-jsonforms")],zx);const Tx="OTP_VALIDATION_SUCCESS",Rx=[{value:"",label:"Select country or region"},{value:"US",label:"United States"}],Mx=[{value:"",label:"Select state"},...[["AL","Alabama"],["AK","Alaska"],["AZ","Arizona"],["AR","Arkansas"],["CA","California"],["CO","Colorado"],["CT","Connecticut"],["DE","Delaware"],["FL","Florida"],["GA","Georgia"],["HI","Hawaii"],["ID","Idaho"],["IL","Illinois"],["IN","Indiana"],["IA","Iowa"],["KS","Kansas"],["KY","Kentucky"],["LA","Louisiana"],["ME","Maine"],["MD","Maryland"],["MA","Massachusetts"],["MI","Michigan"],["MN","Minnesota"],["MS","Mississippi"],["MO","Missouri"],["MT","Montana"],["NE","Nebraska"],["NV","Nevada"],["NH","New Hampshire"],["NJ","New Jersey"],["NM","New Mexico"],["NY","New York"],["NC","North Carolina"],["ND","North Dakota"],["OH","Ohio"],["OK","Oklahoma"],["OR","Oregon"],["PA","Pennsylvania"],["RI","Rhode Island"],["SC","South Carolina"],["SD","South Dakota"],["TN","Tennessee"],["TX","Texas"],["UT","Utah"],["VT","Vermont"],["VA","Virginia"],["WA","Washington"],["WV","West Virginia"],["WI","Wisconsin"],["WY","Wyoming"],["DC","District of Columbia"]].map(([e,t])=>({value:e,label:t}))],Px={apiKey:"YqIvg89urE1WsAdgWwM1EiQTRM1ajSYCaLhnDvimvmHeB78A",configId:"cce84049-0940-4926-9a54-9eaca0c09830",environment:"qa",locale:"en-US",paymentSdkUrl:"https://connect-qa.fiservapis.com/pbb/sdk/web/v2/js/PaymentSDK.js"};let Dx=class extends Xy{constructor(){super(...arguments),this.otpValue="",this.bankLinkLoading=!1,this.bankAccountInstrumentSchemas=[],this.bankAccountFormData={},this.bankAccountFormValid=!1,this.legacyBankAccountDraft={accountNickname:"",routingNumber:"",accountNumber:"",confirmAccountNumber:""},this.legacyBankAccountDraftErrors={},this.legacyBankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},confirmAccountNumber:{status:"idle",normalizedValue:""}},this.bankAccountConfigRequestToken=0,this.bankProviderRequestToken=0,this.transferDraft={fromSourceId:"",toSourceId:"",amount:""},this.transferDraftErrors={},this.transferSubmitSuccess=!1,this.transferFlowActive=!1,this.transferFlowScreen="form",this.cardDraft=Tw(),this.cardDraftErrors={},this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.billingAddresses=[],this.billingAddressSelectorExpanded=!1,this.paymentSourceEditMode=!1,this.addLauncherActive=!1,this.savedSourceVerificationFailed=!1,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.interactionRefresh=new Sw(this),this.nativeBalance=new Aw(this),this.minimumVerificationOverlayToken=0,this.handleSubmit=e=>{e.preventDefault();const t=_j(e,"submitAction");"verify-otp"===t?this.verifyOtp():"submit-required-info"===t?this.submitRequiredInfo():"transfer"===t?this.reviewTransfer():"confirm-transfer"===t?this.submitTransfer():"save-card"===t?this.saveCard():"save-bank-account"===t&&this.saveManualBankAccount()},this.handleClick=e=>{const t=_j(e,"action"),r=_j(e,"paymentMethodId");if(t){if("attach-payment-source"===t){const e=r??this.selectedPaymentSourceId;return void(e&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.attachPaymentSource(e)))}if("open-add-payment-source"===t){const e=aj(this.interactionResponse);return this.attachmentError=void 0,void(e.card&&e.bankAccount?(this.addLauncherActive=!0,this.focusAfterUpdate(".tender-tab")):e.card?this.showAddCardScreen():e.bankAccount&&this.startPayByBankFlow())}if("change-payment-source"===t)return this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("retry-interaction-refresh"!==t){if("toggle-payment-source-edit-mode"===t)return this.clearDeletePaymentSourceConfirmation(),void(this.paymentSourceEditMode=!this.paymentSourceEditMode);if("verify-payment-source"!==t)if("delete-payment-source"!==t)if("cancel-delete-payment-source"!==t){if("done-payment-source-verification"===t)return this.resetSavedSourceVerification(),void this.showPaymentSourceList({refresh:!0});if("open-required-info-file-picker"===t)return this.pendingRequiredInfoDocKey=_j(e,"requiredInfoDocKey")??this.firstRequiredInfoDocKey(),void this.renderRoot.querySelector(".required-info-file-input")?.click();if("submit-required-info"!==t){if("open-transfer"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),this.resetTransferFlow(),void(this.transferFlowActive=!0);if("transfer"!==t)if("edit-transfer"!==t)if("confirm-transfer"!==t)if("verify-otp"!==t)if("resend-otp"!==t)if("select-instrument-schema"!==t)if("save-bank-account"!==t){if("back-to-instrument-schema-selection"===t)return this.clearManualBankAccountForm(),void(this.bankFlowScreen="manual-schema-selection");if("add-bank-account"===t||"use-bank-account-instead"===t||"retry-bank-provider"===t||"use-different-bank-account"===t)return this.addLauncherActive=!1,this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),this.resetBankFlow(),void this.startBankAccountFlow();if("back-to-bank-provider"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),this.resetBankFlow(),void this.startPayByBankFlow();if("add-ach-manually"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),void this.showManualBankAccountScreen();if("back-to-payment-methods"===t)return this.addLauncherActive=!1,this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("continue-bank-outcome"===t||"done-bank-outcome"===t)return this.resetBankFlow(),void this.showPaymentSourceList({refresh:!0});if("add-card"===t)return this.addLauncherActive=!1,this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetRequiredInfo(),void this.showAddCardScreen();if("change-billing-address"!==t)if("save-card"!==t){if("edit-card-details"!==t)return"use-different-method"===t?(this.resetCardFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0})):void 0;this.cardFlowScreen="form"}else this.saveCard();else this.billingAddressSelectorExpanded=!0}else this.saveManualBankAccount();else this.initializeManualBankAccountScreen();else this.resendOtp();else this.verifyOtp();else this.submitTransfer();else this.transferFlowScreen="form";else this.reviewTransfer()}else this.submitRequiredInfo()}else this.clearDeletePaymentSourceConfirmation();else r&&this.deletePaymentSource(r);else r&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.verifySavedPaymentSource(r))}else this.retryInteractionRefresh()}},this.handleInput=e=>{const t=qx(e);if(t)return void this.storeRequiredInfoSsnInput(t);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.cardField));if(r)return void this.updateCardDraftField(r.dataset.cardField,r.value);const n=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.bankAccountField));if(n)return void this.updateLegacyBankAccountDraftField(n.dataset.bankAccountField,n.value);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.transferField));if(i)return void this.updateTransferDraftField(i.dataset.transferField,i.value);const o=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoDocKey));if(o)return void this.storeRequiredInfoValue(o.dataset.requiredInfoDocKey,o.value);const a=e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input"));if(!a)return;const s=this.getOtpInputs(),c=Number(a.dataset.otpIndex),u=zk(a.value);if(!u)return a.value="",void this.syncOtpValueFromInputs(s);if(1===u.length)return a.value=u,this.syncOtpValueFromInputs(s),void this.focusOtpInput(s,c+1);const d=this.writeOtpDigits(s,c,u);this.syncOtpValueFromInputs(s),this.focusOtpInput(s,Math.min(c+u.length,s.length-1),d)},this.handleKeyDown=e=>{if("Escape"===e.key&&!this.pendingAction&&(this.addLauncherActive||this.cardFlowScreen||this.bankFlowScreen||this.requiredInfoSource||this.savedSourceVerificationSource||this.transferFlowActive))return e.preventDefault(),this.addLauncherActive=!1,this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),this.resetSavedSourceVerification(),void this.showPaymentSourceList();const t=e.composedPath().find(e=>e instanceof HTMLButtonElement&&"tab"===e.getAttribute("role"));if(t&&("ArrowLeft"===e.key||"ArrowRight"===e.key||"Home"===e.key||"End"===e.key)){const r=[...this.renderRoot.querySelectorAll('[role="tab"]')],n=r.indexOf(t),i=r["Home"===e.key?0:"End"===e.key?r.length-1:(n+("ArrowRight"===e.key?1:-1)+r.length)%r.length];return e.preventDefault(),void(i&&i!==t&&(i.focus(),i.click()))}const r=gx(e);if(!r)return;const n=this.getOtpInputs(),i=Number(r.dataset.otpIndex);return"ArrowLeft"===e.key?(e.preventDefault(),void this.focusOtpInput(n,i-1)):"ArrowRight"===e.key?(e.preventDefault(),void this.focusOtpInput(n,i+1)):"Backspace"===e.key?(e.preventDefault(),r.value?r.value="":i>0&&(n[i-1].value=""),this.syncOtpValueFromInputs(n),void this.focusOtpInput(n,Math.max(i-1,0))):"Delete"===e.key?(e.preventDefault(),r.value="",void this.syncOtpValueFromInputs(n)):void(e.ctrlKey||e.metaKey||e.altKey||1!==e.key.length||/\d/.test(e.key)||e.preventDefault())},this.handleChange=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.paymentMethodRadio));if(t)return this.selectedPaymentSourceId=t.value,void(this.attachmentError=void 0);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&"instrument-schema"===e.name&&Boolean(e.dataset.instrumentSchemaCode));if(r)return void(this.selectedBankAccountInstrumentSchemaCode=r.dataset.instrumentSchemaCode);const n=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoFileInput));if(n)return this.storeRequiredInfoSelectedFile(n.files?.[0]),void(n.value="");const i=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.cardField));if(i)return void this.updateCardDraftField(i.dataset.cardField,i.value);const o=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.transferField));o&&this.updateTransferDraftField(o.dataset.transferField,o.value)},this.handleBankAccountFormDataChange=e=>{const t=e.detail.data;this.bankAccountFormData="object"!=typeof t||null===t||Array.isArray(t)?{}:t,this.bankAccountFormValid=0===(e.detail.errors?.length??0),this.bankAccountSubmitError=void 0},this.handleBankAccountFormErrorsChange=e=>{this.bankAccountFormValid=0===(e.detail.errors?.length??0)},this.handlePaste=e=>{const t=qx(e);if(t)return void this.pasteRequiredInfoSsnInput(e,t);const r=gx(e);if(!r)return;const n=e,i="function"==typeof n.clipboardData?.getData?n.clipboardData.getData("text"):"",o=zk(i);if(!o)return;e.preventDefault();const a=this.getOtpInputs(),s=Number(r.dataset.otpIndex),c=this.writeOtpDigits(a,s,o);this.syncOtpValueFromInputs(a),this.focusOtpInput(a,Math.min(s+o.length,a.length-1),c)},this.handleFocusIn=e=>{const t=gx(e);t&&t.value&&requestAnimationFrame(()=>{this.renderRoot.contains(t)&&t.select()})},this.handleFocusLost=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Rw(e.dataset.cardField));if(t)return void this.encryptCardField(t.dataset.cardField,t.value);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&o$(e.dataset.bankAccountField));r&&this.encryptLegacyBankAccountField(r.dataset.bankAccountField,r.value)}}willUpdate(e){if(e.has("interactionResponse")&&this.interactionResponse){const t=e.get("interactionResponse");t?.interactionId!==this.interactionResponse.interactionId&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceView=void 0,this.paymentSourceEditMode=!1,this.interactionRefresh.reset({requestUpdate:!1}),this.nativeBalance.reset({requestUpdate:!1}),this.billingAddresses=[],this.resetBankFlow(),this.resetTransferFlow(),this.resetSavedSourceVerification(),this.resetRequiredInfo()),this.interactionResponse.paymentSources?.length||this.interactionResponse.selectedSource||(this.paymentSourceEditMode=!1),this.syncBillingAddressesFromInteractionResponse(this.interactionResponse),this.selectedPaymentSourceId=$j(this.interactionResponse,this.selectedPaymentSourceId)}}updated(e){e.has("designConfig")&&this.syncDesignConfigStyles(),e.has("interactionResponse")&&this.deleteConfirmationPaymentSourceId&&!this.findPaymentSourceById(this.deleteConfirmationPaymentSourceId)&&this.clearDeletePaymentSourceConfirmation(),e.has("interactionResponse")&&this.refreshPaymentSourcesFromInteraction()}render(){return Ry`
      ...
      >
        <span class="screen-reader-status" role="status" aria-live="polite"
          >${Uj(this.pendingAction)}</span
        >
        ${this.renderCurrentScreen()}
      </div>
    `}disconnectedCallback(){super.disconnectedCallback(),this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow()}emitSdkEvent(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t}))}focusAfterUpdate(...e){this.updateComplete.then(()=>{for(const t of e){const e=this.renderRoot.querySelector(t);if(e)return void e.focus()}})}renderWidgetShell({busy:e=!1,overlay:t,...r}){const n=Lj(this.minimumVerificationOverlayAction);return(({title:e,subtitle:t,content:r,headerAction:n,footer:i,width:o="default",layout:a="default",ariaLabel:s="Commerce Hub Connect",closeAction:c="close",showClose:u=!0,showDivider:d=!1,showFooter:l=!0,busy:h=!1,overlay:f})=>Ry`
  <section
    class=${Qk("widget-shell","wide"===o&&"widget-shell-wide","payment-methods"===a&&"widget-shell-payment-methods",h&&"widget-shell-busy")}
    part="shell"
    aria-label=${s}
  ...
  >
    ...
    ${d?Ry`<div class="widget-divider" aria-hidden="true"></div>`:""}
...
`)({...r,busy:e||Boolean(n),overlay:t??n})}showMinimumVerificationOverlay(e){const t=this.minimumVerificationOverlayToken+=1;this.minimumVerificationOverlayAction=e,window.setTimeout(()=>{this.minimumVerificationOverlayToken===t&&(this.minimumVerificationOverlayAction=void 0)},2e3)}renderCurrentScreen(){if(!this.interactionResponse)return this.renderMissingInteractionResponseScreen();if("provider"===this.bankFlowScreen)return this.renderBankProviderScreen();if(this.addLauncherActive)return this.renderAddPaymentSourceLauncher();if("outcome"===this.bankFlowScreen)return this.renderBankOutcomeScreen();if("manual-config-loading"===this.bankFlowScreen)return this.renderManualBankAccountConfigLoadingScreen();if("manual-config-error"===this.bankFlowScreen)return this.renderManualBankAccountConfigErrorScreen();if("manual-schema-selection"===this.bankFlowScreen)return this.renderManualBankAccountSchemaSelectionScreen();if("manual"===this.bankFlowScreen)return this.renderManualBankAccountScreen();if("form"===this.cardFlowScreen)return this.renderAddCardScreen();if("error"===this.cardFlowScreen)return this.renderCardErrorScreen();if(this.requiredInfoSource)return this.renderRequiredInfoScreen();if(this.savedSourceVerificationSource)return this.renderSavedSourceVerificationOutcomeScreen();const e=this.interactionResponse?.status;return"OTP_VALIDATION_PENDING"===e||"OTP_VALIDATION_FAILED"===e?this.renderOtpScreen(e):this.shouldRenderTransferScreen()?this.renderTransferScreen():this.renderPaymentSourceScreen()}renderMissingInteractionResponseScreen(){return this.renderWidgetShell({title:"Configuration required",showClose:!1,showDivider:!1,content:Ry`
        <div class="payment-flow">
          ${cx({variant:"danger",message:"CommerceHub Connect requires an interaction response before it can load payment methods."})}
        </div>
      `})}renderOtpScreen(e){const t=Gx(this.designConfig),r="verify-otp"===this.pendingAction,n="resend-otp"===this.pendingAction,i=Kx(this.interactionResponse);let o;return r?o=Bj({title:"Verifying code",helper:"Verifying your code, please wait."}):n&&(o=Bj({title:"Sending code",helper:"Sending a new code, please wait."})),this.renderWidgetShell({title:t.title,subtitle:t.subtitle??bx(i),showClose:!1,showDivider:!1,busy:r||n,overlay:o,content:yx({status:e,value:this.otpValue,length:6,failedMessage:this.otpErrorMessage,copy:t,submitting:r,resending:n})})}renderPaymentSourceScreen(){const e=Jx(this.designConfig),t=oj(this.interactionResponse,{nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}),r=aj(this.interactionResponse),n=jj(this.interactionResponse,"ADD_ACCOUNT")&&(r.card||r.bankAccount),i=jj(this.interactionResponse,"SELECT"),o=jj(this.interactionResponse,"TRANSFER")&&vj(this.interactionResponse).length>=2,a="attach-payment-source"===this.pendingAction||"verify-payment-source"===this.pendingAction||"delete-payment-source"===this.pendingAction,s=this.paymentSourceEditMode&&t.length>0;if(this.shouldRenderPaymentSourceRefreshSkeleton())return this.renderWidgetShell({title:e.title,layout:"payment-methods",headerAction:Ry`
          <div
        ...
        `,showClose:!1,content:wx()});if(this.shouldRenderPaymentSourceRefreshError())return this.renderPaymentSourceRefreshErrorScreen();if(!t.length)return this.renderNoSavedPaymentMethods();if(this.shouldRenderSelectedPaymentSourceScreen())return this.renderSelectedPaymentSourceScreen();this.queueNativeAccountBalanceRefresh();const c=s?px({label:"Done",action:"toggle-payment-source-edit-mode",disabled:a}):Ry`
          <div class="widget-toolbar" aria-label="Payment method actions">
            ${px({label:"Edit",action:"toggle-payment-source-edit-mode",icon:"edit",disabled:a})}
            ${n?px({label:"Add",action:"open-add-payment-source",icon:"add",variant:"primary",disabled:a}):""}
            ${o?px({label:"Transfer",action:"open-transfer",icon:"transfer",disabled:a}):""}
          </div>
        `;return this.renderWidgetShell({title:e.title,layout:"payment-methods",headerAction:c,showClose:!1,busy:a&&"attach-payment-source"!==this.pendingAction,overlay:"attach-payment-source"===this.pendingAction?void 0:Vj(this.pendingAction),content:$x({methods:t,canSelectPaymentSources:i,editing:s,actionPending:a,selectedPaymentSourceId:this.selectedPaymentSourceId,deleteConfirmationPaymentSourceId:this.deleteConfirmationPaymentSourceId}),footer:s||!i?void 0:Ry`
              ${this.attachmentError?cx({variant:"danger",message:this.attachmentError}):""}
              ${ox({label:"attach-payment-source"===this.pendingAction?e.continuingButton:e.continueButton,action:"attach-payment-source",loading:"attach-payment-source"===this.pendingAction,disabled:!this.selectedPaymentSourceId||"attach-payment-source"===this.pendingAction})}
            `})}renderAddPaymentSourceLauncher(){const e=aj(this.interactionResponse);return this.renderWidgetShell({title:"Add a payment method",headerAction:px({label:"Back",action:"back-to-payment-methods"}),showClose:!1,content:Ry`
      ...
      `})}renderPaymentSourceRefreshErrorScreen(){return this.renderWidgetShell({title:"Payment methods unavailable",showClose:!1,content:Ry`
        <div class="payment-flow">
          ${cx({variant:"danger",message:this.interactionRefresh.errorMessage??"We couldn't load payment methods. Try again."})}
          <div class="primitive-footer">
            ${ox({label:"Try again",variant:"primary",action:"retry-interaction-refresh"})}
          </div>
        </div>
      `})}renderSelectedPaymentSourceScreen(){const e=kj(this.interactionResponse,this.selectedPaymentSourceId);return e?this.renderWidgetShell({title:"Payment method saved",headerAction:px({label:"Change",action:"change-payment-source",disabled:"attach-payment-source"===this.pendingAction}),showClose:!1,showDivider:!1,busy:"attach-payment-source"===this.pendingAction,overlay:"attach-payment-source"===this.pendingAction?Bj({title:oE(e)?"Saving bank account":"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,content:Ry`
        <div class="payment-flow">
          ${lx(cj(e,{selected:!0,nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}))}
        </div>
      `}):(this.paymentSourceView="list",this.renderPaymentSourceScreen())}shouldRenderSelectedPaymentSourceScreen(){return"list"!==this.paymentSourceView&&("PAYMENT_SOURCE_ATTACHED"===this.interactionResponse?.status||"selected"===this.paymentSourceView)}shouldRenderPaymentSourceRefreshSkeleton(){return this.interactionRefresh.shouldRenderSkeleton(this.interactionResponse)}shouldRenderPaymentSourceRefreshError(){return this.interactionRefresh.shouldRenderError(this.interactionResponse)}renderSavedSourceVerificationOutcomeScreen(){const e=this.savedSourceVerificationSource,t=Hj(e,this.savedSourceVerificationFailed),r="declined"===t.kind||"pending"===t.kind;return this.renderWidgetShell({title:t.title,headerAction:r?px({label:"Back",action:"done-payment-source-verification"}):void 0,showClose:!1,showDivider:!1,content:Ry`
        <div class="verification-outcome-flow">
          ${cx({variant:t.variant,message:t.message})}
          ${e?rE(e):""}
          ${r?"":Ry`
                <div class="primitive-footer">
                  ${ox({label:"Back to payment methods",action:"done-payment-source-verification"})}
                </div>
              `}
        </div>
      `})}renderRequiredInfoScreen(){const e=this.requiredInfoSource;if(!e)return this.renderPaymentSourceScreen();const t=Wj(e),r=Qj(t),n="submit-required-info"===this.pendingAction,i=this.canSubmitRequiredInfo();return this.renderWidgetShell({title:"Complete account verification",headerAction:px({label:"Back",action:"back-to-payment-methods",disabled:n}),showClose:!1,showDivider:!1,busy:n,overlay:n?Bj({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,content:Ry`
        <form
          class="required-info-flow"
          data-submit-action="submit-required-info"
        >
          ${rE(e)}
          ${this.requiredInfoSubmitError?cx({variant:"danger",message:this.requiredInfoSubmitError}):""}
          ...
          <div class="required-info-documents">
            ...
            <div class="primitive-stack">
              ${t.map((e,t)=>{const r=Kj(e,t),i=Gj(e)?this.requiredInfoValues[r]:this.requiredInfoFileNames[r];return Gj(e)?Xj({doc:e,key:r,value:i??""}):Ry`
                  <div
...
`)({label:"Required document",requirements:tE(e),actionLabel:"Choose file",fileName:i,action:"open-required-info-file-picker",disabled:n})}
                  </div>
                `})}
            </div>
          </div>
          ...
          <div
            ...
            data-required-info-doc-key=${r??""}
          >
            ${ox({label:n?"Verifying...":"Verify",action:"submit-required-info",type:"submit",loading:n,disabled:n||!i})}
          </div>
        </form>
      `})}renderNoSavedPaymentMethods(){const e=Yx(this.designConfig),t="delete-payment-source"===this.pendingAction,r=aj(this.interactionResponse),n=jj(this.interactionResponse,"ADD_ACCOUNT")&&(r.card||r.bankAccount);return this.renderWidgetShell({title:e.title,subtitle:e.subtitle,headerAction:n?px({label:"Add",action:"open-add-payment-source",disabled:t}):void 0,showClose:!1,showDivider:!1,content:kx({allowedTenderOptions:r,canAddPaymentSources:!1,deletePending:t,copy:e})})}shouldRenderTransferScreen(){const e=this.interactionResponse;return(this.transferFlowActive||Ej(e))&&xj(e?.status)}renderTransferScreen(){const e=vj(this.interactionResponse),t="transfer"===this.pendingAction,r=this.transferFlowActive?px({label:"Back",action:"back-to-payment-methods",disabled:t}):void 0;if(e.length<2)return this.renderWidgetShell({title:"Transfer funds",headerAction:r,showClose:!1,showDivider:!1,content:Ry`
          <div class="payment-flow">
            ${ux({title:"Transfer unavailable",message:"At least two verified bank or native accounts are required to transfer funds."})}
          </div>
        `});const n=[{value:"",label:"Select account"},...e.map(e=>({value:mj(e),label:uj(e)}))],i=qk(this.transferDraft),o=e.find(e=>mj(e)===i.fromSourceId),a=e.find(e=>mj(e)===i.toSourceId);return"confirm"===this.transferFlowScreen&&o&&a&&Lk(i,e)?this.renderTransferConfirmationScreen(o,a,i,t):this.renderWidgetShell({title:"Transfer funds",headerAction:r,showClose:!1,showDivider:!1,busy:t,overlay:t?Bj({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="transfer"
        >
          ${this.transferSubmitError?cx({variant:"danger",message:this.transferSubmitError}):""}
          ${this.transferSubmitSuccess?cx({variant:"success",message:"Transfer initiated."}):""}
          ${vx([sx({id:"transfer-from-source",name:"fromSourceId",label:"From",value:this.transferDraft.fromSourceId,options:n,span:"full",variant:"card-form",dataField:"fromSourceId",dataFieldScope:"transfer",error:this.transferDraftErrors.fromSourceId,disabled:t}),sx({id:"transfer-to-source",name:"toSourceId",label:"To",value:this.transferDraft.toSourceId,options:n,span:"full",variant:"card-form",dataField:"toSourceId",dataFieldScope:"transfer",error:this.transferDraftErrors.toSourceId,disabled:t}),ax({id:"transfer-amount",name:"amount",label:"Amount",value:this.transferDraft.amount,variant:"card-form",inputmode:"decimal",dataField:"amount",dataFieldScope:"transfer",error:this.transferDraftErrors.amount,disabled:t})])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${ox({label:t?"Transferring":"Transfer",action:"transfer",type:"submit",loading:t,disabled:t||!Lk(this.transferDraft,e)})}
            </div>
          </div>
        </form>
      `})}renderTransferConfirmationScreen(e,t,r,n){return this.renderWidgetShell({title:"Confirm transfer",headerAction:px({label:"Back",action:"edit-transfer",disabled:n}),showClose:!1,showDivider:!1,busy:n,overlay:n?Bj({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="confirm-transfer"
        >
          ${this.transferSubmitError?cx({variant:"danger",message:this.transferSubmitError}):""}
          ${hx([{label:"From",value:uj(e)},{label:"To",value:uj(t)},{label:"Amount",value:Vk(r)}])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
      ...
      `})}renderAddCardScreen(){const e="save-card"===this.pendingAction,t="encrypting"===this.cardEncryption.cardNumber.status||"encrypting"===this.cardEncryption.cvv.status,r=[...this.billingAddresses.map(e=>({value:e.id??"",label:Bx(e)})),{value:zw,label:"Add new billing address"}],n=this.billingAddresses.find(e=>e.id===this.cardDraft.billingAddressValue),i=Boolean(n)&&!this.billingAddressSelectorExpanded,o=!i&&this.cardDraft.billingAddressValue===zw,a=[];return n&&i?a.push(Ry`
        <div class="billing-address-summary field field-full">
          <div class="billing-address-summary-heading">
            ...
            >
            ${px({label:"Change",action:"change-billing-address",disabled:e})}
          </div>
          <p class="billing-address-summary-value">
            ${Bx(n)}
          </p>
        </div>
      `):a.push(sx({id:"billing-address",name:"billingAddress",label:"Billing address",value:this.cardDraft.billingAddressValue,options:r,span:"full",variant:"card-form",dataField:"billingAddressValue",error:this.cardDraftErrors.billingAddressValue,disabled:e})),o&&a.push(sx({id:"billing-country",name:"country",label:"Country or region",value:this.cardDraft.country,options:Rx,span:"full",variant:"card-form",dataField:"country",error:this.cardDraftErrors.country,disabled:e}),ax({id:"billing-address-line-1",name:"addressLine1",label:"Address",value:this.cardDraft.addressLine1,placeholder:"Street address",span:"full",variant:"card-form",autocomplete:"address-line1",dataField:"addressLine1",error:this.cardDraftErrors.addressLine1,disabled:e}),ax({id:"billing-address-line-2",name:"addressLine2",label:"Address line 2",value:this.cardDraft.addressLine2,placeholder:"Apartment, suite, unit",span:"full",variant:"card-form",autocomplete:"address-line2",dataField:"addressLine2",error:this.cardDraftErrors.addressLine2,disabled:e}),ax({id:"billing-city",name:"city",label:"City",value:this.cardDraft.city,span:"full",variant:"card-form",autocomplete:"address-level2",dataField:"city",error:this.cardDraftErrors.city,disabled:e}),sx({id:"billing-state",name:"state",label:"State",value:this.cardDraft.state,options:Mx,span:"full",variant:"card-form",dataField:"state",error:this.cardDraftErrors.state,disabled:e}),ax({id:"billing-zip",name:"zip",label:"ZIP code",value:this.cardDraft.zip,placeholder:"ZIP code",span:"full",variant:"card-form",autocomplete:"postal-code",inputmode:"numeric",dataField:"zip",error:this.cardDraftErrors.zip,disabled:e})),this.renderWidgetShell({title:"Add card",headerAction:px({label:"Back",action:"back-to-payment-methods",disabled:e}),showClose:!1,showDivider:!1,busy:e,overlay:e?Bj({title:"Saving card",helper:"Securely saving your card, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="save-card"
        >
          ${this.cardSubmitError?cx({variant:"danger",message:this.cardSubmitError}):""}
          ${vx([ax({id:"card-label",name:"name",label:"Card Name",value:this.cardDraft.name,placeholder:"Corporate card",span:"full",variant:"card-form",dataField:"name",error:this.cardDraftErrors.name,disabled:e}),ax({id:"card-number",name:"cardNumber",label:"Card number",value:this.cardDraft.cardNumber,placeholder:"1234 1234 1234 1234",span:"full",variant:"card-form",autocomplete:"cc-number",inputmode:"numeric",dataField:"cardNumber",error:this.cardDraftErrors.cardNumber,disabled:e}),ax({id:"expiration-date",name:"expirationDate",label:"Expiration",value:this.cardDraft.expirationDate,placeholder:"MM / YY",variant:"card-form",autocomplete:"cc-exp",inputmode:"numeric",dataField:"expirationDate",error:this.cardDraftErrors.expirationDate,disabled:e}),ax({id:"card-cvv",name:"cvv",label:"CVC",value:this.cardDraft.cvv,placeholder:"3 or 4 digits",variant:"card-form",autocomplete:"cc-csc",inputmode:"numeric",dataField:"cvv",error:this.cardDraftErrors.cvv,disabled:e}),ax({id:"name-on-card",name:"fullName",label:"Full name",value:this.cardDraft.fullName,placeholder:"Name on card",span:"full",variant:"card-form",autocomplete:"cc-name",dataField:"fullName",error:this.cardDraftErrors.fullName,disabled:e}),...a])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${ox({label:e?"Saving payment method":"Save card",action:"save-card",type:"submit",loading:e,disabled:e||t||(s=this.cardDraft,c=this.cardEncryption,!(0===Object.keys(Fw(Uw(s))).length&&0===Object.keys(Gw(s,c)).length))})}
            </div>
          </div>
        </form>
      `});var s,c}renderCardErrorScreen(){return this.renderWidgetShell({title:"Credit card not saved",subtitle:"We could not save this card. Check the card details or use a different payment method.",showClose:!1,showDivider:!1,content:mx({variant:"danger",content:this.cardSubmitError?cx({variant:"danger",message:this.cardSubmitError}):void 0,actions:Ry`
          ${ox({label:"Edit card details",action:"edit-card-details"})}
          ${px({label:"Use a different method",action:"use-different-method"})}
        `})})}renderBankProviderScreen(){return this.renderWidgetShell({title:"Connect your bank",headerAction:px({label:"Back",action:"back-to-payment-methods",disabled:this.bankLinkLoading}),showClose:!1,showDivider:!1,busy:this.bankLinkLoading,overlay:this.bankLinkLoading?Bj({title:"Connecting to your bank",helper:"Securely opening your bank connection, please wait."}):void 0,content:fx({containerId:_x,loading:this.bankLinkLoading,loadingLabel:"Connecting to your bank"}),footer:Ry`
        <div class="bank-provider-manual-link">
          ${px({label:"Connect another way",action:"add-ach-manually",disabled:this.bankLinkLoading})}
        </div>
      `})}renderManualBankAccountConfigLoadingScreen(){return this.renderWidgetShell({title:"Select an instrument schema",headerAction:px({label:"Back",action:this.manualBankAccountExitAction(),disabled:!0}),showClose:!1,showDivider:!1,busy:!0,overlay:Bj({title:"Loading instrument schemas",helper:"Loading the available bank account options, please wait."}),content:Ry`<div class="payment-flow card-form-screen"></div>`})}renderManualBankAccountConfigErrorScreen(){return this.renderWidgetShell({title:"Select an instrument schema",headerAction:px({label:"Back",action:this.manualBankAccountExitAction()}),showClose:!1,showDivider:!1,content:Ry`
        <div class="payment-flow card-form-screen">
          ${cx({variant:"danger",message:this.bankAccountConfigError??"Unable to load instrument schemas. Try again."})}
          <div class="primitive-footer card-form-primary">
            ${ox({label:"Try again",action:"add-ach-manually"})}
          </div>
        </div>
      `})}renderManualBankAccountSchemaSelectionScreen(){return this.renderWidgetShell({title:"Select an instrument schema",headerAction:px({label:"Back",action:this.manualBankAccountExitAction()}),showClose:!1,showDivider:!1,content:Ry`
      ...
      `})}renderManualBankAccountScreen(){if("legacy"===this.manualBankAccountFormMode)return this.renderLegacyManualBankAccountScreen();const e=this.bankAccountFormSchema,t=this.bankAccountFormUiSchema;if(!e||!t)return this.renderManualBankAccountConfigErrorScreen();const r="save-bank-account"===this.pendingAction;return this.renderWidgetShell({title:"Enter bank details",headerAction:px({label:"Back",action:this.bankAccountInstrumentSchemas.length>1?"back-to-instrument-schema-selection":this.manualBankAccountExitAction()}),showClose:!1,showDivider:!1,content:Ry`
        <form
          class="payment-flow card-form-screen"
        ...
        >
          ...
          ></commerce-hub-bank-account-jsonforms>
          ${this.bankAccountSubmitError?cx({variant:"danger",message:this.bankAccountSubmitError}):""}
          <div class="primitive-footer card-form-primary">
            ${ox({label:r?"Saving bank account":"Save bank account",action:"save-bank-account",type:"submit",loading:r,disabled:!this.bankAccountFormValid||r})}
          </div>
        </form>
      `})}renderLegacyManualBankAccountScreen(){const e="save-bank-account"===this.pendingAction,t=Object.values(this.legacyBankAccountEncryption).some(e=>"encrypting"===e.status);return this.renderWidgetShell({title:"Enter bank details",headerAction:px({label:"Back",action:this.manualBankAccountExitAction(),disabled:e}),showClose:!1,showDivider:!1,busy:e,overlay:e?Bj({title:"Saving bank account",helper:"Securely saving your bank account, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="save-bank-account"
        >
          ...
          ></commerce-hub-bank-account-jsonforms>
          <div class="primitive-footer card-form-primary">
            ${ox({label:e?"Saving bank account":"Save bank account",action:"save-bank-account",type:"submit",loading:e,disabled:e||t||!b$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption,r$)})}
          </div>
        </form>
      `})}renderBankOutcomeScreen(){const e=Fj(this.bankOutcomeSource),t="declined"===e.kind||"pending"===e.kind;return this.renderWidgetShell({title:e.title,headerAction:t?px({label:"Done",action:"done-bank-outcome"}):void 0,showClose:!1,showDivider:!1,content:Ry`
        <div class="verification-outcome-flow">
          ${cx({variant:e.variant,message:e.message})}
          ${this.bankOutcomeSource?rE(this.bankOutcomeSource):""}
          ${t?"":Ry`
                <div class="primitive-footer">
                  ${"verified"===e.kind?ox({label:"Continue",action:"continue-bank-outcome"}):"pending"===e.kind?ox({label:"Done",action:"done-bank-outcome"}):Ry`
...
`,Lj=e=>"verify-payment-source"===e?Bj({title:"Verifying payment method",helper:"Verifying your payment method, please wait."}):"submit-required-info"===e?Bj({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,Vj=e=>"verify-payment-source"===e?Lj(e):"delete-payment-source"===e?Bj({title:"Deleting payment method",helper:"Deleting your payment method, please wait."}):"attach-payment-source"===e?Bj({title:"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,Uj=e=>{switch(e){case"attach-payment-source":return"Saving the selected payment method.";case"verify-payment-source":case"submit-required-info":return"Verifying the payment method.";case"delete-payment-source":return"Deleting the payment method.";case"verify-otp":return"Verifying the code.";case"resend-otp":return"Sending a new code.";case"save-card":return"Saving the card.";case"save-bank-account":return"Saving the bank account.";case"transfer":return"Submitting the transfer.";default:return""}},Fj=e=>{const t=e?.verificationInfo?.status;return"VERIFIED"===t?{kind:"verified",variant:"success",title:"Bank account verified",message:"Your bank account is connected and ready to use."}:"UNDER_REVIEW"===t?{kind:"pending",variant:"warning",title:"Bank account pending review",message:"We will update this bank account after review is complete."}:"REQUIRE_INFO"===t?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:"Additional information is required before this bank account can be verified."}:"DECLINED"===t?{kind:"declined",variant:"danger",title:"Bank account verification failed",message:"This bank account could not be verified."}:{kind:"failed",variant:"danger",title:"Bank account not verified",message:"This bank account is not verified yet."}},Hj=(e,t=!1)=>{const r=iE(e),n=r.toLowerCase(),i=e?.verificationInfo?.status;return t?{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} not verified`,message:`We could not verify this ${n} right now.`}:"VERIFIED"===i?{kind:"verified",variant:"success",title:"Bank account"===r?"Bank account verified":`${r} saved`,message:`This ${n} is verified and ready to use.`}:"UNDER_REVIEW"===i?{kind:"pending",variant:"warning",title:"Bank account"===r?"Bank account pending review":"Verification pending review",message:`We will update this ${n} after review is complete.`}:"REQUIRE_INFO"===i?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:`Additional information is required before this ${n} can be verified.`}:"DECLINED"===i?{kind:"declined",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} declined`,message:`This ${n} could not be verified.`}:{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account not verified":`${r} not verified`,message:`This ${n} is not verified yet.`}},Wj=e=>{const t=e?.verificationInfo?.docs??[];return t.length>0?t:[{}]},Kj=(e,t=0)=>`${e?.docType??"DOCUMENT"}-${t}`,Gj=e=>"DRIVER_LICENSE_NUMBER"===e.docType||"SOCIAL_SECURITY_NUMBER"===e.docType,Jj=e=>!1!==e.mandatory,Yj=e=>Jj(e)?"required":"optional",Zj=e=>Ry`
  <span
    class="required-info-requirement-badge required-info-requirement-badge-${Yj(e)}"
  >
    ${(e=>Jj(e)?"Required":"Optional")(e)}
  </span>
`,Qj=e=>{const t=e.findIndex(e=>!Gj(e));return t>=0?Kj(e[t],t):void 0},Xj=({doc:e,key:t,value:r})=>{if("SOCIAL_SECURITY_NUMBER"===e.docType)return eE({doc:e,key:t,value:r});const n=`required-info-${t}`;return Ry`
    <div
  ...
  `},eE=({doc:e,key:t,value:r})=>{const n=tE(e),i=(e=>{const t=Rk(e);return[t.slice(0,3),t.slice(3,5),t.slice(5,9)]})(r),o=`required-info-${t}-ssn-0`;return Ry`
    <div
  ...
  `},tE=e=>"BANK_STATEMENT"===e.docType?"Bank statement":"BANK_LETTER"===e.docType?"Bank letter":"BANK_CHECK"===e.docType?"Bank check":"DRIVER_LICENSE_PHOTO"===e.docType?"Driver license photo":"DRIVER_LICENSE_NUMBER"===e.docType?"Driver license number":"SOCIAL_SECURITY_NUMBER"===e.docType?"Social Security number":"Required document",rE=e=>{const t=(e=>({type:pj(e),brand:lj(e)}))(e),r=Wk(t),n=(e=>{if(!aE(e))return;const t=e.card?.expirationMonth?.trim(),r=e.card?.expirationYear?.trim();if(!t||!r)return;return`${t.padStart(2,"0")}/${r.slice(-2)}`})(e);return Ry`
    <div
      ...
      <div class="required-info-card-top">
        <div class="required-info-card-heading">
          <span class="required-info-card-label"
            >${(e=>oE(e)?"Bank account":aE(e)?"Card":sE(e)?"Native account":"Dynamic session card")(e)}</span
          >
          <span
            class="required-info-card-field required-info-card-name"
            data-required-info-card-field="name"
            >${(e=>aE(e)?e.card?.nameOnCard?.trim()||e.name?.trim()||dj(e):oE(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||dj(e):sE(e)?e.account?.nickName?.trim()||e.name?.trim()||dj(e):e.name?.trim()||dj(e))(e)}</span
          >
        </div>
      ...
      <div class="required-info-card-bottom">
        <div class="required-info-card-detail">
          ...
          <span class="required-info-card-status">
            ${ex(zj(e.verificationInfo?.status))}
          </span>
        </div>
        ${n?Ry`
              <div class="required-info-card-detail">
  ...
  `},nE=e=>"REQUIRE_INFO"===e.verificationInfo?.status,iE=e=>e&&oE(e)?"Bank account":e&&sE(e)?"Native account":"Payment method",oE=e=>"BankAccount"===e.tenderType||"BANK_ACCOUNT"===e.tenderType,aE=e=>"Card"===e.tenderType||"CARD"===e.tenderType,sE=e=>"NativeAccount"===e.tenderType||"NATIVE_ACCOUNT"===e.tenderType;let cE,uE;const dE=async e=>{if(!window.PaymentSDK?.init)if(cE&&uE===e)await cE;else if(uE=e,cE=new Promise((t,r)=>{const n=document.querySelector(`script[data-commerce-hub-pay-by-bank-sdk="true"][src="${e}"]`),i=n??document.createElement("script"),o=()=>{i.removeEventListener("load",a),i.removeEventListener("error",s)},a=()=>{o(),t()},s=()=>{o(),cE=void 0,uE=void 0,r(new Error(`Unable to load Connect your bank script: ${e}`))};i.addEventListener("load",a,{once:!0}),i.addEventListener("error",s,{once:!0}),n||(i.src=e,i.async=!0,i.dataset.commerceHubPayByBankSdk="true",document.head.appendChild(i))}),await cE,!window.PaymentSDK?.init)throw new Error(`Connect your bank script loaded but window.PaymentSDK.init is unavailable: ${e}`)},lE=()=>{try{window.PaymentSDK?.destroy?.()}catch{}};export{bw as COMMERCE_HUB_BASE_URLS,Dx as CommerceHubConnect,vw as DEFAULT_COMMERCE_HUB_BASE_URL,Ex as ON_ADD_PAYMENT_METHOD_EVENT,Ax as ON_DELETE_PAYMENT_METHOD_EVENT,Ix as ON_ERROR_EVENT,Cx as ON_LIST_PAYMENT_METHODS_EVENT,jx as ON_SELECT_EVENT,Ox as ON_TRANSFER_EVENT,Sx as ON_VERIFY_PAYMENT_METHOD_EVENT,yw as createCommerceHubClient,$w as createCommerceHubConfigClient,ww as createCommerceHubMerchantClient,gw as resolveCommerceHubBaseURL};

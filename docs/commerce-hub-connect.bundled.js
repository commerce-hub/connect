 ...
 */,Le=e=>e??U,Me=(...e)=>e.filter(Boolean).join(" "),Oe=e=>{const t=e?.trim();return t||void 0},Fe=e=>{const t=(e=>"verified"===e?{label:"Verified",tone:"success"}:"under-review"===e?{label:"Under review",tone:"warning"}:"require-info"===e?{label:"Need More Information",tone:"warning"}:"declined"===e?{label:"Can't Use",tone:"danger"}:{label:"Action Required",tone:"warning"})(e);return P`
  ...
  `},Ve=e=>{const t=Oe(e.accountLabel)??(({label:e,brand:t,last4:i})=>{const r=Oe(e),n=Oe(t);return i&&n&&n!==r?`${n} •••• ${i}`:i?`•••• ${i}`:n??""})(e),i=Oe(e.label)??t,r=Boolean(t);return P`
    <span class="payment-method-copy">
      ...
      ${r?P`
            <span class="payment-method-meta-row">
              ...
              ${(e=>!1!==e.showVerificationStatus&&"verified"!==e.status)(e)?Fe(e.status):""}
            </span>
          `:""}
    </span>
  `},Pe=(e,t)=>P`
...
`,je=(e,t)=>P`
  <span class="payment-method-icon-chip" aria-hidden="true">
    <img
      ...
      data-payment-method-icon=${Be(e)}
      src=${Re(e)}
      alt=""
    />
  </span>
  ${Ve(e)} ${t}
`,Ue=({label:e,variant:t="primary",action:i,type:r="button",icon:n,disabled:a=!1,loading:o=!1})=>P`
  <button
    class=${Me("button",`button-${t}`,o&&"button-loading")}
    type=${r}
    data-action=${Le(i)}
  ...
  >
    <span class="button-content">
      ${o?P`<span class="button-spinner" aria-hidden="true"></span>`:n?P`
            <span
...
`,_e=({id:e,label:t,name:i,value:r="",placeholder:n,type:a="text",span:o="default",variant:s="default",autocomplete:c,inputmode:d,disabled:l=!1,dataField:h,dataFieldScope:u="card",error:m})=>{const p=Me("field","full"===o&&"field-full","card-form"===s&&"field-card-form",m&&"field-invalid"),f=Me("field-label","card-form"===s&&"field-label-card-form"),v=Me("field-input","card-form"===s&&"field-input-card-form"),b=P`
    <input
      class=${v}
      id=${e}
      name=${Le(i)}
      ...
      data-transfer-field=${Le("transfer"===u?h:void 0)}
  ...
  `},He=({id:e,label:t,name:i,value:r="",options:n,span:a="default",variant:o="default",disabled:s=!1,dataField:c,dataFieldScope:d="card",error:l})=>{const h=Me("field","card-form"!==o&&"field-with-select","full"===a&&"field-full","card-form"===o&&"field-card-form",l&&"field-invalid"),u=Me("field-label","card-form"===o&&"field-label-card-form"),m=Me("field-input","field-select","card-form"===o&&"field-input-card-form"),p=P`
    <select
      class=${m}
      id=${e}
      name=${Le(i)}
      ...
      data-transfer-field=${Le("transfer"===d?c:void 0)}
  ...
  `},We=({label:e,value:t="",length:i=6,disabled:r=!1,error:n=!1})=>{const a=Array.from({length:i},(e,i)=>t[i]??"");return P`
    <fieldset
  ...
  `},Ke=({variant:e,message:t})=>P`
  <div class="alert alert-${e}" role="alert">
    <span class="alert-message">${t}</span>
  </div>
`,Ye=({label:e,action:t,disabled:i=!1,loading:r=!1})=>P`
  <button
...
`,Ge=({title:e,message:t})=>P`
  <div class="empty-state">
    <p class="empty-state-title">${e}</p>
    <p class="empty-state-message">${t}</p>
  </div>
`,Je=({id:e,label:t,status:i,type:r,eyebrow:n,brand:a,accountLabel:o,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l,disabled:h=!1},{variant:u="default",deleteDisabled:m=!1,confirmingDelete:p=!1,selected:f=!1}={})=>{const v={id:e,label:t,status:i,type:r,eyebrow:n,brand:a,accountLabel:o,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l,disabled:h};if("edit"===u){const i={...v,showVerificationStatus:!1};return P`
      <div
  ...
  `},Ze=({id:e,label:t,status:i,type:r,eyebrow:n,brand:a,accountLabel:o,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l})=>{const h={label:t,status:i,type:r,brand:a,accountLabel:o,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l};return P`
  ...
  `},Qe=e=>"transfer"===e?P`
      ...
      `:P`<span class="source-action-icon" aria-hidden="true">+</span>`,Xe=({label:e,subtitle:t,action:i,icon:r,variant:n="card",disabled:a=!1})=>"link"===n?P`
        <button
      ...
      `,et=({count:e=3,label:t="Loading payment methods"}={})=>P`
...
`,tt=({containerId:e,title:t,loadingLabel:i,loading:r=!1})=>P`
  <div
...
`,it=({variant:e,title:t,message:i,content:r,actions:n})=>P`
...
`,rt=({label:e,action:t,disabled:i=!1})=>P`
  <button
...
`,nt=e=>P` <div class="form-grid">${e}</div> `,at=({title:e,subtitle:t,content:i,headerAction:r,width:n="default",ariaLabel:a="Commerce Hub Connect",closeAction:o="close",showClose:s=!0,showDivider:c=!1,showFooter:d=!0,busy:l=!1,overlay:h})=>P`
  <section
...
`;var ot=function(e,t,i,r){for(var n,a=arguments.length,o=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r,s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};const st="onSelect",ct="onAddPaymentMethod",dt="onVerifyPaymentMethod",lt="onDeletePaymentMethod",ht="onListPaymentMethods",ut="onTransfer",mt="onError",pt="commerce-hub-pbb-provider",ft="__new__",vt="OTP_VALIDATION_SUCCESS",bt=["ADD_ACCOUNT","SELECT","TRANSFER"],gt=[{value:"",label:"Select country or region"},{value:"US",label:"United States"}],yt=[{value:"",label:"Select state"},...[["AL","Alabama"],["AK","Alaska"],["AZ","Arizona"],["AR","Arkansas"],["CA","California"],["CO","Colorado"],["CT","Connecticut"],["DE","Delaware"],["FL","Florida"],["GA","Georgia"],["HI","Hawaii"],["ID","Idaho"],["IL","Illinois"],["IN","Indiana"],["IA","Iowa"],["KS","Kansas"],["KY","Kentucky"],["LA","Louisiana"],["ME","Maine"],["MD","Maryland"],["MA","Massachusetts"],["MI","Michigan"],["MN","Minnesota"],["MS","Mississippi"],["MO","Missouri"],["MT","Montana"],["NE","Nebraska"],["NV","Nevada"],["NH","New Hampshire"],["NJ","New Jersey"],["NM","New Mexico"],["NY","New York"],["NC","North Carolina"],["ND","North Dakota"],["OH","Ohio"],["OK","Oklahoma"],["OR","Oregon"],["PA","Pennsylvania"],["RI","Rhode Island"],["SC","South Carolina"],["SD","South Dakota"],["TN","Tennessee"],["TX","Texas"],["UT","Utah"],["VT","Vermont"],["VA","Virginia"],["WA","Washington"],["WV","West Virginia"],["WI","Wisconsin"],["WY","Wyoming"],["DC","District of Columbia"]].map(([e,t])=>({value:e,label:t}))],wt={apiKey:"YqIvg89urE1WsAdgWwM1EiQTRM1ajSYCaLhnDvimvmHeB78A",configId:"cce84049-0940-4926-9a54-9eaca0c09830",environment:"qa",locale:"en-US",paymentSdkUrl:"https://connect-qa.fiservapis.com/pbb/sdk/web/v2/js/PaymentSDK.js"},kt=[{id:"visa-1111",label:"James Anderson",type:"card",brand:"VISA",last4:"1111",status:"verified"},{id:"amex-8000",label:"James Anderson",type:"card",brand:"AMEX",last4:"8000",status:"not-verified"}];let $t=class extends ae{constructor(){super(...arguments),this.otpValue="",this.bankLinkLoading=!1,this.bankAccountDraft=St(),this.bankAccountDraftErrors={},this.bankAccountEncryption=At(),this.transferDraft=Ct(),this.transferDraftErrors={},this.transferSubmitSuccess=!1,this.transferFlowActive=!1,this.transferFlowScreen="form",this.cardDraft=xt(),this.cardDraftErrors={},this.cardEncryption=zt(),this.billingAddresses=[],this.billingAddressSelectorExpanded=!1,this.nativeAccountBalances={},this.nativeBalanceLoadingSourceIds=[],this.paymentSourceEditMode=!1,this.savedSourceVerificationFailed=!1,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.minimumVerificationOverlayToken=0,this.handleClick=e=>{const t=yr(e,"action"),i=yr(e,"paymentMethodId");if(t)if("attach-payment-source"!==t){if("change-payment-source"===t)return this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("retry-interaction-refresh"!==t){if("toggle-payment-source-edit-mode"===t)return this.clearDeletePaymentSourceConfirmation(),void(this.paymentSourceEditMode=!this.paymentSourceEditMode);if("verify-payment-source"!==t)if("delete-payment-source"!==t)if("cancel-delete-payment-source"!==t){if("done-payment-source-verification"===t)return this.resetSavedSourceVerification(),void this.showPaymentSourceList({refresh:!0});if("open-required-info-file-picker"===t)return this.pendingRequiredInfoDocKey=yr(e,"requiredInfoDocKey")??this.firstRequiredInfoDocKey(),void this.renderRoot.querySelector(".required-info-file-input")?.click();if("submit-required-info"!==t){if("open-transfer"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),this.resetTransferFlow(),void(this.transferFlowActive=!0);if("transfer"!==t)if("edit-transfer"!==t)if("confirm-transfer"!==t)if("verify-otp"!==t)if("resend-otp"!==t){if("add-bank-account"===t||"use-bank-account-instead"===t||"retry-bank-provider"===t||"back-to-bank-provider"===t||"use-different-bank-account"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),void this.startPayByBankFlow();if("add-ach-manually"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),void this.showManualBankAccountScreen();if("back-to-payment-methods"===t)return this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("continue-bank-outcome"===t||"done-bank-outcome"===t)return this.resetBankFlow(),void this.showPaymentSourceList({refresh:!0});if("add-card"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetRequiredInfo(),void this.showAddCardScreen();if("change-billing-address"!==t)if("save-card"!==t)if("save-ach-manual"!==t){if("edit-card-details"!==t)return"use-different-method"===t?(this.resetCardFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0})):void 0;this.cardFlowScreen="form"}else this.saveManualBankAccount();else this.saveCard();else this.billingAddressSelectorExpanded=!0}else this.resendOtp();else this.verifyOtp();else this.submitTransfer();else this.transferFlowScreen="form";else this.reviewTransfer()}else this.submitRequiredInfo()}else this.clearDeletePaymentSourceConfirmation();else i&&this.deletePaymentSource(i);else i&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.verifySavedPaymentSource(i))}else this.retryInteractionRefresh()}else i&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.selectedPaymentSourceId=i,this.paymentSourceView="selected",this.attachPaymentSource(i))},this.handleInput=e=>{const t=Tt(e);if(t)return void this.storeRequiredInfoSsnInput(t);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.cardField));if(i)return void this.updateCardDraftField(i.dataset.cardField,i.value);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.bankAccountField));if(r)return void this.updateBankAccountDraftField(r.dataset.bankAccountField,r.value);const n=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.transferField));if(n)return void this.updateTransferDraftField(n.dataset.transferField,n.value);const a=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoDocKey));if(a)return void this.storeRequiredInfoValue(a.dataset.requiredInfoDocKey,a.value);const o=e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input"));if(!o)return;const s=this.getOtpInputs(),c=Number(o.dataset.otpIndex),d=It(o.value);if(!d)return o.value="",void this.syncOtpValueFromInputs(s);if(1===d.length)return o.value=d,this.syncOtpValueFromInputs(s),void this.focusOtpInput(s,c+1);const l=this.writeOtpDigits(s,c,d);this.syncOtpValueFromInputs(s),this.focusOtpInput(s,Math.min(c+d.length,s.length-1),l)},this.handleKeyDown=e=>{const t=Nt(e);if(!t)return;const i=this.getOtpInputs(),r=Number(t.dataset.otpIndex);return"ArrowLeft"===e.key?(e.preventDefault(),void this.focusOtpInput(i,r-1)):"ArrowRight"===e.key?(e.preventDefault(),void this.focusOtpInput(i,r+1)):"Backspace"===e.key?(e.preventDefault(),t.value?t.value="":r>0&&(i[r-1].value=""),this.syncOtpValueFromInputs(i),void this.focusOtpInput(i,Math.max(r-1,0))):"Delete"===e.key?(e.preventDefault(),t.value="",void this.syncOtpValueFromInputs(i)):void(e.ctrlKey||e.metaKey||e.altKey||1!==e.key.length||/\d/.test(e.key)||e.preventDefault())},this.handleChange=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoFileInput));if(t)return this.storeRequiredInfoSelectedFile(t.files?.[0]),void(t.value="");const i=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.cardField));if(i)return void this.updateCardDraftField(i.dataset.cardField,i.value);const r=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.bankAccountField));if(r)return void this.updateBankAccountDraftField(r.dataset.bankAccountField,r.value);const n=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.transferField));n&&this.updateTransferDraftField(n.dataset.transferField,n.value)},this.handlePaste=e=>{const t=Tt(e);if(t)return void this.pasteRequiredInfoSsnInput(e,t);const i=Nt(e);if(!i)return;const r=e,n="function"==typeof r.clipboardData?.getData?r.clipboardData.getData("text"):"",a=It(n);if(!a)return;e.preventDefault();const o=this.getOtpInputs(),s=Number(i.dataset.otpIndex),c=this.writeOtpDigits(o,s,a);this.syncOtpValueFromInputs(o),this.focusOtpInput(o,Math.min(s+a.length,o.length-1),c)},this.handleFocusIn=e=>{const t=Nt(e);t&&t.value&&requestAnimationFrame(()=>{this.renderRoot.contains(t)&&t.select()})},this.handleFocusLost=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Rt(e.dataset.cardField));if(t)return void this.encryptCardField(t.dataset.cardField,t.value);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Dt(e.dataset.bankAccountField));i&&this.encryptBankAccountField(i.dataset.bankAccountField,i.value)}}willUpdate(e){if(e.has("interactionResponse")&&this.interactionResponse){const t=e.get("interactionResponse");t?.interactionId!==this.interactionResponse.interactionId&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceView=void 0,this.paymentSourceEditMode=!1,this.interactionSnapshotInteractionId=void 0,this.interactionRefreshInteractionId=void 0,this.interactionRefreshPromise=void 0,this.interactionRefreshErrorMessage=void 0,this.nativeBalanceFetchKey=void 0,this.nativeBalanceQueuedFetchKey=void 0,this.nativeAccountBalances={},this.nativeBalanceLoadingSourceIds=[],this.billingAddresses=[],this.resetTransferFlow(),this.resetSavedSourceVerification(),this.resetRequiredInfo()),this.interactionResponse.paymentSources?.length||this.interactionResponse.selectedSource||(this.paymentSourceEditMode=!1),this.syncBillingAddressesFromInteractionResponse(this.interactionResponse),this.selectedPaymentSourceId=dr(this.interactionResponse,this.selectedPaymentSourceId)}}updated(e){e.has("designConfig")&&this.syncDesignConfigStyles(),e.has("interactionResponse")&&this.deleteConfirmationPaymentSourceId&&!this.findPaymentSourceById(this.deleteConfirmationPaymentSourceId)&&this.clearDeletePaymentSourceConfirmation(),e.has("interactionResponse")&&this.refreshPaymentSourcesFromInteraction()}render(){return P`
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.clearDeletePaymentSourceConfirmation(),this.removePayByBankProviderContainer(),Xr()}emitSdkEvent(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t}))}renderWidgetShell({busy:e=!1,overlay:t,...i}){const r=Ir(this.minimumVerificationOverlayAction);return at({...i,busy:e||Boolean(r),overlay:t??r})}showMinimumVerificationOverlay(e){const t=this.minimumVerificationOverlayToken+=1;this.minimumVerificationOverlayAction=e,window.setTimeout(()=>{this.minimumVerificationOverlayToken===t&&(this.minimumVerificationOverlayAction=void 0)},2e3)}renderCurrentScreen(){if("provider"===this.bankFlowScreen)return this.renderBankProviderScreen();if("outcome"===this.bankFlowScreen)return this.renderBankOutcomeScreen();if("manual"===this.bankFlowScreen)return this.renderManualBankAccountScreen();if("form"===this.cardFlowScreen)return this.renderAddCardScreen();if("error"===this.cardFlowScreen)return this.renderCardErrorScreen();if(this.requiredInfoSource)return this.renderRequiredInfoScreen();if(this.savedSourceVerificationSource)return this.renderSavedSourceVerificationOutcomeScreen();const e=this.interactionResponse?.status;return"OTP_VALIDATION_PENDING"===e||"OTP_VALIDATION_FAILED"===e?this.renderOtpScreen(e):this.shouldRenderTransferScreen()?this.renderTransferScreen():this.renderPaymentSourceScreen()}renderOtpScreen(e){const t=Di(this.designConfig),i="OTP_VALIDATION_FAILED"===e,r="verify-otp"===this.pendingAction,n="resend-otp"===this.pendingAction,a=Ri(this.interactionResponse);return this.renderWidgetShell({title:t.title,subtitle:t.subtitle??Bi(a),showClose:!1,showDivider:!1,busy:r||n,overlay:r?Ar({title:"Verifying code",helper:"Verifying your code, please wait."}):n?Ar({title:"Sending code",helper:"Sending a new code, please wait."}):void 0,content:P`
        <div class="otp-flow">
          ${i?Ke({variant:"danger",message:this.otpErrorMessage??t.failedMessage}):""}
          ${We({label:"Verification code",value:this.otpValue,length:6,disabled:r,error:i})}
      ...
      `})}renderPaymentSourceScreen(){const e=Li(this.designConfig),t=Wi(this.interactionResponse,{nativeBalances:this.nativeAccountBalances,nativeBalanceLoadingSourceIds:this.nativeBalanceLoadingSourceIds}),i=Ki(this.interactionResponse),r=i.card||i.bankAccount,n=i.bankAccount&&mr(this.interactionResponse),a="attach-payment-source"===this.pendingAction||"verify-payment-source"===this.pendingAction||"delete-payment-source"===this.pendingAction,o=this.paymentSourceEditMode&&t.length>0;return this.shouldRenderPaymentSourceRefreshSkeleton()?this.renderWidgetShell({title:e.title,showClose:!1,content:P`
          <div class="payment-flow">
            ${et({count:3,label:"Loading payment methods"})}
          </div>
        `}):this.shouldRenderPaymentSourceRefreshError()?this.renderPaymentSourceRefreshErrorScreen():t.length?this.shouldRenderSelectedPaymentSourceScreen()?this.renderSelectedPaymentSourceScreen():(this.queueNativeAccountBalanceRefresh(),this.renderWidgetShell({title:e.title,headerAction:rt({label:o?"Done":"Edit",action:"toggle-payment-source-edit-mode",disabled:a}),showClose:!1,busy:a,overlay:Nr(this.pendingAction),content:P`
        <div class="payment-flow">
          <div class="primitive-stack" aria-label="Payment methods">
            ${t.map(e=>Je({...e,disabled:e.disabled||a},{variant:o?"edit":"default",deleteDisabled:a,confirmingDelete:e.id===this.deleteConfirmationPaymentSourceId,selected:e.id===this.selectedPaymentSourceId}))}
          </div>
          ${o?"":r?P`
                <div class="payment-action-links">
                  ${i.card?Xe({label:e.addCardTitle,action:"add-card",icon:"card",variant:"link",disabled:a}):""}
                  ${i.bankAccount?Xe({label:e.addBankAccountTitle,action:"add-bank-account",icon:"bank",variant:"link",disabled:a}):""}
                  ${n?Xe({label:"Transfer funds",action:"open-transfer",icon:"transfer",variant:"link",disabled:a}):""}
                </div>
              `:""}
        </div>
      `})):this.renderNoSavedPaymentMethods()}renderPaymentSourceRefreshErrorScreen(){return this.renderWidgetShell({title:"Payment methods unavailable",showClose:!1,content:P`
        <div class="payment-flow">
          ${Ke({variant:"danger",message:this.interactionRefreshErrorMessage??"We couldn't load payment methods. Try again."})}
          <div class="primitive-footer">
            ${Ue({label:"Try again",variant:"primary",action:"retry-interaction-refresh"})}
          </div>
        </div>
      `})}renderSelectedPaymentSourceScreen(){const e=lr(this.interactionResponse,this.selectedPaymentSourceId);return e?this.renderWidgetShell({title:"Payment method saved",headerAction:rt({label:"Change",action:"change-payment-source",disabled:"attach-payment-source"===this.pendingAction}),showClose:!1,showDivider:!1,busy:"attach-payment-source"===this.pendingAction,overlay:"attach-payment-source"===this.pendingAction?Ar({title:Kr(e)?"Saving bank account":"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,content:P`
        <div class="payment-flow">
          ${Ze(Yi(e,{selected:!0,nativeBalances:this.nativeAccountBalances,nativeBalanceLoadingSourceIds:this.nativeBalanceLoadingSourceIds}))}
        </div>
      `}):(this.paymentSourceView="list",this.renderPaymentSourceScreen())}shouldRenderSelectedPaymentSourceScreen(){return"list"!==this.paymentSourceView&&("PAYMENT_SOURCE_ATTACHED"===this.interactionResponse?.status||"selected"===this.paymentSourceView)}shouldRenderPaymentSourceRefreshSkeleton(){const e=this.interactionResponse,t=e?.interactionId;return!!t&&(!(!this.interactionRefreshPromise||this.interactionRefreshInteractionId!==t)||!this.interactionRefreshErrorMessage&&this.shouldRefreshPaymentSourcesFromInteraction())}shouldRenderPaymentSourceRefreshError(){const e=this.interactionResponse?.interactionId;return Boolean(e&&this.interactionRefreshErrorMessage&&this.interactionSnapshotInteractionId!==e)}renderSavedSourceVerificationOutcomeScreen(){const e=this.savedSourceVerificationSource,t=qr(e,this.savedSourceVerificationFailed),i="declined"===t.kind||"pending"===t.kind;return this.renderWidgetShell({title:t.title,headerAction:i?rt({label:"Back",action:"done-payment-source-verification"}):void 0,showClose:!1,showDivider:!1,content:P`
        <div class="verification-outcome-flow">
          ${Ke({variant:t.variant,message:t.message})}
          ${e?_r(e):""}
          ${i?"":P`
                <div class="primitive-footer">
      ...
      `})}renderRequiredInfoScreen(){const e=this.requiredInfoSource;if(!e)return this.renderPaymentSourceScreen();const t=Rr(e),i=Vr(t),r="submit-required-info"===this.pendingAction,n=this.canSubmitRequiredInfo();return this.renderWidgetShell({title:"Complete account verification",headerAction:rt({label:"Back",action:"back-to-payment-methods",disabled:r}),showClose:!1,showDivider:!1,busy:r,overlay:r?Ar({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,content:P`
        <div class="required-info-flow">
          ${_r(e)}
          ${this.requiredInfoSubmitError?Ke({variant:"danger",message:this.requiredInfoSubmitError}):""}
          ...
          <div class="required-info-documents">
            ...
            <div class="primitive-stack">
              ${t.map((e,t)=>{const i=Dr(e,t),n=Lr(e)?this.requiredInfoValues[i]:this.requiredInfoFileNames[i];return Lr(e)?Pr({doc:e,key:i,value:n??""}):P`
                  <div
                    class="required-info-document required-document-text-row"
                    data-required-info-doc-key=${i}
                    data-required-info-requirement=${Or(e)}
                  >
                    ...
                    ${(({label:e,requirements:t,actionLabel:i,fileName:r,action:n,error:a=!1,disabled:o=!1})=>P`
  <button
...
`)({label:"Required document",requirements:Ur(e),actionLabel:"Choose file",fileName:n,action:"open-required-info-file-picker",disabled:r})}
                  </div>
                `})}
            </div>
          </div>
      ...
      `})}renderNoSavedPaymentMethods(){const e=Mi(this.designConfig),t=Boolean(e.emptyTitle||e.emptyMessage),i="delete-payment-source"===this.pendingAction,r=Ki(this.interactionResponse),n=r.card||r.bankAccount,a=r.bankAccount&&mr(this.interactionResponse);return this.renderWidgetShell({title:e.title,subtitle:e.subtitle,showClose:!1,showDivider:!1,content:P`
        <div class="payment-flow">
          ${t?Ge({title:e.emptyTitle,message:e.emptyMessage}):""}
          ${n?P`
                <div class="payment-action-links">
                  ${r.card?Xe({label:e.addCardTitle,subtitle:e.addCardSubtitle,action:"add-card",icon:"card",variant:"link",disabled:i}):""}
                  ${r.bankAccount?Xe({label:e.addBankAccountTitle,subtitle:e.addBankAccountSubtitle,action:"add-bank-account",icon:"bank",variant:"link",disabled:i}):""}
                  ${a?Xe({label:"Transfer funds",action:"open-transfer",icon:"transfer",variant:"link",disabled:i}):""}
                </div>
              `:""}
        </div>
      `})}shouldRenderTransferScreen(){const e=this.interactionResponse;return(this.transferFlowActive||ur(e))&&hr(e?.status)}renderTransferScreen(){const e=rr(this.interactionResponse),t="transfer"===this.pendingAction,i=this.transferFlowActive?rt({label:"Back",action:"back-to-payment-methods",disabled:t}):void 0;if(e.length<2)return this.renderWidgetShell({title:"Transfer funds",headerAction:i,showClose:!1,showDivider:!1,content:P`
          <div class="payment-flow">
            ${Ge({title:"Transfer unavailable",message:"At least two verified bank or native accounts are required to transfer funds."})}
          </div>
        `});const r=[{value:"",label:"Select account"},...e.map(e=>({value:er(e),label:Gi(e)}))],n=ii(this.transferDraft),a=e.find(e=>er(e)===n.fromSourceId),o=e.find(e=>er(e)===n.toSourceId);return"confirm"===this.transferFlowScreen&&a&&o&&ni(n,e)?this.renderTransferConfirmationScreen(a,o,n,t):this.renderWidgetShell({title:"Transfer funds",headerAction:i,showClose:!1,showDivider:!1,busy:t,overlay:t?Ar({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:P`
        <div class="payment-flow card-form-screen">
          ${this.transferSubmitError?Ke({variant:"danger",message:this.transferSubmitError}):""}
          ${this.transferSubmitSuccess?Ke({variant:"success",message:"Transfer initiated."}):""}
          ${nt([He({id:"transfer-from-source",name:"fromSourceId",label:"From",value:this.transferDraft.fromSourceId,options:r,span:"full",variant:"card-form",dataField:"fromSourceId",dataFieldScope:"transfer",error:this.transferDraftErrors.fromSourceId,disabled:t}),He({id:"transfer-to-source",name:"toSourceId",label:"To",value:this.transferDraft.toSourceId,options:r,span:"full",variant:"card-form",dataField:"toSourceId",dataFieldScope:"transfer",error:this.transferDraftErrors.toSourceId,disabled:t}),_e({id:"transfer-amount",name:"amount",label:"Amount",value:this.transferDraft.amount,variant:"card-form",inputmode:"decimal",dataField:"amount",dataFieldScope:"transfer",error:this.transferDraftErrors.amount,disabled:t})])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ue({label:t?"Transferring":"Transfer",action:"transfer",loading:t,disabled:t||!ni(this.transferDraft,e)})}
            </div>
          </div>
        </div>
      `})}renderTransferConfirmationScreen(e,t,i,r){return this.renderWidgetShell({title:"Confirm transfer",headerAction:rt({label:"Back",action:"edit-transfer",disabled:r}),showClose:!1,showDivider:!1,busy:r,overlay:r?Ar({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:P`
        <div class="payment-flow card-form-screen">
          ${this.transferSubmitError?Ke({variant:"danger",message:this.transferSubmitError}):""}
          ${n=[{label:"From",value:Gi(e)},{label:"To",value:Gi(t)},{label:"Amount",value:ai(i)}],P`
...
`}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ue({label:r?"Transferring":"Confirm transfer",action:"confirm-transfer",loading:r,disabled:r})}
            </div>
            <div class="card-form-primary">
              ${Ue({label:"Edit",variant:"secondary",action:"edit-transfer",disabled:r})}
            </div>
          </div>
        </div>
      `});var n}renderAddCardScreen(){const e="save-card"===this.pendingAction,t="encrypting"===this.cardEncryption.cardNumber.status||"encrypting"===this.cardEncryption.cvv.status,i=[...this.billingAddresses.map(e=>({value:e.id??"",label:Si(e)})),{value:ft,label:"Add new billing address"}],r=this.billingAddresses.find(e=>e.id===this.cardDraft.billingAddressValue),n=Boolean(r)&&!this.billingAddressSelectorExpanded,a=!n&&this.cardDraft.billingAddressValue===ft,o=[];return r&&n?o.push(P`
        <div class="billing-address-summary field field-full">
          <div class="billing-address-summary-heading">
            ...
            >
            ${rt({label:"Change",action:"change-billing-address",disabled:e})}
          </div>
          <p class="billing-address-summary-value">
            ${Si(r)}
          </p>
        </div>
      `):o.push(He({id:"billing-address",name:"billingAddress",label:"Billing address",value:this.cardDraft.billingAddressValue,options:i,span:"full",variant:"card-form",dataField:"billingAddressValue",error:this.cardDraftErrors.billingAddressValue,disabled:e})),a&&o.push(He({id:"billing-country",name:"country",label:"Country or region",value:this.cardDraft.country,options:gt,span:"full",variant:"card-form",dataField:"country",error:this.cardDraftErrors.country,disabled:e}),_e({id:"billing-address-line-1",name:"addressLine1",label:"Address",value:this.cardDraft.addressLine1,placeholder:"Street address",span:"full",variant:"card-form",autocomplete:"address-line1",dataField:"addressLine1",error:this.cardDraftErrors.addressLine1,disabled:e}),_e({id:"billing-address-line-2",name:"addressLine2",label:"Address line 2",value:this.cardDraft.addressLine2,placeholder:"Apartment, suite, unit",span:"full",variant:"card-form",autocomplete:"address-line2",dataField:"addressLine2",error:this.cardDraftErrors.addressLine2,disabled:e}),_e({id:"billing-city",name:"city",label:"City",value:this.cardDraft.city,span:"full",variant:"card-form",autocomplete:"address-level2",dataField:"city",error:this.cardDraftErrors.city,disabled:e}),He({id:"billing-state",name:"state",label:"State",value:this.cardDraft.state,options:yt,span:"full",variant:"card-form",dataField:"state",error:this.cardDraftErrors.state,disabled:e}),_e({id:"billing-zip",name:"zip",label:"ZIP code",value:this.cardDraft.zip,placeholder:"ZIP code",span:"full",variant:"card-form",autocomplete:"postal-code",inputmode:"numeric",dataField:"zip",error:this.cardDraftErrors.zip,disabled:e})),this.renderWidgetShell({title:"Add card",headerAction:rt({label:"Back",action:"back-to-payment-methods",disabled:e}),showClose:!1,showDivider:!1,busy:e,overlay:e?Ar({title:"Saving card",helper:"Securely saving your card, please wait."}):void 0,content:P`
        <div class="payment-flow card-form-screen">
          ${this.cardSubmitError?Ke({variant:"danger",message:this.cardSubmitError}):""}
          ${nt([_e({id:"card-label",name:"name",label:"Card Name",value:this.cardDraft.name,placeholder:"Corporate card",span:"full",variant:"card-form",dataField:"name",error:this.cardDraftErrors.name,disabled:e}),_e({id:"card-number",name:"cardNumber",label:"Card number",value:this.cardDraft.cardNumber,placeholder:"1234 1234 1234 1234",span:"full",variant:"card-form",autocomplete:"cc-number",inputmode:"numeric",dataField:"cardNumber",error:this.cardDraftErrors.cardNumber,disabled:e}),_e({id:"expiration-date",name:"expirationDate",label:"Expiration",value:this.cardDraft.expirationDate,placeholder:"MM / YY",variant:"card-form",autocomplete:"cc-exp",inputmode:"numeric",dataField:"expirationDate",error:this.cardDraftErrors.expirationDate,disabled:e}),_e({id:"card-cvv",name:"cvv",label:"CVC",value:this.cardDraft.cvv,placeholder:"3 or 4 digits",variant:"card-form",autocomplete:"cc-csc",inputmode:"numeric",dataField:"cvv",error:this.cardDraftErrors.cvv,disabled:e}),_e({id:"name-on-card",name:"fullName",label:"Full name",value:this.cardDraft.fullName,placeholder:"Name on card",span:"full",variant:"card-form",autocomplete:"cc-name",dataField:"fullName",error:this.cardDraftErrors.fullName,disabled:e}),...o])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ue({label:e?"Saving payment method":"Save card",action:"save-card",loading:e,disabled:e||t||!si(this.cardDraft,this.cardEncryption)})}
            </div>
          </div>
        </div>
      `})}renderCardErrorScreen(){return this.renderWidgetShell({title:"Credit card not saved",subtitle:"We could not save this card. Check the card details or use a different payment method.",showClose:!1,showDivider:!1,content:it({variant:"danger",content:this.cardSubmitError?Ke({variant:"danger",message:this.cardSubmitError}):void 0,actions:P`
          ${Ue({label:"Edit card details",action:"edit-card-details"})}
          ${rt({label:"Use a different method",action:"use-different-method"})}
        `})})}renderBankProviderScreen(){return this.renderWidgetShell({title:"Connect your bank",headerAction:rt({label:"Back",action:"back-to-payment-methods",disabled:this.bankLinkLoading}),showClose:!1,showDivider:!1,busy:this.bankLinkLoading,overlay:this.bankLinkLoading?Ar({title:"Connecting to your bank",helper:"Securely opening your bank connection, please wait."}):void 0,content:P`
        <div class="bank-provider-flow">
          ${tt({containerId:pt,loading:this.bankLinkLoading,loadingLabel:"Connecting to your bank"})}
          <div class="bank-provider-manual-link">
            ${rt({label:"Connect another way",action:"add-ach-manually",disabled:this.bankLinkLoading})}
          </div>
        </div>
      `})}renderManualBankAccountScreen(){const e="save-ach-manual"===this.pendingAction,t="encrypting"===this.bankAccountEncryption.routingNumber.status||"encrypting"===this.bankAccountEncryption.accountNumber.status||"encrypting"===this.bankAccountEncryption.accountNumberReEntered.status;return this.renderWidgetShell({title:"Enter bank details",headerAction:rt({label:"Back",action:"back-to-bank-provider",disabled:e}),showClose:!1,showDivider:!1,busy:e,overlay:e?Ar({title:"Saving bank account",helper:"Securely saving your bank account, please wait."}):void 0,content:P`
        <div class="payment-flow card-form-screen">
          ${this.bankAccountSubmitError?Ke({variant:"danger",message:this.bankAccountSubmitError}):""}
          ${nt([_e({id:"ach-account-nickname",name:"name",label:"Account Nickname",value:this.bankAccountDraft.name,span:"full",variant:"card-form",autocomplete:"off",dataField:"name",dataFieldScope:"bankAccount",disabled:e}),_e({id:"ach-routing-number",name:"routingNumber",label:"Routing number",value:this.bankAccountDraft.routingNumber,span:"full",variant:"card-form",autocomplete:"off",inputmode:"numeric",dataField:"routingNumber",dataFieldScope:"bankAccount",error:this.bankAccountDraftErrors.routingNumber,disabled:e}),_e({id:"ach-account-number",name:"accountNumber",label:"Account number",value:this.bankAccountDraft.accountNumber,type:Yt("accountNumber",this.bankAccountDraft,this.bankAccountEncryption),span:"full",variant:"card-form",autocomplete:"off",inputmode:"numeric",dataField:"accountNumber",dataFieldScope:"bankAccount",error:this.bankAccountDraftErrors.accountNumber,disabled:e}),_e({id:"ach-account-number-confirm",name:"accountNumberReEntered",label:"Confirm account number",value:this.bankAccountDraft.accountNumberReEntered,type:Yt("accountNumberReEntered",this.bankAccountDraft,this.bankAccountEncryption),span:"full",variant:"card-form",autocomplete:"off",inputmode:"numeric",dataField:"accountNumberReEntered",dataFieldScope:"bankAccount",error:this.bankAccountDraftErrors.accountNumberReEntered,disabled:e})])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ue({label:e?"Saving bank account":"Save bank account",action:"save-ach-manual",loading:e,disabled:e||t||!ti(this.bankAccountDraft,this.bankAccountEncryption)})}
            </div>
          </div>
        </div>
      `})}renderBankOutcomeScreen(){const e=Tr(this.bankOutcomeSource),t="declined"===e.kind||"pending"===e.kind;return this.renderWidgetShell({title:e.title,headerAction:t?rt({label:"Done",action:"done-bank-outcome"}):void 0,showClose:!1,showDivider:!1,content:P`
        <div class="verification-outcome-flow">
          ${Ke({variant:e.variant,message:e.message})}
          ${this.bankOutcomeSource?_r(this.bankOutcomeSource):""}
          ${t?"":P`
                <div class="primitive-footer">
                  ${"verified"===e.kind?Ue({label:"Continue",action:"continue-bank-outcome"}):"pending"===e.kind?Ue({label:"Done",action:"done-bank-outcome"}):P`
                        ...
                        ${rt({label:"Use a different account",action:"use-different-bank-account",disabled:this.bankLinkLoading})}
                      `}
                </div>
              `}
        </div>
      `})}getOtpInputs(){return[...this.renderRoot.querySelectorAll(".otp-input")]}getRequiredInfoSsnInputs(e){return[...this.renderRoot.querySelectorAll(".required-info-ssn-input")].filter(t=>t.dataset.requiredInfoDocKey===e)}storeRequiredInfoSsnInput(e){const t=e.dataset.requiredInfoDocKey;if(!t)return;const i=this.getRequiredInfoSsnInputs(t),r=i.indexOf(e),n=Bt(e),a=qt(e.value);if(!(r<0)){if(a.length>n){const e=this.writeRequiredInfoSsnDigits(i,r,a);return this.syncRequiredInfoSsnValue(t,i),void this.focusRequiredInfoSsnInput(i,e)}e.value=a.slice(0,n),this.syncRequiredInfoSsnValue(t,i),e.value.length>=n&&this.focusRequiredInfoSsnInput(i,r+1)}}pasteRequiredInfoSsnInput(e,t){const i=t.dataset.requiredInfoDocKey;if(!i)return;const r=e,n="function"==typeof r.clipboardData?.getData?r.clipboardData.getData("text"):"",a=qt(n);if(!a)return;e.preventDefault();const o=this.getRequiredInfoSsnInputs(i),s=o.indexOf(t);if(s<0)return;const c=this.writeRequiredInfoSsnDigits(o,s,a);this.syncRequiredInfoSsnValue(i,o),this.focusRequiredInfoSsnInput(o,c)}writeRequiredInfoSsnDigits(e,t,i){let r=0,n=t;return e.forEach((e,a)=>{if(a<t)return;const o=Bt(e),s=i.slice(r,r+o);e.value=s,s&&(n=a),r+=o}),n}syncRequiredInfoSsnValue(e,t){this.storeRequiredInfoValue(e,qt(t.map(e=>e.value).join("")))}focusRequiredInfoSsnInput(e,t){e[Math.min(t,e.length-1)]?.focus()}syncOtpValueFromInputs(e=this.getOtpInputs()){this.otpValue=e.map(e=>e.value).join("").slice(0,6),this.otpErrorMessage=void 0}writeOtpDigits(e,t,i){const r=It(i);let n=t;return r.slice(0,Math.max(e.length-t,0)).split("").forEach((i,r)=>{const a=t+r,o=e[a];o&&(o.value=i,n=a)}),n}focusOtpInput(e,t,i=t){const r=e[t]??e[Math.max(0,Math.min(i,e.length-1))];r&&r.focus()}async showAddCardScreen(){this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow(),this.cardFlowScreen="form",this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===ft||!this.billingAddresses.length;const e=this.interactionResponse?.interactionId,t=Boolean(this.interactionResponse?.selectedSource||this.interactionResponse?.paymentSources?.length);if(e&&t&&!this.billingAddresses.length&&void 0===this.interactionResponse?.billerAddress)try{await this.fetchInteraction(e)}catch(e){}}showManualBankAccountScreen(){this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow(),this.bankFlowScreen="manual",this.bankAccountDraft=St(),this.bankAccountDraftErrors={},this.bankAccountEncryption=At(),this.bankAccountSubmitError=void 0}updateTransferDraftField(e,t){const i=ii({...this.transferDraft,[e]:t});this.transferDraft=i,this.transferDraftErrors=ri(i,rr(this.interactionResponse)),this.transferFlowScreen="form",this.transferSubmitError=void 0,this.transferSubmitSuccess=!1}updateBankAccountDraftField(e,t){if(Dt(e)&&Wt(t,this.bankAccountEncryption[e])){const i={...this.bankAccountDraft,[e]:t};return this.bankAccountDraft=i,this.bankAccountDraftErrors=ei(Jt(i,this.bankAccountEncryption)),void(this.bankAccountSubmitError=void 0)}const i=Gt(e,t),r={...this.bankAccountDraft,[e]:i};let n=this.bankAccountEncryption;if(Dt(e)){if(Wt(i,this.bankAccountEncryption[e]))return;n={...this.bankAccountEncryption,[e]:hi(this.bankAccountEncryption[e],Ht(i))}}this.bankAccountDraft=r,this.bankAccountEncryption=n,this.bankAccountDraftErrors=ei(Jt(r,n)),this.bankAccountSubmitError=void 0}updateCardDraftField(e,t){const i=Mt(e,t);this.cardDraft={...this.cardDraft,[e]:i},"billingAddressValue"===e&&(this.billingAddressSelectorExpanded=i===ft),this.cardSubmitError=void 0,Rt(e)&&(this.cardEncryption={...this.cardEncryption,[e]:hi(this.cardEncryption[e],Ut(e,i))})}async encryptCardField(e,t){this.updateCardDraftField(e,t);const i=Ut(e,t),r=ci(e,t);if(!i)return this.cardDraftErrors=ui(this.cardDraftErrors,e),void(this.cardEncryption={...this.cardEncryption,[e]:Et()});if(r)return this.cardDraftErrors={...ui(this.cardDraftErrors,e),[e]:r},void(this.cardEncryption={...this.cardEncryption,[e]:hi(this.cardEncryption[e],i)});const n=this.cardEncryption[e];if("encrypting"!==n.status&&"encrypted"!==n.status||n.normalizedValue!==i){this.cardDraftErrors=ui(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypting",normalizedValue:i}};try{const t=await this.maskSensitiveCardValue(e,i);if(Ut(e,this.cardDraft[e])!==i)return;this.cardDraftErrors=ui(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypted",normalizedValue:i,encryptedValue:t}}}catch(t){if(Ut(e,this.cardDraft[e])!==i)return;this.cardDraftErrors={...ui(this.cardDraftErrors,e),[e]:di(e)},this.cardEncryption={...this.cardEncryption,[e]:{status:"failed",normalizedValue:i}}}}}async encryptBankAccountField(e,t){const i=this.bankAccountEncryption[e];if(Wt(t,i))return this.bankAccountDraft={...this.bankAccountDraft,[e]:t},void(this.bankAccountSubmitError=void 0);this.updateBankAccountDraftField(e,t);const r=Ht(t);if(!r){const t={...this.bankAccountEncryption,[e]:Et()};return this.bankAccountEncryption=t,void(this.bankAccountDraftErrors=ei(Jt(this.bankAccountDraft,t)))}if("encrypting"!==i.status&&"encrypted"!==i.status||i.normalizedValue!==r){this.bankAccountDraftErrors=mi(this.bankAccountDraftErrors,e),this.bankAccountEncryption={...this.bankAccountEncryption,[e]:{status:"encrypting",normalizedValue:r}};try{const t=await this.maskSensitiveBankAccountValue(e,r);if(Ht(this.bankAccountDraft[e])!==r)return;const i={...this.bankAccountDraft,[e]:Kt(r)},n={...this.bankAccountEncryption,[e]:{status:"encrypted",normalizedValue:r,encryptedValue:t}};this.bankAccountDraft=i,this.bankAccountEncryption=n,this.bankAccountDraftErrors=ei(Jt(i,n))}catch(t){if(Ht(this.bankAccountDraft[e])!==r)return;const i={...this.bankAccountEncryption,[e]:{status:"failed",normalizedValue:r}};this.bankAccountEncryption=i,this.bankAccountDraftErrors={...ei(Jt(this.bankAccountDraft,i)),[e]:li(e)}}}}async maskSensitiveCardValue(e,t){const i=this.requireInteractionId();if(!i)throw new Error("An interaction id is required to encrypt card details.");const r="cardNumber"===e?"card":"cvv",n=await this.requestCommerceHubJson(`/interaction/source/mask/${r}`,i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t}),credentials:"include"}),a=n.value?.trim();if(!a)throw new Error("The card encryption response did not include a value.");return a}async maskSensitiveBankAccountValue(e,t){const i=this.requireInteractionId();if(!i)throw new Error("An interaction id is required to encrypt ACH details.");const r="routingNumber"===e?"rt":"bn",n=await this.requestCommerceHubJson(`/interaction/source/mask/${r}`,i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t}),credentials:"include"}),a=n.value?.trim();if(!a)throw new Error("The ACH encryption response did not include a value.");return a}async saveCard(){if("save-card"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=_t(this.cardDraft),i={...oi(t),...pi(t,this.cardEncryption)};if(Object.keys(i).length>0)return this.cardDraft=t,this.cardDraftErrors=i,void(this.cardSubmitError=void 0);this.pendingAction="save-card",this.cardDraft=t,this.cardDraftErrors={},this.cardSubmitError=void 0;try{const i=fi("cardNumber",t.cardNumber,this.cardEncryption),r=fi("cvv",t.cvv,this.cardEncryption),n=ki(t.expirationDate);if(!n)return void(this.cardDraftErrors={expirationDate:"Enter a valid expiration date."});const a=await this.resolveBillingAddressId(e,t),o={id:"",tenderType:"CARD",name:t.name,billingAddressId:a,card:{nameOnCard:t.fullName,cardNumber:i,cvv:r,cardNumberEncrypted:i,cvvEncrypted:r,expirationMonth:n.month,expirationYear:n.year,network:$i(t.cardNumber)}},s=await this.requestCommerceHubJson("/interaction/source/card",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(o),credentials:"include"}),c=this.sourceWithVerificationResponse(Ai(o,t.cardNumber),s),d=Ti(s,"The card creation response did not include a source id."),l=this.interactionResponseWithAddedSource(e,c);if(this.cardFlowScreen=void 0,this.cardDraft=xt(),this.cardDraftErrors={},this.cardEncryption=zt(),this.cardSubmitError=void 0,this.setInteractionResponseFromSdk(l),this.emitSdkEvent(ct,c),"VERIFIED"===c.verificationInfo?.status)return void await this.attachPaymentSource(d);this.showAddedPaymentSourceStatus(c)}catch(e){this.cardSubmitError=gr(e),this.cardFlowScreen="error"}finally{this.pendingAction=void 0}}async saveManualBankAccount(){if("save-ach-manual"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=Jt(this.bankAccountDraft,this.bankAccountEncryption),i=ei(t);if(Object.keys(i).length>0)return this.bankAccountDraft=Qt(this.bankAccountDraft,this.bankAccountEncryption),this.bankAccountDraftErrors=i,void(this.bankAccountSubmitError=void 0);this.pendingAction="save-ach-manual",this.bankAccountDraft=Qt(this.bankAccountDraft,this.bankAccountEncryption),this.bankAccountDraftErrors={},this.bankAccountSubmitError=void 0;try{await this.encryptChangedBankAccountFields();const t=Jt(this.bankAccountDraft,this.bankAccountEncryption),i=ei(t);if(Object.keys(i).length>0)return this.bankAccountDraftErrors=i,void(this.bankAccountSubmitError=void 0);const r=vi("routingNumber",this.bankAccountDraft,this.bankAccountEncryption),n=vi("accountNumber",this.bankAccountDraft,this.bankAccountEncryption),a=vi("accountNumberReEntered",this.bankAccountDraft,this.bankAccountEncryption),o=bi("accountNumber",this.bankAccountEncryption,t),s={id:"",tenderType:"BANK_ACCOUNT",name:gi(this.bankAccountDraft.name,o),bankAccount:{routingNumber:r,accountNumber:n,accountNumberReEntered:a,routingNumberEncrypted:r,accountNumberEncrypted:n}},c=await this.requestCommerceHubJson("/interaction/source/ach",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s),credentials:"include"}),d=this.sourceWithVerificationResponse(Ii(s,o),c),l=Ti(c,"The bank account creation response did not include a source id."),h=this.interactionResponseWithAddedSource(e,d);if(this.bankFlowScreen=void 0,this.bankAccountDraft=St(),this.bankAccountDraftErrors={},this.bankAccountEncryption=At(),this.bankAccountSubmitError=void 0,this.setInteractionResponseFromSdk(h),this.emitSdkEvent(ct,d),"VERIFIED"===d.verificationInfo?.status)return void await this.attachPaymentSource(l);this.showAddedPaymentSourceStatus(d)}catch(e){this.bankAccountSubmitError=gr(e)}finally{this.pendingAction=void 0}}reviewTransfer(){if("transfer"===this.pendingAction)return;const e=rr(this.interactionResponse),t=ii(this.transferDraft),i=ri(t,e);if(Object.keys(i).length>0)return this.transferDraft=t,this.transferDraftErrors=i,this.transferSubmitError=void 0,void(this.transferSubmitSuccess=!1);this.transferDraft=t,this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1,this.transferFlowScreen="confirm"}async submitTransfer(){if("transfer"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=rr(this.interactionResponse),i=ii(this.transferDraft),r=ri(i,t);if(Object.keys(r).length>0)return this.transferDraft=i,this.transferDraftErrors=r,this.transferFlowScreen="form",this.transferSubmitError=void 0,void(this.transferSubmitSuccess=!1);this.pendingAction="transfer",this.transferDraft=i,this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1;try{const t=await this.requestCommerceHubJson("/interaction/source/native/transfer",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({fromSourceId:i.fromSourceId,toSourceId:i.toSourceId,amount:Number(i.amount),asset:{type:"CURRENCY",id:"USD"}}),credentials:"include"});this.transferFlowScreen="form",this.transferSubmitSuccess=!0,this.emitSdkEvent(ut,t)}catch(e){this.transferSubmitError=gr(e)}finally{this.pendingAction=void 0}}async encryptChangedBankAccountFields(){for(const e of["routingNumber","accountNumber","accountNumberReEntered"]){const t=this.bankAccountDraft[e],i=this.bankAccountEncryption[e];if(Wt(t,i))continue;const r=Ht(t);if(!r)continue;"encrypted"===i.status&&i.normalizedValue===r&&Boolean(i.encryptedValue)||await this.encryptBankAccountField(e,t)}}async resolveBillingAddressId(e,t){if(t.billingAddressValue!==ft)return t.billingAddressValue;const i=Ci(t),r=await this.requestCommerceHubJson("/interaction/billing-address",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i),credentials:"include"}),n=r.value?.trim();if(!n)throw new Error("The billing address response did not include an id.");return n}async verifyOtp(){if("verify-otp"===this.pendingAction)return;if(this.otpValue.length<6)return;const e=this.requireInteractionId();if(e){this.pendingAction="verify-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/validate",{body:{otp:this.otpValue,channel:"EMAIL"}}),i=br(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(i)}catch(e){this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk({...this.interactionResponse,status:"OTP_VALIDATION_FAILED"})}finally{this.pendingAction=void 0}}}async resendOtp(){if("resend-otp"===this.pendingAction)return;const e=this.requireInteractionId();if(e){this.pendingAction="resend-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/send/email"),i=br(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(i)}catch(e){}finally{this.pendingAction=void 0}}}async attachPaymentSource(e){if("attach-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),i=this.findPaymentSourceById(e);if(t&&i&&"VERIFIED"===i.verificationInfo?.status){this.selectedPaymentSourceId=e,this.paymentSourceView="selected",this.pendingAction="attach-payment-source";try{const r=await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}/attach`,t,{method:"POST",credentials:"include"}),n=fr(this.interactionResponse??{interactionId:t},r,e),a=lr(n,e)??n.paymentSources?.find(t=>t.id===e)??i;this.selectedPaymentSourceId=a.id,this.setInteractionResponseFromSdk(n),this.paymentSourceView="selected",this.dispatchEvent(new CustomEvent(st,{detail:a}))}catch(e){}finally{this.pendingAction=void 0}}}async verifySavedPaymentSource(e){if("verify-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),i=this.findPaymentSourceById(e);if(t&&i){if(Hr(i))return this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(i);if("NOT_VERIFIED"===i.verificationInfo?.status){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",this.pendingAction="verify-payment-source";try{const r=await this.verifyPaymentSourceStep1(t,{...i,id:e}),n=Cr({...this.interactionResponse??{interactionId:t},selectedSource:this.interactionResponse?.selectedSource,status:vt},r);if(this.setInteractionResponseFromSdk(n),this.emitSdkEvent(dt,r),Hr(r))return void this.showRequiredInfoSource(r);if("VERIFIED"===r.verificationInfo?.status){const t=r.id?.trim()||e;return this.pendingAction=void 0,void await this.attachPaymentSource(t)}this.savedSourceVerificationSource=r,this.savedSourceVerificationFailed=!1}catch(e){this.savedSourceVerificationSource=i,this.savedSourceVerificationFailed=!0}finally{"verify-payment-source"===this.pendingAction&&(this.pendingAction=void 0)}}}}async deletePaymentSource(e){if("delete-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),i=this.findPaymentSourceById(e);if(t&&i)if(this.deleteConfirmationPaymentSourceId===e){this.clearDeletePaymentSourceConfirmation(),this.pendingAction="delete-payment-source";try{await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}`,t,{method:"DELETE",credentials:"include"});const i=vr(this.interactionResponse??{interactionId:t},e);i.paymentSources?.length||(this.paymentSourceEditMode=!1),this.setInteractionResponseFromSdk(i),this.emitSdkEvent(lt,e)}catch(e){}finally{this.pendingAction=void 0}}else this.armDeletePaymentSourceConfirmation(e)}armDeletePaymentSourceConfirmation(e){this.clearDeletePaymentSourceConfirmation(),this.deleteConfirmationPaymentSourceId=e,this.deleteConfirmationTimeoutId=window.setTimeout(()=>{this.deleteConfirmationPaymentSourceId===e&&this.clearDeletePaymentSourceConfirmation()},5e3)}clearDeletePaymentSourceConfirmation(){void 0!==this.deleteConfirmationTimeoutId&&(window.clearTimeout(this.deleteConfirmationTimeoutId),this.deleteConfirmationTimeoutId=void 0),this.deleteConfirmationPaymentSourceId=void 0}findPaymentSourceById(e){return(this.interactionResponse?.paymentSources??[]).find(t=>t.id===e)??(this.interactionResponse?.selectedSource?.id===e?this.interactionResponse.selectedSource:void 0)}resetSavedSourceVerification(){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1}showPaymentSourceList({refresh:e=!1}={}){this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetTransferFlow(),e&&this.refreshPaymentSourcesForList()}async refreshPaymentSourcesForList(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}interactionResponseWithAddedSource(e,t){const i=t.id?.trim(),r=Boolean(i)&&zr(t),n={...this.interactionResponse??{interactionId:e},status:vt};return r?Sr(n,t):Cr({...n,selectedSource:this.interactionResponse?.selectedSource},t)}showAddedPaymentSourceStatus(e){const t=e.id?.trim();return this.resetSavedSourceVerification(),this.resetRequiredInfo(),Hr(e)?(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(e)):"VERIFIED"===e.verificationInfo?.status?(this.selectedPaymentSourceId=t,void(this.paymentSourceView="selected")):(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",Kr(e)?(this.bankOutcomeSource=e,void(this.bankFlowScreen="outcome")):(this.savedSourceVerificationSource=e,void(this.savedSourceVerificationFailed=!1)))}showRequiredInfoSource(e){this.requiredInfoSource=e,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}resetRequiredInfo(){this.requiredInfoSource=void 0,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}firstRequiredInfoDocKey(){return Vr(Rr(this.requiredInfoSource))??Dr(Rr(this.requiredInfoSource)[0],0)}storeRequiredInfoValue(e,t){this.requiredInfoValues={...this.requiredInfoValues,[e]:t},this.requiredInfoSubmitError=void 0}storeRequiredInfoSelectedFile(e){if(!this.requiredInfoSource||!e)return void(this.pendingRequiredInfoDocKey=void 0);const t=this.pendingRequiredInfoDocKey??this.firstRequiredInfoDocKey();this.requiredInfoFiles={...this.requiredInfoFiles,[t]:e},this.requiredInfoFileNames={...this.requiredInfoFileNames,[t]:e.name},this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}canSubmitRequiredInfo(){const e=this.requiredInfoSource;return!!e?.id?.trim()&&Rr(e).some((e,t)=>{const i=Dr(e,t);return Lr(e)?Boolean(this.requiredInfoValues[i]?.trim()):Boolean(this.requiredInfoFiles[i])})}async submitRequiredInfo(){if("submit-required-info"===this.pendingAction)return;const e=this.requireInteractionId(),t=this.requiredInfoSource,i=t?.id?.trim();if(e&&t&&i)if(this.canSubmitRequiredInfo()){this.pendingAction="submit-required-info",this.requiredInfoSubmitError=void 0;try{const r=Rr(t),n=this.providedRequiredInfoEntries(r,!0),a=this.providedRequiredInfoEntries(r,!1);let o=t;n.length>0?(await this.uploadRequiredInfoEntries(e,i,n),o=this.sourceWithVerificationResponse(o,await this.verifyRequiredInfoStep2(e,i)),this.emitSdkEvent(dt,o),Hr(o)&&a.length>0&&(await this.uploadRequiredInfoEntries(e,i,a),o=this.sourceWithVerificationResponse(o,await this.verifyRequiredInfoStep2(e,i)),this.emitSdkEvent(dt,o))):(await this.uploadRequiredInfoEntries(e,i,a),o=this.sourceWithVerificationResponse(o,await this.verifyRequiredInfoStep2(e,i)),this.emitSdkEvent(dt,o));const s=Cr({...this.interactionResponse??{interactionId:e},selectedSource:this.interactionResponse?.selectedSource,status:vt},o);if(this.setInteractionResponseFromSdk(s),"VERIFIED"===o.verificationInfo?.status){const e=o.id?.trim()||i;return this.resetRequiredInfo(),this.pendingAction=void 0,void await this.attachPaymentSource(e)}if(Hr(o))return this.requiredInfoSource=o,this.requiredInfoValues={},this.requiredInfoFileNames={},void(this.requiredInfoFiles={});this.resetRequiredInfo(),this.savedSourceVerificationSource=o,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=o.id,this.paymentSourceView="list"}catch(e){this.requiredInfoSubmitError=gr(e)||"We could not submit the required information. Please try again."}finally{"submit-required-info"===this.pendingAction&&(this.pendingAction=void 0)}}else this.requiredInfoSubmitError="Add required or optional information before verifying."}providedRequiredInfoEntries(e,t){return e.map((e,t)=>({doc:e,index:t})).filter(({doc:e,index:i})=>(t?!0===e.mandatory:!0!==e.mandatory)&&this.hasRequiredInfoValue(e,i))}hasRequiredInfoValue(e,t){const i=Dr(e,t);return Lr(e)?Boolean(this.requiredInfoValues[i]?.trim()):Boolean(this.requiredInfoFiles[i])}async uploadRequiredInfoEntries(e,t,i){for(const{doc:r,index:n}of i){const i=r.docType;if(!i)continue;const a=Dr(r,n);if(Lr(r)){const r=this.requiredInfoValues[a]?.trim();r&&await this.uploadRequiredInfoField(e,t,i,r);continue}const o=this.requiredInfoFiles[a];o&&await this.uploadRequiredInfoDocument(e,t,i,o)}}async verifyRequiredInfoStep2(e,t){return this.showMinimumVerificationOverlay("submit-required-info"),this.requestCommerceHubJson("/interaction/verify/step2",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t}),credentials:"include"})}sourceWithVerificationResponse(e,t){const{sourceId:i,...r}=t,n=i?.trim();return{...e,id:n||e.id,verificationInfo:{...e.verificationInfo,...r}}}async uploadRequiredInfoField(e,t,i,r){await this.requestCommerceHubJson("/interaction/verify/uploadField",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({docType:i,value:t,docValue:r}),credentials:"include"})}async uploadRequiredInfoDocument(e,t,i,r){const n=new FormData;n.set("file",r),await this.requestCommerceHubJson(`/interaction/doc/upload/${encodeURIComponent(t)}/${encodeURIComponent(i)}`,e,{method:"POST",body:n,credentials:"include"})}async startPayByBankFlow(){if(this.bankLinkLoading)return;const e=this.requireInteractionId();if(e){this.bankFlowScreen="provider",this.bankOutcomeSource=void 0,this.bankLinkLoading=!0,this.ensurePayByBankProviderContainer(pt),await this.updateComplete;try{await this.launchPayByBankProvider(e,pt)}catch(e){console.error("CommerceHub Connect Pay by Bank failed",e),this.resetBankFlow(),this.showPaymentSourceList({refresh:!0})}finally{this.bankLinkLoading=!1}}}async launchPayByBankProvider(e,t){const i=await this.requestCommerceHubJson("/interaction/source/pbb/session",e,{method:"GET",credentials:"include"}),{aggregatorSessionId:r,accessToken:n,pToken:a,publicKey:o}=$r(i),s=Oi(this.designConfig?.payByBank);await Qr(s.paymentSdkUrl);const c=window.PaymentSDK;if(!c?.init)throw new Error("PaymentSDK.js loaded but PaymentSDK.init is not available on window.");await new Promise((i,d)=>{let l=!1;Xr(),c.init({apiKey:s.apiKey,accessToken:n,configId:s.configId,environment:s.environment,locale:s.locale,appearance:Fi(this.designConfig),publicKey:o,pToken:a,aggregatorSessionId:r,containerId:t,onEvent:async t=>{if(!l&&xr(t)){if(Xr(),"success"!==t.type)return l=!0,this.resetBankFlow(),this.showPaymentSourceList({refresh:!0}),void i();try{const t=await this.finalizePayByBankSession(e,r,a),n=Ni(t),o=n.id?.trim();if(!o)throw new Error("Connect your bank completed but the resolved bank payment source did not include an id.");const s=this.interactionResponseWithAddedSource(e,n);if(this.setInteractionResponseFromSdk(s),this.emitSdkEvent(ct,n),this.resetBankFlow(),"VERIFIED"===n.verificationInfo?.status)return await this.attachPaymentSource(o),l=!0,void i();this.showAddedPaymentSourceStatus(n),l=!0,i()}catch(e){l=!0,d(e)}}}}),this.bankLinkLoading=!1})}async refreshPaymentSourcesFromInteraction(){const e=this.interactionResponse?.interactionId;if(e&&this.shouldRefreshPaymentSourcesFromInteraction())try{await this.fetchInteraction(e)}catch(e){}}queueNativeAccountBalanceRefresh(){const e=this.interactionResponse?.interactionId,t=ir(this.interactionResponse);if(!e||0===t.length){const e=void 0!==this.nativeBalanceFetchKey||void 0!==this.nativeBalanceQueuedFetchKey||Object.keys(this.nativeAccountBalances).length>0||this.nativeBalanceLoadingSourceIds.length>0;if(this.nativeBalanceQueuedFetchKey=void 0,!e)return;return void queueMicrotask(()=>{0===ir(this.interactionResponse).length&&(this.nativeBalanceFetchKey=void 0,this.nativeAccountBalances={},this.nativeBalanceLoadingSourceIds=[])})}const i=nr(e,t);this.nativeBalanceFetchKey!==i&&this.nativeBalanceQueuedFetchKey!==i&&(this.nativeBalanceQueuedFetchKey=i,queueMicrotask(()=>{if(this.nativeBalanceQueuedFetchKey!==i)return;this.nativeBalanceQueuedFetchKey=void 0;const e=this.interactionResponse?.interactionId,t=ir(this.interactionResponse);e&&0!==t.length&&nr(e,t)===i&&this.refreshNativeAccountBalances()}))}async refreshNativeAccountBalances(){const e=this.interactionResponse?.interactionId,t=ir(this.interactionResponse);if(!e||0===t.length)return this.nativeBalanceFetchKey=void 0,this.nativeBalanceQueuedFetchKey=void 0,this.nativeAccountBalances={},void(this.nativeBalanceLoadingSourceIds=[]);const i=nr(e,t);if(this.nativeBalanceFetchKey!==i){this.nativeBalanceFetchKey=i,this.nativeAccountBalances={},this.nativeBalanceLoadingSourceIds=t.map(er);try{const t=await this.createSdkClient(e).GET("/interaction/source/native/balances");if(this.nativeBalanceFetchKey!==i)return;this.nativeAccountBalances=t.data??{}}catch(e){this.nativeBalanceFetchKey===i&&(this.nativeAccountBalances={})}finally{this.nativeBalanceFetchKey===i&&(this.nativeBalanceLoadingSourceIds=[])}}}shouldRefreshPaymentSourcesFromInteraction(){const e=this.interactionResponse,t=e?.interactionId;return!!t&&this.interactionSnapshotInteractionId!==t}async fetchInteraction(e){return this.interactionRefreshInteractionId===e&&this.interactionRefreshPromise||(this.interactionRefreshInteractionId=e,this.interactionRefreshErrorMessage=void 0,this.interactionRefreshPromise=this.createSdkClient(e).GET("/interaction").then(e=>br(e)).then(t=>{const i=fr(this.interactionResponse??{interactionId:e},t,this.selectedPaymentSourceId);return this.interactionSnapshotInteractionId=e,this.setInteractionResponseFromSdk(i),this.emitSdkEvent(ht,i.paymentSources??[]),i}).catch(t=>{throw this.interactionSnapshotInteractionId!==e&&(this.interactionRefreshErrorMessage="We couldn't load payment methods. Try again."),t}).finally(()=>{this.interactionRefreshPromise=void 0,this.interactionRefreshInteractionId=void 0,this.requestUpdate()})),this.interactionRefreshPromise}async retryInteractionRefresh(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}syncBillingAddressesFromInteractionResponse(e){e.billerAddress&&(this.billingAddresses=e.billerAddress.filter(e=>Boolean(e.id?.trim())),this.cardDraft=xi(this.cardDraft,this.billingAddresses),this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===ft)}async finalizePayByBankSession(e,t,i){return this.requestCommerceHubJson(`/interaction/source/pbb/session/${encodeURIComponent(t)}/${encodeURIComponent(i)}`,e,{method:"PUT",credentials:"include"})}async verifyPaymentSourceStep1(e,t){this.showMinimumVerificationOverlay("verify-payment-source");const i=await this.requestCommerceHubJson("/interaction/verify/step1",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t.id}),credentials:"include"});return this.sourceWithVerificationResponse(t,i)}async requestCommerceHubJson(e,t,i){const r=this.createInteractionHeaders(t,i.headers);r.has("Accept")||r.set("Accept","application/json");const n=new Request(`${xe(this.baseURL)}${e}`,{...i,headers:r}),a=await fetch(n),o=a.headers.get("content-type")??"",s=204===a.status?void 0:o.includes("application/json")?await a.json():await a.text();if(!a.ok)throw new Error(gr(s)||a.statusText);return s}resetBankFlow(){this.bankFlowScreen=void 0,this.bankOutcomeSource=void 0,this.bankLinkLoading=!1,this.bankAccountDraft=St(),this.bankAccountDraftErrors={},this.bankAccountEncryption=At(),this.bankAccountSubmitError=void 0,this.removePayByBankProviderContainer()}resetCardFlow(){this.cardFlowScreen=void 0,this.cardDraft=xt(),this.cardDraftErrors={},this.cardEncryption=zt(),this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=!1}resetTransferFlow(){this.transferFlowActive=!1,this.transferFlowScreen="form",this.transferDraft=Ct(),this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1}ensurePayByBankProviderContainer(e){const t=[...this.children].find(t=>t instanceof HTMLElement&&t.id===e),i=t??document.createElement("div");return i.id=e,i.slot=e,i.className="provider-frame-container",i.replaceChildren(),t||this.appendChild(i),i}removePayByBankProviderContainer(){[...this.children].filter(e=>e instanceof HTMLElement&&e.id===pt).forEach(e=>e.remove())}requireInteractionId(){const e=this.interactionResponse?.interactionId;if(e)return e}createSdkClient(e){return Se({baseURL:this.baseURL,getHeaders:()=>this.createInteractionHeaders(e)})}createInteractionHeaders(e,t){const i=new Headers(t),r=this.interactionResponse?.oauth?.access_token?.trim();return i.set("x-interaction-id",e),r&&!i.has("Authorization")&&i.set("Authorization",`Bearer ${r}`),i}setInteractionResponseFromSdk(e){this.interactionResponse=pr(this.interactionResponseWithPreservedGatewayOAuth(e))}interactionResponseWithPreservedGatewayOAuth(e){if(e.oauth&&e.features)return e;const t=this.interactionResponse;return!t||t.interactionId&&e.interactionId&&t.interactionId!==e.interactionId?e:{...e,oauth:e.oauth??t.oauth,features:e.features??t.features}}syncDesignConfigStyles(){for(const e of Hi)this.style.removeProperty(e);const e=this.designConfig?.colors;if(e)for(const{field:t,property:i}of ji){const r=e[t];r&&this.style.setProperty(i,r)}const t=this.designConfig?.baseFontSize;t?this.style.fontSize=t:this.style.removeProperty("font-size");const i=this.designConfig?.baseFontWeight?.trim();i?this.style.setProperty(Ui,i):this.style.removeProperty(Ui);const r=this.designConfig?.shellPadding?.trim();r?this.style.setProperty(_i,r):this.style.removeProperty(_i)}};$t.styles=De,ot([de({attribute:!1})],$t.prototype,"interactionResponse",void 0),ot([de({attribute:!1})],$t.prototype,"designConfig",void 0),ot([de({attribute:"base-url"})],$t.prototype,"baseURL",void 0),ot([le()],$t.prototype,"selectedPaymentSourceId",void 0),ot([le()],$t.prototype,"otpValue",void 0),ot([le()],$t.prototype,"pendingAction",void 0),ot([le()],$t.prototype,"minimumVerificationOverlayAction",void 0),ot([le()],$t.prototype,"otpErrorMessage",void 0),ot([le()],$t.prototype,"bankFlowScreen",void 0),ot([le()],$t.prototype,"bankLinkLoading",void 0),ot([le(),le()],$t.prototype,"bankOutcomeSource",void 0),ot([le()],$t.prototype,"bankAccountDraft",void 0),ot([le()],$t.prototype,"bankAccountDraftErrors",void 0),ot([le()],$t.prototype,"bankAccountEncryption",void 0),ot([le()],$t.prototype,"bankAccountSubmitError",void 0),ot([le()],$t.prototype,"transferDraft",void 0),ot([le()],$t.prototype,"transferDraftErrors",void 0),ot([le()],$t.prototype,"transferSubmitError",void 0),ot([le()],$t.prototype,"transferSubmitSuccess",void 0),ot([le()],$t.prototype,"transferFlowActive",void 0),ot([le()],$t.prototype,"transferFlowScreen",void 0),ot([le(),le()],$t.prototype,"cardFlowScreen",void 0),ot([le()],$t.prototype,"cardDraft",void 0),ot([le()],$t.prototype,"cardDraftErrors",void 0),ot([le()],$t.prototype,"cardEncryption",void 0),ot([le()],$t.prototype,"cardSubmitError",void 0),ot([le()],$t.prototype,"billingAddresses",void 0),ot([le()],$t.prototype,"billingAddressSelectorExpanded",void 0),ot([le()],$t.prototype,"nativeAccountBalances",void 0),ot([le()],$t.prototype,"nativeBalanceLoadingSourceIds",void 0),ot([le()],$t.prototype,"paymentSourceView",void 0),ot([le()],$t.prototype,"paymentSourceEditMode",void 0),ot([le()],$t.prototype,"deleteConfirmationPaymentSourceId",void 0),ot([le()],$t.prototype,"savedSourceVerificationSource",void 0),ot([le()],$t.prototype,"savedSourceVerificationFailed",void 0),ot([le()],$t.prototype,"requiredInfoSource",void 0),ot([le()],$t.prototype,"requiredInfoValues",void 0),ot([le()],$t.prototype,"requiredInfoFileNames",void 0),ot([le()],$t.prototype,"requiredInfoSubmitError",void 0),ot([le()],$t.prototype,"interactionRefreshErrorMessage",void 0),$t=ot([(e=>(t,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)})("commerce-hub-connect")],$t);const xt=()=>({name:"",fullName:"",cardNumber:"",expirationDate:"",cvv:"",billingAddressValue:ft,country:"",addressLine1:"",addressLine2:"",city:"",state:"",zip:""}),St=()=>({name:"",routingNumber:"",accountNumber:"",accountNumberReEntered:""}),Ct=()=>({fromSourceId:"",toSourceId:"",amount:""}),Et=()=>({status:"idle",normalizedValue:""}),zt=()=>({cardNumber:Et(),cvv:Et()}),At=()=>({routingNumber:Et(),accountNumber:Et(),accountNumberReEntered:Et()}),It=e=>e.replace(/\D/g,""),Nt=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input")),Tt=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("required-info-ssn-input")),qt=e=>e.replace(/\D/g,"").slice(0,9),Bt=e=>{const t=Number(e.dataset.requiredInfoSsnSegment);return Br[t]??0},Rt=e=>"cardNumber"===e||"cvv"===e,Dt=e=>"routingNumber"===e||"accountNumber"===e||"accountNumberReEntered"===e,Lt=e=>e.replace(/\D/g,""),Mt=(e,t)=>"cardNumber"===e?Ot(t):"expirationDate"===e?jt(t):"cvv"===e?Pt(t).slice(0,4):t,Ot=e=>{const t=Lt(e).slice(0,19);return Vt(t,Ft(t))},Ft=e=>/^3[47]/.test(e)?[4,6,5]:/^3(?:0[0-5]|[68])/.test(e)?[4,6,4]:[4,4,4,4,3],Vt=(e,t)=>{const i=[];let r=0;for(const n of t){if(r>=e.length)break;i.push(e.slice(r,r+n)),r+=n}return r<e.length&&i.push(e.slice(r)),i.join(" ")},Pt=e=>e.replace(/\D/g,""),jt=e=>{const t=e.replace(/\D/g,"").slice(0,6);return t.length<=2?2===t.length?`${t} / `:t:`${t.slice(0,2)} / ${t.slice(2)}`},Ut=(e,t)=>"cardNumber"===e?Lt(t):Pt(t),_t=e=>({name:e.name.trim(),fullName:e.fullName.trim(),cardNumber:e.cardNumber.trim(),expirationDate:e.expirationDate.trim(),cvv:e.cvv.trim(),billingAddressValue:e.billingAddressValue.trim()||ft,country:e.country.trim(),addressLine1:e.addressLine1.trim(),addressLine2:e.addressLine2.trim(),city:e.city.trim(),state:e.state.trim(),zip:e.zip.trim()}),Ht=e=>e.replace(/\D/g,""),Wt=(e,t)=>"encrypted"===t.status&&Boolean(t.normalizedValue)&&e===Kt(t.normalizedValue),Kt=e=>e.length<=4?e:`${"•".repeat(e.length-4)}${wr(e)}`,Yt=(e,t,i)=>"routingNumber"===e||Wt(t[e],i[e])?"text":"password",Gt=(e,t)=>"routingNumber"===e?Ht(t).slice(0,9):"accountNumber"===e||"accountNumberReEntered"===e?Ht(t).slice(0,17):t,Jt=(e,t)=>({name:e.name.trim(),routingNumber:Zt("routingNumber",e,t),accountNumber:Zt("accountNumber",e,t),accountNumberReEntered:Zt("accountNumberReEntered",e,t)}),Zt=(e,t,i)=>{const r=t[e],n=i[e];return Wt(r,n)?n.normalizedValue:Ht(r)},Qt=(e,t)=>({name:e.name,routingNumber:Xt("routingNumber",e,t),accountNumber:Xt("accountNumber",e,t),accountNumberReEntered:Xt("accountNumberReEntered",e,t)}),Xt=(e,t,i)=>{const r=t[e];return Wt(r,i[e])?r:Ht(r)},ei=e=>{const t={},i=Ht(e.routingNumber),r=Ht(e.accountNumber),n=Ht(e.accountNumberReEntered);return i?9!==i.length&&(t.routingNumber="Enter a 9-digit routing number."):t.routingNumber="Enter a routing number.",r||(t.accountNumber="Enter an account number."),n?r&&n!==r&&(t.accountNumberReEntered="Account numbers must match."):t.accountNumberReEntered="Confirm the account number.",t},ti=(e,t)=>{const i=Jt(e,t);return 0===Object.keys(ei(i)).length&&["routingNumber","accountNumber","accountNumberReEntered"].every(e=>{const r=t[e],n=i[e];return"encrypted"===r.status&&r.normalizedValue===n&&Boolean(r.encryptedValue)})},ii=e=>({fromSourceId:e.fromSourceId.trim(),toSourceId:e.toSourceId.trim(),amount:e.amount.trim()}),ri=(e,t)=>{const i={},r=new Set(t.map(er)),n=Number(e.amount);return e.fromSourceId?r.has(e.fromSourceId)||(i.fromSourceId="Select a verified bank or native account."):i.fromSourceId="Select a source account.",e.toSourceId?r.has(e.toSourceId)?e.toSourceId===e.fromSourceId&&(i.toSourceId="Select a different destination account."):i.toSourceId="Select a verified bank or native account.":i.toSourceId="Select a destination account.",e.amount?(!Number.isFinite(n)||n<=0)&&(i.amount="Enter an amount greater than zero."):i.amount="Enter an amount.",i},ni=(e,t)=>0===Object.keys(ri(ii(e),t)).length,ai=e=>`${Number(e.amount).toFixed(2)} USD`,oi=e=>{const t={};return e.name||(t.name="Enter a card name."),e.fullName||(t.fullName="Enter the full name."),yi(e.cardNumber)||(t.cardNumber="Enter a valid card number."),ki(e.expirationDate)||(t.expirationDate="Enter a valid expiration date."),wi(e.cvv)||(t.cvv="Enter a valid CVC."),e.billingAddressValue||(t.billingAddressValue="Select a billing address."),e.billingAddressValue===ft&&(e.country||(t.country="Select a country or region."),e.addressLine1||(t.addressLine1="Enter an address."),e.city||(t.city="Enter a city."),e.state||(t.state="Select a state."),/^\d{5}(?:-\d{4})?$/.test(e.zip)||(t.zip="Enter a valid ZIP code.")),t},si=(e,t)=>0===Object.keys(oi(_t(e))).length&&0===Object.keys(pi(e,t)).length,ci=(e,t)=>"cardNumber"===e?yi(t)?void 0:"Enter a valid card number.":wi(t)?void 0:"Enter a valid CVC.",di=e=>"cardNumber"===e?"Unable to encrypt the card number. Try again.":"Unable to encrypt the CVC. Try again.",li=e=>"routingNumber"===e?"Unable to encrypt the routing number. Try again.":"Unable to encrypt the account number. Try again.",hi=(e,t)=>t?e.normalizedValue!==t||"encrypting"!==e.status&&"encrypted"!==e.status?{status:"dirty",normalizedValue:t}:e:Et(),ui=(e,t)=>{const i={...e};return delete i[t],i},mi=(e,t)=>{const i={...e};return delete i[t],i},pi=(e,t)=>{const i={};for(const r of["cardNumber","cvv"]){const n=Ut(r,e[r]),a=t[r];if(!n)continue;"encrypted"===a.status&&a.normalizedValue===n&&Boolean(a.encryptedValue)||(i[r]="failed"===a.status?di(r):"cardNumber"===r?"Encrypt the card number before saving.":"Encrypt the CVC before saving.")}return i},fi=(e,t,i)=>{const r=Ut(e,t),n=i[e];if("encrypted"!==n.status||n.normalizedValue!==r||!n.encryptedValue)throw new Error("cardNumber"===e?"Card number encryption must complete before saving.":"CVC encryption must complete before saving.");return n.encryptedValue},vi=(e,t,i)=>{const r=t[e],n=Ht(r),a=i[e],o=Wt(r,a)||n===a.normalizedValue;if("encrypted"===a.status&&a.encryptedValue&&o)return a.encryptedValue;if(!n)return"";throw new Error("ACH detail encryption must complete before saving.")},bi=(e,t,i)=>wr(t[e].normalizedValue||i[e]),gi=(e,t)=>e.trim()||`Bank Account xxxxxx${t}`,yi=e=>{const t=Lt(e);if(t.length<12||t.length>19)return!1;let i=0,r=!1;for(let e=t.length-1;e>=0;e-=1){let n=Number(t[e]);r&&(n*=2,n>9&&(n-=9)),i+=n,r=!r}return i%10==0},wi=e=>/^\d{3,4}$/.test(Pt(e)),ki=e=>{const t=e.replace(/\D/g,""),i=t.slice(0,2),r=t.slice(2),n=Number(i);if(!(2!==i.length||n<1||n>12))return 2===r.length?{month:i,year:`20${r}`}:4===r.length?{month:i,year:r}:void 0},$i=e=>{const t=Lt(e);return/^4/.test(t)?"Visa":/^(5[1-5]|2[2-7])/.test(t)?"Mastercard":/^3[47]/.test(t)?"AmericanExpress":/^(6011|65|64[4-9])/.test(t)?"Discover":void 0},xi=(e,t)=>{const i=t.map(e=>e.id?.trim()).filter(e=>Boolean(e));if(!i.length)return{...e,billingAddressValue:ft};if(i.includes(e.billingAddressValue))return e;const r=[e.country,e.addressLine1,e.addressLine2,e.city,e.state,e.zip].some(e=>e.trim());return e.billingAddressValue===ft&&r?e:{...e,billingAddressValue:i[0]}},Si=e=>{const t=[e.stateOrProvince,e.postalCode].filter(Boolean).join(" "),i=[e.city,t].filter(Boolean).join(", ");return[e.street,i].filter(Boolean).join(", ")||e.id||"Saved billing address"},Ci=e=>({id:zi(),recipientNameOrAddress:e.fullName,country:e.country,street:e.addressLine1,houseNumberOrName:e.addressLine2||void 0,city:e.city,stateOrProvince:e.state,postalCode:e.zip});let Ei=0;const zi=()=>(Ei+=1,`billing-address-${Date.now().toString(36)}-${Ei.toString(36)}`),Ai=(e,t)=>{const i=Lt(t??"").slice(-4);return{...e,tenderType:"Card",card:{...e.card,...i?{cardNumber:i}:{}}}},Ii=(e,t)=>{const i=Ht(t??"").slice(-4);return{...e,tenderType:"BankAccount",bankAccount:{...e.bankAccount,...i?{accountNumber:i}:{}}}},Ni=e=>({id:Ti(e,"Connect your bank completed but the verification response did not include a source id."),tenderType:"BankAccount",verificationInfo:qi(e),bankAccount:{}}),Ti=(e,t)=>{const i=e.sourceId?.trim();if(!i)throw new Error(t);return i},qi=e=>{const{sourceId:t,...i}=e;return i},Bi=e=>`We sent a one-time code to ${e??"your contact method"}.`,Ri=e=>{const t=e?.email?.trim();if(t)return t;const i=e?.phone?.countryCode?.trim(),r=e?.phone?.phoneNumber?.trim();return[i,r].filter(Boolean).join(" ")||void 0},Di=e=>{const t=e?.copy?.otp;return{title:t?.title??"Enter verification code",subtitle:t?.subtitle,failedMessage:t?.failedMessage??"The code does not match. Try again.",resendPrefix:t?.resendPrefix??"Didn't receive the code?",resendButton:t?.resendButton??"Resend code",resendPendingButton:t?.resendPendingButton??"Sending code...",verifyButton:t?.verifyButton??"Verify",verifyingButton:t?.verifyingButton??"Verifying...",tryAgainButton:t?.tryAgainButton??"Try again"}},Li=e=>{const t=e?.copy?.paymentMethods;return{title:t?.title??"Pay with",subtitle:t?.subtitle??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??"",continueButton:t?.continueButton??"Confirm",continuingButton:t?.continuingButton??"Confirming..."}},Mi=e=>{const t=e?.copy?.noSavedPaymentMethods;return{title:t?.title??"Add payment method",subtitle:t?.subtitle??"",emptyTitle:t?.emptyTitle??"",emptyMessage:t?.emptyMessage??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??""}},Oi=e=>{const t=Object.fromEntries(Object.entries(e??{}).filter(([,e])=>void 0!==e));return{...wt,...t}},Fi=e=>{const t=e?.colors,i={};return Pi(i,"backgroundColor",Vi(t?.widgetBackground,t?.surface)),Pi(i,"primaryColor",t?.primary),Pi(i,"buttonColor",t?.primary),Pi(i,"primaryTextColor",t?.text),Pi(i,"secondaryTextColor",Vi(t?.copy,t?.muted)),Pi(i,"dangerColor",t?.danger),Pi(i,"successColor",t?.success),Pi(i,"borderColor",Vi(t?.border,t?.widgetBorder,t?.borderBackground)),Pi(i,"placeholderColor",t?.placeholder),{branding:i}},Vi=(...e)=>e.map(e=>e?.trim()).find(e=>Boolean(e)),Pi=(e,t,i)=>{const r=i?.trim();r&&(e[t]=r)},ji=[{field:"primary",property:"--chc-primary"},{field:"text",property:"--chc-text"},{field:"copy",property:"--chc-copy"},{field:"muted",property:"--chc-muted"},{field:"placeholder",property:"--chc-placeholder"},{field:"surface",property:"--chc-surface"},{field:"widgetBackground",property:"--chc-widget-background"},{field:"borderBackground",property:"--chc-border"},{field:"widgetBorder",property:"--chc-border"},{field:"softSurface",property:"--chc-soft-surface"},{field:"paymentSelectionBackground",property:"--chc-payment-method-background"},{field:"paymentMethodBackground",property:"--chc-payment-method-background"},{field:"border",property:"--chc-border"},{field:"borderStrong",property:"--chc-border-strong"},{field:"success",property:"--chc-success"},{field:"successBackground",property:"--chc-success-bg"},{field:"successBorder",property:"--chc-success-border"},{field:"danger",property:"--chc-danger"},{field:"dangerBackground",property:"--chc-danger-bg"},{field:"dangerBorder",property:"--chc-danger-border"},{field:"warning",property:"--chc-warning"},{field:"warningBackground",property:"--chc-warning-bg"},{field:"warningBorder",property:"--chc-warning-border"},{field:"disabledText",property:"--chc-disabled-text"},{field:"disabledSurface",property:"--chc-disabled-surface"}],Ui="--chc-font-weight",_i="--chc-shell-padding",Hi=[...ji.map(({property:e})=>e),Ui,_i],Wi=(e,t={})=>{const i=e?.paymentSources;if(!i?.length){const i=lr(e);return i?[Yi(i,{...t,selected:!0})]:hr(e?.status)?[]:kt}return i.map(e=>Yi(e,t))},Ki=e=>{const t=e?.allowedTenderTypes;return t?{card:t.includes("CARD"),bankAccount:t.includes("BANK_ACCOUNT"),nativeAccount:t.includes("NATIVE_ACCOUNT")}:{card:!0,bankAccount:!0,nativeAccount:!0}},Yi=(e,{selected:t=!1,nativeBalances:i={},nativeBalanceLoadingSourceIds:r=[]}={})=>{const n=er(e),a=Gr(e)?ar(e,i):void 0,o=void 0===a?.balance?void 0:sr(a.balance);return{id:n,label:Gi(e,{selected:t}),type:tr(e),brand:Zi(e),accountLabel:Qi(e),balanceLabel:o,balanceLoading:Gr(e)&&r.includes(n),last4:Xi(e),status:kr(e.verificationInfo?.status),showVerificationStatus:Boolean(e.verificationInfo?.status)}},Gi=(e,{selected:t=!1}={})=>Yr(e)?t?e.name?.trim()||e.card?.nameOnCard?.trim()||Ji(e):e.card?.nameOnCard?.trim()||e.name?.trim()||Ji(e):Kr(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||Ji(e):Gr(e)?e.account?.nickName?.trim()||e.name?.trim()||Ji(e):e.name?.trim()||Ji(e),Ji=e=>Yr(e)?"Saved card":Kr(e)?e.bankAccount?.bankName??"Saved bank account":Gr(e)?"Native account":"Dynamic session card",Zi=e=>Yr(e)?e.card?.network??"Card":Kr(e)?e.bankAccount?.bankName??"Bank account":Gr(e)?e.account?.productType??"Native account":"DSC",Qi=e=>{const t=`•••• ${Xi(e)}`;if(Gr(e)){const i=e.account?.productType?.trim();return i?`${i} ${t}`:t}return t},Xi=e=>Yr(e)?wr(e.card?.cardNumber):Kr(e)?wr(e.bankAccount?.accountNumber):Gr(e)?wr(e.account?.positionId??e.account?.token):wr(e.id),er=e=>e.id?.trim()||e.name?.trim()||e.tenderType,tr=e=>Kr(e)?"bank":Gr(e)?"native":"card",ir=e=>(e?.paymentSources??[]).filter(Gr),rr=e=>(e?.paymentSources??[]).filter(e=>(Kr(e)||Gr(e))&&"VERIFIED"===e.verificationInfo?.status&&Boolean(er(e))),nr=(e,t)=>`${e}:${t.map(e=>or(e).join(",")).join("|")}`,ar=(e,t)=>{for(const i of or(e)){const e=t[i];if(e)return e}},or=e=>[e.id,e.account?.positionId,e.account?.token].map(e=>e?.trim()).filter(e=>Boolean(e)),sr=e=>cr.format(e),cr=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}),dr=(e,t)=>{const i=e?.paymentSources;if(i?.length)return t&&i.some(e=>e.id===t)?t:e?.selectedSource?.id},lr=(e,t)=>{if(t){const i=e?.paymentSources?.find(e=>e.id===t);if(i)return i}return e?.selectedSource},hr=e=>e===vt||"PAYMENT_SOURCE_REQUESTED"===e,ur=e=>Boolean(e&&e.features?.includes("TRANSFER")&&!e.features.includes("ADD_ACCOUNT")&&!e.features.includes("SELECT")),mr=e=>Boolean(e?.features?.includes("ADD_ACCOUNT")&&e.features.includes("SELECT")&&e.features.includes("TRANSFER")),pr=e=>e.features?e:{...e,features:[...bt]},fr=(e,t,i)=>{const r={...e,...t},n=t.paymentSources??e.paymentSources??[],a=((e,t)=>{if(t){const i=e.find(e=>e.id===t);if(i)return i}})(n,i??t.selectedSource?.id)??t.selectedSource??e.selectedSource;return{...r,selectedSource:a,paymentSources:n}},vr=(e,t)=>{const i=(e.paymentSources??[]).filter(e=>e.id!==t),r=e.selectedSource?.id===t?void 0:e.selectedSource;return{...e,status:"PAYMENT_SOURCE_ATTACHED"!==e.status||r?e.status:vt,selectedSource:r,paymentSources:i}},br=e=>{if(e.data)return e.data;throw new Error(gr(e.error))},gr=e=>"string"==typeof e?e:e&&"object"==typeof e&&"message"in e&&"string"==typeof e.message?e.message:"CommerceHub API request failed.",yr=(e,t)=>{const i=e.composedPath().find(e=>e instanceof HTMLElement&&Boolean(e.dataset[t]));return i?.dataset[t]},wr=e=>e&&e.length>=4?e.slice(-4):"----",kr=e=>"VERIFIED"===e?"verified":"UNDER_REVIEW"===e?"under-review":"REQUIRE_INFO"===e?"require-info":"DECLINED"===e?"declined":"not-verified",$r=e=>{const t=e.aggregatorSessionId?.trim(),i=e.tokenID?.trim()||e.accessToken?.trim(),r=e.pToken?.trim(),n=e.publicKey?.trim();if(!(t&&i&&r&&n))throw new Error("The /interaction/source/pbb/session response is missing one or more required values.");return{aggregatorSessionId:t,accessToken:i,pToken:r,publicKey:n}},xr=e=>"success"===e.type||"cancel"===e.type||"failure"===e.type||"error"===e.type,Sr=(e,t)=>{const i=Er(e.paymentSources??[],t);return{...e,selectedSource:t,paymentSources:i}},Cr=(e,t)=>({...e,paymentSources:Er(e.paymentSources??[],t)}),Er=(e,t)=>e.some(e=>e.id===t.id)?e.map(e=>e.id===t.id?t:e):[t,...e],zr=e=>"VERIFIED"===e.verificationInfo?.status,Ar=({title:e,helper:t})=>P`
...
`,Ir=e=>"verify-payment-source"===e?Ar({title:"Verifying payment method",helper:"Verifying your payment method, please wait."}):"submit-required-info"===e?Ar({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,Nr=e=>"verify-payment-source"===e?Ir(e):"delete-payment-source"===e?Ar({title:"Deleting payment method",helper:"Deleting your payment method, please wait."}):"attach-payment-source"===e?Ar({title:"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,Tr=e=>{const t=e?.verificationInfo?.status;return"VERIFIED"===t?{kind:"verified",variant:"success",title:"Bank account verified",message:"Your bank account is connected and ready to use."}:"UNDER_REVIEW"===t?{kind:"pending",variant:"warning",title:"Bank account pending review",message:"We will update this bank account after review is complete."}:"REQUIRE_INFO"===t?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:"Additional information is required before this bank account can be verified."}:"DECLINED"===t?{kind:"declined",variant:"danger",title:"Bank account verification failed",message:"This bank account could not be verified."}:{kind:"failed",variant:"danger",title:"Bank account not verified",message:"This bank account is not verified yet."}},qr=(e,t=!1)=>{const i=Wr(e),r=i.toLowerCase(),n=e?.verificationInfo?.status;return t?{kind:"failed",variant:"danger",title:"Bank account"===i?"Bank account verification failed":`${i} not verified`,message:`We could not verify this ${r} right now.`}:"VERIFIED"===n?{kind:"verified",variant:"success",title:"Bank account"===i?"Bank account verified":`${i} saved`,message:`This ${r} is verified and ready to use.`}:"UNDER_REVIEW"===n?{kind:"pending",variant:"warning",title:"Bank account"===i?"Bank account pending review":"Verification pending review",message:`We will update this ${r} after review is complete.`}:"REQUIRE_INFO"===n?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:`Additional information is required before this ${r} can be verified.`}:"DECLINED"===n?{kind:"declined",variant:"danger",title:"Bank account"===i?"Bank account verification failed":`${i} declined`,message:`This ${r} could not be verified.`}:{kind:"failed",variant:"danger",title:"Bank account"===i?"Bank account not verified":`${i} not verified`,message:`This ${r} is not verified yet.`}},Br=[3,2,4],Rr=e=>{const t=e?.verificationInfo?.docs??[];return t.length>0?t:[{}]},Dr=(e,t=0)=>`${e?.docType??"DOCUMENT"}-${t}`,Lr=e=>"DRIVER_LICENSE_NUMBER"===e.docType||"SOCIAL_SECURITY_NUMBER"===e.docType,Mr=e=>!1!==e.mandatory,Or=e=>Mr(e)?"required":"optional",Fr=e=>P`
  <span
    class="required-info-requirement-badge required-info-requirement-badge-${Or(e)}"
  >
    ${(e=>Mr(e)?"Required":"Optional")(e)}
  </span>
`,Vr=e=>{const t=e.findIndex(e=>!Lr(e));return t>=0?Dr(e[t],t):void 0},Pr=({doc:e,key:t,value:i})=>{if("SOCIAL_SECURITY_NUMBER"===e.docType)return jr({doc:e,key:t,value:i});const r=`required-info-${t}`;return P`
    <div
  ...
  `},jr=({doc:e,key:t,value:i})=>{const r=Ur(e),n=(e=>{const t=qt(e);return[t.slice(0,3),t.slice(3,5),t.slice(5,9)]})(i),a=`required-info-${t}-ssn-0`;return P`
    <div
  ...
  `},Ur=e=>"BANK_STATEMENT"===e.docType?"Bank statement":"BANK_LETTER"===e.docType?"Bank letter":"BANK_CHECK"===e.docType?"Bank check":"DRIVER_LICENSE_PHOTO"===e.docType?"Driver license photo":"DRIVER_LICENSE_NUMBER"===e.docType?"Driver license number":"SOCIAL_SECURITY_NUMBER"===e.docType?"Social Security number":"Required document",_r=e=>{const t=(e=>({type:tr(e),brand:Zi(e)}))(e),i=Be(t),r=(e=>{if(!Yr(e))return;const t=e.card?.expirationMonth?.trim(),i=e.card?.expirationYear?.trim();if(!t||!i)return;return`${t.padStart(2,"0")}/${i.slice(-2)}`})(e);return P`
    <div
      ...
      <div class="required-info-card-top">
        <div class="required-info-card-heading">
          <span class="required-info-card-label"
            >${(e=>Kr(e)?"Bank account":Yr(e)?"Card":Gr(e)?"Native account":"Dynamic session card")(e)}</span
          >
          <span
            class="required-info-card-field required-info-card-name"
            data-required-info-card-field="name"
            >${(e=>Yr(e)?e.card?.nameOnCard?.trim()||e.name?.trim()||Ji(e):Kr(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||Ji(e):Gr(e)?e.account?.nickName?.trim()||e.name?.trim()||Ji(e):e.name?.trim()||Ji(e))(e)}</span
          >
        </div>
      ...
      <div class="required-info-card-bottom">
        <div class="required-info-card-detail">
          ...
          <span class="required-info-card-status">
            ${Fe(kr(e.verificationInfo?.status))}
          </span>
        </div>
        ${r?P`
              <div class="required-info-card-detail">
  ...
  `},Hr=e=>"REQUIRE_INFO"===e.verificationInfo?.status,Wr=e=>e&&Kr(e)?"Bank account":e&&Gr(e)?"Native account":"Payment method",Kr=e=>"BankAccount"===e.tenderType||"BANK_ACCOUNT"===e.tenderType,Yr=e=>"Card"===e.tenderType||"CARD"===e.tenderType,Gr=e=>"NativeAccount"===e.tenderType||"NATIVE_ACCOUNT"===e.tenderType;let Jr,Zr;const Qr=async e=>{if(!window.PaymentSDK?.init)if(Jr&&Zr===e)await Jr;else if(Zr=e,Jr=new Promise((t,i)=>{const r=document.querySelector(`script[data-commerce-hub-pay-by-bank-sdk="true"][src="${e}"]`),n=r??document.createElement("script"),a=()=>{n.removeEventListener("load",o),n.removeEventListener("error",s)},o=()=>{a(),t()},s=()=>{a(),Jr=void 0,Zr=void 0,i(new Error(`Unable to load Connect your bank script: ${e}`))};n.addEventListener("load",o,{once:!0}),n.addEventListener("error",s,{once:!0}),r||(n.src=e,n.async=!0,n.dataset.commerceHubPayByBankSdk="true",document.head.appendChild(n))}),await Jr,!window.PaymentSDK?.init)throw new Error(`Connect your bank script loaded but window.PaymentSDK.init is unavailable: ${e}`)},Xr=()=>{try{window.PaymentSDK?.destroy?.()}catch{}};export{$e as COMMERCE_HUB_BASE_URLS,$t as CommerceHubConnect,ke as DEFAULT_COMMERCE_HUB_BASE_URL,ct as ON_ADD_PAYMENT_METHOD_EVENT,lt as ON_DELETE_PAYMENT_METHOD_EVENT,mt as ON_ERROR_EVENT,ht as ON_LIST_PAYMENT_METHODS_EVENT,st as ON_SELECT_EVENT,ut as ON_TRANSFER_EVENT,dt as ON_VERIFY_PAYMENT_METHOD_EVENT,Se as createCommerceHubClient,Ce as createCommerceHubMerchantClient,xe as resolveCommerceHubBaseURL};

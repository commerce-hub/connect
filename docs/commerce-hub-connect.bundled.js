...
const L$=Symbol.for(""),D$=e=>{if(e?.r===L$)return e?._$litStatic$},B$=new Map,q$=(e=>(t,...r)=>{const n=r.length;let i,o;const a=[],s=[];let c,d=0,u=!1;for(;d<n;){for(c=t[d];d<n&&void 0!==(o=r[d],i=D$(o));)c+=i+t[++d],u=!0;d!==n&&s.push(o),a.push(c),d++}if(d===n&&a.push(t[n]),u){const e=a.join("$$lit$$");void 0===(t=B$.get(e))&&(a.raw=a,B$.set(e,t=a)),r=s}return e(t,...r)})(Ry);var V$=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};let U$=class extends Xy{constructor(){super(...arguments),this.path="",this.enabled=!0,this.readonly=!1,this.visible=!0}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.syncSubscription(),this.updateRenderer()}disconnectedCallback(){this.unsubscribe?.(),this.unsubscribe=void 0,super.disconnectedCallback()}updated(e){e.has("store")&&this.syncSubscription(),e.size>0&&this.updateRenderer()}render(){if(void 0===this.store)return Ry``;const e=Wg(this.store.getState(),{uischema:this.uischema,schema:this.schema,path:this.path,enabled:this.enabled,readonly:this.readonly,visible:this.visible,renderers:this.renderers,cells:this.cells,uischemas:this.uischemas});if(void 0===e.uischema||!1===e.visible)return Ry``;const t=(e=>({_$litStatic$:e,r:L$}))(this.selectedRenderer??"jsonforms-lit-unknown-renderer");return q$`
      ...
      ></${t}>
    `}updateRenderer(){if(void 0===this.store)return void(this.selectedRenderer=void 0);const e=Wg(this.store.getState(),{uischema:this.uischema,schema:this.schema,path:this.path,enabled:this.enabled,readonly:this.readonly,visible:this.visible,renderers:this.renderers,cells:this.cells,uischemas:this.uischemas});if(void 0===e.uischema)return void(this.selectedRenderer=void 0);let t,r=-1;const n=e.renderers??[];for(const i of n){const n=i.tester(e.uischema,e.schema??{},{rootSchema:e.rootSchema,config:e.config});n>r&&(r=n,t=i.renderer)}this.selectedRenderer=-1===r?void 0:t}syncSubscription(){this.unsubscribe?.(),this.unsubscribe=void 0,void 0!==this.store&&this.isConnected&&(this.unsubscribe=this.store.subscribe(()=>{this.updateRenderer(),this.requestUpdate()}))}};V$([iw({attribute:!1})],U$.prototype,"store",void 0),V$([iw({attribute:!1})],U$.prototype,"uischema",void 0),V$([iw({attribute:!1})],U$.prototype,"schema",void 0),V$([iw({type:String})],U$.prototype,"path",void 0),V$([iw({type:Boolean})],U$.prototype,"enabled",void 0),V$([iw({type:Boolean})],U$.prototype,"readonly",void 0),V$([iw({type:Boolean})],U$.prototype,"visible",void 0),V$([iw({attribute:!1})],U$.prototype,"renderers",void 0),V$([iw({attribute:!1})],U$.prototype,"cells",void 0),V$([iw({attribute:!1})],U$.prototype,"uischemas",void 0),V$([ow()],U$.prototype,"selectedRenderer",void 0),U$=V$([tw("jsonforms-lit-dispatch")],U$);var F$=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};const H$="jsonforms-layout jsonforms-layout-vertical",W$="jsonforms-layout jsonforms-layout-horizontal",K$="jsonforms-layout jsonforms-group";let G$=class extends M${render(){return this.renderLayout(H$)}renderLayout(e){const t=this.layoutProps;if(void 0===t||!1===t.visible)return Ry``;const r=t.uischema;return Ry`
      <div class=${e}>
    ...
    `}};G$=F$([tw("jsonforms-lit-vertical-layout")],G$);let Y$=class extends G${render(){return this.renderLayout(W$)}};Y$=F$([tw("jsonforms-lit-horizontal-layout")],Y$);let J$=class extends G${render(){return this.renderLayout(K$)}};J$=F$([tw("jsonforms-lit-group-layout")],J$);let Z$=class extends P${render(){return void 0===this.labelProps||!1===this.labelProps.visible?Ry``:Ry`<span class="jsonforms-label">${this.labelProps.text}</span>`}};Z$=F$([tw("jsonforms-lit-label")],Z$);let Q$=class extends R${render(){const e=this.controlProps;if(void 0===e||!1===e.visible)return Ry``;const t=Array.isArray(e.errors)?e.errors.length>0:Boolean(e.errors),r=e.description?`${e.id}-description`:void 0,n=t?`${e.id}-error`:void 0,i=[r,n].filter(Boolean).join(" ");return Ry`
    ...
    `}renderLabel(e,t){return Ry`<label for=${this.controlProps?.id??""}>
      ${e}${t&&!e.endsWith("*")?"*":""}
          ...
          ${e}
        </div>`:Ry``}renderErrors(e,t){const r=Array.isArray(e)?e.join("\n"):e;return r?Ry`<div class="jsonforms-error" id=${aw(t)}>${r}</div>`:Ry``}};Q$=F$([tw("jsonforms-lit-text-control")],Q$);let X$=class extends Q${render(){const e=this.controlProps;return void 0===e||!1===e.visible?Ry``:Ry`
      <div class="jsonforms-control">
        ${this.renderLabel(e.label,e.required)}
        <input
          id=${e.id}
    ...
    `}};X$=F$([tw("jsonforms-lit-number-control")],X$);let ek=class extends Q${render(){const e=this.controlProps;return void 0===e||!1===e.visible?Ry``:Ry`
    ...
    `}};ek=F$([tw("jsonforms-lit-boolean-control")],ek);let tk=class extends Q${render(){const e=this.controlProps;if(void 0===e||!1===e.visible)return Ry``;const t=e.schema.enum??[];return Ry`
      <div class="jsonforms-control">
        ${this.renderLabel(e.label,e.required)}
        <select
          id=${e.id}
    ...
    `}};tk=F$([tw("jsonforms-lit-enum-control")],tk);let rk=class extends P${render(){const e=this.uischema?.type??"unknown";return Ry`<div class="jsonforms-unknown-renderer">
      No renderer found for ${e}
    </div>`}};rk=F$([tw("jsonforms-lit-unknown-renderer")],rk);const nk=[{tester:mg(1,dg("VerticalLayout")),renderer:"jsonforms-lit-vertical-layout"},{tester:mg(1,dg("HorizontalLayout")),renderer:"jsonforms-lit-horizontal-layout"},{tester:mg(1,dg("Group")),renderer:"jsonforms-lit-group-layout"},{tester:mg(1,dg("Label")),renderer:"jsonforms-lit-label"},{tester:mg(4,vg),renderer:"jsonforms-lit-enum-control"},{tester:mg(3,yg),renderer:"jsonforms-lit-text-control"},{tester:mg(3,hg(gg,dg("Control"))),renderer:"jsonforms-lit-number-control"},{tester:mg(3,hg(bg,dg("Control"))),renderer:"jsonforms-lit-number-control"},{tester:mg(3,pg),renderer:"jsonforms-lit-boolean-control"}];var ik=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};let ok=class extends Xy{constructor(){super(...arguments),this.renderers=nk,this.readonly=!1,this.validationMode="ValidateAndShow",this.store=new _$({renderers:nk})}connectedCallback(){super.connectedCallback(),this.unsubscribe=this.store.subscribe(()=>this.onStoreChange()),this.captureCoreRefs()}disconnectedCallback(){this.unsubscribe?.(),this.unsubscribe=void 0,super.disconnectedCallback()}willUpdate(e){e.has("middleware")?this.recreateStore():(e.has("schema")&&this.store.setSchema(this.schema??{}),e.has("uischema")&&this.store.setUiSchema(this.uischema),e.has("data")&&this.store.setData(this.data??{}),e.has("renderers")&&this.store.setRenderers(this.renderers??[]),e.has("cells")&&this.store.setCells(this.cells??[]),e.has("uischemas")&&this.store.setUiSchemas(this.uischemas??[]),e.has("readonly")&&this.store.setReadonly(this.readonly),e.has("validationMode")&&this.store.setValidationMode(this.validationMode),e.has("ajv")&&this.store.setAjv(this.ajv),e.has("config")&&this.store.setConfig(this.config??{}),e.has("i18n")&&this.store.setI18n(this.i18n??{}),e.has("additionalErrors")&&this.store.setAdditionalErrors(this.additionalErrors??[]))}render(){const e=this.store.getState().jsonforms.core;return Ry`
      <jsonforms-lit-dispatch
        .store=${this.store}
        .schema=${e?.schema}
        .uischema=${e?.uischema}
  ...
  `,ik([iw({attribute:!1})],ok.prototype,"data",void 0),ik([iw({attribute:!1})],ok.prototype,"schema",void 0),ik([iw({attribute:!1})],ok.prototype,"uischema",void 0),ik([iw({attribute:!1})],ok.prototype,"renderers",void 0),ik([iw({attribute:!1})],ok.prototype,"cells",void 0),ik([iw({attribute:!1})],ok.prototype,"uischemas",void 0),ik([iw({type:Boolean})],ok.prototype,"readonly",void 0),ik([iw({type:String})],ok.prototype,"validationMode",void 0),ik([iw({attribute:!1})],ok.prototype,"ajv",void 0),ik([iw({attribute:!1})],ok.prototype,"config",void 0),ik([iw({attribute:!1})],ok.prototype,"i18n",void 0),ik([iw({attribute:!1})],ok.prototype,"additionalErrors",void 0),ik([iw({attribute:!1})],ok.prototype,"middleware",void 0),ik([ow()],ok.prototype,"store",void 0),ok=ik([tw("jsonforms-lit")],ok);const ak=e=>Ry`
  <svg
...
`,sk=e=>e?"Hide value":"Show value";var ck=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};const dk={accountNickname:"ach-account-nickname",routingNumber:"ach-routing-number",accountNumber:"ach-account-number",confirmAccountNumber:"ach-account-number-confirm"},uk=new Set(["routingNumber","accountNumber","confirmAccountNumber"]),lk=e=>uk.has(e);let hk=class extends R${constructor(){super(...arguments),this.revealed=!1}render(){const e=this.controlProps,t=e?.path;if(void 0===e||!1===e.visible||void 0===t||!(e=>e in dk)(t))return Ry``;const r=e.config,n=r?.draft,i=r?.encryption,o=n?.[t]??e.data??"",a=r?.errors?.[t],s=Boolean(r?.disabled)||!e.enabled||Boolean(e.readonly),c=n&&i&&lk(t)?((e,t,r)=>"routingNumber"===e||u$(t[e],r[e])?"text":"password")(t,n,i):"text",d="password"===c,u=d&&this.revealed?"text":c,l=lk(t)?"numeric":void 0,h=["field","field-full","field-card-form"];a&&h.push("field-invalid");const f=["field-control","field-control-card-form"];return d&&f.push("field-control-reveal"),Ry`
      <div class=${h.join(" ")}>
        <label
        ...
        <div class=${f.join(" ")}>
          <input
            ...
            aria-describedby=${aw(a?`${dk[t]}-error`:void 0)}
            ?disabled=${s}
            @input=${t=>{e.handleChange(e.path,t.currentTarget.value)}}
          />
          ${d?Ry`
  ...
  *::after {
  ...
  .payment-method-row-main-radio {
    grid-template-columns: 1.125rem 2.375rem minmax(0, 1fr) auto;
  }
...
`,px=(...e)=>e.filter(Boolean).join(" "),vx=e=>{const t=e?.trim();return t||void 0},bx=(e,t)=>{const r=((e,t)=>"verified"===e?{label:t??"Ready",tone:"success"}:"under-review"===e?{label:"Needs review",tone:"warning"}:"require-info"===e?{label:"Needs info",tone:"warning"}:"declined"===e?{label:"Can't use",tone:"danger"}:{label:"Action required",tone:"warning"})(e,t);return Ry`
    <span
  ...
  `},gx=e=>{return"require-info"===(t=e.status)||"not-verified"===t;var t},yx=e=>e.selectionEligible??"verified"===e.status,wx=e=>{const t=vx(e.accountLabel)??(({label:e,brand:t,last4:r})=>{const n=vx(e),i=vx(t);return r&&i&&i!==n?`${i} •••• ${r}`:r?`•••• ${r}`:i??""})(e),r=vx(e.label)??t,n=Boolean(t)||e.isDefault;return Ry`
    <span class="payment-method-copy">
      <span class="payment-method-title-row">
        <span class="payment-method-title">${r}</span>
        ${(e=>!1!==e.showVerificationStatus)(e)?bx(e.status,e.verificationLabel):""}
      </span>
      ${n?Ry`
  ...
  `},$x=({balanceLabel:e,balanceLoading:t})=>t?Ry`
      <span
        class="payment-method-balance-loading"
        role="status"
        aria-label="Loading balance"
      ></span>
    `:e?Ry`<span class="payment-method-balance">${e}</span>`:"",kx=(e,t)=>Ry`
...
`,xx=(e,t)=>Ry`
  <span class="payment-method-icon-chip" aria-hidden="true">
    <img
      ...
      data-payment-method-icon=${nx(e)}
      src=${ix(e)}
      alt=""
    />
  </span>
  ${wx(e)} ${t}
`,Cx=(e,t=gx(e))=>{const r=xx(e,kx(e,t));return t?Ry`
      <button
    ...
    `:Ry`<span class="payment-method-row-main">${r}</span>`},Ex=({label:e,variant:t="primary",action:r,type:n="button",icon:i,disabled:o=!1,loading:a=!1})=>Ry`
  <button
    class=${px("button",`button-${t}`,a&&"button-loading")}
...
`,jx=({id:e,label:t,name:r,value:n="",placeholder:i,type:o="text",span:a="default",variant:s="default",autocomplete:c,inputmode:d,disabled:u=!1,dataField:l,dataFieldScope:h="card",error:f,maskable:m=!1,revealed:p=!1,onToggleReveal:v})=>{const b=px("field","full"===a&&"field-full","card-form"===s&&"field-card-form",f&&"field-invalid"),g=px("field-label","card-form"===s&&"field-label-card-form"),y=px("field-input","card-form"===s&&"field-input-card-form"),w=m&&!p?"password":o,$=Ry`
    <input
      class=${y}
      id=${e}
      name=${aw(r)}
  ...
  `,k=m&&v?Ry`
        ...
        `:"",x=px("field-control","field-control-card-form",m&&"field-control-reveal");return Ry`
    <div class=${b}>
      <label class=${g} for=${e}>${t}</label>
      ${"card-form"===s||m?Ry`
            <div class=${x}>${$}${k}</div>
          `:$}
      ${f?Ry`<p class="field-error" id=${`${e}-error`}>${f}</p>`:""}
    </div>
  `},Sx=({id:e,label:t,name:r,value:n="",options:i,span:o="default",variant:a="default",disabled:s=!1,dataField:c,dataFieldScope:d="card",error:u})=>{const l=px("field","card-form"!==a&&"field-with-select","full"===o&&"field-full","card-form"===a&&"field-card-form",u&&"field-invalid"),h=px("field-label","card-form"===a&&"field-label-card-form"),f=px("field-input","field-select","card-form"===a&&"field-input-card-form"),m=Ry`
    <select
      class=${f}
      id=${e}
      name=${aw(r)}
...
`,Ix=({id:e,label:t,status:r,type:n,eyebrow:i,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:u,verificationLabel:l,selectionEligible:h,isDefault:f,disabled:m=!1},{deleteDisabled:p=!1,confirmingDelete:v=!1,menuOpen:b=!1,menuPlacement:g="below",selected:y=!1,selectable:w=!1,showMarkAsDefault:$=!1}={})=>{const k={id:e,label:t,status:r,type:n,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:u,verificationLabel:l,selectionEligible:h,isDefault:f,disabled:m};if(v&&!k.isDefault)return Ry`
  ...
  `)(e,t,p)}
    ...
    `;const x=w&&yx(k);return Ry`
    <div
      class=${px("payment-method-row",x||gx(k)?"payment-method-row-action":"payment-method-row-static",x&&"payment-method-row-radio",y&&x&&"payment-method-row-selected",k.isDefault&&"payment-method-row-default",b&&!k.isDefault&&"payment-method-row-menu-open")}
      part="payment-method-row"
      aria-label=${t}
  ...
  >
    <input
      ...
      ?disabled=${e.disabled}
    />
    ${xx(e,Ry`<span class="payment-method-trailing">
        ${$x(e)}
      </span>`)}
  </label>
`)(k,y):Cx(k)}
      ${((e,{menuOpen:t,menuPlacement:r,showMarkAsDefault:n})=>{const i=`payment-method-menu-${e.id}`,o=n&&!e.isDefault&&yx(e),a=!e.isDefault;return o||a?Ry`
    <span class="payment-method-overflow">
      ...
      ${t?Ry`
            <span
              class=${px("payment-method-menu","above"===r&&"payment-method-menu-above")}
              id=${i}
              role="menu"
            >
              ${o?Ry`
  ...
  `:Ry``})(k,{menuOpen:b,menuPlacement:g,showMarkAsDefault:$})}
    </div>
  ...
  `,Nx=({label:e,subtitle:t,action:r,icon:n,variant:i="card",disabled:o=!1})=>"link"===i?Ry`
        <button
...
`,Rx=({containerId:e,title:t,loadingLabel:r,loading:n=!1})=>Ry`
  <div
    class=${px("provider-frame",n&&"provider-frame-loading")}
    part="provider-frame"
  ...
  >
    ...
    <slot class="provider-frame-slot" name=${e}>
      <div
        class=${px("provider-frame-container",n&&"provider-frame-container-loading")}
        id=${e}
      ></div>
    </slot>
    ${n?Ry`
...
`,Px=({label:e,action:t,icon:r,variant:n="default",disabled:i=!1})=>Ry`
  <button
    class=${px("text-link-button",`text-link-button-${n}`,r&&`text-link-button-${r}`)}
    type="button"
    data-action=${t}
    ?disabled=${i}
  >
...
`,Lx=e=>Ry` <div class="form-grid">${e}</div> `,Dx=e=>`We sent a one-time code to ${e??"your contact method"}.`,Bx=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input")),qx=({status:e,value:t,length:r,failedMessage:n,copy:i,submitting:o=!1,resending:a=!1})=>{const s="OTP_VALIDATION_FAILED"===e;return Ry`
    <form class="otp-flow" data-submit-action="verify-otp">
      ${s?Ax({variant:"danger",message:n??i.failedMessage}):""}
  ...
  `})({label:"Verification code",value:t,length:r,disabled:o,error:s})}
      <div class="primitive-footer">
        ${Ex({label:o?i.verifyingButton:s?i.tryAgainButton:i.verifyButton,icon:o||s?void 0:"check",variant:"primary",action:"verify-otp",type:"submit",loading:o,disabled:o||t.length<r})}
      </div>
  ...
  <button
    class=${px("otp-resend",n&&"otp-resend-loading")}
    type="button"
    data-action=${t}
    aria-busy=${n?"true":"false"}
    ?disabled=${r||n}
  ...
  `};var Hx=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};const Wx="onSelect",Kx="onAddPaymentMethod",Gx="onVerifyPaymentMethod",Yx="onDeletePaymentMethod",Jx="onListPaymentMethods",Zx="onTransfer",Qx="onError",Xx="commerce-hub-pbb-provider",eC=bb(o$,"VerticalLayout");let tC=class extends ok{createRenderRoot(){return this}};tC=Hx([tw("commerce-hub-bank-account-jsonforms")],tC);const rC="OTP_VALIDATION_SUCCESS",nC=[{value:"",label:"Select country or region"},{value:"US",label:"United States"}],iC=[{value:"",label:"Select state"},...[["AL","Alabama"],["AK","Alaska"],["AZ","Arizona"],["AR","Arkansas"],["CA","California"],["CO","Colorado"],["CT","Connecticut"],["DE","Delaware"],["FL","Florida"],["GA","Georgia"],["HI","Hawaii"],["ID","Idaho"],["IL","Illinois"],["IN","Indiana"],["IA","Iowa"],["KS","Kansas"],["KY","Kentucky"],["LA","Louisiana"],["ME","Maine"],["MD","Maryland"],["MA","Massachusetts"],["MI","Michigan"],["MN","Minnesota"],["MS","Mississippi"],["MO","Missouri"],["MT","Montana"],["NE","Nebraska"],["NV","Nevada"],["NH","New Hampshire"],["NJ","New Jersey"],["NM","New Mexico"],["NY","New York"],["NC","North Carolina"],["ND","North Dakota"],["OH","Ohio"],["OK","Oklahoma"],["OR","Oregon"],["PA","Pennsylvania"],["RI","Rhode Island"],["SC","South Carolina"],["SD","South Dakota"],["TN","Tennessee"],["TX","Texas"],["UT","Utah"],["VT","Vermont"],["VA","Virginia"],["WA","Washington"],["WV","West Virginia"],["WI","Wisconsin"],["WY","Wyoming"],["DC","District of Columbia"]].map(([e,t])=>({value:e,label:t}))],oC={apiKey:"YqIvg89urE1WsAdgWwM1EiQTRM1ajSYCaLhnDvimvmHeB78A",configId:"cce84049-0940-4926-9a54-9eaca0c09830",environment:"qa",locale:"en-US",paymentSdkUrl:"https://connect-qa.fiservapis.com/pbb/sdk/web/v2/js/PaymentSDK.js"};let aC=class extends Xy{constructor(){super(...arguments),this.otpValue="",this.bankLinkLoading=!1,this.bankAccountInstrumentSchemas=[],this.selectedBankCurrencyCode="",this.selectedBankAccountType="",this.selectedBankPaymentType="",this.bankAccountFormData={},this.bankAccountFormValid=!1,this.bankAccountValidationAttempted=!1,this.bankBillingAddressValue="",this.bankBillingAddressSelectorExpanded=!1,this.legacyBankAccountDraft={accountNickname:"",routingNumber:"",accountNumber:"",confirmAccountNumber:""},this.legacyBankAccountDraftErrors={},this.legacyBankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},confirmAccountNumber:{status:"idle",normalizedValue:""}},this.bankAccountConfigRequestToken=0,this.bankProviderRequestToken=0,this.transferDraft={fromSourceId:"",toSourceId:"",amount:""},this.transferDraftErrors={},this.transferValidationAttempted=!1,this.transferSubmitSuccess=!1,this.transferFlowActive=!1,this.transferFlowScreen="form",this.cardDraft=Mw(),this.cardDraftErrors={},this.cardValidationAttempted=!1,this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.cardEncryptionTasks={},this.revealedCardFields=new Set,this.billingAddresses=[],this.billingAddressSelectorExpanded=!1,this.paymentSourceMenuPlacement="below",this.addLauncherActive=!1,this.savedSourceVerificationFailed=!1,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoValidationAttempted=!1,this.requiredInfoFiles={},this.interactionRefresh=new Aw(this),this.nativeBalance=new Ow(this),this.minimumVerificationOverlayToken=0,this.handleSubmit=e=>{e.preventDefault();const t=eE(e,"submitAction");"verify-otp"===t?this.verifyOtp():"submit-required-info"===t?this.submitRequiredInfo():"transfer"===t?this.reviewTransfer():"confirm-transfer"===t?this.submitTransfer():"save-card"===t?this.saveCard():"save-bank-account"===t&&this.saveManualBankAccount()},this.handleClick=e=>{const t=eE(e,"action"),r=eE(e,"paymentMethodId");if(!t){const t=e.composedPath().some(e=>e instanceof HTMLElement&&e.classList.contains("payment-method-overflow"));return void(this.openPaymentSourceMenuId&&!t&&(this.openPaymentSourceMenuId=void 0))}if("toggle-payment-source-menu"!==t)if(this.openPaymentSourceMenuId=void 0,"mark-payment-source-default"!==t){if("attach-payment-source"===t){const e=r??this.selectedPaymentSourceId;return void(e&&(this.clearDeletePaymentSourceConfirmation(),this.attachPaymentSource(e)))}if("open-add-payment-source"===t){const e=IC(this.interactionResponse);return this.attachmentError=void 0,void(e.card&&e.bankAccount?(this.addLauncherActive=!0,this.focusAfterUpdate('[data-action="close-add-payment-source"]')):e.card?this.showAddCardScreen():e.bankAccount&&this.startBankAccountFlow())}if("close-add-payment-source"!==t){if("change-payment-source"===t)return this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("retry-interaction-refresh"!==t)if("verify-payment-source"!==t)if("delete-payment-source"!==t){if("done-payment-source-verification"===t)return this.resetSavedSourceVerification(),void this.showPaymentSourceList({refresh:!0});if("open-required-info-file-picker"===t)return this.pendingRequiredInfoDocKey=eE(e,"requiredInfoDocKey")??this.firstRequiredInfoDocKey(),void this.renderRoot.querySelector(".required-info-file-input")?.click();if("submit-required-info"!==t){if("open-transfer"===t)return this.paymentSourceView="list",this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),this.resetTransferFlow(),void(this.transferFlowActive=!0);if("transfer"!==t)if("edit-transfer"!==t)if("confirm-transfer"!==t)if("verify-otp"!==t)if("resend-otp"!==t)if("select-instrument-schema"!==t)if("save-bank-account"!==t){if("back-to-instrument-schema-selection"===t)return this.clearManualBankAccountForm(),void(this.bankFlowScreen="manual-schema-selection");if("add-bank-account"===t||"use-bank-account-instead"===t||"retry-bank-provider"===t||"use-different-bank-account"===t)return this.addLauncherActive=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),this.resetBankFlow(),void this.startBankAccountFlow();if("back-to-bank-provider"===t)return this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),this.resetBankFlow(),void this.startPayByBankFlow();if("add-ach-manually"===t)return this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),void this.showManualBankAccountScreen();if("back-to-payment-methods"===t)return this.addLauncherActive=!1,this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("continue-bank-outcome"===t||"done-bank-outcome"===t)return this.resetBankFlow(),void this.showPaymentSourceList({refresh:!0});if("add-card"===t)return this.addLauncherActive=!1,this.paymentSourceView="list",this.resetRequiredInfo(),void this.showAddCardScreen();if("change-billing-address"!==t)if("change-bank-billing-address"!==t)if("save-card"!==t){if("edit-card-details"!==t)return"use-different-method"===t?(this.resetCardFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0})):void 0;this.cardFlowScreen="form"}else this.saveCard();else this.bankBillingAddressSelectorExpanded=!0;else this.billingAddressSelectorExpanded=!0}else this.saveManualBankAccount();else this.initializeManualBankAccountScreen();else this.resendOtp();else this.verifyOtp();else this.submitTransfer();else this.transferFlowScreen="form";else this.reviewTransfer()}else this.submitRequiredInfo()}else r&&this.deletePaymentSource(r);else r&&(this.clearDeletePaymentSourceConfirmation(),this.verifySavedPaymentSource(r));else this.retryInteractionRefresh()}else this.closeAddPaymentSourceSheet()}else r&&(this.clearDeletePaymentSourceConfirmation(),this.attachPaymentSource(r,"mark-default"));else if(r){const t=this.openPaymentSourceMenuId!==r,n=e.composedPath().find(e=>e instanceof HTMLElement&&"toggle-payment-source-menu"===e.dataset.action);this.clearDeletePaymentSourceConfirmation(),this.paymentSourceMenuPlacement=t&&this.shouldOpenPaymentSourceMenuAbove(n)?"above":"below",this.openPaymentSourceMenuId=t?r:void 0}},this.handleInput=e=>{const t=sC(e);if(t)return void this.storeRequiredInfoSsnInput(t);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.cardField));if(r)return void this.updateCardDraftField(r.dataset.cardField,r.value);const n=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.bankAccountField));if(n)return void this.updateLegacyBankAccountDraftField(n.dataset.bankAccountField,n.value);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.transferField));if(i)return void this.updateTransferDraftField(i.dataset.transferField,i.value);const o=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoDocKey));if(o)return void this.storeRequiredInfoValue(o.dataset.requiredInfoDocKey,o.value);const a=e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input"));if(!a)return;const s=this.getOtpInputs(),c=Number(a.dataset.otpIndex),d=Wk(a.value);if(!d)return a.value="",void this.syncOtpValueFromInputs(s);if(1===d.length)return a.value=d,this.syncOtpValueFromInputs(s),void this.focusOtpInput(s,c+1);const u=this.writeOtpDigits(s,c,d);this.syncOtpValueFromInputs(s),this.focusOtpInput(s,Math.min(c+d.length,s.length-1),u)},this.handleKeyDown=e=>{if("Escape"===e.key&&this.openPaymentSourceMenuId&&!this.pendingAction){const t=this.openPaymentSourceMenuId;return e.preventDefault(),this.openPaymentSourceMenuId=void 0,void this.updateComplete.then(()=>{this.renderRoot.querySelector(`[data-action="toggle-payment-source-menu"][data-payment-method-id="${CSS.escape(t)}"]`)?.focus()})}if(this.addLauncherActive&&"Tab"===e.key){const t=[...this.renderRoot.querySelectorAll(".add-payment-sheet button:not(:disabled)")],r=t[0],n=t[t.length-1],i=this.shadowRoot?.activeElement;if(!r||!n)return;return void(e.shiftKey&&i===r?(e.preventDefault(),n.focus()):(e.shiftKey||i!==n)&&t.includes(i)||(e.preventDefault(),r.focus()))}if(this.addLauncherActive&&"Escape"===e.key&&!this.pendingAction)return e.preventDefault(),void this.closeAddPaymentSourceSheet();if("Escape"===e.key&&!this.pendingAction&&(this.addLauncherActive||this.cardFlowScreen||this.bankFlowScreen||this.requiredInfoSource||this.savedSourceVerificationSource||this.transferFlowActive))return e.preventDefault(),this.addLauncherActive=!1,this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),this.resetSavedSourceVerification(),void this.showPaymentSourceList();const t=e.composedPath().find(e=>e instanceof HTMLButtonElement&&"tab"===e.getAttribute("role"));if(t&&("ArrowLeft"===e.key||"ArrowRight"===e.key||"Home"===e.key||"End"===e.key)){const r=[...this.renderRoot.querySelectorAll('[role="tab"]')],n=r.indexOf(t),i=r["Home"===e.key?0:"End"===e.key?r.length-1:(n+("ArrowRight"===e.key?1:-1)+r.length)%r.length];return e.preventDefault(),void(i&&i!==t&&(i.focus(),i.click()))}const r=Bx(e);if(!r)return;const n=this.getOtpInputs(),i=Number(r.dataset.otpIndex);return"ArrowLeft"===e.key?(e.preventDefault(),void this.focusOtpInput(n,i-1)):"ArrowRight"===e.key?(e.preventDefault(),void this.focusOtpInput(n,i+1)):"Backspace"===e.key?(e.preventDefault(),r.value?r.value="":i>0&&(n[i-1].value=""),this.syncOtpValueFromInputs(n),void this.focusOtpInput(n,Math.max(i-1,0))):"Delete"===e.key?(e.preventDefault(),r.value="",void this.syncOtpValueFromInputs(n)):void(e.ctrlKey||e.metaKey||e.altKey||1!==e.key.length||/\d/.test(e.key)||e.preventDefault())},this.handleChange=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.paymentMethodRadio));if(t)return this.selectedPaymentSourceId=t.value,void(this.attachmentError=void 0);const r=e.composedPath().find(e=>e instanceof HTMLSelectElement&&["instrumentSchemaCurrency","instrumentSchemaAccountType","instrumentSchemaPaymentType"].includes(e.name));if("instrumentSchemaCurrency"===r?.name)return this.selectedBankCurrencyCode=r.value,this.selectedBankAccountType="",this.selectedBankPaymentType="",void(this.selectedBankAccountInstrumentSchemaCode=void 0);if("instrumentSchemaAccountType"===r?.name)return this.selectedBankAccountType="BUSINESS"===r.value||"PERSONAL"===r.value?r.value:"",this.selectedBankPaymentType="",void(this.selectedBankAccountInstrumentSchemaCode=void 0);if("instrumentSchemaPaymentType"===r?.name){this.selectedBankPaymentType=r.value;const e=((e,t,r,n)=>{const i=e.filter(e=>e.currencyCode===t&&e.accountType===r&&e.paymentType===n);return 1===i.length?i[0].schema:void 0})(Dk(this.bankAccountInstrumentSchemas),this.selectedBankCurrencyCode,this.selectedBankAccountType,this.selectedBankPaymentType);return void(this.selectedBankAccountInstrumentSchemaCode=e?.bavSupportedCode)}const n=e.composedPath().find(e=>e instanceof HTMLSelectElement&&"bankBillingAddress"===e.name);if(n)return void this.updateBankBillingAddress(n.value);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoFileInput));if(i)return this.storeRequiredInfoSelectedFile(i.files?.[0]),void(i.value="");const o=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.cardField));if(o)return void this.updateCardDraftField(o.dataset.cardField,o.value);const a=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.transferField));a&&this.updateTransferDraftField(a.dataset.transferField,a.value)},this.handleBankAccountFormDataChange=e=>{const t=e.detail.data;this.bankAccountFormData="object"!=typeof t||null===t||Array.isArray(t)?{}:t,this.bankAccountFormValid=0===(e.detail.errors?.length??0),this.bankAccountSubmitError=void 0},this.handleBankAccountFormErrorsChange=e=>{this.bankAccountFormValid=0===(e.detail.errors?.length??0)},this.handlePaste=e=>{const t=sC(e);if(t)return void this.pasteRequiredInfoSsnInput(e,t);const r=Bx(e);if(!r)return;const n=e,i="function"==typeof n.clipboardData?.getData?n.clipboardData.getData("text"):"",o=Wk(i);if(!o)return;e.preventDefault();const a=this.getOtpInputs(),s=Number(r.dataset.otpIndex),c=this.writeOtpDigits(a,s,o);this.syncOtpValueFromInputs(a),this.focusOtpInput(a,Math.min(s+o.length,a.length-1),c)},this.handleFocusIn=e=>{const t=Bx(e);t&&t.value&&requestAnimationFrame(()=>{this.renderRoot.contains(t)&&t.select()})},this.handleFocusLost=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Pw(e.dataset.cardField));if(t)return void this.trackCardFieldEncryption(t.dataset.cardField,t.value);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&c$(e.dataset.bankAccountField));r&&this.encryptLegacyBankAccountField(r.dataset.bankAccountField,r.value)}}willUpdate(e){if(e.has("interactionResponse")&&this.interactionResponse){const t=e.get("interactionResponse");t?.interactionId!==this.interactionResponse.interactionId&&(this.pendingAction=void 0,this.clearDeletePaymentSourceConfirmation(),this.paymentSourceView=void 0,this.openPaymentSourceMenuId=void 0,this.interactionRefresh.reset({requestUpdate:!1}),this.nativeBalance.reset({requestUpdate:!1}),this.billingAddresses=[],this.resetBankFlow(),this.resetTransferFlow(),this.resetSavedSourceVerification(),this.resetRequiredInfo()),this.interactionResponse.paymentSources?.length||this.interactionResponse.selectedSource||(this.openPaymentSourceMenuId=void 0),this.syncBillingAddressesFromInteractionResponse(this.interactionResponse),this.selectedPaymentSourceId=HC(this.interactionResponse,this.selectedPaymentSourceId)}}updated(e){e.has("designConfig")&&this.syncDesignConfigStyles(),e.has("interactionResponse")&&this.deleteConfirmationPaymentSourceId&&!this.findPaymentSourceById(this.deleteConfirmationPaymentSourceId)&&this.clearDeletePaymentSourceConfirmation(),e.has("interactionResponse")&&this.refreshPaymentSourcesFromInteraction()}render(){return Ry`
      ...
      >
        <span class="screen-reader-status" role="status" aria-live="polite"
          >${hE(this.pendingAction)}</span
        >
        ${this.renderCurrentScreen()}
        ${this.addLauncherActive?this.renderAddPaymentSourceSheet():""}
      </div>
    `}disconnectedCallback(){super.disconnectedCallback(),this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow()}emitSdkEvent(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t}))}focusAfterUpdate(...e){this.updateComplete.then(()=>{for(const t of e){const e=this.renderRoot.querySelector(t);if(e)return void e.focus()}})}renderWidgetShell({busy:e=!1,overlay:t,...r}){const n=uE(this.minimumVerificationOverlayAction);return(({title:e,subtitle:t,content:r,backAction:n,backDisabled:i=!1,titleAction:o,headerAction:a,footer:s,width:c="default",layout:d="default",ariaLabel:u="Commerce Hub Connect",closeAction:l="close",showClose:h=!0,showDivider:f=!1,showFooter:m=!0,busy:p=!1,overlay:v})=>Ry`
  <section
    class=${px("widget-shell","wide"===c&&"widget-shell-wide","payment-methods"===d&&"widget-shell-payment-methods",p&&"widget-shell-busy")}
    part="shell"
    aria-label=${u}
...
`)({...r,busy:e||Boolean(n),overlay:t??n})}showMinimumVerificationOverlay(e){const t=this.minimumVerificationOverlayToken+=1;this.minimumVerificationOverlayAction=e,window.setTimeout(()=>{this.minimumVerificationOverlayToken===t&&(this.minimumVerificationOverlayAction=void 0)},2e3)}renderCurrentScreen(){if(!this.interactionResponse)return this.renderMissingInteractionResponseScreen();if("provider"===this.bankFlowScreen)return this.renderBankProviderScreen();if("outcome"===this.bankFlowScreen)return this.renderBankOutcomeScreen();if("manual-config-loading"===this.bankFlowScreen)return this.renderManualBankAccountConfigLoadingScreen();if("manual-config-error"===this.bankFlowScreen)return this.renderManualBankAccountConfigErrorScreen();if("manual-schema-selection"===this.bankFlowScreen)return this.renderManualBankAccountSchemaSelectionScreen();if("manual"===this.bankFlowScreen)return this.renderManualBankAccountScreen();if("form"===this.cardFlowScreen)return this.renderAddCardScreen();if("error"===this.cardFlowScreen)return this.renderCardErrorScreen();if(this.requiredInfoSource)return this.renderRequiredInfoScreen();if(this.savedSourceVerificationSource)return this.renderSavedSourceVerificationOutcomeScreen();const e=this.interactionResponse?.status;return"OTP_VALIDATION_PENDING"===e||"OTP_VALIDATION_FAILED"===e?this.renderOtpScreen(e):this.shouldRenderTransferScreen()?this.renderTransferScreen():this.renderPaymentSourceScreen()}renderMissingInteractionResponseScreen(){return this.renderWidgetShell({title:"Configuration required",showClose:!1,showDivider:!1,content:Ry`
        <div class="payment-flow">
          ${Ax({variant:"danger",message:"CommerceHub Connect requires an interaction response before it can load payment methods."})}
        </div>
      `})}renderOtpScreen(e){const t=gC(this.designConfig),r="verify-otp"===this.pendingAction,n="resend-otp"===this.pendingAction,i=bC(this.interactionResponse);let o;return r?o=dE({title:"Verifying code",helper:"Verifying your code, please wait."}):n&&(o=dE({title:"Sending code",helper:"Sending a new code, please wait."})),this.renderWidgetShell({title:t.title,subtitle:t.subtitle??Dx(i),showClose:!1,showDivider:!1,busy:r||n,overlay:o,content:qx({status:e,value:this.otpValue,length:6,failedMessage:this.otpErrorMessage,copy:t,submitting:r,resending:n})})}renderPaymentSourceScreen(){const e=yC(this.designConfig),t=OC(this.interactionResponse,{nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}),r=IC(this.interactionResponse),n=GC(this.interactionResponse,"ADD_ACCOUNT")&&(r.card||r.bankAccount),i=GC(this.interactionResponse,"SELECT"),o=GC(this.interactionResponse,"TRANSFER")&&BC(this.interactionResponse).length>=2,a="attach-payment-source"===this.pendingAction||"verify-payment-source"===this.pendingAction||"delete-payment-source"===this.pendingAction;if(this.shouldRenderPaymentSourceRefreshSkeleton())return this.renderWidgetShell({title:e.title,layout:"payment-methods",headerAction:Ry`
          <div
        ...
        `,showClose:!1,content:Vx()});if(this.shouldRenderPaymentSourceRefreshError())return this.renderPaymentSourceRefreshErrorScreen();if(!t.length)return this.renderNoSavedPaymentMethods();if(this.shouldRenderSelectedPaymentSourceScreen())return this.renderSelectedPaymentSourceScreen();this.queueNativeAccountBalanceRefresh();const s=o?Ry`
          <div class="widget-toolbar" aria-label="Payment method actions">
            ${Px({label:"Transfer",action:"open-transfer",icon:"transfer",disabled:a})}
          </div>
        `:void 0;return this.renderWidgetShell({title:e.title,layout:"payment-methods",headerAction:s,showClose:!1,busy:a,overlay:lE(this.pendingAction),content:Ry`
        ${this.attachmentError?Ax({variant:"danger",message:this.attachmentError}):""}
        ${Ux({methods:t,canAddPaymentSources:n,canSelectPaymentSources:i,actionPending:a,selectedPaymentSourceId:this.selectedPaymentSourceId,openPaymentSourceMenuId:this.openPaymentSourceMenuId,paymentSourceMenuPlacement:this.paymentSourceMenuPlacement,deleteConfirmationPaymentSourceId:this.deleteConfirmationPaymentSourceId})}
      `,footer:n||i?Ry`
              <div
                class="payment-method-add-footer"
                aria-label="Payment method actions"
              >
                ${i?Ex({label:"attach-payment-source"===this.pendingAction?e.continuingButton:e.continueButton,action:"attach-payment-source",loading:"attach-payment-source"===this.pendingAction,disabled:!this.selectedPaymentSourceId||a}):""}
                ${n?Ex({label:"Add payment method",action:"open-add-payment-source",icon:"plus",disabled:a}):""}
              </div>
            `:void 0})}renderAddPaymentSourceSheet(){const e=IC(this.interactionResponse);return Ry`
    ...
    `}renderPaymentSourceRefreshErrorScreen(){return this.renderWidgetShell({title:"Payment methods unavailable",showClose:!1,content:Ry`
        <div class="payment-flow">
          ${Ax({variant:"danger",message:this.interactionRefresh.errorMessage??"We couldn't load payment methods. Try again."})}
          <div class="primitive-footer">
            ${Ex({label:"Try again",variant:"primary",action:"retry-interaction-refresh"})}
          </div>
        </div>
      `})}renderSelectedPaymentSourceScreen(){const e=WC(this.interactionResponse,this.selectedPaymentSourceId);return e?this.renderWidgetShell({title:"Payment method saved",headerAction:Px({label:"Change",action:"change-payment-source",disabled:"attach-payment-source"===this.pendingAction}),showClose:!1,showDivider:!1,busy:"attach-payment-source"===this.pendingAction,overlay:"attach-payment-source"===this.pendingAction?dE({title:OE(e)?"Saving bank account":"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,content:Ry`
        <div class="payment-flow">
          ${_x(zC(e,{selected:!0,nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}))}
        </div>
      `}):(this.paymentSourceView="list",this.renderPaymentSourceScreen())}shouldRenderSelectedPaymentSourceScreen(){return"list"!==this.paymentSourceView&&("PAYMENT_SOURCE_ATTACHED"===this.interactionResponse?.status||"selected"===this.paymentSourceView)}shouldRenderPaymentSourceRefreshSkeleton(){return this.interactionRefresh.shouldRenderSkeleton(this.interactionResponse)}shouldRenderPaymentSourceRefreshError(){return this.interactionRefresh.shouldRenderError(this.interactionResponse)}renderSavedSourceVerificationOutcomeScreen(){const e=this.savedSourceVerificationSource,t=mE(e,this.savedSourceVerificationFailed),r="declined"===t.kind||"pending"===t.kind;return this.renderWidgetShell({title:t.title,backAction:r?"done-payment-source-verification":void 0,showClose:!1,showDivider:!1,content:Ry`
        <div class="verification-outcome-flow">
          ${Ax({variant:t.variant,message:t.message})}
          ${e?jE(e):""}
          ${r?"":Ry`
                <div class="primitive-footer">
                  ${Ex({label:"Back to payment methods",action:"done-payment-source-verification"})}
                </div>
              `}
        </div>
      `})}renderRequiredInfoScreen(){const e=this.requiredInfoSource;if(!e)return this.renderPaymentSourceScreen();const t=pE(e),r=$E(t),n="submit-required-info"===this.pendingAction,i=this.canSubmitRequiredInfo();return this.renderWidgetShell({title:"Complete account verification",backAction:"back-to-payment-methods",backDisabled:n,showClose:!1,showDivider:!1,busy:n,overlay:n?dE({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,content:Ry`
        <form
          class="required-info-flow"
          data-submit-action="submit-required-info"
        >
          ${jE(e)}
          ${this.requiredInfoSubmitError?Ax({variant:"danger",message:this.requiredInfoSubmitError}):""}
          ...
          <div class="required-info-documents">
            ...
            <div class="primitive-stack">
              ${t.map((e,t)=>{const r=vE(e,t),i=bE(e)?this.requiredInfoValues[r]:this.requiredInfoFileNames[r],o=this.visibleRequiredInfoError(e,t);return bE(e)?kE({doc:e,key:r,value:i??"",error:o}):Ry`
                  <div
                    class="required-info-document required-document-text-row"
                    data-required-info-doc-key=${r}
                    data-required-info-requirement=${yE(e)}
                  >
...
`)({label:"Required document",requirements:CE(e),actionLabel:"Choose file",fileName:i,action:"open-required-info-file-picker",disabled:n})}
                    ${o?Ry`<p
                          class="field-error"
          ...
          <div
            ...
            data-required-info-doc-key=${r??""}
          >
            ${Ex({label:n?"Verifying...":"Verify",action:"submit-required-info",type:"submit",loading:n,disabled:n||!i})}
          </div>
        </form>
      `})}renderNoSavedPaymentMethods(){const e=wC(this.designConfig),t="delete-payment-source"===this.pendingAction,r=IC(this.interactionResponse),n=GC(this.interactionResponse,"ADD_ACCOUNT")&&(r.card||r.bankAccount);return this.renderWidgetShell({title:e.title,subtitle:e.subtitle,showClose:!1,showDivider:!1,content:Fx({allowedTenderOptions:r,canAddPaymentSources:n,deletePending:t,copy:e})})}shouldRenderTransferScreen(){const e=this.interactionResponse;return(this.transferFlowActive||YC(e))&&KC(e?.status)}renderTransferScreen(){const e=BC(this.interactionResponse),t="transfer"===this.pendingAction,r=this.transferFlowActive?"back-to-payment-methods":void 0;if(e.length<2)return this.renderWidgetShell({title:"Transfer funds",backAction:r,backDisabled:t,showClose:!1,showDivider:!1,content:Ry`
          <div class="payment-flow">
            ${Ox({title:"Transfer unavailable",message:"At least two verified bank or native accounts are required to transfer funds."})}
          </div>
        `});const n=[{value:"",label:"Select account"},...e.map(e=>({value:LC(e),label:NC(e)}))],i=Jk(this.transferDraft),o=e.find(e=>LC(e)===i.fromSourceId),a=e.find(e=>LC(e)===i.toSourceId);return"confirm"===this.transferFlowScreen&&o&&a&&(s=i,c=e,0===Object.keys(Zk(Jk(s),c)).length)?this.renderTransferConfirmationScreen(o,a,i,t):this.renderWidgetShell({title:"Transfer funds",backAction:r,backDisabled:t,showClose:!1,showDivider:!1,busy:t,overlay:t?dE({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="transfer"
        >
          ${this.transferSubmitError?Ax({variant:"danger",message:this.transferSubmitError}):""}
          ${this.transferSubmitSuccess?Ax({variant:"success",message:"Transfer initiated."}):""}
          ${Lx([Sx({id:"transfer-from-source",name:"fromSourceId",label:"From",value:this.transferDraft.fromSourceId,options:n,span:"full",variant:"card-form",dataField:"fromSourceId",dataFieldScope:"transfer",error:this.transferValidationAttempted?this.transferDraftErrors.fromSourceId:void 0,disabled:t}),Sx({id:"transfer-to-source",name:"toSourceId",label:"To",value:this.transferDraft.toSourceId,options:n,span:"full",variant:"card-form",dataField:"toSourceId",dataFieldScope:"transfer",error:this.transferValidationAttempted?this.transferDraftErrors.toSourceId:void 0,disabled:t}),jx({id:"transfer-amount",name:"amount",label:"Amount",value:this.transferDraft.amount,variant:"card-form",inputmode:"decimal",dataField:"amount",dataFieldScope:"transfer",error:this.transferValidationAttempted?this.transferDraftErrors.amount:void 0,disabled:t})])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ex({label:t?"Transferring":"Transfer",action:"transfer",type:"submit",loading:t,disabled:t||!Qk(this.transferDraft)})}
            </div>
          </div>
        </form>
      `});var s,c}renderTransferConfirmationScreen(e,t,r,n){return this.renderWidgetShell({title:"Confirm transfer",backAction:"edit-transfer",backDisabled:n,showClose:!1,showDivider:!1,busy:n,overlay:n?dE({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="confirm-transfer"
        >
          ${this.transferSubmitError?Ax({variant:"danger",message:this.transferSubmitError}):""}
          ${Tx([{label:"From",value:NC(e)},{label:"To",value:NC(t)},{label:"Amount",value:Xk(r)}])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ex({label:n?"Transferring":"Confirm transfer",action:"confirm-transfer",type:"submit",loading:n,disabled:n})}
            </div>
            <div class="card-form-primary">
              ${Ex({label:"Edit",variant:"secondary",action:"edit-transfer",disabled:n})}
            </div>
          </div>
        </form>
      `})}renderAddCardScreen(){const e="save-card"===this.pendingAction,t="encrypting"===this.cardEncryption.cardNumber.status||"encrypting"===this.cardEncryption.cvv.status,r=[...this.billingAddresses.map(e=>({value:e.id??"",label:cC(e)})),{value:Rw,label:"Add new billing address"}],n=this.billingAddresses.find(e=>e.id===this.cardDraft.billingAddressValue),i=Boolean(n)&&!this.billingAddressSelectorExpanded,o=!i&&this.cardDraft.billingAddressValue===Rw,a=[];return n&&i?a.push(Ry`
      ...
      `):a.push(Sx({id:"billing-address",name:"billingAddress",label:"Billing address",value:this.cardDraft.billingAddressValue,options:r,span:"full",variant:"card-form",dataField:"billingAddressValue",error:this.visibleCardDraftError("billingAddressValue"),disabled:e})),o&&a.push(Sx({id:"billing-country",name:"country",label:"Country or region",value:this.cardDraft.country,options:nC,span:"full",variant:"card-form",dataField:"country",error:this.visibleCardDraftError("country"),disabled:e}),jx({id:"billing-address-line-1",name:"addressLine1",label:"Address",value:this.cardDraft.addressLine1,placeholder:"Street address",span:"full",variant:"card-form",autocomplete:"address-line1",dataField:"addressLine1",error:this.visibleCardDraftError("addressLine1"),disabled:e}),jx({id:"billing-address-line-2",name:"addressLine2",label:"Address line 2",value:this.cardDraft.addressLine2,placeholder:"Apartment, suite, unit",span:"full",variant:"card-form",autocomplete:"address-line2",dataField:"addressLine2",error:this.visibleCardDraftError("addressLine2"),disabled:e}),jx({id:"billing-city",name:"city",label:"City",value:this.cardDraft.city,span:"full",variant:"card-form",autocomplete:"address-level2",dataField:"city",error:this.visibleCardDraftError("city"),disabled:e}),Sx({id:"billing-state",name:"state",label:"State",value:this.cardDraft.state,options:iC,span:"full",variant:"card-form",dataField:"state",error:this.visibleCardDraftError("state"),disabled:e}),jx({id:"billing-zip",name:"zip",label:"ZIP code",value:this.cardDraft.zip,placeholder:"ZIP code",span:"full",variant:"card-form",autocomplete:"postal-code",inputmode:"numeric",dataField:"zip",error:this.visibleCardDraftError("zip"),disabled:e})),this.renderWidgetShell({title:"Add card",backAction:"back-to-payment-methods",backDisabled:e,showClose:!1,showDivider:!1,busy:e,overlay:e?dE({title:"Saving card",helper:"Securely saving your card, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="save-card"
        >
          ${this.cardSubmitError?Ax({variant:"danger",message:this.cardSubmitError}):""}
          ${Lx([jx({id:"card-label",name:"name",label:"Card Name",value:this.cardDraft.name,placeholder:"Corporate card",span:"full",variant:"card-form",dataField:"name",error:this.visibleCardDraftError("name"),disabled:e}),jx({id:"card-number",name:"cardNumber",label:"Card number",value:this.cardDraft.cardNumber,placeholder:"1234 1234 1234 1234",span:"full",variant:"card-form",autocomplete:"cc-number",inputmode:"numeric",dataField:"cardNumber",error:this.visibleCardDraftError("cardNumber"),disabled:e,maskable:!0,revealed:this.revealedCardFields.has("cardNumber"),onToggleReveal:()=>this.toggleCardFieldReveal("cardNumber")}),jx({id:"expiration-date",name:"expirationDate",label:"Expiration",value:this.cardDraft.expirationDate,placeholder:"MM / YY",variant:"card-form",autocomplete:"cc-exp",inputmode:"numeric",dataField:"expirationDate",error:this.visibleCardDraftError("expirationDate"),disabled:e}),jx({id:"card-cvv",name:"cvv",label:"CVC",value:this.cardDraft.cvv,placeholder:"3 or 4 digits",variant:"card-form",autocomplete:"cc-csc",inputmode:"numeric",dataField:"cvv",error:this.visibleCardDraftError("cvv"),disabled:e,maskable:!0,revealed:this.revealedCardFields.has("cvv"),onToggleReveal:()=>this.toggleCardFieldReveal("cvv")}),jx({id:"name-on-card",name:"fullName",label:"Full name",value:this.cardDraft.fullName,placeholder:"Name on card",span:"full",variant:"card-form",autocomplete:"cc-name",dataField:"fullName",error:this.visibleCardDraftError("fullName"),disabled:e}),...a])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Ex({label:e?"Saving payment method":"Save card",action:"save-card",type:"submit",loading:e,disabled:e||t||!Kw(this.cardDraft)})}
            </div>
          </div>
        </form>
      `})}renderCardErrorScreen(){return this.renderWidgetShell({title:"Credit card not saved",subtitle:"We could not save this card. Check the card details or use a different payment method.",showClose:!1,showDivider:!1,content:Mx({variant:"danger",content:this.cardSubmitError?Ax({variant:"danger",message:this.cardSubmitError}):void 0,actions:Ry`
          ${Ex({label:"Edit card details",action:"edit-card-details"})}
          ${Px({label:"Use a different method",action:"use-different-method"})}
        `})})}renderBankProviderScreen(){return this.renderWidgetShell({title:"Connect your bank",backAction:"back-to-payment-methods",backDisabled:this.bankLinkLoading,showClose:!1,showDivider:!1,busy:this.bankLinkLoading,overlay:this.bankLinkLoading?dE({title:"Connecting to your bank",helper:"Securely opening your bank connection, please wait."}):void 0,content:Rx({containerId:Xx,loading:this.bankLinkLoading,loadingLabel:"Connecting to your bank"}),footer:Ry`
        <div class="bank-provider-manual-link">
          ${Px({label:"Connect another way",action:"add-ach-manually",disabled:this.bankLinkLoading})}
        </div>
      `})}renderManualBankAccountConfigLoadingScreen(){return this.renderWidgetShell({title:"Select bank account type",backAction:this.manualBankAccountExitAction(),backDisabled:!0,showClose:!1,showDivider:!1,busy:!0,overlay:dE({title:"Loading instrument schemas",helper:"Loading the available bank account options, please wait."}),content:Ry`<div class="payment-flow card-form-screen"></div>`})}renderManualBankAccountConfigErrorScreen(){return this.renderWidgetShell({title:"Select bank account type",backAction:this.manualBankAccountExitAction(),showClose:!1,showDivider:!1,content:Ry`
        <div class="payment-flow card-form-screen">
          ${Ax({variant:"danger",message:this.bankAccountConfigError??"Unable to load instrument schemas. Try again."})}
          <div class="primitive-footer card-form-primary">
            ${Ex({label:"Try again",action:"add-ach-manually"})}
          </div>
        </div>
      `})}renderManualBankAccountSchemaSelectionScreen(){const e=Dk(this.bankAccountInstrumentSchemas),t=(e=>Bk(e.map(({currencyCode:e,currencyName:t})=>({value:e,label:t})),({label:e})=>e))(e),r=this.selectedBankCurrencyCode?((e,t)=>Bk(e.filter(e=>e.currencyCode===t).map(({accountType:e})=>({value:e,label:"BUSINESS"===e?"Business":"Personal"}))))(e,this.selectedBankCurrencyCode):[],n=this.selectedBankAccountType?((e,t,r)=>Bk(e.filter(e=>e.currencyCode===t&&e.accountType===r).map(({paymentType:e,schema:t})=>({value:e,label:t.productId}))))(e,this.selectedBankCurrencyCode,this.selectedBankAccountType):[];return this.renderWidgetShell({title:"Select bank account type",backAction:this.manualBankAccountExitAction(),showClose:!1,showDivider:!1,content:Ry`
        <div class="instrument-schema-selection payment-flow card-form-screen">
          ${Sx({id:"instrument-schema-currency",name:"instrumentSchemaCurrency",label:"Currency",value:this.selectedBankCurrencyCode,options:[{value:"",label:"Select currency"},...t],span:"full",variant:"card-form"})}
          ${this.selectedBankCurrencyCode?Sx({id:"instrument-schema-account-type",name:"instrumentSchemaAccountType",label:"Account type",value:this.selectedBankAccountType,options:[{value:"",label:"Select account type"},...r],span:"full",variant:"card-form"}):""}
          ${this.selectedBankAccountType?Sx({id:"instrument-schema-payment-type",name:"instrumentSchemaPaymentType",label:"Payment type",value:this.selectedBankPaymentType,options:[{value:"",label:"Select payment type"},...n],span:"full",variant:"card-form"}):""}
          <div class="primitive-footer card-form-primary">
            ${Ex({label:"Continue",action:"select-instrument-schema",disabled:!this.selectedBankAccountInstrumentSchemaCode})}
          </div>
        </div>
      `})}renderManualBankAccountScreen(){if("legacy"===this.manualBankAccountFormMode)return this.renderLegacyManualBankAccountScreen();const e=this.bankAccountFormSchema,t=this.bankAccountFormUiSchema;if(!e||!t)return this.renderManualBankAccountConfigErrorScreen();const r="save-bank-account"===this.pendingAction;return this.renderWidgetShell({title:"Enter bank details",backAction:"back-to-instrument-schema-selection",showClose:!1,showDivider:!1,content:Ry`
        ...
        >
          ...
          ></commerce-hub-bank-account-jsonforms>
          ${this.bankAccountSubmitError?Ax({variant:"danger",message:this.bankAccountSubmitError}):""}
          <div class="primitive-footer card-form-primary">
            ${Ex({label:r?"Saving bank account":"Save bank account",action:"save-bank-account",type:"submit",loading:r,disabled:r||!_k(e,this.bankAccountFormData)})}
          </div>
        </form>
      `})}renderBankBillingAddressControl(e){const t=[...this.billingAddresses.map(e=>({value:e.id??"",label:cC(e)})),{value:Rw,label:"Add new billing address"}],r=this.billingAddresses.find(e=>e.id===this.bankBillingAddressValue);return r&&!this.bankBillingAddressSelectorExpanded?Ry`
        <div class="billing-address-summary field field-full">
          <div class="billing-address-summary-heading">
            <span class="billing-address-summary-label field-label"
              >Billing address</span
            >
            ${Px({label:"Change",action:"change-bank-billing-address",disabled:e})}
          </div>
          <p class="billing-address-summary-value">
            ${cC(r)}
          </p>
        </div>
      `:Sx({id:"bank-billing-address",name:"bankBillingAddress",label:"Billing address",value:this.bankBillingAddressValue,options:t,span:"full",variant:"card-form",disabled:e})}renderLegacyManualBankAccountScreen(){const e="save-bank-account"===this.pendingAction,t=Object.values(this.legacyBankAccountEncryption).some(e=>"encrypting"===e.status);return this.renderWidgetShell({title:"Enter bank details",backAction:this.manualBankAccountExitAction(),backDisabled:e,showClose:!1,showDivider:!1,busy:e,overlay:e?dE({title:"Saving bank account",helper:"Securely saving your bank account, please wait."}):void 0,content:Ry`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="save-bank-account"
        >
          ...
          ></commerce-hub-bank-account-jsonforms>
          <div class="primitive-footer card-form-primary">
            ${Ex({label:e?"Saving bank account":"Save bank account",action:"save-bank-account",type:"submit",loading:e,disabled:e||t||(r=this.legacyBankAccountDraft,n=o$,!(n.required??[]).every(e=>!s$(e)||Boolean(r[e].trim())))})}
          </div>
        </form>
      `});var r,n}renderBankOutcomeScreen(){const e=fE(this.bankOutcomeSource),t="declined"===e.kind||"pending"===e.kind;return this.renderWidgetShell({title:e.title,headerAction:t?Px({label:"Done",action:"done-bank-outcome"}):void 0,showClose:!1,showDivider:!1,content:Ry`
        <div class="verification-outcome-flow">
          ${Ax({variant:e.variant,message:e.message})}
          ${this.bankOutcomeSource?jE(this.bankOutcomeSource):""}
          ${t?"":Ry`
                <div class="primitive-footer">
                  ${"verified"===e.kind?Ex({label:"Continue",action:"continue-bank-outcome"}):"pending"===e.kind?Ex({label:"Done",action:"done-bank-outcome"}):Ry`
                        ${Ex({label:this.bankLinkLoading?"Retrying":"Try again",action:"retry-bank-provider",loading:this.bankLinkLoading,disabled:this.bankLinkLoading})}
                        ${Px({label:"Use a different account",action:"use-different-bank-account",disabled:this.bankLinkLoading})}
                      `}
                </div>
              `}
        </div>
      `})}getOtpInputs(){return[...this.renderRoot.querySelectorAll(".otp-input")]}getRequiredInfoSsnInputs(e){return[...this.renderRoot.querySelectorAll(".required-info-ssn-input")].filter(t=>t.dataset.requiredInfoDocKey===e)}storeRequiredInfoSsnInput(e){const t=e.dataset.requiredInfoDocKey;if(!t)return;const r=this.getRequiredInfoSsnInputs(t),n=r.indexOf(e),i=Yk(Number(e.dataset.requiredInfoSsnSegment)),o=Gk(e.value);if(!(n<0)){if(o.length>i){const e=this.writeRequiredInfoSsnDigits(r,n,o);return this.syncRequiredInfoSsnValue(t,r),void this.focusRequiredInfoSsnInput(r,e)}e.value=o.slice(0,i),this.syncRequiredInfoSsnValue(t,r),e.value.length>=i&&this.focusRequiredInfoSsnInput(r,n+1)}}pasteRequiredInfoSsnInput(e,t){const r=t.dataset.requiredInfoDocKey;if(!r)return;const n=e,i="function"==typeof n.clipboardData?.getData?n.clipboardData.getData("text"):"",o=Gk(i);if(!o)return;e.preventDefault();const a=this.getRequiredInfoSsnInputs(r),s=a.indexOf(t);if(s<0)return;const c=this.writeRequiredInfoSsnDigits(a,s,o);this.syncRequiredInfoSsnValue(r,a),this.focusRequiredInfoSsnInput(a,c)}writeRequiredInfoSsnDigits(e,t,r){let n=0,i=t;return e.forEach((e,o)=>{if(o<t)return;const a=Yk(Number(e.dataset.requiredInfoSsnSegment)),s=r.slice(n,n+a);e.value=s,s&&(i=o),n+=a}),i}syncRequiredInfoSsnValue(e,t){this.storeRequiredInfoValue(e,Gk(t.map(e=>e.value).join("")))}focusRequiredInfoSsnInput(e,t){e[Math.min(t,e.length-1)]?.focus()}syncOtpValueFromInputs(e=this.getOtpInputs()){this.otpValue=((e,t=6)=>Wk(e.join("")).slice(0,t))(e.map(e=>e.value)),this.otpErrorMessage=void 0,"OTP_VALIDATION_FAILED"===this.interactionResponse?.status&&this.setInteractionResponseFromSdk({...this.interactionResponse,status:"OTP_VALIDATION_PENDING"})}writeOtpDigits(e,t,r){const n=(({values:e,startIndex:t,value:r})=>{const n=[...e],i=Wk(r);let o=t;return i.slice(0,Math.max(n.length-t,0)).split("").forEach((e,r)=>{const i=t+r;i>=n.length||(n[i]=e,o=i)}),{values:n,lastWrittenIndex:o}})({values:e.map(e=>e.value),startIndex:t,value:r});return n.values.forEach((t,r)=>{e[r].value=t}),n.lastWrittenIndex}focusOtpInput(e,t,r=t){const n=e[t]??e[Math.max(0,Math.min(r,e.length-1))];n&&n.focus()}async showAddCardScreen(){this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow(),this.cardFlowScreen="form",this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===Rw||!this.billingAddresses.length;const e=this.interactionResponse?.interactionId,t=Boolean(this.interactionResponse?.selectedSource||this.interactionResponse?.paymentSources?.length);if(e&&t&&!this.billingAddresses.length&&void 0===this.interactionResponse?.billerAddress)try{await this.fetchInteraction(e)}catch(e){}this.focusAfterUpdate("#card-label")}async showManualBankAccountScreen(){const e=this.requireInteractionId(),t=this.interactionResponse?.country?.trim();this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow();const r=++this.bankAccountConfigRequestToken;if(this.bankFlowScreen="manual-config-loading",!e)return this.bankAccountConfigError="CommerceHub Connect requires an interaction response before bank details can load.",void(this.bankFlowScreen="manual-config-error");if(!t)return this.bankAccountConfigError="Bank account details are not available because the interaction response is missing a country.",void(this.bankFlowScreen="manual-config-error");try{const i=await this.fetchManualBankAccountCountryConfig(e,t);if(!this.isCurrentManualBankAccountConfigRequest(r,e,t))return void(r===this.bankAccountConfigRequestToken&&this.resetBankFlow());const o=i.instrumentSchemas;if(void 0===o||Array.isArray(o)&&0===o.length)return void this.initializeLegacyManualBankAccountScreen();const a=(n=o,(Array.isArray(n)?n:vk(n)&&Array.isArray(n.instrumentSchemas)?n.instrumentSchemas:[]).filter(Sk));if(0===a.length||0===Dk(a).length)return this.bankAccountConfigError="No instrument schemas are available for this country. Try again.",void(this.bankFlowScreen="manual-config-error");this.bankAccountInstrumentSchemas=a,this.bankAccountConfigError=void 0,this.bankFlowScreen="manual-schema-selection"}catch(n){if(!this.isCurrentManualBankAccountConfigRequest(r,e,t))return void(r===this.bankAccountConfigRequestToken&&this.resetBankFlow());this.bankAccountConfigError=QC(n),this.bankFlowScreen="manual-config-error"}var n}manualBankAccountExitAction(){return _C(this.interactionResponse?.country)?"back-to-bank-provider":"back-to-payment-methods"}isCurrentManualBankAccountConfigRequest(e,t,r){return e===this.bankAccountConfigRequestToken&&Boolean(t)&&Boolean(r)&&this.interactionResponse?.interactionId===t&&this.interactionResponse?.country?.trim()===r}initializeManualBankAccountScreen(){const e=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);e&&(this.bankAccountValidationAttempted=!1,this.reconcileBankBillingAddressSelection(),this.manualBankAccountFormMode="instrument-schema",this.bankFlowScreen="manual",this.configureManualBankAccountForm(e,!0),this.bankAccountSubmitError=void 0,this.bankAccountFormI18n={translateError:Pk(e)},this.bankAccountConfigError=void 0)}configureManualBankAccountForm(e,t){const r=this.bankBillingAddressValue===Rw?e:(e=>{const t=Object.fromEntries(Object.entries(e.properties).filter(([e])=>"address"!==e&&!e.startsWith("address."))),r=e.required.filter(e=>"address"!==e&&!e.startsWith("address."));return{...e,properties:t,required:r}})(e),n=this.interactionResponse?.country,i=((e,t)=>{jk(e);const r={};for(const t of Object.keys(e.properties)){let e=r;for(const r of xk(t).slice(0,-1)){const t=bk(e,r)?e[r]:void 0,n=vk(t)?t:{};e[r]=n,e=n}}const n=yk(t);if(bk(e.properties,"address.country")&&void 0!==n){const e=vk(r.address)?r.address:{};e.country=n,r.address=e}return r})(r,n);var o;this.bankAccountFormSchema=this.instrumentSchemaWithBillingAddressControl(((e,t)=>{jk(e);const r={type:"object",properties:{}},n=yk(t);for(const[t,i]of Object.entries(e.properties))Ok(r,xk(t),i,"address.country"===t&&void 0!==n);for(const t of e.required)Ik(r,xk(t));return r})(r,n)),this.bankAccountFormUiSchema=((e,t)=>{const r=e,n=r.elements??[],i=n.filter(e=>(e=>e.scope??"")(e).startsWith("#/properties/address/")),o=n.filter(e=>!i.includes(e)),a={type:"Control",scope:t};return{...r,elements:[...o,a,...i]}})((jk(o=r),{type:"VerticalLayout",elements:Rk(o).map(e=>({type:"Control",scope:`#/properties/${xk(e).map(zk).join("/properties/")}`}))}),"#/properties/__bankBillingAddress"),this.bankAccountFormData=t?{...i,[qk]:this.bankBillingAddressValue}:{...i,...this.bankAccountFormData,[qk]:this.bankBillingAddressValue},this.bankAccountFormValid=!1}instrumentSchemaWithBillingAddressControl(e){return{...e,properties:{...e.properties??{},[qk]:{type:"string",title:"Billing address"}}}}updateBankBillingAddress(e){if(!(e===Rw||this.billingAddresses.some(t=>t.id===e)))return;this.bankBillingAddressValue=e,this.bankBillingAddressSelectorExpanded=e===Rw,this.bankAccountSubmitError=void 0;const t=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);t&&"instrument-schema"===this.manualBankAccountFormMode&&this.configureManualBankAccountForm(t,!1)}reconcileBankBillingAddressSelection(){if(this.bankBillingAddressValue===Rw)return void(this.bankBillingAddressSelectorExpanded=!0);this.billingAddresses.some(e=>e.id===this.bankBillingAddressValue)||(this.bankBillingAddressValue=this.billingAddresses[0]?.id??Rw,this.bankBillingAddressSelectorExpanded=this.bankBillingAddressValue===Rw)}initializeLegacyManualBankAccountScreen(){this.bankAccountValidationAttempted=!1,this.manualBankAccountFormMode="legacy",this.bankFlowScreen="manual",this.legacyBankAccountDraft={accountNickname:"",routingNumber:"",accountNumber:"",confirmAccountNumber:""},this.legacyBankAccountDraftErrors={},this.legacyBankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},confirmAccountNumber:{status:"idle",normalizedValue:""}},this.bankAccountSubmitError=void 0,this.bankAccountConfigError=void 0}clearManualBankAccountForm(){this.manualBankAccountFormMode=void 0,this.bankAccountValidationAttempted=!1,this.bankAccountFormSchema=void 0,this.bankAccountFormUiSchema=void 0,this.bankAccountFormData={},this.bankAccountFormValid=!1,this.bankAccountSubmitError=void 0,this.bankAccountFormI18n=void 0,this.legacyBankAccountDraft={accountNickname:"",routingNumber:"",accountNumber:"",confirmAccountNumber:""},this.legacyBankAccountDraftErrors={},this.legacyBankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},confirmAccountNumber:{status:"idle",normalizedValue:""}}}updateTransferDraftField(e,t){const r=Jk({...this.transferDraft,[e]:t});this.transferDraft=r,this.transferDraftErrors=Zk(r,BC(this.interactionResponse)),this.transferFlowScreen="form",this.transferSubmitError=void 0,this.transferSubmitSuccess=!1}visibleCardDraftError(e){return this.cardValidationAttempted?this.cardDraftErrors[e]:void 0}updateLegacyBankAccountDraftField(e,t){if("legacy"!==this.manualBankAccountFormMode)return;const r=$$({draft:this.legacyBankAccountDraft,errors:this.legacyBankAccountDraftErrors,encryption:this.legacyBankAccountEncryption,schema:o$,field:e,value:t});this.legacyBankAccountDraft=r.draft,this.legacyBankAccountEncryption=r.encryption,this.legacyBankAccountDraftErrors=r.errors,this.bankAccountSubmitError=void 0}toggleCardFieldReveal(e){const t=new Set(this.revealedCardFields);t.has(e)?t.delete(e):t.add(e),this.revealedCardFields=t}updateCardDraftField(e,t){const r=((e,t)=>"cardNumber"===e?qw(t):"expirationDate"===e?Fw(t):"cvv"===e?Dw(t).slice(0,4):t)(e,t),n={...this.cardDraft,[e]:r};if(this.cardDraft=n,"billingAddressValue"===e&&(this.billingAddressSelectorExpanded=r===Rw),this.cardSubmitError=void 0,this.cardValidationAttempted){const t=Ww(Hw(n))[e],r=Jw(this.cardDraftErrors,e);this.cardDraftErrors=t?{...r,[e]:t}:r}Pw(e)&&(this.cardEncryption={...this.cardEncryption,[e]:Yw(this.cardEncryption[e],Bw(e,r))})}async encryptCardField(e,t){this.updateCardDraftField(e,t);const r=Bw(e,t),n=((e,t)=>"cardNumber"===e?Xw(t)?void 0:"Enter a valid card number.":e$(t)?void 0:"Enter a valid CVC.")(e,t);if(!r){const t=Jw(this.cardDraftErrors,e);return this.cardDraftErrors=this.cardValidationAttempted&&n?{...t,[e]:n}:t,void(this.cardEncryption={...this.cardEncryption,[e]:{status:"idle",normalizedValue:""}})}if(n)return this.cardDraftErrors={...Jw(this.cardDraftErrors,e),[e]:n},void(this.cardEncryption={...this.cardEncryption,[e]:Yw(this.cardEncryption[e],r)});const i=this.cardEncryption[e];if("encrypting"!==i.status&&"encrypted"!==i.status||i.normalizedValue!==r){this.cardDraftErrors=Jw(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypting",normalizedValue:r}};try{const t=await this.encryptSensitiveSourceValue(r);if(Bw(e,this.cardDraft[e])!==r)return;this.cardDraftErrors=Jw(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypted",normalizedValue:r,encryptedValue:t}}}catch(t){if(Bw(e,this.cardDraft[e])!==r)return;this.cardDraftErrors={...Jw(this.cardDraftErrors,e),[e]:Gw(e)},this.cardEncryption={...this.cardEncryption,[e]:{status:"failed",normalizedValue:r}}}}}async encryptLegacyBankAccountField(e,t){if("legacy"!==this.manualBankAccountFormMode)return;const r=this.legacyBankAccountEncryption[e];if(u$(t,r))return this.legacyBankAccountDraft={...this.legacyBankAccountDraft,[e]:t},void(this.bankAccountSubmitError=void 0);this.updateLegacyBankAccountDraftField(e,t);const n=d$(t);if(!n){const t={...this.legacyBankAccountEncryption,[e]:{status:"idle",normalizedValue:""}};return this.legacyBankAccountEncryption=t,void(this.legacyBankAccountDraftErrors=v$(h$(this.legacyBankAccountDraft,t),o$))}if("encrypting"!==r.status&&"encrypted"!==r.status||r.normalizedValue!==n){this.legacyBankAccountDraftErrors=((e,t)=>{const r={...e};return delete r[t],r})(this.legacyBankAccountDraftErrors,e),this.legacyBankAccountEncryption={...this.legacyBankAccountEncryption,[e]:{status:"encrypting",normalizedValue:n}};try{const t=await this.encryptSensitiveSourceValue(n);if("legacy"!==this.manualBankAccountFormMode||d$(this.legacyBankAccountDraft[e])!==n)return;const r={...this.legacyBankAccountDraft,[e]:l$(n)},i={...this.legacyBankAccountEncryption,[e]:{status:"encrypted",normalizedValue:n,encryptedValue:t}};this.legacyBankAccountDraft=r,this.legacyBankAccountEncryption=i,this.legacyBankAccountDraftErrors=v$(h$(r,i),o$)}catch(t){if("legacy"!==this.manualBankAccountFormMode||d$(this.legacyBankAccountDraft[e])!==n)return;const r={...this.legacyBankAccountEncryption,[e]:{status:"failed",normalizedValue:n}};this.legacyBankAccountEncryption=r,this.legacyBankAccountDraftErrors={...v$(h$(this.legacyBankAccountDraft,r),o$),[e]:w$(e)}}}}async encryptSensitiveSourceValue(e){const t=this.requireSourceCreateContext();return lx(e,t.publicKey)}trackCardFieldEncryption(e,t){const r=this.encryptCardField(e,t);this.cardEncryptionTasks[e]=r;const n=()=>{this.cardEncryptionTasks[e]===r&&delete this.cardEncryptionTasks[e]};return r.then(n,n),r}async ensureSensitiveCardFieldsEncrypted(){await Promise.all(["cardNumber","cvv"].map(async e=>{const t=this.cardEncryptionTasks[e];t&&await t;const r=this.cardDraft[e],n=Bw(e,r);if(!n)return;const i=this.cardEncryption[e];"encrypted"===i.status&&i.normalizedValue===n&&Boolean(i.encryptedValue)||await this.trackCardFieldEncryption(e,r)}))}async saveCard(){if("save-card"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;this.cardValidationAttempted=!0,await this.ensureSensitiveCardFieldsEncrypted();const t=Hw(this.cardDraft),r={...Zw(t,this.cardEncryption),...Ww(t)};if(Object.keys(r).length>0)return this.cardDraft=t,this.cardDraftErrors=r,void(this.cardSubmitError=void 0);let n;try{n=this.requireSourceCreateContext()}catch(e){return this.cardDraft=t,this.cardDraftErrors={},void(this.cardSubmitError=QC(e))}this.pendingAction="save-card",this.cardDraft=t,this.cardDraftErrors={},this.cardSubmitError=void 0;try{const r=Qw("cardNumber",t.cardNumber,this.cardEncryption),i=Qw("cvv",t.cvv,this.cardEncryption),o=t$(t.expirationDate);if(!o)return void(this.cardDraftErrors={expirationDate:"Enter a valid expiration date."});const a=await this.resolveBillingAddressId(e,t),s={id:"",tenderType:"CARD",name:t.name,billingAddressId:a,card:{nameOnCard:t.fullName,cardNumber:r,cvv:i,cardNumberEncrypted:r,cvvEncrypted:i,expirationMonth:o.month,expirationYear:o.year,network:r$(t.cardNumber)}},c=await this.requestCommerceHubJson("/interaction/source/card",e,{method:"POST",headers:this.createSourceCreateHeaders(e,n,{"Content-Type":"application/json"}),body:JSON.stringify(s),credentials:"include"});this.assertCurrentInteraction(e);const d=this.sourceWithVerificationResponse(dC(s,t.cardNumber),c);mC(c,"The card creation response did not include a source id.");const u=this.interactionResponseWithAddedSource(e,d);this.cardFlowScreen=void 0,this.cardDraft=Mw(),this.cardDraftErrors={},this.cardValidationAttempted=!1,this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.cardSubmitError=void 0,this.setInteractionResponseFromSdk(u),this.emitSdkEvent(Kx,d);const l=await this.refreshInteractionAfterMutation(e),h=this.findPaymentSourceInInteraction(l,d.id)??d;this.showAddedPaymentSourceStatus(h)}catch(t){if(this.isStaleMutationFailure(e,t))return;this.cardSubmitError=QC(t),this.cardFlowScreen="error"}finally{this.clearPendingMutationAction(e,"save-card")}}async saveManualBankAccount(){if("legacy"===this.manualBankAccountFormMode)return void await this.saveLegacyManualBankAccount();if("save-bank-account"===this.pendingAction)return;if(this.bankAccountValidationAttempted=!0,!this.bankAccountFormValid)return;const e=this.requireInteractionId(),t=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);if(!e||!t)return;let r;try{r=this.requireSourceCreateContext()}catch(e){return void(this.bankAccountSubmitError=QC(e))}this.pendingAction="save-bank-account",this.bankAccountSubmitError=void 0;try{const n=Hk({data:this.bankAccountFormData,schema:t,addressSelection:this.bankBillingAddressValue===Rw?{kind:"new"}:{kind:"existing",id:this.bankBillingAddressValue},id:XC()}),i=await(async(e,t)=>{const r=await Promise.all(Vk.flatMap(r=>{const n=Uk(e[r]);return n?[t(n).then(e=>[r,e])]:[]})),n=Object.fromEntries(r),i=n.accountNumber;return{...e,...n,..."string"==typeof i&&i.trim()?{accountNumberReEntered:i}:{}}})(n,e=>lx(e,r.publicKey)),o=await this.requestCommerceHubJson(`/interaction/source/v2/ach?currencyCode=${encodeURIComponent(n.currencyCode)}`,e,{method:"POST",headers:this.createSourceCreateHeaders(e,r,{"Content-Type":"application/json"}),body:JSON.stringify(i),credentials:"include"});this.assertCurrentInteraction(e);const a=pC(o);let s,c;if(a)c=this.sourceWithVerificationResponse(hC(n),a);else{const t=await this.resolveConfigDrivenBankSourceFromInteraction(e,n);c=t.source,s=t.interactionResponse}const d=this.interactionResponseWithAddedSource(e,c);this.setInteractionResponseFromSdk(d),this.emitSdkEvent(Kx,c),this.resetBankFlow(),s??=await this.refreshInteractionAfterMutation(e);const u=this.findPaymentSourceInInteraction(s,c.id)??c;this.showAddedPaymentSourceStatus(u)}catch(t){if(this.isStaleMutationFailure(e,t))return;this.bankAccountSubmitError=QC(t)}finally{this.clearPendingMutationAction(e,"save-bank-account")}}async resolveConfigDrivenBankSourceFromInteraction(e,t){const r=await this.fetchFreshInteraction(e),n=(r.paymentSources??[]).filter(OE).find(e=>e.id?.trim()===t.id),i=n?.id?.trim();if(!n||!i)throw new Error("The bank account was created but could not be resolved from the interaction.");const o=hC(t);return{source:{...n,...o,id:i,verificationInfo:n.verificationInfo,bankAccount:{...n.bankAccount,...o.bankAccount}},interactionResponse:r}}async saveLegacyManualBankAccount(){if("save-bank-account"===this.pendingAction)return;const e=this.requireInteractionId();if(!e||"legacy"!==this.manualBankAccountFormMode)return;this.bankAccountValidationAttempted=!0;const t=h$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),r=v$(t,o$);if(Object.keys(r).length>0)return this.legacyBankAccountDraft=m$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),this.legacyBankAccountDraftErrors=r,void(this.bankAccountSubmitError=void 0);let n;try{n=this.requireSourceCreateContext()}catch(e){return this.legacyBankAccountDraft=m$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),this.legacyBankAccountDraftErrors={},void(this.bankAccountSubmitError=QC(e))}this.pendingAction="save-bank-account",this.legacyBankAccountDraft=m$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),this.legacyBankAccountDraftErrors={},this.bankAccountSubmitError=void 0;try{await this.encryptChangedLegacyBankAccountFields();const t=h$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),r=v$(t,o$);if(Object.keys(r).length>0)return void(this.legacyBankAccountDraftErrors=r);const s=k$("routingNumber",this.legacyBankAccountDraft,this.legacyBankAccountEncryption),c=k$("accountNumber",this.legacyBankAccountDraft,this.legacyBankAccountEncryption),d=k$("confirmAccountNumber",this.legacyBankAccountDraft,this.legacyBankAccountEncryption),u=(i="accountNumber",o=this.legacyBankAccountEncryption,a=t,C$(o[i].normalizedValue||a[i])),l={id:"",tenderType:"BANK_ACCOUNT",productCode:"POACH",name:x$(this.legacyBankAccountDraft.accountNickname,u),bankAccount:{routingNumber:s,accountNumber:c,accountNumberReEntered:d,routingNumberEncrypted:s,accountNumberEncrypted:c,asset:{type:"CURRENCY",id:"USD"}}},h=await this.requestCommerceHubJson("/interaction/source/ach",e,{method:"POST",headers:this.createSourceCreateHeaders(e,n,{"Content-Type":"application/json"}),body:JSON.stringify(l),credentials:"include"});this.assertCurrentInteraction(e);const f=this.sourceWithVerificationResponse(fC(l,u),h);mC(h,"The bank account creation response did not include a source id.");const m=this.interactionResponseWithAddedSource(e,f);this.setInteractionResponseFromSdk(m),this.emitSdkEvent(Kx,f),this.resetBankFlow();const p=await this.refreshInteractionAfterMutation(e),v=this.findPaymentSourceInInteraction(p,f.id)??f;this.showAddedPaymentSourceStatus(v)}catch(t){if(this.isStaleMutationFailure(e,t))return;this.bankAccountSubmitError=QC(t)}finally{this.clearPendingMutationAction(e,"save-bank-account")}var i,o,a}async encryptChangedLegacyBankAccountFields(){for(const e of["routingNumber","accountNumber","confirmAccountNumber"]){const t=this.legacyBankAccountDraft[e],r=this.legacyBankAccountEncryption[e];if(u$(t,r))continue;const n=d$(t);if(!n)continue;"encrypted"===r.status&&r.normalizedValue===n&&Boolean(r.encryptedValue)||await this.encryptLegacyBankAccountField(e,t)}}reviewTransfer(){if("transfer"===this.pendingAction)return;this.transferValidationAttempted=!0;const e=BC(this.interactionResponse),t=Jk(this.transferDraft),r=Zk(t,e);if(Object.keys(r).length>0)return this.transferDraft=t,this.transferDraftErrors=r,this.transferSubmitError=void 0,void(this.transferSubmitSuccess=!1);this.transferDraft=t,this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1,this.transferFlowScreen="confirm"}async submitTransfer(){if("transfer"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=BC(this.interactionResponse),r=Jk(this.transferDraft),n=Zk(r,t);if(Object.keys(n).length>0)return this.transferDraft=r,this.transferDraftErrors=n,this.transferFlowScreen="form",this.transferSubmitError=void 0,void(this.transferSubmitSuccess=!1);this.pendingAction="transfer",this.transferDraft=r,this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1;try{const t=await this.requestCommerceHubJson("/interaction/source/native/transfer",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({fromSourceId:r.fromSourceId,toSourceId:r.toSourceId,amount:Number(r.amount),asset:{type:"CURRENCY",id:"USD"}}),credentials:"include"});this.transferFlowScreen="form",this.transferValidationAttempted=!1,this.transferSubmitSuccess=!0,this.emitSdkEvent(Zx,t)}catch(e){this.transferSubmitError=QC(e)}finally{this.pendingAction=void 0}}async resolveBillingAddressId(e,t){if(t.billingAddressValue!==Rw)return t.billingAddressValue;const r=(e=>({id:i$(),recipientNameOrAddress:e.fullName,country:e.country,street:e.addressLine1,houseNumberOrName:e.addressLine2||void 0,city:e.city,stateOrProvince:e.state,postalCode:e.zip}))(t),n=await this.requestCommerceHubJson("/interaction/billing-address",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r),credentials:"include"}),i=n.value?.trim();if(!i)throw new Error("The billing address response did not include an id.");return i}async verifyOtp(){if("verify-otp"===this.pendingAction)return;if(this.otpValue.length<6)return;const e=this.requireInteractionId();if(e){this.pendingAction="verify-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/validate",{body:{otp:this.otpValue,channel:"EMAIL"}}),r=ZC(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(r)}catch(e){this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk({...this.interactionResponse,status:"OTP_VALIDATION_FAILED"})}finally{this.pendingAction=void 0}}}async resendOtp(){if("resend-otp"===this.pendingAction)return;const e=this.requireInteractionId();if(e){this.pendingAction="resend-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/send/email"),r=ZC(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(r)}catch(e){}finally{this.pendingAction=void 0}}}async attachPaymentSource(e,t="select"){if("attach-payment-source"===this.pendingAction)return;const r=this.requireInteractionId(),n=this.findPaymentSourceById(e);if(r&&n&&dx(n)){this.selectedPaymentSourceId=e,this.paymentSourceView="list",this.attachmentError=void 0,this.pendingAction="attach-payment-source";try{const i=await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}/attach`,r,{method:"POST",credentials:"include"});this.assertCurrentInteraction(r);const o=JC(this.interactionResponse??{interactionId:r},i,e);this.setInteractionResponseFromSdk(o);const a=await this.refreshInteractionAfterMutation(r),s=this.findPaymentSourceInInteraction(a,e)??this.findPaymentSourceInInteraction(o,e)??n;if(this.selectedPaymentSourceId=s.id,"mark-default"===t)return void(this.paymentSourceView="list");this.paymentSourceView="list",this.emitSdkEvent(Wx,s),this.focusAfterUpdate(".payment-method-radio:checked")}catch(e){if(this.isStaleMutationFailure(r,e))return;this.paymentSourceView="list",this.attachmentError=QC(e)||"We couldn't save this payment method. Please try again."}finally{this.clearPendingMutationAction(r,"attach-payment-source")}}}async verifySavedPaymentSource(e){if("verify-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),r=this.findPaymentSourceById(e);if(t&&r){if(SE(r))return this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(r);if("NOT_VERIFIED"===r.verificationInfo?.status){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",this.pendingAction="verify-payment-source";try{const n=await this.verifyPaymentSourceStep1(t,{...r,id:e}),i=aE({...this.interactionResponse??{interactionId:t},selectedSource:this.interactionResponse?.selectedSource,status:rC},n);if(this.setInteractionResponseFromSdk(i),this.emitSdkEvent(Gx,n),SE(n))return void this.showRequiredInfoSource(n);if("VERIFIED"===n.verificationInfo?.status)return this.pendingAction=void 0,this.selectedPaymentSourceId=dx(n)?n.id?.trim()||e:void 0,void(this.paymentSourceView="list");this.savedSourceVerificationSource=n,this.savedSourceVerificationFailed=!1}catch(e){this.savedSourceVerificationSource=r,this.savedSourceVerificationFailed=!0}finally{"verify-payment-source"===this.pendingAction&&(this.pendingAction=void 0)}}}}async deletePaymentSource(e){if("delete-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),r=this.findPaymentSourceById(e);if(t&&r)if("PAYMENT_SOURCE_ATTACHED"!==this.interactionResponse?.status||this.interactionResponse.selectedSource?.id!==e)if(this.deleteConfirmationPaymentSourceId===e){this.clearDeletePaymentSourceConfirmation(),this.pendingAction="delete-payment-source";try{await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}`,t,{method:"DELETE",credentials:"include"}),await this.refreshInteractionAfterMutation(t),this.emitSdkEvent(Yx,e)}catch(e){if(this.isStaleMutationFailure(t,e))return}finally{this.clearPendingMutationAction(t,"delete-payment-source")}}else this.armDeletePaymentSourceConfirmation(e);else this.clearDeletePaymentSourceConfirmation()}armDeletePaymentSourceConfirmation(e){this.clearDeletePaymentSourceConfirmation(),this.deleteConfirmationPaymentSourceId=e,this.deleteConfirmationTimeoutId=window.setTimeout(()=>{this.deleteConfirmationPaymentSourceId===e&&this.clearDeletePaymentSourceConfirmation()},1e4)}clearDeletePaymentSourceConfirmation(){void 0!==this.deleteConfirmationTimeoutId&&(window.clearTimeout(this.deleteConfirmationTimeoutId),this.deleteConfirmationTimeoutId=void 0),this.deleteConfirmationPaymentSourceId=void 0}findPaymentSourceById(e){return(this.interactionResponse?.paymentSources??[]).find(t=>t.id===e)??(this.interactionResponse?.selectedSource?.id===e?this.interactionResponse.selectedSource:void 0)}findPaymentSourceInInteraction(e,t){return(e?.selectedSource?.id===t?e.selectedSource:void 0)??e?.paymentSources?.find(e=>e.id===t)}resetSavedSourceVerification(){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1}showPaymentSourceList({refresh:e=!0}={}){this.clearDeletePaymentSourceConfirmation(),this.openPaymentSourceMenuId=void 0,this.paymentSourceView="list",this.addLauncherActive=!1,this.resetTransferFlow(),e?this.refreshPaymentSourcesForList().finally(()=>{this.focusPaymentSourceList()}):this.focusPaymentSourceList()}focusPaymentSourceList(){this.focusAfterUpdate('[data-action="open-add-payment-source"]','[data-action="toggle-payment-source-menu"]','[data-action="add-card"]','[data-action="add-bank-account"]')}shouldOpenPaymentSourceMenuAbove(e){const t=e?.closest(".primitive-stack"),r=e?.closest(".payment-method-row");if(!t||!r)return!1;const n=t.getBoundingClientRect(),i=r.getBoundingClientRect(),o=6*(Number.parseFloat(getComputedStyle(this).fontSize)||16),a=n.bottom-i.bottom,s=i.top-n.top;return a<o&&s>a}closeAddPaymentSourceSheet(){this.addLauncherActive=!1,this.focusAfterUpdate('[data-action="open-add-payment-source"]')}async refreshPaymentSourcesForList(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}async refreshInteractionAfterMutation(e){try{return await this.fetchFreshInteraction(e)}catch(e){if(e instanceof Sw)throw e;return}}assertCurrentInteraction(e){if(this.interactionResponse?.interactionId!==e)throw new Sw(e)}isStaleMutationFailure(e,t){return this.interactionResponse?.interactionId!==e||t instanceof Sw}clearPendingMutationAction(e,t){this.interactionResponse?.interactionId===e&&this.pendingAction===t&&(this.pendingAction=void 0)}fetchFreshInteraction(e){return this.interactionRefresh.fetchFresh(e,this.interactionRefreshOptions())}interactionResponseWithAddedSource(e,t){const r=t.id?.trim(),n=Boolean(r)&&cE(t),i={...this.interactionResponse??{interactionId:e},status:rC};return n?oE(i,t):aE({...i,selectedSource:this.interactionResponse?.selectedSource},t)}showAddedPaymentSourceStatus(e){const t=e.id?.trim();return this.resetSavedSourceVerification(),this.resetRequiredInfo(),SE(e)?(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(e)):"VERIFIED"===e.verificationInfo?.status?(this.selectedPaymentSourceId=dx(e)?t:void 0,void(this.paymentSourceView="list")):(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",OE(e)?(this.bankOutcomeSource=e,void(this.bankFlowScreen="outcome")):(this.savedSourceVerificationSource=e,void(this.savedSourceVerificationFailed=!1)))}showRequiredInfoSource(e){this.requiredInfoSource=e,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.requiredInfoValidationAttempted=!1,this.pendingRequiredInfoDocKey=void 0}resetRequiredInfo(){this.requiredInfoSource=void 0,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.requiredInfoValidationAttempted=!1,this.pendingRequiredInfoDocKey=void 0}firstRequiredInfoDocKey(){return $E(pE(this.requiredInfoSource))??vE(pE(this.requiredInfoSource)[0],0)}storeRequiredInfoValue(e,t){this.requiredInfoValues=((e,t,r)=>({...e,[t]:r}))(this.requiredInfoValues,e,t),this.requiredInfoSubmitError=void 0}storeRequiredInfoSelectedFile(e){if(!this.requiredInfoSource||!e)return void(this.pendingRequiredInfoDocKey=void 0);const t=this.pendingRequiredInfoDocKey??this.firstRequiredInfoDocKey(),r=(({files:e,fileNames:t,key:r,file:n})=>({files:{...e,[r]:n},fileNames:{...t,[r]:n.name}}))({files:this.requiredInfoFiles,fileNames:this.requiredInfoFileNames,key:t,file:e});this.requiredInfoFiles=r.files,this.requiredInfoFileNames=r.fileNames,this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}canSubmitRequiredInfo(){const e=this.requiredInfoSource;if(!e?.id?.trim())return!1;const t=pE(e),r=t.map((e,t)=>({doc:e,index:t})).filter(({doc:e})=>gE(e));return r.length>0?r.every(({doc:e,index:t})=>this.hasRequiredInfoValue(e,t)):t.some((e,t)=>this.hasRequiredInfoValue(e,t))}visibleRequiredInfoError(e,t){return this.requiredInfoValidationAttempted?this.requiredInfoValidationError(e,t):void 0}requiredInfoValidationError(e,t){return this.hasRequiredInfoValue(e,t)?"SOCIAL_SECURITY_NUMBER"===e.docType?(r=this.requiredInfoValues[vE(e,t)]??"",9===Gk(r).length?void 0:"Enter a 9-digit Social Security number."):void 0:gE(e)?EE(e):void 0;var r}async submitRequiredInfo(){if("submit-required-info"===this.pendingAction)return;const e=this.requireInteractionId(),t=this.requiredInfoSource,r=t?.id?.trim();if(e&&t&&r)if(this.requiredInfoValidationAttempted=!0,pE(t).some((e,t)=>Boolean(this.requiredInfoValidationError(e,t))))this.requiredInfoSubmitError=void 0;else if(this.canSubmitRequiredInfo()){this.pendingAction="submit-required-info",this.requiredInfoSubmitError=void 0;try{const n=pE(t),i=this.providedRequiredInfoEntries(n,!0),o=this.providedRequiredInfoEntries(n,!1);let a=t;i.length>0?(await this.uploadRequiredInfoEntries(e,r,i),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,r)),this.emitSdkEvent(Gx,a),SE(a)&&o.length>0&&(await this.uploadRequiredInfoEntries(e,r,o),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,r)),this.emitSdkEvent(Gx,a))):(await this.uploadRequiredInfoEntries(e,r,o),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,r)),this.emitSdkEvent(Gx,a));const s=aE({...this.interactionResponse??{interactionId:e},selectedSource:this.interactionResponse?.selectedSource,status:rC},a);if(this.setInteractionResponseFromSdk(s),"VERIFIED"===a.verificationInfo?.status)return this.resetRequiredInfo(),this.pendingAction=void 0,this.selectedPaymentSourceId=dx(a)?a.id?.trim()||r:void 0,void this.showPaymentSourceList({refresh:!0});if(SE(a))return this.requiredInfoSource=a,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},void(this.requiredInfoValidationAttempted=!1);this.resetRequiredInfo(),this.savedSourceVerificationSource=a,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=a.id,this.paymentSourceView="list"}catch(e){this.requiredInfoSubmitError=QC(e)||"We could not submit the required information. Please try again."}finally{"submit-required-info"===this.pendingAction&&(this.pendingAction=void 0)}}else this.requiredInfoSubmitError="Add required or optional information before verifying."}providedRequiredInfoEntries(e,t){return e.map((e,t)=>({doc:e,index:t})).filter(({doc:e,index:r})=>(t?gE(e):!gE(e))&&this.hasRequiredInfoValue(e,r))}hasRequiredInfoValue(e,t){const r=vE(e,t);return bE(e)?((e,t)=>Boolean(e[t]?.trim()))(this.requiredInfoValues,r):((e,t)=>Boolean(e[t]))(this.requiredInfoFiles,r)}async uploadRequiredInfoEntries(e,t,r){for(const{doc:n,index:i}of r){const r=n.docType;if(!r)continue;const o=vE(n,i);if(bE(n)){const n=this.requiredInfoValues[o]?.trim();n&&await this.uploadRequiredInfoField(e,t,r,n);continue}const a=this.requiredInfoFiles[o];a&&await this.uploadRequiredInfoDocument(e,t,r,a)}}async verifyRequiredInfoStep2(e,t){return this.showMinimumVerificationOverlay("submit-required-info"),this.requestCommerceHubJson("/interaction/verify/step2",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t}),credentials:"include"})}sourceWithVerificationResponse(e,t){const{sourceId:r,...n}=t,i=r?.trim();return{...e,id:i||e.id,verificationInfo:{...e.verificationInfo,...n}}}async uploadRequiredInfoField(e,t,r,n){await this.requestCommerceHubJson("/interaction/verify/uploadField",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({docType:r,value:t,docValue:n}),credentials:"include"})}async uploadRequiredInfoDocument(e,t,r,n){const i=new FormData;i.set("file",n),await this.requestCommerceHubJson(`/interaction/doc/upload/${encodeURIComponent(t)}/${encodeURIComponent(r)}`,e,{method:"POST",body:i,credentials:"include"})}async startPayByBankFlow(){if(this.bankLinkLoading)return;const e=this.requireInteractionId();if(!e)return;const t=++this.bankProviderRequestToken;this.bankFlowScreen="provider",this.bankOutcomeSource=void 0,this.bankLinkLoading=!0,this.ensurePayByBankProviderContainer(Xx),await this.updateComplete;try{await this.launchPayByBankProvider(e,Xx,t)}catch(r){if(!this.isCurrentPayByBankProviderRequest(t,e))return;console.error("CommerceHub Connect Pay by Bank failed",r),this.resetBankFlow(),this.showPaymentSourceList({refresh:!0})}finally{t===this.bankProviderRequestToken&&(this.cancelPayByBankLaunch=void 0,this.bankLinkLoading=!1)}}async startBankAccountFlow(){_C(this.interactionResponse?.country)?await this.startPayByBankFlow():await this.showManualBankAccountScreen()}isCurrentPayByBankProviderRequest(e,t){return this.isConnected&&e===this.bankProviderRequestToken&&this.interactionResponse?.interactionId===t&&"provider"===this.bankFlowScreen}async launchPayByBankProvider(e,t,r){const n=await this.requestCommerceHubJson("/interaction/source/pbb/session",e,{method:"GET",credentials:"include"});if(!this.isCurrentPayByBankProviderRequest(r,e))return;const{aggregatorSessionId:i,accessToken:o,pToken:a,publicKey:s}=nE(n),c=$C(this.designConfig?.payByBank);if(await TE(c.paymentSdkUrl),!this.isCurrentPayByBankProviderRequest(r,e))return;const d=window.PaymentSDK;if(!d?.init)throw new Error("PaymentSDK.js loaded but PaymentSDK.init is not available on window.");await new Promise((n,u)=>{let l=!1;this.cancelPayByBankLaunch=()=>{l=!0,n()},RE(),d.init({apiKey:c.apiKey,accessToken:o,configId:c.configId,environment:c.environment,locale:c.locale,appearance:kC(this.designConfig),publicKey:s,pToken:a,aggregatorSessionId:i,containerId:t,onEvent:async t=>{if(!l&&iE(t)&&this.isCurrentPayByBankProviderRequest(r,e)){if(l=!0,this.bankLinkLoading=!0,RE(),"success"!==t.type)return this.resetBankFlow(),this.showPaymentSourceList({refresh:!0}),void n();try{const t=await this.finalizePayByBankSession(e,i,a);if(!this.isCurrentPayByBankProviderRequest(r,e))return void n();const o=uC(t),s=o.id?.trim();if(!s)throw new Error("Connect your bank completed but the resolved bank payment source did not include an id.");const c=this.interactionResponseWithAddedSource(e,o);this.setInteractionResponseFromSdk(c),this.emitSdkEvent(Kx,o);const d=await this.refreshInteractionAfterMutation(e);if(!this.isCurrentPayByBankProviderRequest(r,e))return void n();const u=this.findPaymentSourceInInteraction(d,s)??o;this.resetBankFlow(),this.showAddedPaymentSourceStatus(u),n()}catch(t){if(!this.isCurrentPayByBankProviderRequest(r,e))return void n();u(t)}}}}),!l&&this.isCurrentPayByBankProviderRequest(r,e)&&(this.bankLinkLoading=!1)})}async refreshPaymentSourcesFromInteraction(){await this.interactionRefresh.refreshFromInteraction(this.interactionRefreshOptions())}queueNativeAccountBalanceRefresh(){this.nativeBalance.queueRefresh(()=>this.interactionResponse,e=>this.fetchNativeAccountBalances(e))}async fetchNativeAccountBalances(e){return(await this.createSdkClient(e).GET("/interaction/source/native/balances")).data??{}}async fetchInteraction(e){return this.interactionRefresh.fetch(e,this.interactionRefreshOptions())}async retryInteractionRefresh(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}interactionRefreshOptions(){return{getCurrentInteractionResponse:()=>this.interactionResponse,getSelectedPaymentSourceId:()=>this.interactionResponse?.selectedSource?.id,requestInteraction:e=>this.createSdkClient(e).GET("/interaction").then(e=>ZC(e)),mergeInteractionResponse:JC,setInteractionResponse:e=>this.setInteractionResponseFromSdk(e),emitListPaymentMethods:e=>this.emitSdkEvent(Jx,e)}}syncBillingAddressesFromInteractionResponse(e){if(!e.billerAddress)return;this.billingAddresses=e.billerAddress.filter(e=>Boolean(e.id?.trim())),this.cardDraft=((e,t)=>{const r=t.map(e=>e.id?.trim()).filter(e=>Boolean(e));if(!r.length)return{...e,billingAddressValue:Rw};if(r.includes(e.billingAddressValue))return e;const n=[e.country,e.addressLine1,e.addressLine2,e.city,e.state,e.zip].some(e=>e.trim());return e.billingAddressValue===Rw&&n?e:{...e,billingAddressValue:r[0]}})(this.cardDraft,this.billingAddresses),this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===Rw,this.reconcileBankBillingAddressSelection();const t=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);t&&"instrument-schema"===this.manualBankAccountFormMode&&this.configureManualBankAccountForm(t,!1)}async finalizePayByBankSession(e,t,r){return this.requestCommerceHubJson(`/interaction/source/pbb/session/${encodeURIComponent(t)}/${encodeURIComponent(r)}`,e,{method:"PUT",credentials:"include"})}async verifyPaymentSourceStep1(e,t){this.showMinimumVerificationOverlay("verify-payment-source");const r=await this.requestCommerceHubJson("/interaction/verify/step1",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t.id}),credentials:"include"});return this.sourceWithVerificationResponse(t,r)}async requestCommerceHubJson(e,t,r){const n=this.createInteractionHeaders(t,r.headers);n.has("Accept")||n.set("Accept","application/json");const i=new Request(`${yw(this.baseURL)}${e}`,{...r,headers:n}),o=await fetch(i),a=await(async e=>{if(204===e.status)return;const t=await e.text();return""!==t.trim()?(e=>{const t=e.split(";",1)[0].trim().toLowerCase();return"application/json"===t||t.endsWith("+json")})(e.headers.get("content-type")??"")?JSON.parse(t):t:void 0})(o);if(!o.ok)throw new Error(QC(a)||o.statusText);return a}async fetchManualBankAccountCountryConfig(e,t){return this.requestCommerceHubJson("/party/configuration-inquiry",e,{method:"POST",headers:{"Client-Id":XC(),"Content-Type":"application/json","User-Id":XC()},body:JSON.stringify({configurationType:"COUNTRY_TENDER",country:t}),credentials:"include"})}resetBankFlow(){this.bankAccountConfigRequestToken+=1,this.cancelPayByBankProvider(),this.bankFlowScreen=void 0,this.bankOutcomeSource=void 0,this.bankLinkLoading=!1,this.bankAccountInstrumentSchemas=[],this.selectedBankAccountInstrumentSchemaCode=void 0,this.selectedBankCurrencyCode="",this.selectedBankAccountType="",this.selectedBankPaymentType="",this.bankBillingAddressValue="",this.bankBillingAddressSelectorExpanded=!1,this.clearManualBankAccountForm(),this.bankAccountConfigError=void 0,this.removePayByBankProviderContainer()}cancelPayByBankProvider(){this.bankProviderRequestToken+=1,this.cancelPayByBankLaunch?.(),this.cancelPayByBankLaunch=void 0,RE()}resetCardFlow(){this.cardFlowScreen=void 0,this.cardDraft=Mw(),this.cardDraftErrors={},this.cardValidationAttempted=!1,this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=!1}resetTransferFlow(){this.transferFlowActive=!1,this.transferFlowScreen="form",this.transferDraft={fromSourceId:"",toSourceId:"",amount:""},this.transferDraftErrors={},this.transferValidationAttempted=!1,this.transferSubmitError=void 0,this.transferSubmitSuccess=!1}ensurePayByBankProviderContainer(e){const t=[...this.children].find(t=>t instanceof HTMLElement&&t.id===e),r=t??document.createElement("div");return r.id=e,r.slot=e,r.className="provider-frame-container",r.replaceChildren(),t||this.appendChild(r),r}removePayByBankProviderContainer(){[...this.children].filter(e=>e instanceof HTMLElement&&e.id===Xx).forEach(e=>e.remove())}requireInteractionId(){const e=this.interactionResponse?.interactionId;if(e)return e}createSdkClient(e){return ww({baseURL:this.baseURL,getHeaders:()=>this.createInteractionHeaders(e)})}createInteractionHeaders(e,t){const r=new Headers(t),n=this.interactionResponse?.oauth?.access_token?.trim();return r.set("x-interaction-id",e),n&&!r.has("Authorization")&&r.set("Authorization",`Bearer ${n}`),r}createSourceCreateHeaders(e,t,r){const n=this.createInteractionHeaders(e,r);return n.set("Api-Key",t.clientId),n.set("Auth-Token-Type",t.tokenType),n.set("x-key-id",t.keyId),n}requireSourceCreateContext(){const e=this.interactionResponse?.publicKey?.trim(),t=this.interactionResponse?.keyId?.trim(),r=this.interactionResponse?.oauth,n=r?.client_id?.trim(),i=r?.token_type?.trim(),o=r?.access_token?.trim();if(!(e&&t&&n&&i&&o))throw new Error("Payment source encryption is not configured. Try again later.");return{publicKey:e,keyId:t,clientId:n,tokenType:i,accessToken:o}}setInteractionResponseFromSdk(e){this.interactionResponse=this.interactionResponseWithPreservedGatewayOAuth(e)}interactionResponseWithPreservedGatewayOAuth(e){if(e.oauth&&e.features)return e;const t=this.interactionResponse;return!t||t.interactionId&&e.interactionId&&t.interactionId!==e.interactionId?e:{...e,oauth:e.oauth??t.oauth,features:e.features??t.features}}syncDesignConfigStyles(){for(const e of AC)this.style.removeProperty(e);const e=this.designConfig?.colors;if(e)for(const{field:t,property:r}of EC){const n=e[t];n&&this.style.setProperty(r,n)}const t=this.designConfig?.baseFontSize;t?this.style.fontSize=t:this.style.removeProperty("font-size");const r=this.designConfig?.baseFontWeight?.trim();r?this.style.setProperty(jC,r):this.style.removeProperty(jC);const n=this.designConfig?.shellPadding?.trim();n?this.style.setProperty(SC,n):this.style.removeProperty(SC)}};aC.styles=mx,Hx([iw({attribute:!1})],aC.prototype,"interactionResponse",void 0),Hx([iw({attribute:!1})],aC.prototype,"designConfig",void 0),Hx([iw({attribute:"base-url"})],aC.prototype,"baseURL",void 0),Hx([ow()],aC.prototype,"selectedPaymentSourceId",void 0),Hx([ow()],aC.prototype,"otpValue",void 0),Hx([ow()],aC.prototype,"pendingAction",void 0),Hx([ow()],aC.prototype,"minimumVerificationOverlayAction",void 0),Hx([ow()],aC.prototype,"otpErrorMessage",void 0),Hx([ow()],aC.prototype,"bankFlowScreen",void 0),Hx([ow()],aC.prototype,"bankLinkLoading",void 0),Hx([ow(),ow()],aC.prototype,"bankOutcomeSource",void 0),Hx([ow()],aC.prototype,"bankAccountInstrumentSchemas",void 0),Hx([ow()],aC.prototype,"manualBankAccountFormMode",void 0),Hx([ow()],aC.prototype,"selectedBankAccountInstrumentSchemaCode",void 0),Hx([ow()],aC.prototype,"selectedBankCurrencyCode",void 0),Hx([ow()],aC.prototype,"selectedBankAccountType",void 0),Hx([ow()],aC.prototype,"selectedBankPaymentType",void 0),Hx([ow()],aC.prototype,"bankAccountFormSchema",void 0),Hx([ow()],aC.prototype,"bankAccountFormUiSchema",void 0),Hx([ow()],aC.prototype,"bankAccountFormData",void 0),Hx([ow()],aC.prototype,"bankAccountFormValid",void 0),Hx([ow()],aC.prototype,"bankAccountValidationAttempted",void 0),Hx([ow()],aC.prototype,"bankBillingAddressValue",void 0),Hx([ow()],aC.prototype,"bankBillingAddressSelectorExpanded",void 0),Hx([ow()],aC.prototype,"bankAccountSubmitError",void 0),Hx([ow()],aC.prototype,"legacyBankAccountDraft",void 0),Hx([ow()],aC.prototype,"legacyBankAccountDraftErrors",void 0),Hx([ow()],aC.prototype,"legacyBankAccountEncryption",void 0),Hx([ow()],aC.prototype,"bankAccountConfigError",void 0),Hx([ow()],aC.prototype,"transferDraft",void 0),Hx([ow()],aC.prototype,"transferDraftErrors",void 0),Hx([ow()],aC.prototype,"transferValidationAttempted",void 0),Hx([ow()],aC.prototype,"transferSubmitError",void 0),Hx([ow()],aC.prototype,"transferSubmitSuccess",void 0),Hx([ow()],aC.prototype,"transferFlowActive",void 0),Hx([ow()],aC.prototype,"transferFlowScreen",void 0),Hx([ow(),ow()],aC.prototype,"cardFlowScreen",void 0),Hx([ow()],aC.prototype,"cardDraft",void 0),Hx([ow()],aC.prototype,"cardDraftErrors",void 0),Hx([ow()],aC.prototype,"cardValidationAttempted",void 0),Hx([ow()],aC.prototype,"cardEncryption",void 0),Hx([ow()],aC.prototype,"revealedCardFields",void 0),Hx([ow()],aC.prototype,"cardSubmitError",void 0),Hx([ow()],aC.prototype,"billingAddresses",void 0),Hx([ow()],aC.prototype,"billingAddressSelectorExpanded",void 0),Hx([ow()],aC.prototype,"paymentSourceView",void 0),Hx([ow()],aC.prototype,"openPaymentSourceMenuId",void 0),Hx([ow()],aC.prototype,"paymentSourceMenuPlacement",void 0),Hx([ow()],aC.prototype,"addLauncherActive",void 0),Hx([ow()],aC.prototype,"attachmentError",void 0),Hx([ow()],aC.prototype,"deleteConfirmationPaymentSourceId",void 0),Hx([ow()],aC.prototype,"savedSourceVerificationSource",void 0),Hx([ow()],aC.prototype,"savedSourceVerificationFailed",void 0),Hx([ow()],aC.prototype,"requiredInfoSource",void 0),Hx([ow()],aC.prototype,"requiredInfoValues",void 0),Hx([ow()],aC.prototype,"requiredInfoFileNames",void 0),Hx([ow()],aC.prototype,"requiredInfoSubmitError",void 0),Hx([ow()],aC.prototype,"requiredInfoValidationAttempted",void 0),aC=Hx([tw("commerce-hub-connect")],aC);const sC=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("required-info-ssn-input")),cC=e=>{const t=[e.stateOrProvince,e.postalCode].filter(Boolean).join(" "),r=[e.city,t].filter(Boolean).join(", ");return[e.street,r].filter(Boolean).join(", ")||e.id||"Saved billing address"},dC=(e,t)=>{const r=Lw(t??"").slice(-4);return{...e,tenderType:"Card",card:{...e.card,...r?{cardNumber:r}:{}}}},uC=e=>({id:mC(e,"Connect your bank completed but the verification response did not include a source id."),tenderType:"BankAccount",verificationInfo:vC(e),bankAccount:{}}),lC=(e,t)=>{const r=e[t];return"string"==typeof r&&r.trim()?r.trim():void 0},hC=e=>{const t=lC(e,"bankName"),r=lC(e,"bankAccountType"),n=lC(e,"accountNumber")??lC(e,"interacAccount"),i=(e=>{const t=/-([BP])$/u.exec(e.trim())?.[1];if("B"===t)return"BUSINESS";if("P"===t)return"PERSONAL";throw new Error("The selected instrument schema does not identify a business or personal account.")})(e.bavSupportedCode);return{id:e.id,name:e.name,tenderType:"BankAccount",accountHolderType:i,bankAccount:{...t?{bankName:t}:{},...r?{accountType:r}:{},...n?{accountNumber:tE(n)}:{},asset:{type:"CURRENCY",id:e.currencyCode},country:e.countryCode}}},fC=(e,t)=>{const r=d$(t??"").slice(-4);return{...e,tenderType:"BankAccount",bankAccount:{...e.bankAccount,...r?{accountNumber:r}:{}}}},mC=(e,t)=>{const r=e.sourceId?.trim();if(!r)throw new Error(t);return r},pC=e=>{if("object"!=typeof e||null===e||Array.isArray(e))return;const t=e;return t.sourceId?.trim()?t:void 0},vC=e=>{const{sourceId:t,...r}=e;return r},bC=e=>{const t=e?.email?.trim();if(t)return t;const r=e?.phone?.countryCode?.trim(),n=e?.phone?.phoneNumber?.trim();return[r,n].filter(Boolean).join(" ")||void 0},gC=e=>{const t=e?.copy?.otp;return{title:t?.title??"Enter verification code",subtitle:t?.subtitle,failedMessage:t?.failedMessage??"The code does not match. Try again.",resendPrefix:t?.resendPrefix??"Didn't receive the code?",resendButton:t?.resendButton??"Resend code",resendPendingButton:t?.resendPendingButton??"Sending code...",verifyButton:t?.verifyButton??"Verify",verifyingButton:t?.verifyingButton??"Verifying...",tryAgainButton:t?.tryAgainButton??"Try again"}},yC=e=>{const t=e?.copy?.paymentMethods;return{title:t?.title??"Payment methods",subtitle:t?.subtitle??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??"",continueButton:t?.continueButton??"Use selected method",continuingButton:t?.continuingButton??"Saving..."}},wC=e=>{const t=e?.copy?.noSavedPaymentMethods;return{title:t?.title??"Payment methods",subtitle:t?.subtitle??"",emptyTitle:t?.emptyTitle??"",emptyMessage:t?.emptyMessage??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"Connect or enter an account",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??"Add your card details"}},$C=e=>{const t=Object.fromEntries(Object.entries(e??{}).filter(([,e])=>void 0!==e));return{...oC,...t}},kC=e=>{const t=e?.colors,r={};return CC(r,"backgroundColor",xC(t?.widgetBackground,t?.surface)),CC(r,"primaryColor",t?.primary),CC(r,"buttonColor",t?.primary),CC(r,"primaryTextColor",t?.text),CC(r,"secondaryTextColor",xC(t?.copy,t?.muted)),CC(r,"dangerColor",t?.danger),CC(r,"successColor",t?.success),CC(r,"borderColor",xC(t?.border,t?.widgetBorder,t?.borderBackground)),CC(r,"placeholderColor",t?.placeholder),{branding:r}},xC=(...e)=>e.map(e=>e?.trim()).find(e=>Boolean(e)),CC=(e,t,r)=>{const n=r?.trim();n&&(e[t]=n)},EC=[{field:"primary",property:"--chc-primary"},{field:"text",property:"--chc-text"},{field:"copy",property:"--chc-copy"},{field:"muted",property:"--chc-muted"},{field:"placeholder",property:"--chc-placeholder"},{field:"surface",property:"--chc-surface"},{field:"widgetBackground",property:"--chc-widget-background"},{field:"borderBackground",property:"--chc-border"},{field:"widgetBorder",property:"--chc-border"},{field:"softSurface",property:"--chc-soft-surface"},{field:"paymentSelectionBackground",property:"--chc-payment-method-background"},{field:"paymentMethodBackground",property:"--chc-payment-method-background"},{field:"border",property:"--chc-border"},{field:"borderStrong",property:"--chc-border-strong"},{field:"success",property:"--chc-success"},{field:"successBackground",property:"--chc-success-bg"},{field:"successBorder",property:"--chc-success-border"},{field:"danger",property:"--chc-danger"},{field:"dangerBackground",property:"--chc-danger-bg"},{field:"dangerBorder",property:"--chc-danger-border"},{field:"warning",property:"--chc-warning"},{field:"warningBackground",property:"--chc-warning-bg"},{field:"warningBorder",property:"--chc-warning-border"},{field:"disabledText",property:"--chc-disabled-text"},{field:"disabledSurface",property:"--chc-disabled-surface"}],jC="--chc-font-weight",SC="--chc-shell-padding",AC=[...EC.map(({property:e})=>e),jC,SC],OC=(e,t={})=>{const r=e?.paymentSources;if(!r?.length){const r=WC(e);return r?[zC(r,{...t,selected:!0,isDefault:"PAYMENT_SOURCE_ATTACHED"===e?.status})]:[]}const n="PAYMENT_SOURCE_ATTACHED"===e?.status?e.selectedSource?.id:void 0;return r.map(e=>zC(e,{...t,isDefault:Boolean(n&&e.id===n)}))},IC=e=>{const t=e?.allowedTenderTypes;return t?{card:t.includes("CARD"),bankAccount:t.includes("BANK_ACCOUNT"),nativeAccount:t.includes("NATIVE_ACCOUNT")}:{card:!0,bankAccount:!0,nativeAccount:!0}},_C=e=>{const t=e?.trim().toUpperCase();return"US"===t||"USA"===t},zC=(e,{selected:t=!1,isDefault:r=!1,nativeBalances:n={},nativeBalanceLoadingSourceIds:i=[]}={})=>{const o=LC(e),a=_E(e)?qC(e,n):void 0,s=void 0===a?.balance?void 0:UC(a.balance);return{id:o,label:NC(e,{selected:t}),type:DC(e),brand:RC(e),accountLabel:MC(e),balanceLabel:s,balanceLoading:_E(e)&&i.includes(o),last4:PC(e),status:rE(e.verificationInfo?.status),showVerificationStatus:Boolean(e.verificationInfo?.status),verificationLabel:ux(e),selectionEligible:dx(e),isDefault:r}},NC=(e,{selected:t=!1}={})=>IE(e)?t?e.name?.trim()||e.card?.nameOnCard?.trim()||TC(e):e.card?.nameOnCard?.trim()||e.name?.trim()||TC(e):OE(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||TC(e):_E(e)?e.account?.nickName?.trim()||e.name?.trim()||TC(e):e.name?.trim()||TC(e),TC=e=>IE(e)?"Saved card":OE(e)?e.bankAccount?.bankName??"Saved bank account":_E(e)?"Native account":"Dynamic session card",RC=e=>IE(e)?e.card?.network??"Card":OE(e)?e.bankAccount?.bankName??"Bank account":_E(e)?e.account?.productType??"Native account":"DSC",MC=e=>{const t=PC(e);if(IE(e))return`${e.card?.network?.trim()||"Card"} xx ${t}`;if(OE(e))return`${e.bankAccount?.accountType?.trim()||"Bank account"} xx ${t}`;if(_E(e)){const r=e.account?.productType?.trim();return`${r||"Native account"} xx ${t}`}return`Card xx ${t}`},PC=e=>IE(e)?tE(e.card?.cardNumber):OE(e)?tE(e.bankAccount?.accountNumber):_E(e)?tE(e.account?.positionId??e.account?.token):tE(e.id),LC=e=>e.id?.trim()||e.name?.trim()||e.tenderType,DC=e=>OE(e)?"bank":_E(e)?"native":"card",BC=e=>(e?.paymentSources??[]).filter(e=>(OE(e)||_E(e))&&"VERIFIED"===e.verificationInfo?.status&&Boolean(LC(e))),qC=(e,t)=>{for(const r of VC(e)){const e=t[r];if(e)return e}},VC=e=>[e.id,e.account?.positionId,e.account?.token].map(e=>e?.trim()).filter(e=>Boolean(e)),UC=e=>FC.format(e),FC=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}),HC=(e,t)=>{const r=e?.paymentSources;if(!r?.length)return;const n=r.filter(dx);if(t&&n.some(e=>e.id===t))return t;const i=e?.selectedSource?.id;return i&&n.some(e=>e.id===i)?i:n[0]?.id},WC=(e,t)=>{if(t){const r=e?.paymentSources?.find(e=>e.id===t);if(r)return r}return e?.selectedSource},KC=e=>e===rC||"PAYMENT_SOURCE_REQUESTED"===e,GC=(e,t)=>Boolean(e?.features?.includes(t)),YC=e=>Boolean(GC(e,"TRANSFER")&&!GC(e,"ADD_ACCOUNT")&&!GC(e,"SELECT")),JC=(e,t,r)=>{const n={...e,...t},i=void 0!==t.paymentSources,o=i?t.paymentSources??[]:e.paymentSources??[],a=((e,t)=>{if(t){const r=e.find(e=>e.id===t);if(r)return r}})(o,r??t.selectedSource?.id)??t.selectedSource??(i?void 0:e.selectedSource);return{...n,selectedSource:a,paymentSources:o}},ZC=e=>{if(e.data)return e.data;throw new Error(QC(e.error))},QC=e=>"string"==typeof e?e:e&&"object"==typeof e&&"message"in e&&"string"==typeof e.message&&e.message.trim()?e.message:"CommerceHub API request failed.",XC=()=>{if(globalThis.crypto?.randomUUID)return globalThis.crypto.randomUUID();const e=new Uint8Array(16);globalThis.crypto?.getRandomValues(e),e[6]=15&e[6]|64,e[8]=63&e[8]|128;const t=[...e].map(e=>e.toString(16).padStart(2,"0"));return`${t.slice(0,4).join("")}-${t.slice(4,6).join("")}-${t.slice(6,8).join("")}-${t.slice(8,10).join("")}-${t.slice(10,16).join("")}`},eE=(e,t)=>{const r=e.composedPath().find(e=>e instanceof HTMLElement&&Boolean(e.dataset[t]));return r?.dataset[t]},tE=e=>e&&e.length>=4?e.slice(-4):"----",rE=e=>"VERIFIED"===e?"verified":"UNDER_REVIEW"===e?"under-review":"REQUIRE_INFO"===e?"require-info":"DECLINED"===e?"declined":"not-verified",nE=e=>{const t=e.aggregatorSessionId?.trim(),r=e.tokenID?.trim()||e.accessToken?.trim(),n=e.pToken?.trim(),i=e.publicKey?.trim();if(!(t&&r&&n&&i))throw new Error("The /interaction/source/pbb/session response is missing one or more required values.");return{aggregatorSessionId:t,accessToken:r,pToken:n,publicKey:i}},iE=e=>"success"===e.type||"cancel"===e.type||"failure"===e.type||"error"===e.type,oE=(e,t)=>{const r=sE(e.paymentSources??[],t);return{...e,selectedSource:t,paymentSources:r}},aE=(e,t)=>({...e,paymentSources:sE(e.paymentSources??[],t)}),sE=(e,t)=>e.some(e=>e.id===t.id)?e.map(e=>e.id===t.id?t:e):[t,...e],cE=e=>dx(e),dE=({title:e,helper:t})=>Ry`
...
`,uE=e=>"verify-payment-source"===e?dE({title:"Verifying payment method",helper:"Verifying your payment method, please wait."}):"submit-required-info"===e?dE({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,lE=e=>"verify-payment-source"===e?uE(e):"delete-payment-source"===e?dE({title:"Deleting payment method",helper:"Deleting your payment method, please wait."}):"attach-payment-source"===e?dE({title:"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,hE=e=>{switch(e){case"attach-payment-source":return"Saving the selected payment method.";case"verify-payment-source":case"submit-required-info":return"Verifying the payment method.";case"delete-payment-source":return"Deleting the payment method.";case"verify-otp":return"Verifying the code.";case"resend-otp":return"Sending a new code.";case"save-card":return"Saving the card.";case"save-bank-account":return"Saving the bank account.";case"transfer":return"Submitting the transfer.";default:return""}},fE=e=>{const t=e?.verificationInfo?.status;return"VERIFIED"===t?{kind:"verified",variant:"success",title:"Bank account verified",message:"Your bank account is connected and ready to use."}:"UNDER_REVIEW"===t?{kind:"pending",variant:"warning",title:"Bank account pending review",message:"We will update this bank account after review is complete."}:"REQUIRE_INFO"===t?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:"Additional information is required before this bank account can be verified."}:"DECLINED"===t?{kind:"declined",variant:"danger",title:"Bank account verification failed",message:"This bank account could not be verified."}:{kind:"failed",variant:"danger",title:"Bank account not verified",message:"This bank account is not verified yet."}},mE=(e,t=!1)=>{const r=AE(e),n=r.toLowerCase(),i=e?.verificationInfo?.status;return t?{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} not verified`,message:`We could not verify this ${n} right now.`}:"VERIFIED"===i?{kind:"verified",variant:"success",title:"Bank account"===r?"Bank account verified":`${r} saved`,message:`This ${n} is verified and ready to use.`}:"UNDER_REVIEW"===i?{kind:"pending",variant:"warning",title:"Bank account"===r?"Bank account pending review":"Verification pending review",message:`We will update this ${n} after review is complete.`}:"REQUIRE_INFO"===i?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:`Additional information is required before this ${n} can be verified.`}:"DECLINED"===i?{kind:"declined",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} declined`,message:`This ${n} could not be verified.`}:{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account not verified":`${r} not verified`,message:`This ${n} is not verified yet.`}},pE=e=>{const t=e?.verificationInfo?.docs??[];return t.length>0?t:[{}]},vE=(e,t=0)=>`${e?.docType??"DOCUMENT"}-${t}`,bE=e=>"DRIVER_LICENSE_NUMBER"===e.docType||"SOCIAL_SECURITY_NUMBER"===e.docType,gE=e=>!1!==e.mandatory,yE=e=>gE(e)?"required":"optional",wE=e=>Ry`
  <span
    class="required-info-requirement-badge required-info-requirement-badge-${yE(e)}"
  >
    ${(e=>gE(e)?"Required":"Optional")(e)}
  </span>
`,$E=e=>{const t=e.findIndex(e=>!bE(e));return t>=0?vE(e[t],t):void 0},kE=({doc:e,key:t,value:r,error:n})=>{if("SOCIAL_SECURITY_NUMBER"===e.docType)return xE({doc:e,key:t,value:r,error:n});const i=`required-info-${t}`,o=`${i}-error`;return Ry`
    <div
  ...
  `},xE=({doc:e,key:t,value:r,error:n})=>{const i=CE(e),o=(e=>{const t=Gk(e);return[t.slice(0,3),t.slice(3,5),t.slice(5,9)]})(r),a=`required-info-${t}-ssn-0`,s=`required-info-${t}-error`;return Ry`
    <div
  ...
  `},CE=e=>"BANK_STATEMENT"===e.docType?"Bank statement":"BANK_LETTER"===e.docType?"Bank letter":"BANK_CHECK"===e.docType?"Bank check":"DRIVER_LICENSE_PHOTO"===e.docType?"Driver license photo":"DRIVER_LICENSE_NUMBER"===e.docType?"Driver license number":"SOCIAL_SECURITY_NUMBER"===e.docType?"Social Security number":"Required document",EE=e=>{const t=CE(e);return"SOCIAL_SECURITY_NUMBER"===e.docType?"Enter a Social Security number.":bE(e)?`Enter a ${t.toLowerCase()}.`:`Choose a ${t.toLowerCase()}.`},jE=e=>{const t=(e=>({type:DC(e),brand:RC(e)}))(e),r=nx(t),n=(e=>{if(!IE(e))return;const t=e.card?.expirationMonth?.trim(),r=e.card?.expirationYear?.trim();if(!t||!r)return;return`${t.padStart(2,"0")}/${r.slice(-2)}`})(e);return Ry`
    <div
      ...
      <div class="required-info-card-top">
        <div class="required-info-card-heading">
          <span class="required-info-card-label"
            >${(e=>OE(e)?"Bank account":IE(e)?"Card":_E(e)?"Native account":"Dynamic session card")(e)}</span
          >
          <span
            class="required-info-card-field required-info-card-name"
            data-required-info-card-field="name"
            >${(e=>IE(e)?e.card?.nameOnCard?.trim()||e.name?.trim()||TC(e):OE(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||TC(e):_E(e)?e.account?.nickName?.trim()||e.name?.trim()||TC(e):e.name?.trim()||TC(e))(e)}</span
          >
        </div>
      ...
      <div class="required-info-card-bottom">
        <div class="required-info-card-detail">
          ...
          <span class="required-info-card-status">
            ${bx(rE(e.verificationInfo?.status))}
          </span>
        </div>
        ${n?Ry`
              <div class="required-info-card-detail">
  ...
  `},SE=e=>"REQUIRE_INFO"===e.verificationInfo?.status,AE=e=>e&&OE(e)?"Bank account":e&&_E(e)?"Native account":"Payment method",OE=e=>"BankAccount"===e.tenderType||"BANK_ACCOUNT"===e.tenderType,IE=e=>"Card"===e.tenderType||"CARD"===e.tenderType,_E=e=>"NativeAccount"===e.tenderType||"NATIVE_ACCOUNT"===e.tenderType;let zE,NE;const TE=async e=>{if(!window.PaymentSDK?.init)if(zE&&NE===e)await zE;else if(NE=e,zE=new Promise((t,r)=>{const n=document.querySelector(`script[data-commerce-hub-pay-by-bank-sdk="true"][src="${e}"]`),i=n??document.createElement("script"),o=()=>{i.removeEventListener("load",a),i.removeEventListener("error",s)},a=()=>{o(),t()},s=()=>{o(),zE=void 0,NE=void 0,r(new Error(`Unable to load Connect your bank script: ${e}`))};i.addEventListener("load",a,{once:!0}),i.addEventListener("error",s,{once:!0}),n||(i.src=e,i.async=!0,i.dataset.commerceHubPayByBankSdk="true",document.head.appendChild(i))}),await zE,!window.PaymentSDK?.init)throw new Error(`Connect your bank script loaded but window.PaymentSDK.init is unavailable: ${e}`)},RE=()=>{try{window.PaymentSDK?.destroy?.()}catch{}};export{gw as COMMERCE_HUB_BASE_URLS,aC as CommerceHubConnect,bw as DEFAULT_COMMERCE_HUB_BASE_URL,Kx as ON_ADD_PAYMENT_METHOD_EVENT,Yx as ON_DELETE_PAYMENT_METHOD_EVENT,Qx as ON_ERROR_EVENT,Jx as ON_LIST_PAYMENT_METHODS_EVENT,Wx as ON_SELECT_EVENT,Zx as ON_TRANSFER_EVENT,Gx as ON_VERIFY_PAYMENT_METHOD_EVENT,ww as createCommerceHubClient,kw as createCommerceHubConfigClient,$w as createCommerceHubMerchantClient,yw as resolveCommerceHubBaseURL};

 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const k=globalThis,$=e=>e,x=k.trustedTypes,S=x?x.createPolicy("lit-html",{createHTML:e=>e}):void 0,C="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,z="?"+E,A=`<${z}>`,I=document,N=()=>I.createComment(""),T=e=>null===e||"object"!=typeof e&&"function"!=typeof e,q=Array.isArray,R="[ \t\n\f\r]",B=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,D=/-->/g,O=/>/g,L=RegExp(`>|${R}(?:([^\\s"'>=/]+)(${R}*=${R}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),M=/'/g,V=/"/g,P=/^(?:script|style|textarea|title)$/i,F=(e=>(t,...i)=>({_$litType$:e,strings:t,values:i}))(1),U=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),_=new WeakMap,H=I.createTreeWalker(I,129);function W(e,t){if(!q(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==S?S.createHTML(t):t}const K=(e,t)=>{const i=e.length-1,r=[];let n,a=2===t?"<svg>":3===t?"<math>":"",o=B;for(let t=0;t<i;t++){const i=e[t];let s,c,d=-1,l=0;for(;l<i.length&&(o.lastIndex=l,c=o.exec(i),null!==c);)l=o.lastIndex,o===B?"!--"===c[1]?o=D:void 0!==c[1]?o=O:void 0!==c[2]?(P.test(c[2])&&(n=RegExp("</"+c[2],"g")),o=L):void 0!==c[3]&&(o=L):o===L?">"===c[0]?(o=n??B,d=-1):void 0===c[1]?d=-2:(d=o.lastIndex-c[2].length,s=c[1],o=void 0===c[3]?L:'"'===c[3]?V:M):o===V||o===M?o=L:o===D||o===O?o=B:(o=L,n=void 0);const h=o===L&&e[t+1].startsWith("/>")?" ":"";a+=o===B?i+A:d>=0?(r.push(s),i.slice(0,d)+C+i.slice(d)+E+h):i+E+(-2===d?t:h)}return[W(e,a+(e[i]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),r]};class G{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let n=0,a=0;const o=e.length-1,s=this.parts,[c,d]=K(e,t);if(this.el=G.createElement(c,i),H.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(r=H.nextNode())&&s.length<o;){if(1===r.nodeType){if(r.hasAttributes())for(const e of r.getAttributeNames())if(e.endsWith(C)){const t=d[a++],i=r.getAttribute(e).split(E),o=/([.?@])?(.*)/.exec(t);s.push({type:1,index:n,name:o[2],strings:i,ctor:"."===o[1]?X:"?"===o[1]?ee:"@"===o[1]?te:Q}),r.removeAttribute(e)}else e.startsWith(E)&&(s.push({type:6,index:n}),r.removeAttribute(e));if(P.test(r.tagName)){const e=r.textContent.split(E),t=e.length-1;if(t>0){r.textContent=x?x.emptyScript:"";for(let i=0;i<t;i++)r.append(e[i],N()),H.nextNode(),s.push({type:2,index:++n});r.append(e[t],N())}}}else if(8===r.nodeType)if(r.data===z)s.push({type:2,index:n});else{let e=-1;for(;-1!==(e=r.data.indexOf(E,e+1));)s.push({type:7,index:n}),e+=E.length-1}n++}}static createElement(e,t){const i=I.createElement("template");return i.innerHTML=e,i}}function Y(e,t,i=e,r){if(t===U)return t;let n=void 0!==r?i._$Co?.[r]:i._$Cl;const a=T(t)?void 0:t._$litDirective$;return n?.constructor!==a&&(n?._$AO?.(!1),void 0===a?n=void 0:(n=new a(e),n._$AT(e,i,r)),void 0!==r?(i._$Co??=[])[r]=n:i._$Cl=n),void 0!==n&&(t=Y(e,n._$AS(e,t.values),n,r)),t}class Z{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,r=(e?.creationScope??I).importNode(t,!0);H.currentNode=r;let n=H.nextNode(),a=0,o=0,s=i[0];for(;void 0!==s;){if(a===s.index){let t;2===s.type?t=new J(n,n.nextSibling,this,e):1===s.type?t=new s.ctor(n,s.name,s.strings,this,e):6===s.type&&(t=new ie(n,this,e)),this._$AV.push(t),s=i[++o]}a!==s?.index&&(n=H.nextNode(),a++)}return H.currentNode=I,r}p(e){let t=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class J{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,r){this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Y(this,e,t),T(e)?e===j||null==e||""===e?(this._$AH!==j&&this._$AR(),this._$AH=j):e!==this._$AH&&e!==U&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>q(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==j&&T(this._$AH)?this._$AA.nextSibling.data=e:this.T(I.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,r="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=G.createElement(W(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.p(t);else{const e=new Z(r,this),i=e.u(this.options);e.p(t),this.T(i),this._$AH=e}}_$AC(e){let t=_.get(e.strings);return void 0===t&&_.set(e.strings,t=new G(e)),t}k(e){q(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,r=0;for(const n of e)r===t.length?t.push(i=new J(this.O(N()),this.O(N()),this,this.options)):i=t[r],i._$AI(n),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=$(e).nextSibling;$(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class Q{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,r,n){this.type=1,this._$AH=j,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=n,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=j}_$AI(e,t=this,i,r){const n=this.strings;let a=!1;if(void 0===n)e=Y(this,e,t,0),a=!T(e)||e!==this._$AH&&e!==U,a&&(this._$AH=e);else{const r=e;let o,s;for(e=n[0],o=0;o<n.length-1;o++)s=Y(this,r[i+o],t,o),s===U&&(s=this._$AH[o]),a||=!T(s)||s!==this._$AH[o],s===j?e=j:e!==j&&(e+=(s??"")+n[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class X extends Q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===j?void 0:e}}class ee extends Q{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==j)}}class te extends Q{constructor(e,t,i,r,n){super(e,t,i,r,n),this.type=5}_$AI(e,t=this){if((e=Y(this,e,t,0)??j)===U)return;const i=this._$AH,r=e===j&&i!==j||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==j&&(i===j||r);r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class ie{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Y(this,e)}}const re=k.litHtmlPolyfillSupport;re?.(G,J),(k.litHtmlVersions??=[]).push("3.3.2");const ne=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */,Pt=e=>e??j,Ft=(...e)=>e.filter(Boolean).join(" "),Ut=e=>{const t=e?.trim();return t||void 0},jt=e=>{const t=(e=>"verified"===e?{label:"Verified",tone:"success"}:"under-review"===e?{label:"Under review",tone:"warning"}:"require-info"===e?{label:"Need More Information",tone:"warning"}:"declined"===e?{label:"Can't Use",tone:"danger"}:{label:"Action Required",tone:"warning"})(e);return F`
  ...
  `},_t=e=>{const t=Ut(e.accountLabel)??(({label:e,brand:t,last4:i})=>{const r=Ut(e),n=Ut(t);return i&&n&&n!==r?`${n} •••• ${i}`:i?`•••• ${i}`:n??""})(e),i=Ut(e.label)??t,r=Boolean(t);return F`
    <span class="payment-method-copy">
      ...
      ${r?F`
            <span class="payment-method-meta-row">
              ...
              ${(e=>!1!==e.showVerificationStatus&&"verified"!==e.status)(e)?jt(e.status):""}
            </span>
          `:""}
    </span>
  `},Ht=(e,t)=>F`
...
`,Wt=(e,t)=>F`
  ...
  ${_t(e)} ${t}
`,Kt=({label:e,variant:t="primary",action:i,type:r="button",icon:n,disabled:a=!1,loading:o=!1})=>F`
  <button
    class=${Ft("button",`button-${t}`,o&&"button-loading")}
    part=${Pt("primary"===t?"primary-action":void 0)}
    type=${r}
    data-action=${Pt(i)}
...
`,Gt=({id:e,label:t,name:i,value:r="",placeholder:n,type:a="text",span:o="default",variant:s="default",autocomplete:c,inputmode:d,disabled:l=!1,dataField:h,dataFieldScope:u="card",error:m})=>{const p=Ft("field","full"===o&&"field-full","card-form"===s&&"field-card-form",m&&"field-invalid"),f=Ft("field-label","card-form"===s&&"field-label-card-form"),v=Ft("field-input","card-form"===s&&"field-input-card-form"),b=F`
    <input
      class=${v}
      id=${e}
      name=${Pt(i)}
      ...
      autocomplete=${Pt(c)}
      inputmode=${Pt(d)}
      data-card-field=${Pt("card"===u?h:void 0)}
      data-bank-account-field=${Pt("bankAccount"===u?h:void 0)}
      data-transfer-field=${Pt("transfer"===u?h:void 0)}
      aria-invalid=${m?"true":"false"}
      aria-describedby=${Pt(m?`${e}-error`:void 0)}
      ?disabled=${l}
    />
  `;return F`
    <div class=${p}>
  ...
  `},Yt=({id:e,label:t,name:i,value:r="",options:n,span:a="default",variant:o="default",disabled:s=!1,dataField:c,dataFieldScope:d="card",error:l})=>{const h=Ft("field","card-form"!==o&&"field-with-select","full"===a&&"field-full","card-form"===o&&"field-card-form",l&&"field-invalid"),u=Ft("field-label","card-form"===o&&"field-label-card-form"),m=Ft("field-input","field-select","card-form"===o&&"field-input-card-form"),p=F`
    <select
      class=${m}
      id=${e}
      name=${Pt(i)}
      .value=${r}
      data-card-field=${Pt("card"===d?c:void 0)}
      data-bank-account-field=${Pt("bankAccount"===d?c:void 0)}
      data-transfer-field=${Pt("transfer"===d?c:void 0)}
      aria-invalid=${l?"true":"false"}
      aria-describedby=${Pt(l?`${e}-error`:void 0)}
      ?disabled=${s}
    >
      ${n.map(e=>F`
...
`,Qt=({id:e,label:t,status:i,type:r,eyebrow:n,brand:a,accountLabel:o,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l,disabled:h=!1},{variant:u="default",deleteDisabled:m=!1,confirmingDelete:p=!1,selected:f=!1,selectable:v=!0}={})=>{const b={id:e,label:t,status:i,type:r,eyebrow:n,brand:a,accountLabel:o,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l,disabled:h};if("edit"===u){const i={...b,showVerificationStatus:!1};return F`
      <div
        class=${Ft("payment-method-row","payment-method-row-edit",p&&"payment-method-row-delete-confirming")}
        part="payment-method-row"
        aria-label=${t}
        data-payment-method-id=${e}
      >
        ${Wt(i,((e,t,i=!1,r=!1)=>{const n=`Delete ${t}`;return r?F`
  ...
  `})(e,t,m,p))}
    ...
    `}return v&&(e=>{return"verified"===(t=e.status)||"require-info"===t||"not-verified"===t;var t})(b)?F`
      <button
        class=${Ft("payment-method-row","payment-method-row-action",f&&"payment-method-row-selected")}
        part="payment-method-row"
        type="button"
    ...
    `:F`
    <div
      class=${Ft("payment-method-row","payment-method-row-static")}
      part="payment-method-row"
      aria-label=${t}
      aria-disabled="true"
      data-payment-method-id=${e}
  ...
  `},Xt=({id:e,label:t,status:i,type:r,eyebrow:n,brand:a,accountLabel:o,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l})=>{const h={label:t,status:i,type:r,brand:a,accountLabel:o,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:l};return F`
    <div
  ...
  `},ei=e=>"transfer"===e?F`
      ...
      `:F`<span class="source-action-icon" aria-hidden="true">+</span>`,ti=({label:e,subtitle:t,action:i,icon:r,variant:n="card",disabled:a=!1})=>"link"===n?F`
        <button
      ...
      `,ii=({containerId:e,title:t,loadingLabel:i,loading:r=!1})=>F`
  <div
    class=${Ft("provider-frame",r&&"provider-frame-loading")}
    part="provider-frame"
  ...
  >
    ...
    <slot class="provider-frame-slot" name=${e}>
      <div
        class=${Ft("provider-frame-container",r&&"provider-frame-container-loading")}
        id=${e}
      ></div>
    </slot>
    ${r?F`
...
`,ri=({variant:e,title:t,message:i,content:r,actions:n})=>F`
...
`,ni=({label:e,action:t,disabled:i=!1})=>F`
  <button
...
`,ai=e=>F` <div class="form-grid">${e}</div> `,oi=({title:e,subtitle:t,content:i,headerAction:r,width:n="default",ariaLabel:a="Commerce Hub Connect",closeAction:o="close",showClose:s=!0,showDivider:c=!1,showFooter:d=!0,busy:l=!1,overlay:h})=>F`
  <section
    class=${Ft("widget-shell","wide"===n&&"widget-shell-wide",l&&"widget-shell-busy")}
    part="shell"
    aria-label=${a}
...
`,si=e=>`We sent a one-time code to ${e??"your contact method"}.`,ci=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input")),di=({status:e,value:t,length:i,failedMessage:r,copy:n,submitting:a=!1,resending:o=!1})=>{const s="OTP_VALIDATION_FAILED"===e;return F`
    <div class="otp-flow">
      ${s?Zt({variant:"danger",message:r??n.failedMessage}):""}
  ...
  `})({label:"Verification code",value:t,length:i,disabled:a,error:s})}
      <div class="primitive-footer">
        ${Kt({label:a?n.verifyingButton:s?n.tryAgainButton:n.verifyButton,icon:a||s?void 0:"check",variant:"primary",action:"verify-otp",loading:a,disabled:a||t.length<i})}
      </div>
  ...
  <button
    class=${Ft("otp-resend",r&&"otp-resend-loading")}
    type="button"
    data-action=${t}
    aria-busy=${r?"true":"false"}
    ?disabled=${i||r}
...
`,hi=({methods:e,allowedTenderOptions:t,canAddPaymentSources:i,canSelectPaymentSources:r,editing:n,actionPending:a,selectedPaymentSourceId:o,deleteConfirmationPaymentSourceId:s,copy:c,showTransferAction:d=!1})=>{const l=i&&(t.card||t.bankAccount);return F`
  ...
  `};var mi=function(e,t,i,r){for(var n,a=arguments.length,o=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r,s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};const pi="onSelect",fi="onAddPaymentMethod",vi="onVerifyPaymentMethod",bi="onDeletePaymentMethod",gi="onListPaymentMethods",yi="onTransfer",wi="onError",ki="commerce-hub-pbb-provider",$i="OTP_VALIDATION_SUCCESS",xi=[{value:"",label:"Select country or region"},{value:"US",label:"United States"}],Si=[{value:"",label:"Select state"},...[["AL","Alabama"],["AK","Alaska"],["AZ","Arizona"],["AR","Arkansas"],["CA","California"],["CO","Colorado"],["CT","Connecticut"],["DE","Delaware"],["FL","Florida"],["GA","Georgia"],["HI","Hawaii"],["ID","Idaho"],["IL","Illinois"],["IN","Indiana"],["IA","Iowa"],["KS","Kansas"],["KY","Kentucky"],["LA","Louisiana"],["ME","Maine"],["MD","Maryland"],["MA","Massachusetts"],["MI","Michigan"],["MN","Minnesota"],["MS","Mississippi"],["MO","Missouri"],["MT","Montana"],["NE","Nebraska"],["NV","Nevada"],["NH","New Hampshire"],["NJ","New Jersey"],["NM","New Mexico"],["NY","New York"],["NC","North Carolina"],["ND","North Dakota"],["OH","Ohio"],["OK","Oklahoma"],["OR","Oregon"],["PA","Pennsylvania"],["RI","Rhode Island"],["SC","South Carolina"],["SD","South Dakota"],["TN","Tennessee"],["TX","Texas"],["UT","Utah"],["VT","Vermont"],["VA","Virginia"],["WA","Washington"],["WV","West Virginia"],["WI","Wisconsin"],["WY","Wyoming"],["DC","District of Columbia"]].map(([e,t])=>({value:e,label:t}))],Ci={apiKey:"YqIvg89urE1WsAdgWwM1EiQTRM1ajSYCaLhnDvimvmHeB78A",configId:"cce84049-0940-4926-9a54-9eaca0c09830",environment:"qa",locale:"en-US",paymentSdkUrl:"https://connect-qa.fiservapis.com/pbb/sdk/web/v2/js/PaymentSDK.js"};let Ei=class extends ae{constructor(){super(...arguments),this.otpValue="",this.bankLinkLoading=!1,this.bankAccountDraft={name:"",routingNumber:"",accountNumber:"",accountNumberReEntered:""},this.bankAccountDraftErrors={},this.bankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},accountNumberReEntered:{status:"idle",normalizedValue:""}},this.transferDraft={fromSourceId:"",toSourceId:"",amount:""},this.transferDraftErrors={},this.transferSubmitSuccess=!1,this.transferFlowActive=!1,this.transferFlowScreen="form",this.cardDraft=Me(),this.cardDraftErrors={},this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.billingAddresses=[],this.billingAddressSelectorExpanded=!1,this.paymentSourceEditMode=!1,this.savedSourceVerificationFailed=!1,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.interactionRefresh=new Ne(this),this.nativeBalance=new Te(this),this.minimumVerificationOverlayToken=0,this.handleClick=e=>{const t=br(e,"action"),i=br(e,"paymentMethodId");if(t)if("attach-payment-source"!==t){if("change-payment-source"===t)return this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("retry-interaction-refresh"!==t){if("toggle-payment-source-edit-mode"===t)return this.clearDeletePaymentSourceConfirmation(),void(this.paymentSourceEditMode=!this.paymentSourceEditMode);if("verify-payment-source"!==t)if("delete-payment-source"!==t)if("cancel-delete-payment-source"!==t){if("done-payment-source-verification"===t)return this.resetSavedSourceVerification(),void this.showPaymentSourceList({refresh:!0});if("open-required-info-file-picker"===t)return this.pendingRequiredInfoDocKey=br(e,"requiredInfoDocKey")??this.firstRequiredInfoDocKey(),void this.renderRoot.querySelector(".required-info-file-input")?.click();if("submit-required-info"!==t){if("open-transfer"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),this.resetTransferFlow(),void(this.transferFlowActive=!0);if("transfer"!==t)if("edit-transfer"!==t)if("confirm-transfer"!==t)if("verify-otp"!==t)if("resend-otp"!==t){if("add-bank-account"===t||"use-bank-account-instead"===t||"retry-bank-provider"===t||"back-to-bank-provider"===t||"use-different-bank-account"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),void this.startPayByBankFlow();if("add-ach-manually"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetCardFlow(),this.resetRequiredInfo(),void this.showManualBankAccountScreen();if("back-to-payment-methods"===t)return this.resetCardFlow(),this.resetBankFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0});if("continue-bank-outcome"===t||"done-bank-outcome"===t)return this.resetBankFlow(),void this.showPaymentSourceList({refresh:!0});if("add-card"===t)return this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetRequiredInfo(),void this.showAddCardScreen();if("change-billing-address"!==t)if("save-card"!==t)if("save-ach-manual"!==t){if("edit-card-details"!==t)return"use-different-method"===t?(this.resetCardFlow(),this.resetRequiredInfo(),void this.showPaymentSourceList({refresh:!0})):void 0;this.cardFlowScreen="form"}else this.saveManualBankAccount();else this.saveCard();else this.billingAddressSelectorExpanded=!0}else this.resendOtp();else this.verifyOtp();else this.submitTransfer();else this.transferFlowScreen="form";else this.reviewTransfer()}else this.submitRequiredInfo()}else this.clearDeletePaymentSourceConfirmation();else i&&this.deletePaymentSource(i);else i&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.verifySavedPaymentSource(i))}else this.retryInteractionRefresh()}else i&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.selectedPaymentSourceId=i,this.paymentSourceView="selected",this.attachPaymentSource(i))},this.handleInput=e=>{const t=zi(e);if(t)return void this.storeRequiredInfoSsnInput(t);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.cardField));if(i)return void this.updateCardDraftField(i.dataset.cardField,i.value);const r=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.bankAccountField));if(r)return void this.updateBankAccountDraftField(r.dataset.bankAccountField,r.value);const n=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.transferField));if(n)return void this.updateTransferDraftField(n.dataset.transferField,n.value);const a=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoDocKey));if(a)return void this.storeRequiredInfoValue(a.dataset.requiredInfoDocKey,a.value);const o=e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input"));if(!o)return;const s=this.getOtpInputs(),c=Number(o.dataset.otpIndex),d=$t(o.value);if(!d)return o.value="",void this.syncOtpValueFromInputs(s);if(1===d.length)return o.value=d,this.syncOtpValueFromInputs(s),void this.focusOtpInput(s,c+1);const l=this.writeOtpDigits(s,c,d);this.syncOtpValueFromInputs(s),this.focusOtpInput(s,Math.min(c+d.length,s.length-1),l)},this.handleKeyDown=e=>{const t=ci(e);if(!t)return;const i=this.getOtpInputs(),r=Number(t.dataset.otpIndex);return"ArrowLeft"===e.key?(e.preventDefault(),void this.focusOtpInput(i,r-1)):"ArrowRight"===e.key?(e.preventDefault(),void this.focusOtpInput(i,r+1)):"Backspace"===e.key?(e.preventDefault(),t.value?t.value="":r>0&&(i[r-1].value=""),this.syncOtpValueFromInputs(i),void this.focusOtpInput(i,Math.max(r-1,0))):"Delete"===e.key?(e.preventDefault(),t.value="",void this.syncOtpValueFromInputs(i)):void(e.ctrlKey||e.metaKey||e.altKey||1!==e.key.length||/\d/.test(e.key)||e.preventDefault())},this.handleChange=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Boolean(e.dataset.requiredInfoFileInput));if(t)return this.storeRequiredInfoSelectedFile(t.files?.[0]),void(t.value="");const i=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.cardField));if(i)return void this.updateCardDraftField(i.dataset.cardField,i.value);const r=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.bankAccountField));if(r)return void this.updateBankAccountDraftField(r.dataset.bankAccountField,r.value);const n=e.composedPath().find(e=>e instanceof HTMLSelectElement&&Boolean(e.dataset.transferField));n&&this.updateTransferDraftField(n.dataset.transferField,n.value)},this.handlePaste=e=>{const t=zi(e);if(t)return void this.pasteRequiredInfoSsnInput(e,t);const i=ci(e);if(!i)return;const r=e,n="function"==typeof r.clipboardData?.getData?r.clipboardData.getData("text"):"",a=$t(n);if(!a)return;e.preventDefault();const o=this.getOtpInputs(),s=Number(i.dataset.otpIndex),c=this.writeOtpDigits(o,s,a);this.syncOtpValueFromInputs(o),this.focusOtpInput(o,Math.min(s+a.length,o.length-1),c)},this.handleFocusIn=e=>{const t=ci(e);t&&t.value&&requestAnimationFrame(()=>{this.renderRoot.contains(t)&&t.select()})},this.handleFocusLost=e=>{const t=e.composedPath().find(e=>e instanceof HTMLInputElement&&Ve(e.dataset.cardField));if(t)return void this.encryptCardField(t.dataset.cardField,t.value);const i=e.composedPath().find(e=>e instanceof HTMLInputElement&&ot(e.dataset.bankAccountField));i&&this.encryptBankAccountField(i.dataset.bankAccountField,i.value)}}willUpdate(e){if(e.has("interactionResponse")&&this.interactionResponse){const t=e.get("interactionResponse");t?.interactionId!==this.interactionResponse.interactionId&&(this.clearDeletePaymentSourceConfirmation(),this.paymentSourceView=void 0,this.paymentSourceEditMode=!1,this.interactionRefresh.reset({requestUpdate:!1}),this.nativeBalance.reset({requestUpdate:!1}),this.billingAddresses=[],this.resetTransferFlow(),this.resetSavedSourceVerification(),this.resetRequiredInfo()),this.interactionResponse.paymentSources?.length||this.interactionResponse.selectedSource||(this.paymentSourceEditMode=!1),this.syncBillingAddressesFromInteractionResponse(this.interactionResponse),this.selectedPaymentSourceId=sr(this.interactionResponse,this.selectedPaymentSourceId)}}updated(e){e.has("designConfig")&&this.syncDesignConfigStyles(),e.has("interactionResponse")&&this.deleteConfirmationPaymentSourceId&&!this.findPaymentSourceById(this.deleteConfirmationPaymentSourceId)&&this.clearDeletePaymentSourceConfirmation(),e.has("interactionResponse")&&this.refreshPaymentSourcesFromInteraction()}render(){return F`
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.clearDeletePaymentSourceConfirmation(),this.removePayByBankProviderContainer(),Zr()}emitSdkEvent(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t}))}renderWidgetShell({busy:e=!1,overlay:t,...i}){const r=zr(this.minimumVerificationOverlayAction);return oi({...i,busy:e||Boolean(r),overlay:t??r})}showMinimumVerificationOverlay(e){const t=this.minimumVerificationOverlayToken+=1;this.minimumVerificationOverlayAction=e,window.setTimeout(()=>{this.minimumVerificationOverlayToken===t&&(this.minimumVerificationOverlayAction=void 0)},2e3)}renderCurrentScreen(){if(!this.interactionResponse)return this.renderMissingInteractionResponseScreen();if("provider"===this.bankFlowScreen)return this.renderBankProviderScreen();if("outcome"===this.bankFlowScreen)return this.renderBankOutcomeScreen();if("manual"===this.bankFlowScreen)return this.renderManualBankAccountScreen();if("form"===this.cardFlowScreen)return this.renderAddCardScreen();if("error"===this.cardFlowScreen)return this.renderCardErrorScreen();if(this.requiredInfoSource)return this.renderRequiredInfoScreen();if(this.savedSourceVerificationSource)return this.renderSavedSourceVerificationOutcomeScreen();const e=this.interactionResponse?.status;return"OTP_VALIDATION_PENDING"===e||"OTP_VALIDATION_FAILED"===e?this.renderOtpScreen(e):this.shouldRenderTransferScreen()?this.renderTransferScreen():this.renderPaymentSourceScreen()}renderMissingInteractionResponseScreen(){return this.renderWidgetShell({title:"Configuration required",showClose:!1,showDivider:!1,content:F`
        <div class="payment-flow">
          ${Zt({variant:"danger",message:"CommerceHub Connect requires an interaction response before it can load payment methods."})}
        </div>
      `})}renderOtpScreen(e){const t=Di(this.designConfig),i="verify-otp"===this.pendingAction,r="resend-otp"===this.pendingAction,n=Bi(this.interactionResponse);let a;return i?a=Er({title:"Verifying code",helper:"Verifying your code, please wait."}):r&&(a=Er({title:"Sending code",helper:"Sending a new code, please wait."})),this.renderWidgetShell({title:t.title,subtitle:t.subtitle??si(n),showClose:!1,showDivider:!1,busy:i||r,overlay:a,content:di({status:e,value:this.otpValue,length:6,failedMessage:this.otpErrorMessage,copy:t,submitting:i,resending:r})})}renderPaymentSourceScreen(){const e=Oi(this.designConfig),t=Wi(this.interactionResponse,{nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}),i=Ki(this.interactionResponse),r=lr(this.interactionResponse,"ADD_ACCOUNT"),n=lr(this.interactionResponse,"SELECT"),a=i.bankAccount&&ur(this.interactionResponse),o="attach-payment-source"===this.pendingAction||"verify-payment-source"===this.pendingAction||"delete-payment-source"===this.pendingAction,s=this.paymentSourceEditMode&&t.length>0;return this.shouldRenderPaymentSourceRefreshSkeleton()?this.renderWidgetShell({title:e.title,showClose:!1,content:li()}):this.shouldRenderPaymentSourceRefreshError()?this.renderPaymentSourceRefreshErrorScreen():t.length?this.shouldRenderSelectedPaymentSourceScreen()?this.renderSelectedPaymentSourceScreen():(this.queueNativeAccountBalanceRefresh(),this.renderWidgetShell({title:e.title,headerAction:ni({label:s?"Done":"Edit",action:"toggle-payment-source-edit-mode",disabled:o}),showClose:!1,busy:o,overlay:Ar(this.pendingAction),content:hi({methods:t,allowedTenderOptions:i,canAddPaymentSources:r,canSelectPaymentSources:n,editing:s,actionPending:o,selectedPaymentSourceId:this.selectedPaymentSourceId,deleteConfirmationPaymentSourceId:this.deleteConfirmationPaymentSourceId,copy:e,showTransferAction:a})})):this.renderNoSavedPaymentMethods()}renderPaymentSourceRefreshErrorScreen(){return this.renderWidgetShell({title:"Payment methods unavailable",showClose:!1,content:F`
        <div class="payment-flow">
          ${Zt({variant:"danger",message:this.interactionRefresh.errorMessage??"We couldn't load payment methods. Try again."})}
          <div class="primitive-footer">
            ${Kt({label:"Try again",variant:"primary",action:"retry-interaction-refresh"})}
          </div>
        </div>
      `})}renderSelectedPaymentSourceScreen(){const e=cr(this.interactionResponse,this.selectedPaymentSourceId);return e?this.renderWidgetShell({title:"Payment method saved",headerAction:ni({label:"Change",action:"change-payment-source",disabled:"attach-payment-source"===this.pendingAction}),showClose:!1,showDivider:!1,busy:"attach-payment-source"===this.pendingAction,overlay:"attach-payment-source"===this.pendingAction?Er({title:_r(e)?"Saving bank account":"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,content:F`
        <div class="payment-flow">
          ${Xt(Gi(e,{selected:!0,nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}))}
        </div>
      `}):(this.paymentSourceView="list",this.renderPaymentSourceScreen())}shouldRenderSelectedPaymentSourceScreen(){return"list"!==this.paymentSourceView&&("PAYMENT_SOURCE_ATTACHED"===this.interactionResponse?.status||"selected"===this.paymentSourceView)}shouldRenderPaymentSourceRefreshSkeleton(){return this.interactionRefresh.shouldRenderSkeleton(this.interactionResponse)}shouldRenderPaymentSourceRefreshError(){return this.interactionRefresh.shouldRenderError(this.interactionResponse)}renderSavedSourceVerificationOutcomeScreen(){const e=this.savedSourceVerificationSource,t=Nr(e,this.savedSourceVerificationFailed),i="declined"===t.kind||"pending"===t.kind;return this.renderWidgetShell({title:t.title,headerAction:i?ni({label:"Back",action:"done-payment-source-verification"}):void 0,showClose:!1,showDivider:!1,content:F`
        <div class="verification-outcome-flow">
          ${Zt({variant:t.variant,message:t.message})}
          ${e?Fr(e):""}
          ${i?"":F`
                <div class="primitive-footer">
                  ${Kt({label:"Back to payment methods",action:"done-payment-source-verification"})}
                </div>
              `}
        </div>
      `})}renderRequiredInfoScreen(){const e=this.requiredInfoSource;if(!e)return this.renderPaymentSourceScreen();const t=Tr(e),i=Lr(t),r="submit-required-info"===this.pendingAction,n=this.canSubmitRequiredInfo();return this.renderWidgetShell({title:"Complete account verification",headerAction:ni({label:"Back",action:"back-to-payment-methods",disabled:r}),showClose:!1,showDivider:!1,busy:r,overlay:r?Er({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,content:F`
        <div class="required-info-flow">
          ${Fr(e)}
          ${this.requiredInfoSubmitError?Zt({variant:"danger",message:this.requiredInfoSubmitError}):""}
          ...
          <div class="required-info-documents">
            ...
            <div class="primitive-stack">
              ${t.map((e,t)=>{const i=qr(e,t),n=Rr(e)?this.requiredInfoValues[i]:this.requiredInfoFileNames[i];return Rr(e)?Mr({doc:e,key:i,value:n??""}):F`
                  <div
                    class="required-info-document required-document-text-row"
                    data-required-info-doc-key=${i}
                    data-required-info-requirement=${Dr(e)}
                  >
...
`)({label:"Required document",requirements:Pr(e),actionLabel:"Choose file",fileName:n,action:"open-required-info-file-picker",disabled:r})}
                  </div>
                `})}
            </div>
          </div>
          ...
          <div
            ...
            data-required-info-doc-key=${i??""}
          >
            ${Kt({label:r?"Verifying...":"Verify",action:"submit-required-info",loading:r,disabled:r||!n})}
          </div>
        </div>
      `})}renderNoSavedPaymentMethods(){const e=Li(this.designConfig),t="delete-payment-source"===this.pendingAction,i=Ki(this.interactionResponse),r=lr(this.interactionResponse,"ADD_ACCOUNT"),n=i.bankAccount&&ur(this.interactionResponse);return this.renderWidgetShell({title:e.title,subtitle:e.subtitle,showClose:!1,showDivider:!1,content:ui({allowedTenderOptions:i,canAddPaymentSources:r,deletePending:t,copy:e,showTransferAction:n})})}shouldRenderTransferScreen(){const e=this.interactionResponse;return(this.transferFlowActive||hr(e))&&dr(e?.status)}renderTransferScreen(){const e=ir(this.interactionResponse),t="transfer"===this.pendingAction,i=this.transferFlowActive?ni({label:"Back",action:"back-to-payment-methods",disabled:t}):void 0;if(e.length<2)return this.renderWidgetShell({title:"Transfer funds",headerAction:i,showClose:!1,showDivider:!1,content:F`
          <div class="payment-flow">
            ${Jt({title:"Transfer unavailable",message:"At least two verified bank or native accounts are required to transfer funds."})}
          </div>
        `});const r=[{value:"",label:"Select account"},...e.map(e=>({value:er(e),label:Yi(e)}))],n=At(this.transferDraft),a=e.find(e=>er(e)===n.fromSourceId),o=e.find(e=>er(e)===n.toSourceId);return"confirm"===this.transferFlowScreen&&a&&o&&Nt(n,e)?this.renderTransferConfirmationScreen(a,o,n,t):this.renderWidgetShell({title:"Transfer funds",headerAction:i,showClose:!1,showDivider:!1,busy:t,overlay:t?Er({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:F`
        <div class="payment-flow card-form-screen">
          ${this.transferSubmitError?Zt({variant:"danger",message:this.transferSubmitError}):""}
          ${this.transferSubmitSuccess?Zt({variant:"success",message:"Transfer initiated."}):""}
          ${ai([Yt({id:"transfer-from-source",name:"fromSourceId",label:"From",value:this.transferDraft.fromSourceId,options:r,span:"full",variant:"card-form",dataField:"fromSourceId",dataFieldScope:"transfer",error:this.transferDraftErrors.fromSourceId,disabled:t}),Yt({id:"transfer-to-source",name:"toSourceId",label:"To",value:this.transferDraft.toSourceId,options:r,span:"full",variant:"card-form",dataField:"toSourceId",dataFieldScope:"transfer",error:this.transferDraftErrors.toSourceId,disabled:t}),Gt({id:"transfer-amount",name:"amount",label:"Amount",value:this.transferDraft.amount,variant:"card-form",inputmode:"decimal",dataField:"amount",dataFieldScope:"transfer",error:this.transferDraftErrors.amount,disabled:t})])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Kt({label:t?"Transferring":"Transfer",action:"transfer",loading:t,disabled:t||!Nt(this.transferDraft,e)})}
            </div>
          </div>
        </div>
      `})}renderTransferConfirmationScreen(e,t,i,r){return this.renderWidgetShell({title:"Confirm transfer",headerAction:ni({label:"Back",action:"edit-transfer",disabled:r}),showClose:!1,showDivider:!1,busy:r,overlay:r?Er({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:F`
        <div class="payment-flow card-form-screen">
          ${this.transferSubmitError?Zt({variant:"danger",message:this.transferSubmitError}):""}
          ${n=[{label:"From",value:Yi(e)},{label:"To",value:Yi(t)},{label:"Amount",value:Tt(i)}],F`
...
`}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Kt({label:r?"Transferring":"Confirm transfer",action:"confirm-transfer",loading:r,disabled:r})}
            </div>
            <div class="card-form-primary">
              ${Kt({label:"Edit",variant:"secondary",action:"edit-transfer",disabled:r})}
            </div>
          </div>
        </div>
      `});var n}renderAddCardScreen(){const e="save-card"===this.pendingAction,t="encrypting"===this.cardEncryption.cardNumber.status||"encrypting"===this.cardEncryption.cvv.status,i=[...this.billingAddresses.map(e=>({value:e.id??"",label:Ai(e)})),{value:Le,label:"Add new billing address"}],r=this.billingAddresses.find(e=>e.id===this.cardDraft.billingAddressValue),n=Boolean(r)&&!this.billingAddressSelectorExpanded,a=!n&&this.cardDraft.billingAddressValue===Le,o=[];return r&&n?o.push(F`
        <div class="billing-address-summary field field-full">
          <div class="billing-address-summary-heading">
            ...
            >
            ${ni({label:"Change",action:"change-billing-address",disabled:e})}
          </div>
          <p class="billing-address-summary-value">
            ${Ai(r)}
          </p>
        </div>
      `):o.push(Yt({id:"billing-address",name:"billingAddress",label:"Billing address",value:this.cardDraft.billingAddressValue,options:i,span:"full",variant:"card-form",dataField:"billingAddressValue",error:this.cardDraftErrors.billingAddressValue,disabled:e})),a&&o.push(Yt({id:"billing-country",name:"country",label:"Country or region",value:this.cardDraft.country,options:xi,span:"full",variant:"card-form",dataField:"country",error:this.cardDraftErrors.country,disabled:e}),Gt({id:"billing-address-line-1",name:"addressLine1",label:"Address",value:this.cardDraft.addressLine1,placeholder:"Street address",span:"full",variant:"card-form",autocomplete:"address-line1",dataField:"addressLine1",error:this.cardDraftErrors.addressLine1,disabled:e}),Gt({id:"billing-address-line-2",name:"addressLine2",label:"Address line 2",value:this.cardDraft.addressLine2,placeholder:"Apartment, suite, unit",span:"full",variant:"card-form",autocomplete:"address-line2",dataField:"addressLine2",error:this.cardDraftErrors.addressLine2,disabled:e}),Gt({id:"billing-city",name:"city",label:"City",value:this.cardDraft.city,span:"full",variant:"card-form",autocomplete:"address-level2",dataField:"city",error:this.cardDraftErrors.city,disabled:e}),Yt({id:"billing-state",name:"state",label:"State",value:this.cardDraft.state,options:Si,span:"full",variant:"card-form",dataField:"state",error:this.cardDraftErrors.state,disabled:e}),Gt({id:"billing-zip",name:"zip",label:"ZIP code",value:this.cardDraft.zip,placeholder:"ZIP code",span:"full",variant:"card-form",autocomplete:"postal-code",inputmode:"numeric",dataField:"zip",error:this.cardDraftErrors.zip,disabled:e})),this.renderWidgetShell({title:"Add card",headerAction:ni({label:"Back",action:"back-to-payment-methods",disabled:e}),showClose:!1,showDivider:!1,busy:e,overlay:e?Er({title:"Saving card",helper:"Securely saving your card, please wait."}):void 0,content:F`
        <div class="payment-flow card-form-screen">
          ${this.cardSubmitError?Zt({variant:"danger",message:this.cardSubmitError}):""}
          ${ai([Gt({id:"card-label",name:"name",label:"Card Name",value:this.cardDraft.name,placeholder:"Corporate card",span:"full",variant:"card-form",dataField:"name",error:this.cardDraftErrors.name,disabled:e}),Gt({id:"card-number",name:"cardNumber",label:"Card number",value:this.cardDraft.cardNumber,placeholder:"1234 1234 1234 1234",span:"full",variant:"card-form",autocomplete:"cc-number",inputmode:"numeric",dataField:"cardNumber",error:this.cardDraftErrors.cardNumber,disabled:e}),Gt({id:"expiration-date",name:"expirationDate",label:"Expiration",value:this.cardDraft.expirationDate,placeholder:"MM / YY",variant:"card-form",autocomplete:"cc-exp",inputmode:"numeric",dataField:"expirationDate",error:this.cardDraftErrors.expirationDate,disabled:e}),Gt({id:"card-cvv",name:"cvv",label:"CVC",value:this.cardDraft.cvv,placeholder:"3 or 4 digits",variant:"card-form",autocomplete:"cc-csc",inputmode:"numeric",dataField:"cvv",error:this.cardDraftErrors.cvv,disabled:e}),Gt({id:"name-on-card",name:"fullName",label:"Full name",value:this.cardDraft.fullName,placeholder:"Name on card",span:"full",variant:"card-form",autocomplete:"cc-name",dataField:"fullName",error:this.cardDraftErrors.fullName,disabled:e}),...o])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Kt({label:e?"Saving payment method":"Save card",action:"save-card",loading:e,disabled:e||t||(s=this.cardDraft,c=this.cardEncryption,!(0===Object.keys(Ge(Ke(s))).length&&0===Object.keys(Qe(s,c)).length))})}
            </div>
          </div>
        </div>
      `});var s,c}renderCardErrorScreen(){return this.renderWidgetShell({title:"Credit card not saved",subtitle:"We could not save this card. Check the card details or use a different payment method.",showClose:!1,showDivider:!1,content:ri({variant:"danger",content:this.cardSubmitError?Zt({variant:"danger",message:this.cardSubmitError}):void 0,actions:F`
          ${Kt({label:"Edit card details",action:"edit-card-details"})}
          ${ni({label:"Use a different method",action:"use-different-method"})}
        `})})}renderBankProviderScreen(){return this.renderWidgetShell({title:"Connect your bank",headerAction:ni({label:"Back",action:"back-to-payment-methods",disabled:this.bankLinkLoading}),showClose:!1,showDivider:!1,busy:this.bankLinkLoading,overlay:this.bankLinkLoading?Er({title:"Connecting to your bank",helper:"Securely opening your bank connection, please wait."}):void 0,content:F`
        <div class="bank-provider-flow">
          ${ii({containerId:ki,loading:this.bankLinkLoading,loadingLabel:"Connecting to your bank"})}
          <div class="bank-provider-manual-link">
            ${ni({label:"Connect another way",action:"add-ach-manually",disabled:this.bankLinkLoading})}
          </div>
        </div>
      `})}renderManualBankAccountScreen(){const e="save-ach-manual"===this.pendingAction,t="encrypting"===this.bankAccountEncryption.routingNumber.status||"encrypting"===this.bankAccountEncryption.accountNumber.status||"encrypting"===this.bankAccountEncryption.accountNumberReEntered.status;return this.renderWidgetShell({title:"Enter bank details",headerAction:ni({label:"Back",action:"back-to-bank-provider",disabled:e}),showClose:!1,showDivider:!1,busy:e,overlay:e?Er({title:"Saving bank account",helper:"Securely saving your bank account, please wait."}):void 0,content:F`
        <div class="payment-flow card-form-screen">
          ${this.bankAccountSubmitError?Zt({variant:"danger",message:this.bankAccountSubmitError}):""}
          ${ai([Gt({id:"ach-account-nickname",name:"name",label:"Account Nickname",value:this.bankAccountDraft.name,span:"full",variant:"card-form",autocomplete:"off",dataField:"name",dataFieldScope:"bankAccount",disabled:e}),Gt({id:"ach-routing-number",name:"routingNumber",label:"Routing number",value:this.bankAccountDraft.routingNumber,span:"full",variant:"card-form",autocomplete:"off",inputmode:"numeric",dataField:"routingNumber",dataFieldScope:"bankAccount",error:this.bankAccountDraftErrors.routingNumber,disabled:e}),Gt({id:"ach-account-number",name:"accountNumber",label:"Account number",value:this.bankAccountDraft.accountNumber,type:lt("accountNumber",this.bankAccountDraft,this.bankAccountEncryption),span:"full",variant:"card-form",autocomplete:"off",inputmode:"numeric",dataField:"accountNumber",dataFieldScope:"bankAccount",error:this.bankAccountDraftErrors.accountNumber,disabled:e}),Gt({id:"ach-account-number-confirm",name:"accountNumberReEntered",label:"Confirm account number",value:this.bankAccountDraft.accountNumberReEntered,type:lt("accountNumberReEntered",this.bankAccountDraft,this.bankAccountEncryption),span:"full",variant:"card-form",autocomplete:"off",inputmode:"numeric",dataField:"accountNumberReEntered",dataFieldScope:"bankAccount",error:this.bankAccountDraftErrors.accountNumberReEntered,disabled:e})])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${Kt({label:e?"Saving bank account":"Save bank account",action:"save-ach-manual",loading:e,disabled:e||t||!vt(this.bankAccountDraft,this.bankAccountEncryption)})}
            </div>
          </div>
        </div>
      `})}renderBankOutcomeScreen(){const e=Ir(this.bankOutcomeSource),t="declined"===e.kind||"pending"===e.kind;return this.renderWidgetShell({title:e.title,headerAction:t?ni({label:"Done",action:"done-bank-outcome"}):void 0,showClose:!1,showDivider:!1,content:F`
        <div class="verification-outcome-flow">
          ${Zt({variant:e.variant,message:e.message})}
          ${this.bankOutcomeSource?Fr(this.bankOutcomeSource):""}
          ${t?"":F`
                <div class="primitive-footer">
                  ${"verified"===e.kind?Kt({label:"Continue",action:"continue-bank-outcome"}):"pending"===e.kind?Kt({label:"Done",action:"done-bank-outcome"}):F`
                        ${Kt({label:this.bankLinkLoading?"Retrying":"Try again",action:"retry-bank-provider",loading:this.bankLinkLoading,disabled:this.bankLinkLoading})}
                        ${ni({label:"Use a different account",action:"use-different-bank-account",disabled:this.bankLinkLoading})}
                      `}
                </div>
              `}
        </div>
      `})}getOtpInputs(){return[...this.renderRoot.querySelectorAll(".otp-input")]}getRequiredInfoSsnInputs(e){return[...this.renderRoot.querySelectorAll(".required-info-ssn-input")].filter(t=>t.dataset.requiredInfoDocKey===e)}storeRequiredInfoSsnInput(e){const t=e.dataset.requiredInfoDocKey;if(!t)return;const i=this.getRequiredInfoSsnInputs(t),r=i.indexOf(e),n=Ct(Number(e.dataset.requiredInfoSsnSegment)),a=St(e.value);if(!(r<0)){if(a.length>n){const e=this.writeRequiredInfoSsnDigits(i,r,a);return this.syncRequiredInfoSsnValue(t,i),void this.focusRequiredInfoSsnInput(i,e)}e.value=a.slice(0,n),this.syncRequiredInfoSsnValue(t,i),e.value.length>=n&&this.focusRequiredInfoSsnInput(i,r+1)}}pasteRequiredInfoSsnInput(e,t){const i=t.dataset.requiredInfoDocKey;if(!i)return;const r=e,n="function"==typeof r.clipboardData?.getData?r.clipboardData.getData("text"):"",a=St(n);if(!a)return;e.preventDefault();const o=this.getRequiredInfoSsnInputs(i),s=o.indexOf(t);if(s<0)return;const c=this.writeRequiredInfoSsnDigits(o,s,a);this.syncRequiredInfoSsnValue(i,o),this.focusRequiredInfoSsnInput(o,c)}writeRequiredInfoSsnDigits(e,t,i){let r=0,n=t;return e.forEach((e,a)=>{if(a<t)return;const o=Ct(Number(e.dataset.requiredInfoSsnSegment)),s=i.slice(r,r+o);e.value=s,s&&(n=a),r+=o}),n}syncRequiredInfoSsnValue(e,t){this.storeRequiredInfoValue(e,St(t.map(e=>e.value).join("")))}focusRequiredInfoSsnInput(e,t){e[Math.min(t,e.length-1)]?.focus()}syncOtpValueFromInputs(e=this.getOtpInputs()){this.otpValue=((e,t=6)=>$t(e.join("")).slice(0,t))(e.map(e=>e.value)),this.otpErrorMessage=void 0}writeOtpDigits(e,t,i){const r=(({values:e,startIndex:t,value:i})=>{const r=[...e],n=$t(i);let a=t;return n.slice(0,Math.max(r.length-t,0)).split("").forEach((e,i)=>{const n=t+i;n>=r.length||(r[n]=e,a=n)}),{values:r,lastWrittenIndex:a}})({values:e.map(e=>e.value),startIndex:t,value:i});return r.values.forEach((t,i)=>{e[i].value=t}),r.lastWrittenIndex}focusOtpInput(e,t,i=t){const r=e[t]??e[Math.max(0,Math.min(i,e.length-1))];r&&r.focus()}async showAddCardScreen(){this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow(),this.cardFlowScreen="form",this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===Le||!this.billingAddresses.length;const e=this.interactionResponse?.interactionId,t=Boolean(this.interactionResponse?.selectedSource||this.interactionResponse?.paymentSources?.length);if(e&&t&&!this.billingAddresses.length&&void 0===this.interactionResponse?.billerAddress)try{await this.fetchInteraction(e)}catch(e){}}showManualBankAccountScreen(){this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow(),this.bankFlowScreen="manual",this.bankAccountDraft={name:"",routingNumber:"",accountNumber:"",accountNumberReEntered:""},this.bankAccountDraftErrors={},this.bankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},accountNumberReEntered:{status:"idle",normalizedValue:""}},this.bankAccountSubmitError=void 0}updateTransferDraftField(e,t){const i=At({...this.transferDraft,[e]:t});this.transferDraft=i,this.transferDraftErrors=It(i,ir(this.interactionResponse)),this.transferFlowScreen="form",this.transferSubmitError=void 0,this.transferSubmitSuccess=!1}updateBankAccountDraftField(e,t){const i=gt({draft:this.bankAccountDraft,errors:this.bankAccountDraftErrors,encryption:this.bankAccountEncryption,field:e,value:t});this.bankAccountDraft=i.draft,this.bankAccountEncryption=i.encryption,this.bankAccountDraftErrors=i.errors,this.bankAccountSubmitError=void 0}updateCardDraftField(e,t){const i=((e,t)=>"cardNumber"===e?je(t):"expirationDate"===e?We(t):"cvv"===e?Fe(t).slice(0,4):t)(e,t);this.cardDraft={...this.cardDraft,[e]:i},"billingAddressValue"===e&&(this.billingAddressSelectorExpanded=i===Le),this.cardSubmitError=void 0,Ve(e)&&(this.cardEncryption={...this.cardEncryption,[e]:Ze(this.cardEncryption[e],Ue(e,i))})}async encryptCardField(e,t){this.updateCardDraftField(e,t);const i=Ue(e,t),r=((e,t)=>"cardNumber"===e?et(t)?void 0:"Enter a valid card number.":tt(t)?void 0:"Enter a valid CVC.")(e,t);if(!i)return this.cardDraftErrors=Je(this.cardDraftErrors,e),void(this.cardEncryption={...this.cardEncryption,[e]:{status:"idle",normalizedValue:""}});if(r)return this.cardDraftErrors={...Je(this.cardDraftErrors,e),[e]:r},void(this.cardEncryption={...this.cardEncryption,[e]:Ze(this.cardEncryption[e],i)});const n=this.cardEncryption[e];if("encrypting"!==n.status&&"encrypted"!==n.status||n.normalizedValue!==i){this.cardDraftErrors=Je(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypting",normalizedValue:i}};try{const t=await this.encryptSensitiveSourceValue(i);if(Ue(e,this.cardDraft[e])!==i)return;this.cardDraftErrors=Je(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypted",normalizedValue:i,encryptedValue:t}}}catch(t){if(Ue(e,this.cardDraft[e])!==i)return;this.cardDraftErrors={...Je(this.cardDraftErrors,e),[e]:Ye(e)},this.cardEncryption={...this.cardEncryption,[e]:{status:"failed",normalizedValue:i}}}}}async encryptBankAccountField(e,t){const i=this.bankAccountEncryption[e];if(ct(t,i))return this.bankAccountDraft={...this.bankAccountDraft,[e]:t},void(this.bankAccountSubmitError=void 0);this.updateBankAccountDraftField(e,t);const r=st(t);if(!r){const t={...this.bankAccountEncryption,[e]:{status:"idle",normalizedValue:""}};return this.bankAccountEncryption=t,void(this.bankAccountDraftErrors=ft(ht(this.bankAccountDraft,t)))}if("encrypting"!==i.status&&"encrypted"!==i.status||i.normalizedValue!==r){this.bankAccountDraftErrors=((e,t)=>{const i={...e};return delete i[t],i})(this.bankAccountDraftErrors,e),this.bankAccountEncryption={...this.bankAccountEncryption,[e]:{status:"encrypting",normalizedValue:r}};try{const t=await this.encryptSensitiveSourceValue(r);if(st(this.bankAccountDraft[e])!==r)return;const i={...this.bankAccountDraft,[e]:dt(r)},n={...this.bankAccountEncryption,[e]:{status:"encrypted",normalizedValue:r,encryptedValue:t}};this.bankAccountDraft=i,this.bankAccountEncryption=n,this.bankAccountDraftErrors=ft(ht(i,n))}catch(t){if(st(this.bankAccountDraft[e])!==r)return;const i={...this.bankAccountEncryption,[e]:{status:"failed",normalizedValue:r}};this.bankAccountEncryption=i,this.bankAccountDraftErrors={...ft(ht(this.bankAccountDraft,i)),[e]:bt(e)}}}}async encryptSensitiveSourceValue(e){return(async(e,t)=>{const i=await crypto.subtle.importKey("spki",Lt(t),{name:"RSA-OAEP",hash:"SHA-512"},!1,["encrypt"]),r=await crypto.subtle.encrypt({name:"RSA-OAEP"},i,(new TextEncoder).encode(e));return Mt(r)})(e,this.requireSourceCreateContext().publicKey)}async saveCard(){if("save-card"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=Ke(this.cardDraft),i={...Ge(t),...Qe(t,this.cardEncryption)};if(Object.keys(i).length>0)return this.cardDraft=t,this.cardDraftErrors=i,void(this.cardSubmitError=void 0);let r;try{r=this.requireSourceCreateContext()}catch(e){return this.cardDraft=t,this.cardDraftErrors={},void(this.cardSubmitError=vr(e))}this.pendingAction="save-card",this.cardDraft=t,this.cardDraftErrors={},this.cardSubmitError=void 0;try{const i=Xe("cardNumber",t.cardNumber,this.cardEncryption),n=Xe("cvv",t.cvv,this.cardEncryption),a=it(t.expirationDate);if(!a)return void(this.cardDraftErrors={expirationDate:"Enter a valid expiration date."});const o=await this.resolveBillingAddressId(e,t),s={id:"",tenderType:"CARD",name:t.name,billingAddressId:o,card:{nameOnCard:t.fullName,cardNumber:i,cvv:n,cardNumberEncrypted:i,cvvEncrypted:n,expirationMonth:a.month,expirationYear:a.year,network:rt(t.cardNumber)}},c=await this.requestCommerceHubJson("/interaction/source/card",e,{method:"POST",headers:this.createSourceCreateHeaders(e,r,{"Content-Type":"application/json"}),body:JSON.stringify(s),credentials:"include"}),d=this.sourceWithVerificationResponse(Ii(s,t.cardNumber),c),l=qi(c,"The card creation response did not include a source id."),h=this.interactionResponseWithAddedSource(e,d);if(this.cardFlowScreen=void 0,this.cardDraft=Me(),this.cardDraftErrors={},this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.cardSubmitError=void 0,this.setInteractionResponseFromSdk(h),this.emitSdkEvent(fi,d),"VERIFIED"===d.verificationInfo?.status)return void await this.attachPaymentSource(l);this.showAddedPaymentSourceStatus(d)}catch(e){this.cardSubmitError=vr(e),this.cardFlowScreen="error"}finally{this.pendingAction=void 0}}async saveManualBankAccount(){if("save-ach-manual"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=ht(this.bankAccountDraft,this.bankAccountEncryption),i=ft(t);if(Object.keys(i).length>0)return this.bankAccountDraft=mt(this.bankAccountDraft,this.bankAccountEncryption),this.bankAccountDraftErrors=i,void(this.bankAccountSubmitError=void 0);let r;try{r=this.requireSourceCreateContext()}catch(e){return this.bankAccountDraft=mt(this.bankAccountDraft,this.bankAccountEncryption),this.bankAccountDraftErrors={},void(this.bankAccountSubmitError=vr(e))}this.pendingAction="save-ach-manual",this.bankAccountDraft=mt(this.bankAccountDraft,this.bankAccountEncryption),this.bankAccountDraftErrors={},this.bankAccountSubmitError=void 0;try{await this.encryptChangedBankAccountFields();const t=ht(this.bankAccountDraft,this.bankAccountEncryption),i=ft(t);if(Object.keys(i).length>0)return this.bankAccountDraftErrors=i,void(this.bankAccountSubmitError=void 0);const s=yt("routingNumber",this.bankAccountDraft,this.bankAccountEncryption),c=yt("accountNumber",this.bankAccountDraft,this.bankAccountEncryption),d=yt("accountNumberReEntered",this.bankAccountDraft,this.bankAccountEncryption),l=(n="accountNumber",a=this.bankAccountEncryption,o=t,kt(a[n].normalizedValue||o[n])),h={id:"",tenderType:"BANK_ACCOUNT",name:wt(this.bankAccountDraft.name,l),bankAccount:{routingNumber:s,accountNumber:c,accountNumberReEntered:d,routingNumberEncrypted:s,accountNumberEncrypted:c}},u=await this.requestCommerceHubJson("/interaction/source/ach",e,{method:"POST",headers:this.createSourceCreateHeaders(e,r,{"Content-Type":"application/json"}),body:JSON.stringify(h),credentials:"include"}),m=this.sourceWithVerificationResponse(Ni(h,l),u),p=qi(u,"The bank account creation response did not include a source id."),f=this.interactionResponseWithAddedSource(e,m);if(this.bankFlowScreen=void 0,this.bankAccountDraft={name:"",routingNumber:"",accountNumber:"",accountNumberReEntered:""},this.bankAccountDraftErrors={},this.bankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},accountNumberReEntered:{status:"idle",normalizedValue:""}},this.bankAccountSubmitError=void 0,this.setInteractionResponseFromSdk(f),this.emitSdkEvent(fi,m),"VERIFIED"===m.verificationInfo?.status)return void await this.attachPaymentSource(p);this.showAddedPaymentSourceStatus(m)}catch(e){this.bankAccountSubmitError=vr(e)}finally{this.pendingAction=void 0}var n,a,o}reviewTransfer(){if("transfer"===this.pendingAction)return;const e=ir(this.interactionResponse),t=At(this.transferDraft),i=It(t,e);if(Object.keys(i).length>0)return this.transferDraft=t,this.transferDraftErrors=i,this.transferSubmitError=void 0,void(this.transferSubmitSuccess=!1);this.transferDraft=t,this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1,this.transferFlowScreen="confirm"}async submitTransfer(){if("transfer"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=ir(this.interactionResponse),i=At(this.transferDraft),r=It(i,t);if(Object.keys(r).length>0)return this.transferDraft=i,this.transferDraftErrors=r,this.transferFlowScreen="form",this.transferSubmitError=void 0,void(this.transferSubmitSuccess=!1);this.pendingAction="transfer",this.transferDraft=i,this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1;try{const t=await this.requestCommerceHubJson("/interaction/source/native/transfer",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({fromSourceId:i.fromSourceId,toSourceId:i.toSourceId,amount:Number(i.amount),asset:{type:"CURRENCY",id:"USD"}}),credentials:"include"});this.transferFlowScreen="form",this.transferSubmitSuccess=!0,this.emitSdkEvent(yi,t)}catch(e){this.transferSubmitError=vr(e)}finally{this.pendingAction=void 0}}async encryptChangedBankAccountFields(){for(const e of["routingNumber","accountNumber","accountNumberReEntered"]){const t=this.bankAccountDraft[e],i=this.bankAccountEncryption[e];if(ct(t,i))continue;const r=st(t);if(!r)continue;"encrypted"===i.status&&i.normalizedValue===r&&Boolean(i.encryptedValue)||await this.encryptBankAccountField(e,t)}}async resolveBillingAddressId(e,t){if(t.billingAddressValue!==Le)return t.billingAddressValue;const i=(e=>({id:at(),recipientNameOrAddress:e.fullName,country:e.country,street:e.addressLine1,houseNumberOrName:e.addressLine2||void 0,city:e.city,stateOrProvince:e.state,postalCode:e.zip}))(t),r=await this.requestCommerceHubJson("/interaction/billing-address",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i),credentials:"include"}),n=r.value?.trim();if(!n)throw new Error("The billing address response did not include an id.");return n}async verifyOtp(){if("verify-otp"===this.pendingAction)return;if(this.otpValue.length<6)return;const e=this.requireInteractionId();if(e){this.pendingAction="verify-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/validate",{body:{otp:this.otpValue,channel:"EMAIL"}}),i=fr(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(i)}catch(e){this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk({...this.interactionResponse,status:"OTP_VALIDATION_FAILED"})}finally{this.pendingAction=void 0}}}async resendOtp(){if("resend-otp"===this.pendingAction)return;const e=this.requireInteractionId();if(e){this.pendingAction="resend-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/send/email"),i=fr(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(i)}catch(e){}finally{this.pendingAction=void 0}}}async attachPaymentSource(e){if("attach-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),i=this.findPaymentSourceById(e);if(t&&i&&"VERIFIED"===i.verificationInfo?.status){this.selectedPaymentSourceId=e,this.paymentSourceView="selected",this.pendingAction="attach-payment-source";try{const r=await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}/attach`,t,{method:"POST",credentials:"include"}),n=mr(this.interactionResponse??{interactionId:t},r,e),a=cr(n,e)??n.paymentSources?.find(t=>t.id===e)??i;this.selectedPaymentSourceId=a.id,this.setInteractionResponseFromSdk(n),this.paymentSourceView="selected",this.emitSdkEvent(pi,a)}catch(e){}finally{this.pendingAction=void 0}}}async verifySavedPaymentSource(e){if("verify-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),i=this.findPaymentSourceById(e);if(t&&i){if(Ur(i))return this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(i);if("NOT_VERIFIED"===i.verificationInfo?.status){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",this.pendingAction="verify-payment-source";try{const r=await this.verifyPaymentSourceStep1(t,{...i,id:e}),n=xr({...this.interactionResponse??{interactionId:t},selectedSource:this.interactionResponse?.selectedSource,status:$i},r);if(this.setInteractionResponseFromSdk(n),this.emitSdkEvent(vi,r),Ur(r))return void this.showRequiredInfoSource(r);if("VERIFIED"===r.verificationInfo?.status){const t=r.id?.trim()||e;return this.pendingAction=void 0,void await this.attachPaymentSource(t)}this.savedSourceVerificationSource=r,this.savedSourceVerificationFailed=!1}catch(e){this.savedSourceVerificationSource=i,this.savedSourceVerificationFailed=!0}finally{"verify-payment-source"===this.pendingAction&&(this.pendingAction=void 0)}}}}async deletePaymentSource(e){if("delete-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),i=this.findPaymentSourceById(e);if(t&&i)if(this.deleteConfirmationPaymentSourceId===e){this.clearDeletePaymentSourceConfirmation(),this.pendingAction="delete-payment-source";try{await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}`,t,{method:"DELETE",credentials:"include"});const i=pr(this.interactionResponse??{interactionId:t},e);i.paymentSources?.length||(this.paymentSourceEditMode=!1),this.setInteractionResponseFromSdk(i),this.emitSdkEvent(bi,e)}catch(e){}finally{this.pendingAction=void 0}}else this.armDeletePaymentSourceConfirmation(e)}armDeletePaymentSourceConfirmation(e){this.clearDeletePaymentSourceConfirmation(),this.deleteConfirmationPaymentSourceId=e,this.deleteConfirmationTimeoutId=window.setTimeout(()=>{this.deleteConfirmationPaymentSourceId===e&&this.clearDeletePaymentSourceConfirmation()},5e3)}clearDeletePaymentSourceConfirmation(){void 0!==this.deleteConfirmationTimeoutId&&(window.clearTimeout(this.deleteConfirmationTimeoutId),this.deleteConfirmationTimeoutId=void 0),this.deleteConfirmationPaymentSourceId=void 0}findPaymentSourceById(e){return(this.interactionResponse?.paymentSources??[]).find(t=>t.id===e)??(this.interactionResponse?.selectedSource?.id===e?this.interactionResponse.selectedSource:void 0)}resetSavedSourceVerification(){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1}showPaymentSourceList({refresh:e=!1}={}){this.clearDeletePaymentSourceConfirmation(),this.paymentSourceEditMode=!1,this.paymentSourceView="list",this.resetTransferFlow(),e&&this.refreshPaymentSourcesForList()}async refreshPaymentSourcesForList(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}interactionResponseWithAddedSource(e,t){const i=t.id?.trim(),r=Boolean(i)&&Cr(t),n={...this.interactionResponse??{interactionId:e},status:$i};return r?$r(n,t):xr({...n,selectedSource:this.interactionResponse?.selectedSource},t)}showAddedPaymentSourceStatus(e){const t=e.id?.trim();return this.resetSavedSourceVerification(),this.resetRequiredInfo(),Ur(e)?(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(e)):"VERIFIED"===e.verificationInfo?.status?(this.selectedPaymentSourceId=t,void(this.paymentSourceView="selected")):(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",_r(e)?(this.bankOutcomeSource=e,void(this.bankFlowScreen="outcome")):(this.savedSourceVerificationSource=e,void(this.savedSourceVerificationFailed=!1)))}showRequiredInfoSource(e){this.requiredInfoSource=e,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}resetRequiredInfo(){this.requiredInfoSource=void 0,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}firstRequiredInfoDocKey(){return Lr(Tr(this.requiredInfoSource))??qr(Tr(this.requiredInfoSource)[0],0)}storeRequiredInfoValue(e,t){this.requiredInfoValues=((e,t,i)=>({...e,[t]:i}))(this.requiredInfoValues,e,t),this.requiredInfoSubmitError=void 0}storeRequiredInfoSelectedFile(e){if(!this.requiredInfoSource||!e)return void(this.pendingRequiredInfoDocKey=void 0);const t=this.pendingRequiredInfoDocKey??this.firstRequiredInfoDocKey(),i=(({files:e,fileNames:t,key:i,file:r})=>({files:{...e,[i]:r},fileNames:{...t,[i]:r.name}}))({files:this.requiredInfoFiles,fileNames:this.requiredInfoFileNames,key:t,file:e});this.requiredInfoFiles=i.files,this.requiredInfoFileNames=i.fileNames,this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}canSubmitRequiredInfo(){const e=this.requiredInfoSource;return!!e?.id?.trim()&&Tr(e).some((e,t)=>{const i=qr(e,t);return Rr(e)?Et(this.requiredInfoValues,i):zt(this.requiredInfoFiles,i)})}async submitRequiredInfo(){if("submit-required-info"===this.pendingAction)return;const e=this.requireInteractionId(),t=this.requiredInfoSource,i=t?.id?.trim();if(e&&t&&i)if(this.canSubmitRequiredInfo()){this.pendingAction="submit-required-info",this.requiredInfoSubmitError=void 0;try{const r=Tr(t),n=this.providedRequiredInfoEntries(r,!0),a=this.providedRequiredInfoEntries(r,!1);let o=t;n.length>0?(await this.uploadRequiredInfoEntries(e,i,n),o=this.sourceWithVerificationResponse(o,await this.verifyRequiredInfoStep2(e,i)),this.emitSdkEvent(vi,o),Ur(o)&&a.length>0&&(await this.uploadRequiredInfoEntries(e,i,a),o=this.sourceWithVerificationResponse(o,await this.verifyRequiredInfoStep2(e,i)),this.emitSdkEvent(vi,o))):(await this.uploadRequiredInfoEntries(e,i,a),o=this.sourceWithVerificationResponse(o,await this.verifyRequiredInfoStep2(e,i)),this.emitSdkEvent(vi,o));const s=xr({...this.interactionResponse??{interactionId:e},selectedSource:this.interactionResponse?.selectedSource,status:$i},o);if(this.setInteractionResponseFromSdk(s),"VERIFIED"===o.verificationInfo?.status){const e=o.id?.trim()||i;return this.resetRequiredInfo(),this.pendingAction=void 0,void await this.attachPaymentSource(e)}if(Ur(o))return this.requiredInfoSource=o,this.requiredInfoValues={},this.requiredInfoFileNames={},void(this.requiredInfoFiles={});this.resetRequiredInfo(),this.savedSourceVerificationSource=o,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=o.id,this.paymentSourceView="list"}catch(e){this.requiredInfoSubmitError=vr(e)||"We could not submit the required information. Please try again."}finally{"submit-required-info"===this.pendingAction&&(this.pendingAction=void 0)}}else this.requiredInfoSubmitError="Add required or optional information before verifying."}providedRequiredInfoEntries(e,t){return e.map((e,t)=>({doc:e,index:t})).filter(({doc:e,index:i})=>(t?!0===e.mandatory:!0!==e.mandatory)&&this.hasRequiredInfoValue(e,i))}hasRequiredInfoValue(e,t){const i=qr(e,t);return Rr(e)?Et(this.requiredInfoValues,i):zt(this.requiredInfoFiles,i)}async uploadRequiredInfoEntries(e,t,i){for(const{doc:r,index:n}of i){const i=r.docType;if(!i)continue;const a=qr(r,n);if(Rr(r)){const r=this.requiredInfoValues[a]?.trim();r&&await this.uploadRequiredInfoField(e,t,i,r);continue}const o=this.requiredInfoFiles[a];o&&await this.uploadRequiredInfoDocument(e,t,i,o)}}async verifyRequiredInfoStep2(e,t){return this.showMinimumVerificationOverlay("submit-required-info"),this.requestCommerceHubJson("/interaction/verify/step2",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t}),credentials:"include"})}sourceWithVerificationResponse(e,t){const{sourceId:i,...r}=t,n=i?.trim();return{...e,id:n||e.id,verificationInfo:{...e.verificationInfo,...r}}}async uploadRequiredInfoField(e,t,i,r){await this.requestCommerceHubJson("/interaction/verify/uploadField",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({docType:i,value:t,docValue:r}),credentials:"include"})}async uploadRequiredInfoDocument(e,t,i,r){const n=new FormData;n.set("file",r),await this.requestCommerceHubJson(`/interaction/doc/upload/${encodeURIComponent(t)}/${encodeURIComponent(i)}`,e,{method:"POST",body:n,credentials:"include"})}async startPayByBankFlow(){if(this.bankLinkLoading)return;const e=this.requireInteractionId();if(e){this.bankFlowScreen="provider",this.bankOutcomeSource=void 0,this.bankLinkLoading=!0,this.ensurePayByBankProviderContainer(ki),await this.updateComplete;try{await this.launchPayByBankProvider(e,ki)}catch(e){console.error("CommerceHub Connect Pay by Bank failed",e),this.resetBankFlow(),this.showPaymentSourceList({refresh:!0})}finally{this.bankLinkLoading=!1}}}async launchPayByBankProvider(e,t){const i=await this.requestCommerceHubJson("/interaction/source/pbb/session",e,{method:"GET",credentials:"include"}),{aggregatorSessionId:r,accessToken:n,pToken:a,publicKey:o}=wr(i),s=Mi(this.designConfig?.payByBank);await Yr(s.paymentSdkUrl);const c=window.PaymentSDK;if(!c?.init)throw new Error("PaymentSDK.js loaded but PaymentSDK.init is not available on window.");await new Promise((i,d)=>{let l=!1;Zr(),c.init({apiKey:s.apiKey,accessToken:n,configId:s.configId,environment:s.environment,locale:s.locale,appearance:Vi(this.designConfig),publicKey:o,pToken:a,aggregatorSessionId:r,containerId:t,onEvent:async t=>{if(!l&&kr(t)){if(Zr(),"success"!==t.type)return l=!0,this.resetBankFlow(),this.showPaymentSourceList({refresh:!0}),void i();try{const t=await this.finalizePayByBankSession(e,r,a),n=Ti(t),o=n.id?.trim();if(!o)throw new Error("Connect your bank completed but the resolved bank payment source did not include an id.");const s=this.interactionResponseWithAddedSource(e,n);if(this.setInteractionResponseFromSdk(s),this.emitSdkEvent(fi,n),this.resetBankFlow(),"VERIFIED"===n.verificationInfo?.status)return await this.attachPaymentSource(o),l=!0,void i();this.showAddedPaymentSourceStatus(n),l=!0,i()}catch(e){l=!0,d(e)}}}}),this.bankLinkLoading=!1})}async refreshPaymentSourcesFromInteraction(){await this.interactionRefresh.refreshFromInteraction(this.interactionRefreshOptions())}queueNativeAccountBalanceRefresh(){this.nativeBalance.queueRefresh(()=>this.interactionResponse,e=>this.fetchNativeAccountBalances(e))}async fetchNativeAccountBalances(e){return(await this.createSdkClient(e).GET("/interaction/source/native/balances")).data??{}}async fetchInteraction(e){return this.interactionRefresh.fetch(e,this.interactionRefreshOptions())}async retryInteractionRefresh(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}interactionRefreshOptions(){return{getCurrentInteractionResponse:()=>this.interactionResponse,getSelectedPaymentSourceId:()=>this.selectedPaymentSourceId,requestInteraction:e=>this.createSdkClient(e).GET("/interaction").then(e=>fr(e)),mergeInteractionResponse:mr,setInteractionResponse:e=>this.setInteractionResponseFromSdk(e),emitListPaymentMethods:e=>this.emitSdkEvent(gi,e)}}syncBillingAddressesFromInteractionResponse(e){e.billerAddress&&(this.billingAddresses=e.billerAddress.filter(e=>Boolean(e.id?.trim())),this.cardDraft=((e,t)=>{const i=t.map(e=>e.id?.trim()).filter(e=>Boolean(e));if(!i.length)return{...e,billingAddressValue:Le};if(i.includes(e.billingAddressValue))return e;const r=[e.country,e.addressLine1,e.addressLine2,e.city,e.state,e.zip].some(e=>e.trim());return e.billingAddressValue===Le&&r?e:{...e,billingAddressValue:i[0]}})(this.cardDraft,this.billingAddresses),this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===Le)}async finalizePayByBankSession(e,t,i){return this.requestCommerceHubJson(`/interaction/source/pbb/session/${encodeURIComponent(t)}/${encodeURIComponent(i)}`,e,{method:"PUT",credentials:"include"})}async verifyPaymentSourceStep1(e,t){this.showMinimumVerificationOverlay("verify-payment-source");const i=await this.requestCommerceHubJson("/interaction/verify/step1",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t.id}),credentials:"include"});return this.sourceWithVerificationResponse(t,i)}async requestCommerceHubJson(e,t,i){const r=this.createInteractionHeaders(t,i.headers);r.has("Accept")||r.set("Accept","application/json");const n=new Request(`${xe(this.baseURL)}${e}`,{...i,headers:r}),a=await fetch(n),o=a.headers.get("content-type")??"",s=204===a.status?void 0:o.includes("application/json")?await a.json():await a.text();if(!a.ok)throw new Error(vr(s)||a.statusText);return s}resetBankFlow(){this.bankFlowScreen=void 0,this.bankOutcomeSource=void 0,this.bankLinkLoading=!1,this.bankAccountDraft={name:"",routingNumber:"",accountNumber:"",accountNumberReEntered:""},this.bankAccountDraftErrors={},this.bankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},accountNumberReEntered:{status:"idle",normalizedValue:""}},this.bankAccountSubmitError=void 0,this.removePayByBankProviderContainer()}resetCardFlow(){this.cardFlowScreen=void 0,this.cardDraft=Me(),this.cardDraftErrors={},this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=!1}resetTransferFlow(){this.transferFlowActive=!1,this.transferFlowScreen="form",this.transferDraft={fromSourceId:"",toSourceId:"",amount:""},this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1}ensurePayByBankProviderContainer(e){const t=[...this.children].find(t=>t instanceof HTMLElement&&t.id===e),i=t??document.createElement("div");return i.id=e,i.slot=e,i.className="provider-frame-container",i.replaceChildren(),t||this.appendChild(i),i}removePayByBankProviderContainer(){[...this.children].filter(e=>e instanceof HTMLElement&&e.id===ki).forEach(e=>e.remove())}requireInteractionId(){const e=this.interactionResponse?.interactionId;if(e)return e}createSdkClient(e){return Se({baseURL:this.baseURL,getHeaders:()=>this.createInteractionHeaders(e)})}createInteractionHeaders(e,t){const i=new Headers(t),r=this.interactionResponse?.oauth?.access_token?.trim();return i.set("x-interaction-id",e),r&&!i.has("Authorization")&&i.set("Authorization",`Bearer ${r}`),i}createSourceCreateHeaders(e,t,i){const r=this.createInteractionHeaders(e,i);return r.set("Api-Key",t.clientId),r.set("Auth-Token-Type",t.tokenType),r.set("x-key-id",t.keyId),r}requireSourceCreateContext(){const e=this.interactionResponse?.publicKey?.trim(),t=this.interactionResponse?.keyId?.trim(),i=this.interactionResponse?.oauth,r=i?.client_id?.trim(),n=i?.token_type?.trim(),a=i?.access_token?.trim();if(!(e&&t&&r&&n&&a))throw new Error("Payment source encryption is not configured. Try again later.");return{publicKey:e,keyId:t,clientId:r,tokenType:n,accessToken:a}}setInteractionResponseFromSdk(e){this.interactionResponse=this.interactionResponseWithPreservedGatewayOAuth(e)}interactionResponseWithPreservedGatewayOAuth(e){if(e.oauth&&e.features)return e;const t=this.interactionResponse;return!t||t.interactionId&&e.interactionId&&t.interactionId!==e.interactionId?e:{...e,oauth:e.oauth??t.oauth,features:e.features??t.features}}syncDesignConfigStyles(){for(const e of Hi)this.style.removeProperty(e);const e=this.designConfig?.colors;if(e)for(const{field:t,property:i}of Ui){const r=e[t];r&&this.style.setProperty(i,r)}const t=this.designConfig?.baseFontSize;t?this.style.fontSize=t:this.style.removeProperty("font-size");const i=this.designConfig?.baseFontWeight?.trim();i?this.style.setProperty(ji,i):this.style.removeProperty(ji);const r=this.designConfig?.shellPadding?.trim();r?this.style.setProperty(_i,r):this.style.removeProperty(_i)}};Ei.styles=Vt,mi([de({attribute:!1})],Ei.prototype,"interactionResponse",void 0),mi([de({attribute:!1})],Ei.prototype,"designConfig",void 0),mi([de({attribute:"base-url"})],Ei.prototype,"baseURL",void 0),mi([le()],Ei.prototype,"selectedPaymentSourceId",void 0),mi([le()],Ei.prototype,"otpValue",void 0),mi([le()],Ei.prototype,"pendingAction",void 0),mi([le()],Ei.prototype,"minimumVerificationOverlayAction",void 0),mi([le()],Ei.prototype,"otpErrorMessage",void 0),mi([le()],Ei.prototype,"bankFlowScreen",void 0),mi([le()],Ei.prototype,"bankLinkLoading",void 0),mi([le(),le()],Ei.prototype,"bankOutcomeSource",void 0),mi([le()],Ei.prototype,"bankAccountDraft",void 0),mi([le()],Ei.prototype,"bankAccountDraftErrors",void 0),mi([le()],Ei.prototype,"bankAccountEncryption",void 0),mi([le()],Ei.prototype,"bankAccountSubmitError",void 0),mi([le()],Ei.prototype,"transferDraft",void 0),mi([le()],Ei.prototype,"transferDraftErrors",void 0),mi([le()],Ei.prototype,"transferSubmitError",void 0),mi([le()],Ei.prototype,"transferSubmitSuccess",void 0),mi([le()],Ei.prototype,"transferFlowActive",void 0),mi([le()],Ei.prototype,"transferFlowScreen",void 0),mi([le(),le()],Ei.prototype,"cardFlowScreen",void 0),mi([le()],Ei.prototype,"cardDraft",void 0),mi([le()],Ei.prototype,"cardDraftErrors",void 0),mi([le()],Ei.prototype,"cardEncryption",void 0),mi([le()],Ei.prototype,"cardSubmitError",void 0),mi([le()],Ei.prototype,"billingAddresses",void 0),mi([le()],Ei.prototype,"billingAddressSelectorExpanded",void 0),mi([le()],Ei.prototype,"paymentSourceView",void 0),mi([le()],Ei.prototype,"paymentSourceEditMode",void 0),mi([le()],Ei.prototype,"deleteConfirmationPaymentSourceId",void 0),mi([le()],Ei.prototype,"savedSourceVerificationSource",void 0),mi([le()],Ei.prototype,"savedSourceVerificationFailed",void 0),mi([le()],Ei.prototype,"requiredInfoSource",void 0),mi([le()],Ei.prototype,"requiredInfoValues",void 0),mi([le()],Ei.prototype,"requiredInfoFileNames",void 0),mi([le()],Ei.prototype,"requiredInfoSubmitError",void 0),Ei=mi([(e=>(t,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)})("commerce-hub-connect")],Ei);const zi=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("required-info-ssn-input")),Ai=e=>{const t=[e.stateOrProvince,e.postalCode].filter(Boolean).join(" "),i=[e.city,t].filter(Boolean).join(", ");return[e.street,i].filter(Boolean).join(", ")||e.id||"Saved billing address"},Ii=(e,t)=>{const i=Pe(t??"").slice(-4);return{...e,tenderType:"Card",card:{...e.card,...i?{cardNumber:i}:{}}}},Ni=(e,t)=>{const i=st(t??"").slice(-4);return{...e,tenderType:"BankAccount",bankAccount:{...e.bankAccount,...i?{accountNumber:i}:{}}}},Ti=e=>({id:qi(e,"Connect your bank completed but the verification response did not include a source id."),tenderType:"BankAccount",verificationInfo:Ri(e),bankAccount:{}}),qi=(e,t)=>{const i=e.sourceId?.trim();if(!i)throw new Error(t);return i},Ri=e=>{const{sourceId:t,...i}=e;return i},Bi=e=>{const t=e?.email?.trim();if(t)return t;const i=e?.phone?.countryCode?.trim(),r=e?.phone?.phoneNumber?.trim();return[i,r].filter(Boolean).join(" ")||void 0},Di=e=>{const t=e?.copy?.otp;return{title:t?.title??"Enter verification code",subtitle:t?.subtitle,failedMessage:t?.failedMessage??"The code does not match. Try again.",resendPrefix:t?.resendPrefix??"Didn't receive the code?",resendButton:t?.resendButton??"Resend code",resendPendingButton:t?.resendPendingButton??"Sending code...",verifyButton:t?.verifyButton??"Verify",verifyingButton:t?.verifyingButton??"Verifying...",tryAgainButton:t?.tryAgainButton??"Try again"}},Oi=e=>{const t=e?.copy?.paymentMethods;return{title:t?.title??"Pay with",subtitle:t?.subtitle??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??"",continueButton:t?.continueButton??"Confirm",continuingButton:t?.continuingButton??"Confirming..."}},Li=e=>{const t=e?.copy?.noSavedPaymentMethods;return{title:t?.title??"Add payment method",subtitle:t?.subtitle??"",emptyTitle:t?.emptyTitle??"",emptyMessage:t?.emptyMessage??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??""}},Mi=e=>{const t=Object.fromEntries(Object.entries(e??{}).filter(([,e])=>void 0!==e));return{...Ci,...t}},Vi=e=>{const t=e?.colors,i={};return Fi(i,"backgroundColor",Pi(t?.widgetBackground,t?.surface)),Fi(i,"primaryColor",t?.primary),Fi(i,"buttonColor",t?.primary),Fi(i,"primaryTextColor",t?.text),Fi(i,"secondaryTextColor",Pi(t?.copy,t?.muted)),Fi(i,"dangerColor",t?.danger),Fi(i,"successColor",t?.success),Fi(i,"borderColor",Pi(t?.border,t?.widgetBorder,t?.borderBackground)),Fi(i,"placeholderColor",t?.placeholder),{branding:i}},Pi=(...e)=>e.map(e=>e?.trim()).find(e=>Boolean(e)),Fi=(e,t,i)=>{const r=i?.trim();r&&(e[t]=r)},Ui=[{field:"primary",property:"--chc-primary"},{field:"text",property:"--chc-text"},{field:"copy",property:"--chc-copy"},{field:"muted",property:"--chc-muted"},{field:"placeholder",property:"--chc-placeholder"},{field:"surface",property:"--chc-surface"},{field:"widgetBackground",property:"--chc-widget-background"},{field:"borderBackground",property:"--chc-border"},{field:"widgetBorder",property:"--chc-border"},{field:"softSurface",property:"--chc-soft-surface"},{field:"paymentSelectionBackground",property:"--chc-payment-method-background"},{field:"paymentMethodBackground",property:"--chc-payment-method-background"},{field:"border",property:"--chc-border"},{field:"borderStrong",property:"--chc-border-strong"},{field:"success",property:"--chc-success"},{field:"successBackground",property:"--chc-success-bg"},{field:"successBorder",property:"--chc-success-border"},{field:"danger",property:"--chc-danger"},{field:"dangerBackground",property:"--chc-danger-bg"},{field:"dangerBorder",property:"--chc-danger-border"},{field:"warning",property:"--chc-warning"},{field:"warningBackground",property:"--chc-warning-bg"},{field:"warningBorder",property:"--chc-warning-border"},{field:"disabledText",property:"--chc-disabled-text"},{field:"disabledSurface",property:"--chc-disabled-surface"}],ji="--chc-font-weight",_i="--chc-shell-padding",Hi=[...Ui.map(({property:e})=>e),ji,_i],Wi=(e,t={})=>{const i=e?.paymentSources;if(!i?.length){const i=cr(e);return i?[Gi(i,{...t,selected:!0})]:[]}return i.map(e=>Gi(e,t))},Ki=e=>{const t=e?.allowedTenderTypes;return t?{card:t.includes("CARD"),bankAccount:t.includes("BANK_ACCOUNT"),nativeAccount:t.includes("NATIVE_ACCOUNT")}:{card:!0,bankAccount:!0,nativeAccount:!0}},Gi=(e,{selected:t=!1,nativeBalances:i={},nativeBalanceLoadingSourceIds:r=[]}={})=>{const n=er(e),a=Wr(e)?rr(e,i):void 0,o=void 0===a?.balance?void 0:ar(a.balance);return{id:n,label:Yi(e,{selected:t}),type:tr(e),brand:Ji(e),accountLabel:Qi(e),balanceLabel:o,balanceLoading:Wr(e)&&r.includes(n),last4:Xi(e),status:yr(e.verificationInfo?.status),showVerificationStatus:Boolean(e.verificationInfo?.status)}},Yi=(e,{selected:t=!1}={})=>Hr(e)?t?e.name?.trim()||e.card?.nameOnCard?.trim()||Zi(e):e.card?.nameOnCard?.trim()||e.name?.trim()||Zi(e):_r(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||Zi(e):Wr(e)?e.account?.nickName?.trim()||e.name?.trim()||Zi(e):e.name?.trim()||Zi(e),Zi=e=>Hr(e)?"Saved card":_r(e)?e.bankAccount?.bankName??"Saved bank account":Wr(e)?"Native account":"Dynamic session card",Ji=e=>Hr(e)?e.card?.network??"Card":_r(e)?e.bankAccount?.bankName??"Bank account":Wr(e)?e.account?.productType??"Native account":"DSC",Qi=e=>{const t=`•••• ${Xi(e)}`;if(Wr(e)){const i=e.account?.productType?.trim();return i?`${i} ${t}`:t}return t},Xi=e=>Hr(e)?gr(e.card?.cardNumber):_r(e)?gr(e.bankAccount?.accountNumber):Wr(e)?gr(e.account?.positionId??e.account?.token):gr(e.id),er=e=>e.id?.trim()||e.name?.trim()||e.tenderType,tr=e=>_r(e)?"bank":Wr(e)?"native":"card",ir=e=>(e?.paymentSources??[]).filter(e=>(_r(e)||Wr(e))&&"VERIFIED"===e.verificationInfo?.status&&Boolean(er(e))),rr=(e,t)=>{for(const i of nr(e)){const e=t[i];if(e)return e}},nr=e=>[e.id,e.account?.positionId,e.account?.token].map(e=>e?.trim()).filter(e=>Boolean(e)),ar=e=>or.format(e),or=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}),sr=(e,t)=>{const i=e?.paymentSources;if(i?.length)return t&&i.some(e=>e.id===t)?t:e?.selectedSource?.id},cr=(e,t)=>{if(t){const i=e?.paymentSources?.find(e=>e.id===t);if(i)return i}return e?.selectedSource},dr=e=>e===$i||"PAYMENT_SOURCE_REQUESTED"===e,lr=(e,t)=>Boolean(e?.features?.includes(t)),hr=e=>Boolean(lr(e,"TRANSFER")&&!lr(e,"ADD_ACCOUNT")&&!lr(e,"SELECT")),ur=e=>((e,t)=>t.every(t=>lr(e,t)))(e,["ADD_ACCOUNT","SELECT","TRANSFER"]),mr=(e,t,i)=>{const r={...e,...t},n=t.paymentSources??e.paymentSources??[],a=((e,t)=>{if(t){const i=e.find(e=>e.id===t);if(i)return i}})(n,i??t.selectedSource?.id)??t.selectedSource??e.selectedSource;return{...r,selectedSource:a,paymentSources:n}},pr=(e,t)=>{const i=(e.paymentSources??[]).filter(e=>e.id!==t),r=e.selectedSource?.id===t?void 0:e.selectedSource;return{...e,status:"PAYMENT_SOURCE_ATTACHED"!==e.status||r?e.status:$i,selectedSource:r,paymentSources:i}},fr=e=>{if(e.data)return e.data;throw new Error(vr(e.error))},vr=e=>"string"==typeof e?e:e&&"object"==typeof e&&"message"in e&&"string"==typeof e.message?e.message:"CommerceHub API request failed.",br=(e,t)=>{const i=e.composedPath().find(e=>e instanceof HTMLElement&&Boolean(e.dataset[t]));return i?.dataset[t]},gr=e=>e&&e.length>=4?e.slice(-4):"----",yr=e=>"VERIFIED"===e?"verified":"UNDER_REVIEW"===e?"under-review":"REQUIRE_INFO"===e?"require-info":"DECLINED"===e?"declined":"not-verified",wr=e=>{const t=e.aggregatorSessionId?.trim(),i=e.tokenID?.trim()||e.accessToken?.trim(),r=e.pToken?.trim(),n=e.publicKey?.trim();if(!(t&&i&&r&&n))throw new Error("The /interaction/source/pbb/session response is missing one or more required values.");return{aggregatorSessionId:t,accessToken:i,pToken:r,publicKey:n}},kr=e=>"success"===e.type||"cancel"===e.type||"failure"===e.type||"error"===e.type,$r=(e,t)=>{const i=Sr(e.paymentSources??[],t);return{...e,selectedSource:t,paymentSources:i}},xr=(e,t)=>({...e,paymentSources:Sr(e.paymentSources??[],t)}),Sr=(e,t)=>e.some(e=>e.id===t.id)?e.map(e=>e.id===t.id?t:e):[t,...e],Cr=e=>"VERIFIED"===e.verificationInfo?.status,Er=({title:e,helper:t})=>F`
...
`,zr=e=>"verify-payment-source"===e?Er({title:"Verifying payment method",helper:"Verifying your payment method, please wait."}):"submit-required-info"===e?Er({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,Ar=e=>"verify-payment-source"===e?zr(e):"delete-payment-source"===e?Er({title:"Deleting payment method",helper:"Deleting your payment method, please wait."}):"attach-payment-source"===e?Er({title:"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,Ir=e=>{const t=e?.verificationInfo?.status;return"VERIFIED"===t?{kind:"verified",variant:"success",title:"Bank account verified",message:"Your bank account is connected and ready to use."}:"UNDER_REVIEW"===t?{kind:"pending",variant:"warning",title:"Bank account pending review",message:"We will update this bank account after review is complete."}:"REQUIRE_INFO"===t?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:"Additional information is required before this bank account can be verified."}:"DECLINED"===t?{kind:"declined",variant:"danger",title:"Bank account verification failed",message:"This bank account could not be verified."}:{kind:"failed",variant:"danger",title:"Bank account not verified",message:"This bank account is not verified yet."}},Nr=(e,t=!1)=>{const i=jr(e),r=i.toLowerCase(),n=e?.verificationInfo?.status;return t?{kind:"failed",variant:"danger",title:"Bank account"===i?"Bank account verification failed":`${i} not verified`,message:`We could not verify this ${r} right now.`}:"VERIFIED"===n?{kind:"verified",variant:"success",title:"Bank account"===i?"Bank account verified":`${i} saved`,message:`This ${r} is verified and ready to use.`}:"UNDER_REVIEW"===n?{kind:"pending",variant:"warning",title:"Bank account"===i?"Bank account pending review":"Verification pending review",message:`We will update this ${r} after review is complete.`}:"REQUIRE_INFO"===n?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:`Additional information is required before this ${r} can be verified.`}:"DECLINED"===n?{kind:"declined",variant:"danger",title:"Bank account"===i?"Bank account verification failed":`${i} declined`,message:`This ${r} could not be verified.`}:{kind:"failed",variant:"danger",title:"Bank account"===i?"Bank account not verified":`${i} not verified`,message:`This ${r} is not verified yet.`}},Tr=e=>{const t=e?.verificationInfo?.docs??[];return t.length>0?t:[{}]},qr=(e,t=0)=>`${e?.docType??"DOCUMENT"}-${t}`,Rr=e=>"DRIVER_LICENSE_NUMBER"===e.docType||"SOCIAL_SECURITY_NUMBER"===e.docType,Br=e=>!1!==e.mandatory,Dr=e=>Br(e)?"required":"optional",Or=e=>F`
  <span
    class="required-info-requirement-badge required-info-requirement-badge-${Dr(e)}"
  >
    ${(e=>Br(e)?"Required":"Optional")(e)}
  </span>
`,Lr=e=>{const t=e.findIndex(e=>!Rr(e));return t>=0?qr(e[t],t):void 0},Mr=({doc:e,key:t,value:i})=>{if("SOCIAL_SECURITY_NUMBER"===e.docType)return Vr({doc:e,key:t,value:i});const r=`required-info-${t}`;return F`
    <div
  ...
  `},Vr=({doc:e,key:t,value:i})=>{const r=Pr(e),n=(e=>{const t=St(e);return[t.slice(0,3),t.slice(3,5),t.slice(5,9)]})(i),a=`required-info-${t}-ssn-0`;return F`
    <div
  ...
  `},Pr=e=>"BANK_STATEMENT"===e.docType?"Bank statement":"BANK_LETTER"===e.docType?"Bank letter":"BANK_CHECK"===e.docType?"Bank check":"DRIVER_LICENSE_PHOTO"===e.docType?"Driver license photo":"DRIVER_LICENSE_NUMBER"===e.docType?"Driver license number":"SOCIAL_SECURITY_NUMBER"===e.docType?"Social Security number":"Required document",Fr=e=>{const t=(e=>({type:tr(e),brand:Ji(e)}))(e),i=Dt(t),r=(e=>{if(!Hr(e))return;const t=e.card?.expirationMonth?.trim(),i=e.card?.expirationYear?.trim();if(!t||!i)return;return`${t.padStart(2,"0")}/${i.slice(-2)}`})(e);return F`
    <div
      ...
      <div class="required-info-card-top">
        <div class="required-info-card-heading">
          <span class="required-info-card-label"
            >${(e=>_r(e)?"Bank account":Hr(e)?"Card":Wr(e)?"Native account":"Dynamic session card")(e)}</span
          >
          <span
            class="required-info-card-field required-info-card-name"
            data-required-info-card-field="name"
            >${(e=>Hr(e)?e.card?.nameOnCard?.trim()||e.name?.trim()||Zi(e):_r(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||Zi(e):Wr(e)?e.account?.nickName?.trim()||e.name?.trim()||Zi(e):e.name?.trim()||Zi(e))(e)}</span
          >
        </div>
      ...
      <div class="required-info-card-bottom">
        <div class="required-info-card-detail">
          ...
          <span class="required-info-card-status">
            ${jt(yr(e.verificationInfo?.status))}
          </span>
        </div>
        ${r?F`
              <div class="required-info-card-detail">
  ...
  `},Ur=e=>"REQUIRE_INFO"===e.verificationInfo?.status,jr=e=>e&&_r(e)?"Bank account":e&&Wr(e)?"Native account":"Payment method",_r=e=>"BankAccount"===e.tenderType||"BANK_ACCOUNT"===e.tenderType,Hr=e=>"Card"===e.tenderType||"CARD"===e.tenderType,Wr=e=>"NativeAccount"===e.tenderType||"NATIVE_ACCOUNT"===e.tenderType;let Kr,Gr;const Yr=async e=>{if(!window.PaymentSDK?.init)if(Kr&&Gr===e)await Kr;else if(Gr=e,Kr=new Promise((t,i)=>{const r=document.querySelector(`script[data-commerce-hub-pay-by-bank-sdk="true"][src="${e}"]`),n=r??document.createElement("script"),a=()=>{n.removeEventListener("load",o),n.removeEventListener("error",s)},o=()=>{a(),t()},s=()=>{a(),Kr=void 0,Gr=void 0,i(new Error(`Unable to load Connect your bank script: ${e}`))};n.addEventListener("load",o,{once:!0}),n.addEventListener("error",s,{once:!0}),r||(n.src=e,n.async=!0,n.dataset.commerceHubPayByBankSdk="true",document.head.appendChild(n))}),await Kr,!window.PaymentSDK?.init)throw new Error(`Connect your bank script loaded but window.PaymentSDK.init is unavailable: ${e}`)},Zr=()=>{try{window.PaymentSDK?.destroy?.()}catch{}};export{$e as COMMERCE_HUB_BASE_URLS,Ei as CommerceHubConnect,ke as DEFAULT_COMMERCE_HUB_BASE_URL,fi as ON_ADD_PAYMENT_METHOD_EVENT,bi as ON_DELETE_PAYMENT_METHOD_EVENT,wi as ON_ERROR_EVENT,gi as ON_LIST_PAYMENT_METHODS_EVENT,pi as ON_SELECT_EVENT,yi as ON_TRANSFER_EVENT,vi as ON_VERIFY_PAYMENT_METHOD_EVENT,Se as createCommerceHubClient,Ce as createCommerceHubMerchantClient,xe as resolveCommerceHubBaseURL};

...
`,W$=e=>e?"Hide value":"Show value";var K$=function(e,t,r,n){for(var i,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n,s=e.length-1;s>=0;s--)(i=e[s])&&(a=(o<3?i(a):o>3?i(t,r,a):i(t,r))||a);return o>3&&a&&Object.defineProperty(t,r,a),a};const G$="jsonforms-layout jsonforms-layout-vertical",Y$="jsonforms-layout jsonforms-layout-horizontal",J$="jsonforms-layout jsonforms-group";let Z$=class extends M${render(){return this.renderLayout(G$)}renderLayout(e){const t=this.layoutProps;if(void 0===t||!1===t.visible)return Ty``;const r=t.uischema;return Ty`
    ...
    `}};ok=K$([tw("jsonforms-lit-enum-control")],ok);let ak=class extends L${render(){const e=this.uischema?.type??"unknown";return Ty`<div class="jsonforms-unknown-renderer">
...
`,$x=(...e)=>e.filter(Boolean).join(" "),kx=e=>{const t=e?.trim();return t||void 0},xx=(e,t)=>{const r=((e,t)=>"verified"===e?{label:t??"Ready",tone:"success"}:"under-review"===e?{label:"Needs review",tone:"warning"}:"require-info"===e?{label:"Needs info",tone:"warning"}:"declined"===e?{label:"Can't use",tone:"danger"}:{label:"Needs info",tone:"warning"})(e,t);return Ty`
    <span
  ...
  `},jx=e=>{return"require-info"===(t=e.status)||"not-verified"===t;var t},Cx=e=>{const t=kx(e.accountLabel)??(({label:e,brand:t,last4:r})=>{const n=kx(e),i=kx(t);return r&&i&&i!==n?`${i} •••• ${r}`:r?`•••• ${r}`:i??""})(e),r=kx(e.label)??t,n=Boolean(t)||e.isDefault;return Ty`
    <span class="payment-method-copy">
      <span class="payment-method-title-row">
        <span class="payment-method-title">${r}</span>
        ${(e=>!1!==e.showVerificationStatus)(e)?xx(e.status,e.verificationLabel):""}
      </span>
      ${n?Ty`
  ...
  `},Ex=({balanceLabel:e,balanceLoading:t})=>t?Ty`
      <span
        class="payment-method-balance-loading"
        role="status"
        aria-label="Loading balance"
      ></span>
    `:e?Ty`<span class="payment-method-balance">${e}</span>`:"",Sx=(e,t)=>Ty`
...
`,Ax=(e,t)=>Ty`
  <span class="payment-method-icon-chip" aria-hidden="true">
    <img
      ...
      data-payment-method-icon=${dx(e)}
      src=${ux(e)}
      alt=""
    />
  </span>
  ${Cx(e)} ${t}
`,Ox=(e,t=jx(e))=>{const r=Ax(e,Sx(e));return t?Ty`
      <button
    ...
    `:Ty`<span class="payment-method-row-main">${r}</span>`},Ix=e=>`payment-method-radio-${e.replace(/[^a-zA-Z0-9_-]/g,"-")}`,_x=(e,t)=>{const r=t&&!e.isDefault&&"verified"===e.status,n=!e.isDefault;return r||n},zx=({label:e,variant:t="primary",action:r,type:n="button",icon:i,disabled:o=!1,loading:a=!1})=>Ty`
  <button
...
`,Nx=({id:e,label:t,name:r,value:n="",placeholder:i,type:o="text",span:a="default",variant:s="default",autocomplete:c,inputmode:d,maxLength:u,disabled:l=!1,dataField:h,dataFieldScope:f="card",error:m,maskable:p=!1,revealed:v=!1,onToggleReveal:b,maskReveal:g})=>{const y=$x("field","full"===a&&"field-full","card-form"===s&&"field-card-form",m&&"field-invalid"),w=$x("field-label","card-form"===s&&"field-label-card-form"),$=$x("field-input","card-form"===s&&"field-input-card-form"),k=p&&void 0!==g,x=p,j=x?"off":c,C=k?"text":p&&!v?"password":o,E=Ty`
    <input
      class=${$x($,k&&!v&&""!==n&&"field-input-mask-hidden")}
      id=${e}
      name=${aw(r)}
      type=${C}
      .value=${n}
  ...
  `,S=k?Ty`
      ...
      `:E,A=p&&b?Ty`
        ...
        `:"",O=$x("field-control","field-control-card-form",p&&"field-control-reveal");return Ty`
    <div class=${y}>
      <label class=${w} for=${e}>${t}</label>
      ${"card-form"===s||p?Ty`
            <div class=${O}>${S}${A}</div>
          `:S}
      ${m?Ty`<p class="field-error" id=${`${e}-error`}>${m}</p>`:""}
    </div>
  `},Rx=({id:e,label:t,name:r,value:n="",options:i,span:o="default",variant:a="default",disabled:s=!1,dataField:c,dataFieldScope:d="card",error:u})=>{const l=$x("field","card-form"!==a&&"field-with-select","full"===o&&"field-full","card-form"===a&&"field-card-form",u&&"field-invalid"),h=$x("field-label","card-form"===a&&"field-label-card-form"),f=$x("field-input","field-select","card-form"===a&&"field-input-card-form"),m=Ty`
    <select
      class=${f}
      id=${e}
      name=${aw(r)}
...
`,Lx=({id:e,label:t,status:r,type:n,eyebrow:i,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:u,verificationLabel:l,selectionEligible:h,isDefault:f,disabled:m=!1},{deleteDisabled:p=!1,confirmingDelete:v=!1,menuOpen:b=!1,menuPlacement:g="below",selected:y=!1,selectable:w=!1,showMarkAsDefault:$=!1}={})=>{const k={id:e,label:t,status:r,type:n,brand:o,accountLabel:a,balanceLabel:s,balanceLoading:c,last4:d,showVerificationStatus:u,verificationLabel:l,selectionEligible:h,isDefault:f,disabled:m};if(v&&!k.isDefault)return Ty`
  ...
  `)(e,t,p)}
    ...
    `;const x=w&&(e=>e.selectionEligible??"verified"===e.status)(k),j=_x(k,$),C=x||jx(k),E=j&&!C;return Ty`
    <div
      class=${$x("payment-method-row",x||jx(k)?"payment-method-row-action":"payment-method-row-static",x&&"payment-method-row-radio",j&&"payment-method-row-has-overflow",C&&"payment-method-row-has-affordance",E&&"payment-method-row-has-overflow-without-affordance",y&&x&&"payment-method-row-selected",k.isDefault&&"payment-method-row-default",b&&!k.isDefault&&"payment-method-row-menu-open")}
      part="payment-method-row"
      aria-label=${t}
  ...
  <label
    ...
    for=${t}
  >
    ${Ax(e,Ty`<span class="payment-method-trailing">
        ${Ex(e)}
      </span>`)}
  </label>
`)(k,Ix(k.id)):Ox(k)}
      ${((e,{menuOpen:t,menuPlacement:r,showMarkAsDefault:n})=>{const i=`payment-method-menu-${e.id}`,o=n&&!e.isDefault&&"verified"===e.status,a=!e.isDefault;return _x(e,n)?Ty`
  ...
  `:Ty``})(k,{menuOpen:b,menuPlacement:g,showMarkAsDefault:$})}
      ${E?Ty`<span class="payment-method-row-spacer" aria-hidden="true"></span>`:""}
  ...
  `,Bx=({label:e,subtitle:t,action:r,icon:n,variant:i="card",disabled:o=!1})=>"link"===i?Ty`
        <button
...
`,Vx=({containerId:e,title:t,loadingLabel:r,loading:n=!1})=>Ty`
  <div
...
`,Fx=({variant:e,title:t,message:r,content:n,actions:i})=>Ty`
...
`,Ux=({label:e,action:t,icon:r,variant:n="default",disabled:i=!1})=>Ty`
  <button
...
`,Hx=e=>Ty` <div class="form-grid">${e}</div> `,Wx=e=>`We sent a one-time code to ${e??"your contact method"}.`,Kx=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("otp-input")),Gx=({status:e,value:t,length:r,failedMessage:n,copy:i,submitting:o=!1,resending:a=!1})=>{const s="OTP_VALIDATION_FAILED"===e;return Ty`
    <form class="otp-flow" data-submit-action="verify-otp">
      ${s?Tx({variant:"danger",message:n??i.failedMessage}):""}
  ...
  `})({label:"Verification code",value:t,length:r,disabled:o,error:s})}
      <div class="primitive-footer">
        ${zx({label:o?i.verifyingButton:s?i.tryAgainButton:i.verifyButton,icon:o||s?void 0:"check",variant:"primary",action:"verify-otp",type:"submit",loading:o,disabled:o||t.length<r})}
      </div>
...
`)({...r,busy:e||Boolean(n),overlay:t??n})}showMinimumVerificationOverlay(e){const t=this.minimumVerificationOverlayToken+=1;this.minimumVerificationOverlayAction=e,window.setTimeout(()=>{this.minimumVerificationOverlayToken===t&&(this.minimumVerificationOverlayAction=void 0)},2e3)}renderCurrentScreen(){if(!this.interactionResponse)return this.renderMissingInteractionResponseScreen();if("provider"===this.bankFlowScreen)return this.renderBankProviderScreen();if("outcome"===this.bankFlowScreen)return this.renderBankOutcomeScreen();if("manual-config-loading"===this.bankFlowScreen)return this.renderManualBankAccountConfigLoadingScreen();if("manual-config-error"===this.bankFlowScreen)return this.renderManualBankAccountConfigErrorScreen();if("manual-schema-selection"===this.bankFlowScreen)return this.renderManualBankAccountSchemaSelectionScreen();if("manual"===this.bankFlowScreen)return this.renderManualBankAccountScreen();if("form"===this.cardFlowScreen)return this.renderAddCardScreen();if("error"===this.cardFlowScreen)return this.renderCardErrorScreen();if(this.requiredInfoSource)return this.renderRequiredInfoScreen();if(this.savedSourceVerificationSource)return this.renderSavedSourceVerificationOutcomeScreen();const e=this.interactionResponse?.status;return"OTP_VALIDATION_PENDING"===e||"OTP_VALIDATION_FAILED"===e?this.renderOtpScreen(e):this.shouldRenderTransferScreen()?this.renderTransferScreen():this.renderPaymentSourceScreen()}renderMissingInteractionResponseScreen(){return this.renderWidgetShell({title:"Configuration required",showClose:!1,showDivider:!1,content:Ty`
        <div class="payment-flow">
          ${Tx({variant:"danger",message:"CommerceHub Connect requires an interaction response before it can load payment methods."})}
        </div>
      `})}renderOtpScreen(e){const t=Ej(this.designConfig),r="verify-otp"===this.pendingAction,n="resend-otp"===this.pendingAction,i=Cj(this.interactionResponse);let o;return r?o=wC({title:"Verifying code",helper:"Verifying your code, please wait."}):n&&(o=wC({title:"Sending code",helper:"Sending a new code, please wait."})),this.renderWidgetShell({title:t.title,subtitle:t.subtitle??Wx(i),showClose:!1,showDivider:!1,busy:r||n,overlay:o,content:Gx({status:e,value:this.otpValue,length:6,failedMessage:this.otpErrorMessage,copy:t,submitting:r,resending:n})})}renderPaymentSourceScreen(){const e=Sj(this.designConfig),t=Lj(this.interactionResponse,{nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}),r=Pj(this.interactionResponse),n=iC(this.interactionResponse,"ADD_ACCOUNT")&&(r.card||r.bankAccount),i=iC(this.interactionResponse,"SELECT"),o=iC(this.interactionResponse,"TRANSFER")&&Gj(this.interactionResponse).length>=2,a="attach-payment-source"===this.pendingAction||"verify-payment-source"===this.pendingAction||"delete-payment-source"===this.pendingAction;if(this.shouldRenderPaymentSourceRefreshSkeleton())return this.renderWidgetShell({title:e.title,layout:"payment-methods",headerAction:Ty`
          <div
        ...
        `,showClose:!1,content:Yx()});if(this.shouldRenderPaymentSourceRefreshError())return this.renderPaymentSourceRefreshErrorScreen();if(!t.length)return this.renderNoSavedPaymentMethods();if(this.shouldRenderSelectedPaymentSourceScreen())return this.renderSelectedPaymentSourceScreen();this.queueNativeAccountBalanceRefresh();const s=o?Ty`
          <div class="widget-toolbar" aria-label="Payment method actions">
            ${Ux({label:"Transfer",action:"open-transfer",icon:"transfer",disabled:a})}
          </div>
        `:void 0;return this.renderWidgetShell({title:e.title,layout:"payment-methods",headerAction:s,showClose:!1,busy:a,overlay:kC(this.pendingAction),content:Ty`
        ${this.attachmentError?Tx({variant:"danger",message:this.attachmentError}):""}
        ${Jx({methods:t,canAddPaymentSources:n,canSelectPaymentSources:i,actionPending:a,selectedPaymentSourceId:this.selectedPaymentSourceId,openPaymentSourceMenuId:this.openPaymentSourceMenuId,paymentSourceMenuPlacement:this.paymentSourceMenuPlacement,deleteConfirmationPaymentSourceId:this.deleteConfirmationPaymentSourceId})}
      `,footer:n||i?Ty`
              <div
                class="payment-method-add-footer"
                aria-label="Payment method actions"
              >
                ${i?zx({label:"attach-payment-source"===this.pendingAction?e.continuingButton:e.continueButton,action:"attach-payment-source",loading:"attach-payment-source"===this.pendingAction,disabled:!this.selectedPaymentSourceId||a}):""}
                ${n?zx({label:"Add payment method",action:"open-add-payment-source",icon:"plus",disabled:a}):""}
              </div>
            `:void 0})}renderAddPaymentSourceSheet(){const e=Pj(this.interactionResponse);return Ty`
    ...
    `}renderPaymentSourceRefreshErrorScreen(){return this.renderWidgetShell({title:"Payment methods unavailable",showClose:!1,content:Ty`
        <div class="payment-flow">
          ${Tx({variant:"danger",message:this.interactionRefresh.errorMessage??"We couldn't load payment methods. Try again."})}
          <div class="primitive-footer">
            ${zx({label:"Try again",variant:"primary",action:"retry-interaction-refresh"})}
          </div>
        </div>
      `})}renderSelectedPaymentSourceScreen(){const e=eC(this.interactionResponse,this.selectedPaymentSourceId);return e?this.renderWidgetShell({title:"Payment method saved",headerAction:Ux({label:"Change",action:"change-payment-source",disabled:"attach-payment-source"===this.pendingAction}),showClose:!1,showDivider:!1,busy:"attach-payment-source"===this.pendingAction,overlay:"attach-payment-source"===this.pendingAction?wC({title:BC(e)?"Saving bank account":"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,content:Ty`
        <div class="payment-flow">
          ${Px(Bj(e,{selected:!0,nativeBalances:this.nativeBalance.balances,nativeBalanceLoadingSourceIds:this.nativeBalance.loadingSourceIds}))}
        </div>
      `}):(this.paymentSourceView="list",this.renderPaymentSourceScreen())}shouldRenderSelectedPaymentSourceScreen(){return"list"!==this.paymentSourceView&&("PAYMENT_SOURCE_ATTACHED"===this.interactionResponse?.status||"selected"===this.paymentSourceView)}shouldRenderPaymentSourceRefreshSkeleton(){return this.interactionRefresh.shouldRenderSkeleton(this.interactionResponse)}shouldRenderPaymentSourceRefreshError(){return this.interactionRefresh.shouldRenderError(this.interactionResponse)}renderSavedSourceVerificationOutcomeScreen(){const e=this.savedSourceVerificationSource,t=CC(e,this.savedSourceVerificationFailed);return this.renderWidgetShell({title:t.title,backAction:"done-payment-source-verification",showClose:!1,showDivider:!1,content:Ty`
        <div class="verification-outcome-flow">
          ${Tx({variant:t.variant,message:t.message})}
          ${e?LC(e):""}
        </div>
      `})}renderRequiredInfoScreen(){const e=this.requiredInfoSource;if(!e)return this.renderPaymentSourceScreen();const t=EC(e),r=zC(t),n="submit-required-info"===this.pendingAction,i=this.canSubmitRequiredInfo();return this.renderWidgetShell({title:"Complete account verification",backAction:"back-to-payment-methods",backDisabled:n,showClose:!1,showDivider:!1,busy:n,overlay:n?wC({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,content:Ty`
        <form
          class="required-info-flow"
          data-submit-action="submit-required-info"
        >
          ${LC(e)}
          ${this.requiredInfoSubmitError?Tx({variant:"danger",message:this.requiredInfoSubmitError}):""}
          ...
          <div class="required-info-documents">
            ...
            <div class="primitive-stack">
              ${t.map((e,t)=>{const r=SC(e,t),i=AC(e)?this.requiredInfoValues[r]:this.requiredInfoFileNames[r],o=this.visibleRequiredInfoError(e,t);return AC(e)?NC({doc:e,key:r,value:i??"",error:o}):Ty`
                  <div
                    class="required-info-document required-document-text-row"
                    data-required-info-doc-key=${r}
                    data-required-info-requirement=${IC(e)}
                  >
...
`)({label:"Required document",requirements:TC(e),actionLabel:"Choose file",fileName:i,action:"open-required-info-file-picker",disabled:n})}
                    ${o?Ty`<p
                          class="field-error"
          ...
          <div
            ...
            data-required-info-doc-key=${r??""}
          >
            ${zx({label:n?"Verifying...":"Verify",action:"submit-required-info",type:"submit",loading:n,disabled:n||!i||this.hasBlockingRequiredInfoValidationErrors()})}
          </div>
        </form>
      `})}renderNoSavedPaymentMethods(){const e=Aj(this.designConfig),t="delete-payment-source"===this.pendingAction,r=Pj(this.interactionResponse),n=iC(this.interactionResponse,"ADD_ACCOUNT")&&(r.card||r.bankAccount);return this.renderWidgetShell({title:e.title,subtitle:e.subtitle,showClose:!1,showDivider:!1,content:Zx({allowedTenderOptions:r,canAddPaymentSources:n,deletePending:t,copy:e})})}shouldRenderTransferScreen(){const e=this.interactionResponse;return(this.transferFlowActive||oC(e))&&nC(e?.status)}renderTransferScreen(){const e=Gj(this.interactionResponse),t="transfer"===this.pendingAction,r=this.transferFlowActive?"back-to-payment-methods":void 0;if(e.length<2)return this.renderWidgetShell({title:"Transfer funds",backAction:r,backDisabled:t,showClose:!1,showDivider:!1,content:Ty`
          <div class="payment-flow">
            ${Mx({title:"Transfer unavailable",message:"At least two verified bank or native accounts are required to transfer funds."})}
          </div>
        `});const n=[{value:"",label:"Select account"},...e.map(e=>({value:Wj(e),label:qj(e)}))],i=rx(this.transferDraft),o=e.find(e=>Wj(e)===i.fromSourceId),a=e.find(e=>Wj(e)===i.toSourceId);return"confirm"===this.transferFlowScreen&&o&&a&&ix(i,e)?this.renderTransferConfirmationScreen(o,a,i,t):this.renderWidgetShell({title:"Transfer funds",backAction:r,backDisabled:t,showClose:!1,showDivider:!1,busy:t,overlay:t?wC({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ty`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="transfer"
        >
          ${this.transferSubmitError?Tx({variant:"danger",message:this.transferSubmitError}):""}
          ${this.transferSubmitSuccess?Tx({variant:"success",message:"Transfer initiated."}):""}
          ${Hx([Rx({id:"transfer-from-source",name:"fromSourceId",label:"From",value:this.transferDraft.fromSourceId,options:n,span:"full",variant:"card-form",dataField:"fromSourceId",dataFieldScope:"transfer",error:this.transferValidationAttempted?this.transferDraftErrors.fromSourceId:void 0,disabled:t}),Rx({id:"transfer-to-source",name:"toSourceId",label:"To",value:this.transferDraft.toSourceId,options:n,span:"full",variant:"card-form",dataField:"toSourceId",dataFieldScope:"transfer",error:this.transferValidationAttempted?this.transferDraftErrors.toSourceId:void 0,disabled:t}),Nx({id:"transfer-amount",name:"amount",label:"Amount",value:this.transferDraft.amount,variant:"card-form",inputmode:"decimal",dataField:"amount",dataFieldScope:"transfer",error:this.transferValidationAttempted?this.transferDraftErrors.amount:void 0,disabled:t})])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${zx({label:t?"Transferring":"Transfer",action:"transfer",type:"submit",loading:t,disabled:t||(s=this.transferDraft,![s.fromSourceId,s.toSourceId,s.amount].every(e=>Boolean(e.trim())))||this.hasBlockingTransferValidationErrors()})}
            </div>
          </div>
        </form>
      `});var s}renderTransferConfirmationScreen(e,t,r,n){return this.renderWidgetShell({title:"Confirm transfer",backAction:"edit-transfer",backDisabled:n,showClose:!1,showDivider:!1,busy:n,overlay:n?wC({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ty`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="confirm-transfer"
        >
          ${this.transferSubmitError?Tx({variant:"danger",message:this.transferSubmitError}):""}
          ${qx([{label:"From",value:qj(e)},{label:"To",value:qj(t)},{label:"Amount",value:ox(r)}])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${zx({label:n?"Transferring":"Confirm transfer",action:"confirm-transfer",type:"submit",loading:n,disabled:n})}
            </div>
            <div class="card-form-primary">
              ${zx({label:"Edit",variant:"secondary",action:"edit-transfer",disabled:n})}
            </div>
          </div>
        </form>
      `})}renderAddCardScreen(){const e="save-card"===this.pendingAction,t="encrypting"===this.cardEncryption.cardNumber.status||"encrypting"===this.cardEncryption.cvv.status,r=[...this.billingAddresses.map(e=>({value:e.id??"",label:vj(e)})),{value:Tw,label:"Add new billing address"}],n=this.billingAddresses.find(e=>e.id===this.cardDraft.billingAddressValue),i=Boolean(n)&&!this.billingAddressSelectorExpanded,o=!i&&this.cardDraft.billingAddressValue===Tw,a=[];return n&&i?a.push(Ty`
        <div class="billing-address-summary field field-full">
          <div class="billing-address-summary-heading">
            ...
            >
            ${Ux({label:"Change",action:"change-billing-address",disabled:e})}
          </div>
          <p class="billing-address-summary-value">
            ${vj(n)}
          </p>
        </div>
      `):a.push(Rx({id:"billing-address",name:"billingAddress",label:"Billing address",value:this.cardDraft.billingAddressValue,options:r,span:"full",variant:"card-form",dataField:"billingAddressValue",error:this.visibleCardDraftError("billingAddressValue"),disabled:e})),o&&a.push(Rx({id:"billing-country",name:"country",label:"Country or region",value:this.cardDraft.country,options:lj,span:"full",variant:"card-form",dataField:"country",error:this.visibleCardDraftError("country"),disabled:e}),Nx({id:"billing-address-line-1",name:"addressLine1",label:"Address",value:this.cardDraft.addressLine1,placeholder:"Street address",span:"full",variant:"card-form",autocomplete:"address-line1",dataField:"addressLine1",error:this.visibleCardDraftError("addressLine1"),disabled:e}),Nx({id:"billing-address-line-2",name:"addressLine2",label:"Address line 2",value:this.cardDraft.addressLine2,placeholder:"Apartment, suite, unit",span:"full",variant:"card-form",autocomplete:"address-line2",dataField:"addressLine2",error:this.visibleCardDraftError("addressLine2"),disabled:e}),Nx({id:"billing-city",name:"city",label:"City",value:this.cardDraft.city,span:"full",variant:"card-form",autocomplete:"address-level2",dataField:"city",error:this.visibleCardDraftError("city"),disabled:e}),Rx({id:"billing-state",name:"state",label:"State",value:this.cardDraft.state,options:hj,span:"full",variant:"card-form",dataField:"state",error:this.visibleCardDraftError("state"),disabled:e}),Nx({id:"billing-zip",name:"zip",label:"ZIP code",value:this.cardDraft.zip,placeholder:"ZIP code",span:"full",variant:"card-form",autocomplete:"postal-code",inputmode:"numeric",dataField:"zip",error:this.visibleCardDraftError("zip"),disabled:e})),this.renderWidgetShell({title:"Add card",backAction:"back-to-payment-methods",backDisabled:e,showClose:!1,showDivider:!1,busy:e,overlay:e?wC({title:"Saving card",helper:"Securely saving your card, please wait."}):void 0,content:Ty`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="save-card"
        >
          ${this.cardSubmitError?Tx({variant:"danger",message:this.cardSubmitError}):""}
          ${Hx([Nx({id:"card-label",name:"name",label:"Card Name",value:this.cardDraft.name,placeholder:"Corporate card",span:"full",variant:"card-form",dataField:"name",error:this.visibleCardDraftError("name"),disabled:e}),Nx({id:"card-number",name:"cardNumber",label:"Card number",value:this.cardDraft.cardNumber,placeholder:"1234 1234 1234 1234",span:"full",variant:"card-form",autocomplete:"cc-number",inputmode:"numeric",maxLength:23,dataField:"cardNumber",error:this.visibleCardDraftError("cardNumber"),disabled:e,maskable:!0,revealed:this.revealedCardFields.has("cardNumber"),onToggleReveal:()=>this.toggleCardFieldReveal("cardNumber"),maskReveal:U$(this.cardDraft.cardNumber,this.cardFieldsRevealingLastChar.has("cardNumber"))}),Nx({id:"expiration-date",name:"expirationDate",label:"Expiration",value:this.cardDraft.expirationDate,placeholder:"MM / YY",variant:"card-form",autocomplete:"cc-exp",inputmode:"numeric",maxLength:7,dataField:"expirationDate",error:this.visibleCardDraftError("expirationDate"),disabled:e}),Nx({id:"card-cvv",name:"cvv",label:"CVC",value:this.cardDraft.cvv,placeholder:"3 or 4 digits",variant:"card-form",autocomplete:"cc-csc",inputmode:"numeric",maxLength:4,dataField:"cvv",error:this.visibleCardDraftError("cvv"),disabled:e,maskable:!0,revealed:this.revealedCardFields.has("cvv"),onToggleReveal:()=>this.toggleCardFieldReveal("cvv"),maskReveal:U$(this.cardDraft.cvv,this.cardFieldsRevealingLastChar.has("cvv"))}),Nx({id:"name-on-card",name:"fullName",label:"Full name",value:this.cardDraft.fullName,placeholder:"Name on card",span:"full",variant:"card-form",autocomplete:"cc-name",dataField:"fullName",error:this.visibleCardDraftError("fullName"),disabled:e}),...a])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${zx({label:e?"Saving payment method":"Save card",action:"save-card",type:"submit",loading:e,disabled:e||t||!Kw(this.cardDraft)||this.hasBlockingCardValidationErrors()})}
            </div>
          </div>
        </form>
      `})}renderCardErrorScreen(){return this.renderWidgetShell({title:"Credit card not saved",subtitle:"We could not save this card. Check the card details or use a different payment method.",showClose:!1,showDivider:!1,content:Fx({variant:"danger",content:this.cardSubmitError?Tx({variant:"danger",message:this.cardSubmitError}):void 0,actions:Ty`
          ${zx({label:"Edit card details",action:"edit-card-details"})}
          ${Ux({label:"Use a different method",action:"use-different-method"})}
        `})})}renderBankProviderScreen(){return this.renderWidgetShell({title:"Connect your bank",backAction:"back-to-payment-methods",backDisabled:this.bankLinkLoading,showClose:!1,showDivider:!1,busy:this.bankLinkLoading,overlay:this.bankLinkLoading?wC({title:"Connecting to your bank",helper:"Securely opening your bank connection, please wait."}):void 0,content:Vx({containerId:sj,loading:this.bankLinkLoading,loadingLabel:"Connecting to your bank"}),footer:Ty`
        <div class="bank-provider-manual-link">
          ${Ux({label:"Connect another way",action:"add-ach-manually",disabled:this.bankLinkLoading})}
        </div>
      `})}renderManualBankAccountConfigLoadingScreen(){return this.renderWidgetShell({title:"Select bank account type",backAction:this.manualBankAccountExitAction(),backDisabled:!0,showClose:!1,showDivider:!1,busy:!0,overlay:wC({title:"Loading instrument schemas",helper:"Loading the available bank account options, please wait."}),content:Ty`<div class="payment-flow card-form-screen"></div>`})}renderManualBankAccountConfigErrorScreen(){return this.renderWidgetShell({title:"Select bank account type",backAction:this.manualBankAccountExitAction(),showClose:!1,showDivider:!1,content:Ty`
        <div class="payment-flow card-form-screen">
          ${Tx({variant:"danger",message:this.bankAccountConfigError??"Unable to load instrument schemas. Try again."})}
          <div class="primitive-footer card-form-primary">
            ${zx({label:"Try again",action:"add-ach-manually"})}
          </div>
        </div>
      `})}renderManualBankAccountSchemaSelectionScreen(){const e=Vk(this.bankAccountInstrumentSchemas),t=Uk(e),r=this.selectedBankCurrencyCode?Hk(e,this.selectedBankCurrencyCode):[],n=this.selectedBankAccountType?Wk(e,this.selectedBankCurrencyCode,this.selectedBankAccountType):[];return this.renderWidgetShell({title:"Select bank account type",backAction:this.manualBankAccountExitAction(),showClose:!1,showDivider:!1,content:Ty`
        <div class="instrument-schema-selection payment-flow card-form-screen">
          ${Rx({id:"instrument-schema-currency",name:"instrumentSchemaCurrency",label:"Currency",value:this.selectedBankCurrencyCode,options:[{value:"",label:"Select currency"},...t],disabled:1===t.length,span:"full",variant:"card-form"})}
          ${this.selectedBankCurrencyCode?Rx({id:"instrument-schema-account-type",name:"instrumentSchemaAccountType",label:"Account type",value:this.selectedBankAccountType,options:[{value:"",label:"Select account type"},...r],disabled:1===r.length,span:"full",variant:"card-form"}):""}
          ${this.selectedBankAccountType?Rx({id:"instrument-schema-payment-type",name:"instrumentSchemaPaymentType",label:"Payment type",value:this.selectedBankPaymentType,options:[{value:"",label:"Select payment type"},...n],disabled:1===n.length,span:"full",variant:"card-form"}):""}
          <div class="primitive-footer card-form-primary">
            ${zx({label:"Continue",action:"select-instrument-schema",disabled:!this.selectedBankAccountInstrumentSchemaCode})}
          </div>
        </div>
      `})}renderManualBankAccountScreen(){if("legacy"===this.manualBankAccountFormMode)return this.renderLegacyManualBankAccountScreen();const e=this.bankAccountFormSchema,t=this.bankAccountFormUiSchema;if(!e||!t)return this.renderManualBankAccountConfigErrorScreen();const r="save-bank-account"===this.pendingAction;return this.renderWidgetShell({title:"Enter bank details",backAction:"back-to-instrument-schema-selection",showClose:!1,showDivider:!1,content:Ty`
        ...
        >
          ...
          ></commerce-hub-bank-account-jsonforms>
          ${this.bankAccountSubmitError?Tx({variant:"danger",message:this.bankAccountSubmitError}):""}
          <div class="primitive-footer card-form-primary">
            ${zx({label:r?"Saving bank account":"Save bank account",action:"save-bank-account",type:"submit",loading:r,disabled:r||this.hasBlockingConfigBankValidationErrors()||!Rk(e,this.bankAccountFormData)})}
          </div>
        </form>
      `})}renderBankBillingAddressControl(e){const t=[...this.billingAddresses.map(e=>({value:e.id??"",label:vj(e)})),{value:Tw,label:"Add new billing address"}],r=this.billingAddresses.find(e=>e.id===this.bankBillingAddressValue);return r&&!this.bankBillingAddressSelectorExpanded?Ty`
        <div class="billing-address-summary field field-full">
          <div class="billing-address-summary-heading">
            <span class="billing-address-summary-label field-label"
              >Billing address</span
            >
            ${Ux({label:"Change",action:"change-bank-billing-address",disabled:e})}
          </div>
          <p class="billing-address-summary-value">
            ${vj(r)}
          </p>
        </div>
      `:Rx({id:"bank-billing-address",name:"bankBillingAddress",label:"Billing address",value:this.bankBillingAddressValue,options:t,span:"full",variant:"card-form",disabled:e})}renderLegacyManualBankAccountScreen(){const e="save-bank-account"===this.pendingAction,t=Object.values(this.legacyBankAccountEncryption).some(e=>"encrypting"===e.status);return this.renderWidgetShell({title:"Enter bank details",backAction:this.manualBankAccountExitAction(),backDisabled:e,showClose:!1,showDivider:!1,busy:e,overlay:e?wC({title:"Saving bank account",helper:"Securely saving your bank account, please wait."}):void 0,content:Ty`
        <form
          class="payment-flow card-form-screen"
          data-submit-action="save-bank-account"
        >
          ...
          ></commerce-hub-bank-account-jsonforms>
          <div class="primitive-footer card-form-primary">
            ${zx({label:e?"Saving bank account":"Save bank account",action:"save-bank-account",type:"submit",loading:e,disabled:e||t||this.hasBlockingLegacyBankValidationErrors()||(r=this.legacyBankAccountDraft,n=o$,!(n.required??[]).every(e=>!s$(e)||Boolean(r[e].trim())))})}
          </div>
        </form>
      `});var r,n}renderBankOutcomeScreen(){const e=jC(this.bankOutcomeSource),t="declined"===e.kind||"pending"===e.kind;return this.renderWidgetShell({title:e.title,headerAction:t?Ux({label:"Done",action:"done-bank-outcome"}):void 0,showClose:!1,showDivider:!1,content:Ty`
        <div class="verification-outcome-flow">
          ${Tx({variant:e.variant,message:e.message})}
          ${this.bankOutcomeSource?LC(this.bankOutcomeSource):""}
          ${t?"":Ty`
                <div class="primitive-footer">
                  ${"verified"===e.kind?zx({label:"Continue",action:"continue-bank-outcome"}):"pending"===e.kind?zx({label:"Done",action:"done-bank-outcome"}):Ty`
                        ${zx({label:this.bankLinkLoading?"Retrying":"Try again",action:"retry-bank-provider",loading:this.bankLinkLoading,disabled:this.bankLinkLoading})}
                        ${Ux({label:"Use a different account",action:"use-different-bank-account",disabled:this.bankLinkLoading})}
                      `}
                </div>
              `}
        </div>
      `})}getOtpInputs(){return[...this.renderRoot.querySelectorAll(".otp-input")]}getRequiredInfoSsnInputs(e){return[...this.renderRoot.querySelectorAll(".required-info-ssn-input")].filter(t=>t.dataset.requiredInfoDocKey===e)}storeRequiredInfoSsnInput(e){const t=e.dataset.requiredInfoDocKey;if(!t)return;const r=this.getRequiredInfoSsnInputs(t),n=r.indexOf(e),i=tx(Number(e.dataset.requiredInfoSsnSegment)),o=ex(e.value);if(!(n<0)){if(o.length>i){const e=this.writeRequiredInfoSsnDigits(r,n,o);return this.syncRequiredInfoSsnValue(t,r),void this.focusRequiredInfoSsnInput(r,e)}e.value=o.slice(0,i),this.syncRequiredInfoSsnValue(t,r),e.value.length>=i&&this.focusRequiredInfoSsnInput(r,n+1)}}pasteRequiredInfoSsnInput(e,t){const r=t.dataset.requiredInfoDocKey;if(!r)return;const n=e,i="function"==typeof n.clipboardData?.getData?n.clipboardData.getData("text"):"",o=ex(i);if(!o)return;e.preventDefault();const a=this.getRequiredInfoSsnInputs(r),s=a.indexOf(t);if(s<0)return;const c=this.writeRequiredInfoSsnDigits(a,s,o);this.syncRequiredInfoSsnValue(r,a),this.focusRequiredInfoSsnInput(a,c)}writeRequiredInfoSsnDigits(e,t,r){let n=0,i=t;return e.forEach((e,o)=>{if(o<t)return;const a=tx(Number(e.dataset.requiredInfoSsnSegment)),s=r.slice(n,n+a);e.value=s,s&&(i=o),n+=a}),i}syncRequiredInfoSsnValue(e,t){this.storeRequiredInfoValue(e,ex(t.map(e=>e.value).join("")))}focusRequiredInfoSsnInput(e,t){e[Math.min(t,e.length-1)]?.focus()}syncOtpValueFromInputs(e=this.getOtpInputs()){this.otpValue=((e,t=6)=>Qk(e.join("")).slice(0,t))(e.map(e=>e.value)),this.otpErrorMessage=void 0,"OTP_VALIDATION_FAILED"===this.interactionResponse?.status&&this.setInteractionResponseFromSdk({...this.interactionResponse,status:"OTP_VALIDATION_PENDING"})}writeOtpDigits(e,t,r){const n=(({values:e,startIndex:t,value:r})=>{const n=[...e],i=Qk(r);let o=t;return i.slice(0,Math.max(n.length-t,0)).split("").forEach((e,r)=>{const i=t+r;i>=n.length||(n[i]=e,o=i)}),{values:n,lastWrittenIndex:o}})({values:e.map(e=>e.value),startIndex:t,value:r});return n.values.forEach((t,r)=>{e[r].value=t}),n.lastWrittenIndex}focusOtpInput(e,t,r=t){const n=e[t]??e[Math.max(0,Math.min(r,e.length-1))];n&&n.focus()}async showAddCardScreen(){this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow(),this.cardFlowScreen="form",this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===Tw||!this.billingAddresses.length;const e=this.interactionResponse?.interactionId,t=Boolean(this.interactionResponse?.selectedSource||this.interactionResponse?.paymentSources?.length);if(e&&t&&!this.billingAddresses.length&&void 0===this.interactionResponse?.billerAddress)try{await this.fetchInteraction(e)}catch(e){}this.focusAfterUpdate("#card-label")}async showManualBankAccountScreen(){const e=this.requireInteractionId(),t=this.interactionResponse?.country?.trim();this.clearDeletePaymentSourceConfirmation(),this.resetBankFlow();const r=++this.bankAccountConfigRequestToken;if(this.bankFlowScreen="manual-config-loading",!e)return this.bankAccountConfigError="CommerceHub Connect requires an interaction response before bank details can load.",void(this.bankFlowScreen="manual-config-error");if(!t)return this.bankAccountConfigError="Bank account details are not available because the interaction response is missing a country.",void(this.bankFlowScreen="manual-config-error");try{const i=await this.fetchManualBankAccountCountryConfig(e,t);if(!this.isCurrentManualBankAccountConfigRequest(r,e,t))return void(r===this.bankAccountConfigRequestToken&&this.resetBankFlow());const o=i.instrumentSchemas;if(void 0===o||Array.isArray(o)&&0===o.length)return void this.initializeLegacyManualBankAccountScreen();const a=(n=o,(Array.isArray(n)?n:yk(n)&&Array.isArray(n.instrumentSchemas)?n.instrumentSchemas:[]).filter(Ik));if(0===a.length||0===Vk(a).length)return this.bankAccountConfigError="No instrument schemas are available for this country. Try again.",void(this.bankFlowScreen="manual-config-error");this.bankAccountInstrumentSchemas=a,this.bankAccountConfigError=void 0,this.bankFlowScreen="manual-schema-selection",this.reconcileInstrumentSchemaSelection()}catch(n){if(!this.isCurrentManualBankAccountConfigRequest(r,e,t))return void(r===this.bankAccountConfigRequestToken&&this.resetBankFlow());this.bankAccountConfigError=cC(n),this.bankFlowScreen="manual-config-error"}var n}manualBankAccountExitAction(){return Dj(this.interactionResponse?.country)?"back-to-bank-provider":"back-to-payment-methods"}isCurrentManualBankAccountConfigRequest(e,t,r){return e===this.bankAccountConfigRequestToken&&Boolean(t)&&Boolean(r)&&this.interactionResponse?.interactionId===t&&this.interactionResponse?.country?.trim()===r}reconcileInstrumentSchemaSelection(e=!0){const t=Vk(this.bankAccountInstrumentSchemas),r=Uk(t);if(r.some(e=>e.value===this.selectedBankCurrencyCode)||(this.selectedBankCurrencyCode=1===r.length?r[0].value:"",this.selectedBankAccountType="",this.selectedBankPaymentType=""),!this.selectedBankCurrencyCode)return void(this.selectedBankAccountInstrumentSchemaCode=void 0);const n=Hk(t,this.selectedBankCurrencyCode);if(n.some(e=>e.value===this.selectedBankAccountType)||(this.selectedBankAccountType=1===n.length?n[0].value:"",this.selectedBankPaymentType=""),!this.selectedBankAccountType)return void(this.selectedBankAccountInstrumentSchemaCode=void 0);const i=Wk(t,this.selectedBankCurrencyCode,this.selectedBankAccountType);i.some(e=>e.value===this.selectedBankPaymentType)||(this.selectedBankPaymentType=1===i.length?i[0].value:"");const o=((e,t,r,n)=>{const i=e.filter(e=>e.currencyCode===t&&e.accountType===r&&e.paymentType===n);return 1===i.length?i[0].schema:void 0})(t,this.selectedBankCurrencyCode,this.selectedBankAccountType,this.selectedBankPaymentType);this.selectedBankAccountInstrumentSchemaCode=o?.bavSupportedCode,o&&e&&this.initializeManualBankAccountScreen()}initializeManualBankAccountScreen(){const e=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);e&&(this.bankAccountValidationAttempted=!1,this.reconcileBankBillingAddressSelection(),this.manualBankAccountFormMode="instrument-schema",this.bankFlowScreen="manual",this.configureManualBankAccountForm(e,!0),this.bankAccountSubmitError=void 0,this.bankAccountFormI18n={translateError:Bk(e)},this.bankAccountConfigError=void 0)}configureManualBankAccountForm(e,t){const r=this.bankBillingAddressValue===Tw?e:(e=>{const t=Object.fromEntries(Object.entries(e.properties).filter(([e])=>"address"!==e&&!e.startsWith("address."))),r=e.required.filter(e=>"address"!==e&&!e.startsWith("address."));return{...e,properties:t,required:r}})(e),n=this.interactionResponse?.country,i=((e,t)=>{Ok(e);const r={};for(const t of Object.keys(e.properties)){let e=r;for(const r of Ek(t).slice(0,-1)){const t=wk(e,r)?e[r]:void 0,n=yk(t)?t:{};e[r]=n,e=n}}const n=kk(t);if(wk(e.properties,"address.country")&&void 0!==n){const e=yk(r.address)?r.address:{};e.country=n,r.address=e}return r})(r,n);var o;this.bankAccountFormSchema=this.instrumentSchemaWithBillingAddressControl(((e,t)=>{Ok(e);const r={type:"object",properties:{}},n=kk(t);for(const[t,i]of Object.entries(e.properties))zk(r,Ek(t),i,"address.country"===t&&void 0!==n);for(const t of e.required)Nk(r,Ek(t));return r})(r,n)),this.bankAccountFormUiSchema=((e,t)=>{const r=e,n=r.elements??[],i=n.filter(e=>(e=>e.scope??"")(e).startsWith("#/properties/address/")),o=n.filter(e=>!i.includes(e)),a={type:"Control",scope:t};return{...r,elements:[...o,a,...i]}})((Ok(o=r),{type:"VerticalLayout",elements:Pk(o).map(e=>({type:"Control",scope:`#/properties/${Ek(e).map(Tk).join("/properties/")}`}))}),"#/properties/__bankBillingAddress"),this.bankAccountFormData=t?{...i,[Kk]:this.bankBillingAddressValue}:{...i,...this.bankAccountFormData,[Kk]:this.bankBillingAddressValue},this.bankAccountFormValid=!1}instrumentSchemaWithBillingAddressControl(e){return{...e,properties:{...e.properties??{},[Kk]:{type:"string",title:"Billing address"}}}}updateBankBillingAddress(e){if(!(e===Tw||this.billingAddresses.some(t=>t.id===e)))return;this.bankBillingAddressValue=e,this.bankBillingAddressSelectorExpanded=e===Tw,this.bankAccountSubmitError=void 0;const t=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);t&&"instrument-schema"===this.manualBankAccountFormMode&&this.configureManualBankAccountForm(t,!1)}reconcileBankBillingAddressSelection(){if(this.bankBillingAddressValue===Tw)return void(this.bankBillingAddressSelectorExpanded=!0);this.billingAddresses.some(e=>e.id===this.bankBillingAddressValue)||(this.bankBillingAddressValue=this.billingAddresses[0]?.id??Tw,this.bankBillingAddressSelectorExpanded=this.bankBillingAddressValue===Tw)}initializeLegacyManualBankAccountScreen(){this.bankAccountValidationAttempted=!1,this.manualBankAccountFormMode="legacy",this.bankFlowScreen="manual",this.legacyBankAccountDraft={accountNickname:"",routingNumber:"",accountNumber:"",confirmAccountNumber:""},this.legacyBankAccountDraftErrors={},this.legacyBankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},confirmAccountNumber:{status:"idle",normalizedValue:""}},this.bankAccountSubmitError=void 0,this.bankAccountConfigError=void 0}clearManualBankAccountForm(){this.manualBankAccountFormMode=void 0,this.bankAccountValidationAttempted=!1,this.bankAccountFormSchema=void 0,this.bankAccountFormUiSchema=void 0,this.bankAccountFormData={},this.bankAccountFormValid=!1,this.bankAccountSubmitError=void 0,this.bankAccountFormI18n=void 0,this.legacyBankAccountDraft={accountNickname:"",routingNumber:"",accountNumber:"",confirmAccountNumber:""},this.legacyBankAccountDraftErrors={},this.legacyBankAccountEncryption={routingNumber:{status:"idle",normalizedValue:""},accountNumber:{status:"idle",normalizedValue:""},confirmAccountNumber:{status:"idle",normalizedValue:""}}}updateTransferDraftField(e,t){const r=rx({...this.transferDraft,[e]:t});this.transferDraft=r,this.transferDraftErrors=nx(r,Gj(this.interactionResponse)),this.transferFlowScreen="form",this.transferSubmitError=void 0,this.transferSubmitSuccess=!1}visibleCardDraftError(e){return this.cardValidationAttempted?this.cardDraftErrors[e]:void 0}hasBlockingTransferValidationErrors(){return!!this.transferValidationAttempted&&Object.values(this.transferDraftErrors).some(e=>Boolean(e))}hasBlockingCardValidationErrors(){return!!this.cardValidationAttempted&&Object.values(this.cardDraftErrors).some(e=>Boolean(e))}hasBlockingConfigBankValidationErrors(){return this.bankAccountValidationAttempted&&!this.bankAccountFormValid}hasBlockingLegacyBankValidationErrors(){return!!this.bankAccountValidationAttempted&&Object.values(this.legacyBankAccountDraftErrors).some(e=>Boolean(e))}hasBlockingRequiredInfoValidationErrors(){return!(!this.requiredInfoValidationAttempted||!this.requiredInfoSource)&&EC(this.requiredInfoSource).some((e,t)=>Boolean(this.requiredInfoValidationError(e,t)))}updateLegacyBankAccountDraftField(e,t){if("legacy"!==this.manualBankAccountFormMode)return;const r=$$({draft:this.legacyBankAccountDraft,errors:this.legacyBankAccountDraftErrors,encryption:this.legacyBankAccountEncryption,schema:o$,field:e,value:t});this.legacyBankAccountDraft=r.draft,this.legacyBankAccountEncryption=r.encryption,this.legacyBankAccountDraftErrors=r.errors,this.bankAccountSubmitError=void 0}toggleCardFieldReveal(e){const t=new Set(this.revealedCardFields);t.has(e)?t.delete(e):t.add(e),this.revealedCardFields=t}armCardFieldLastCharReveal(e){const t=new Set(this.cardFieldsRevealingLastChar);t.add(e),this.cardFieldsRevealingLastChar=t;const r=this.cardRevealTimeoutIds[e];void 0!==r&&window.clearTimeout(r),this.cardRevealTimeoutIds[e]=window.setTimeout(()=>{this.clearCardFieldLastCharReveal(e)},1500)}clearCardFieldLastCharReveal(e){const t=this.cardRevealTimeoutIds[e];if(void 0!==t&&(window.clearTimeout(t),delete this.cardRevealTimeoutIds[e]),this.cardFieldsRevealingLastChar.has(e)){const t=new Set(this.cardFieldsRevealingLastChar);t.delete(e),this.cardFieldsRevealingLastChar=t}}clearAllCardFieldLastCharReveal(){Object.values(this.cardRevealTimeoutIds).forEach(e=>{void 0!==e&&window.clearTimeout(e)}),this.cardRevealTimeoutIds={},this.cardFieldsRevealingLastChar.size>0&&(this.cardFieldsRevealingLastChar=new Set)}updateCardDraftField(e,t){const r=((e,t)=>"cardNumber"===e?qw(t):"expirationDate"===e?Uw(t):"cvv"===e?Dw(t).slice(0,4):t)(e,t),n={...this.cardDraft,[e]:r};if(this.cardDraft=n,"billingAddressValue"===e&&(this.billingAddressSelectorExpanded=r===Tw),this.cardSubmitError=void 0,this.cardValidationAttempted){const t=Ww(Hw(n))[e],r=Jw(this.cardDraftErrors,e);this.cardDraftErrors=t?{...r,[e]:t}:r}Lw(e)&&(this.cardEncryption={...this.cardEncryption,[e]:Yw(this.cardEncryption[e],Bw(e,r))})}async encryptCardField(e,t){this.updateCardDraftField(e,t);const r=Bw(e,t),n=((e,t)=>"cardNumber"===e?Xw(t)?void 0:"Enter a valid card number.":e$(t)?void 0:"Enter a valid CVC.")(e,t);if(!r){const t=Jw(this.cardDraftErrors,e);return this.cardDraftErrors=this.cardValidationAttempted&&n?{...t,[e]:n}:t,void(this.cardEncryption={...this.cardEncryption,[e]:{status:"idle",normalizedValue:""}})}if(n)return this.cardDraftErrors={...Jw(this.cardDraftErrors,e),[e]:n},void(this.cardEncryption={...this.cardEncryption,[e]:Yw(this.cardEncryption[e],r)});const i=this.cardEncryption[e];if("encrypting"!==i.status&&"encrypted"!==i.status||i.normalizedValue!==r){this.cardDraftErrors=Jw(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypting",normalizedValue:r}};try{const t=await this.encryptSensitiveSourceValue(r);if(Bw(e,this.cardDraft[e])!==r)return;this.cardDraftErrors=Jw(this.cardDraftErrors,e),this.cardEncryption={...this.cardEncryption,[e]:{status:"encrypted",normalizedValue:r,encryptedValue:t}}}catch(t){if(Bw(e,this.cardDraft[e])!==r)return;this.cardDraftErrors={...Jw(this.cardDraftErrors,e),[e]:Gw(e)},this.cardEncryption={...this.cardEncryption,[e]:{status:"failed",normalizedValue:r}}}}}async encryptLegacyBankAccountField(e,t){if("legacy"!==this.manualBankAccountFormMode)return;const r=this.legacyBankAccountEncryption[e];if(u$(t,r))return this.legacyBankAccountDraft={...this.legacyBankAccountDraft,[e]:t},void(this.bankAccountSubmitError=void 0);this.updateLegacyBankAccountDraftField(e,t);const n=d$(t);if(!n){const t={...this.legacyBankAccountEncryption,[e]:{status:"idle",normalizedValue:""}};return this.legacyBankAccountEncryption=t,void(this.legacyBankAccountDraftErrors=v$(h$(this.legacyBankAccountDraft,t),o$))}if("encrypting"!==r.status&&"encrypted"!==r.status||r.normalizedValue!==n){this.legacyBankAccountDraftErrors=((e,t)=>{const r={...e};return delete r[t],r})(this.legacyBankAccountDraftErrors,e),this.legacyBankAccountEncryption={...this.legacyBankAccountEncryption,[e]:{status:"encrypting",normalizedValue:n}};try{const t=await this.encryptSensitiveSourceValue(n);if("legacy"!==this.manualBankAccountFormMode||d$(this.legacyBankAccountDraft[e])!==n)return;const r={...this.legacyBankAccountDraft,[e]:l$(n)},i={...this.legacyBankAccountEncryption,[e]:{status:"encrypted",normalizedValue:n,encryptedValue:t}};this.legacyBankAccountDraft=r,this.legacyBankAccountEncryption=i,this.legacyBankAccountDraftErrors=v$(h$(r,i),o$)}catch(t){if("legacy"!==this.manualBankAccountFormMode||d$(this.legacyBankAccountDraft[e])!==n)return;const r={...this.legacyBankAccountEncryption,[e]:{status:"failed",normalizedValue:n}};this.legacyBankAccountEncryption=r,this.legacyBankAccountDraftErrors={...v$(h$(this.legacyBankAccountDraft,r),o$),[e]:w$(e)}}}}async encryptSensitiveSourceValue(e){const t=this.requireSourceCreateContext();return bx(e,t.publicKey)}trackCardFieldEncryption(e,t){const r=this.encryptCardField(e,t);this.cardEncryptionTasks[e]=r;const n=()=>{this.cardEncryptionTasks[e]===r&&delete this.cardEncryptionTasks[e]};return r.then(n,n),r}async ensureSensitiveCardFieldsEncrypted(){await Promise.all(["cardNumber","cvv"].map(async e=>{const t=this.cardEncryptionTasks[e];t&&await t;const r=this.cardDraft[e],n=Bw(e,r);if(!n)return;const i=this.cardEncryption[e];"encrypted"===i.status&&i.normalizedValue===n&&Boolean(i.encryptedValue)||await this.trackCardFieldEncryption(e,r)}))}async saveCard(){if("save-card"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;this.cardValidationAttempted=!0,await this.ensureSensitiveCardFieldsEncrypted();const t=Hw(this.cardDraft),r={...Zw(t,this.cardEncryption),...Ww(t)};if(Object.keys(r).length>0)return this.cardDraft=t,this.cardDraftErrors=r,void(this.cardSubmitError=void 0);let n;try{n=this.requireSourceCreateContext()}catch(e){return this.cardDraft=t,this.cardDraftErrors={},void(this.cardSubmitError=cC(e))}this.pendingAction="save-card",this.cardDraft=t,this.cardDraftErrors={},this.cardSubmitError=void 0;try{const r=Qw("cardNumber",t.cardNumber,this.cardEncryption),i=Qw("cvv",t.cvv,this.cardEncryption),o=t$(t.expirationDate);if(!o)return void(this.cardDraftErrors={expirationDate:"Enter a valid expiration date."});const a=await this.resolveBillingAddressId(e,t),s={id:"",tenderType:"CARD",name:t.name,billingAddressId:a,card:{nameOnCard:t.fullName,cardNumber:r,cvv:i,cardNumberEncrypted:r,cvvEncrypted:i,expirationMonth:o.month,expirationYear:o.year,network:r$(t.cardNumber)}},c=await this.requestCommerceHubJson("/interaction/source/card",e,{method:"POST",headers:this.createSourceCreateHeaders(e,n,{"Content-Type":"application/json"}),body:JSON.stringify(s),credentials:"include"});this.assertCurrentInteraction(e);const d=this.sourceWithVerificationResponse(bj(s,t.cardNumber),c);kj(c,"The card creation response did not include a source id.");const u=this.interactionResponseWithAddedSource(e,d);this.cardFlowScreen=void 0,this.cardDraft=Mw(),this.cardDraftErrors={},this.cardValidationAttempted=!1,this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.cardSubmitError=void 0,this.setInteractionResponseFromSdk(u),this.emitSdkEvent(ej,d);const l=await this.refreshInteractionAfterMutation(e),h=this.findPaymentSourceInInteraction(l,d.id)??d;this.showAddedPaymentSourceStatus(h)}catch(t){if(this.isStaleMutationFailure(e,t))return;this.cardSubmitError=cC(t),this.cardFlowScreen="error"}finally{this.clearPendingMutationAction(e,"save-card")}}async saveManualBankAccount(){if("legacy"===this.manualBankAccountFormMode)return void await this.saveLegacyManualBankAccount();if("save-bank-account"===this.pendingAction)return;if(this.bankAccountValidationAttempted=!0,!this.bankAccountFormValid)return;const e=this.requireInteractionId(),t=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);if(!e||!t)return;let r;try{r=this.requireSourceCreateContext()}catch(e){return void(this.bankAccountSubmitError=cC(e))}this.pendingAction="save-bank-account",this.bankAccountSubmitError=void 0;try{const n=Zk({data:this.bankAccountFormData,schema:t,addressSelection:this.bankBillingAddressValue===Tw?{kind:"new"}:{kind:"existing",id:this.bankBillingAddressValue},id:dC()}),i=await(async(e,t)=>{const r=await Promise.all(Gk.flatMap(r=>{const n=Yk(e[r]);return n?[t(n).then(e=>[r,e])]:[]})),n=Object.fromEntries(r),i=n.accountNumber;return{...e,...n,..."string"==typeof i&&i.trim()?{accountNumberReEntered:i}:{}}})(n,e=>bx(e,r.publicKey)),o=await this.requestCommerceHubJson(`/interaction/source/v2/ach?currencyCode=${encodeURIComponent(n.currencyCode)}`,e,{method:"POST",headers:this.createSourceCreateHeaders(e,r,{"Content-Type":"application/json"}),body:JSON.stringify(i),credentials:"include"});this.assertCurrentInteraction(e);const a=xj(o);let s,c;if(a)c=this.sourceWithVerificationResponse(wj(n),a);else{const t=await this.resolveConfigDrivenBankSourceFromInteraction(e,n);c=t.source,s=t.interactionResponse}const d=this.interactionResponseWithAddedSource(e,c);this.setInteractionResponseFromSdk(d),this.emitSdkEvent(ej,c),this.resetBankFlow(),s??=await this.refreshInteractionAfterMutation(e);const u=this.findPaymentSourceInInteraction(s,c.id)??c;this.showAddedPaymentSourceStatus(u)}catch(t){if(this.isStaleMutationFailure(e,t))return;this.bankAccountSubmitError=cC(t)}finally{this.clearPendingMutationAction(e,"save-bank-account")}}async resolveConfigDrivenBankSourceFromInteraction(e,t){const r=await this.fetchFreshInteraction(e),n=(r.paymentSources??[]).filter(BC).find(e=>e.id?.trim()===t.id),i=n?.id?.trim();if(!n||!i)throw new Error("The bank account was created but could not be resolved from the interaction.");const o=wj(t);return{source:{...n,...o,id:i,verificationInfo:n.verificationInfo,bankAccount:{...n.bankAccount,...o.bankAccount}},interactionResponse:r}}async saveLegacyManualBankAccount(){if("save-bank-account"===this.pendingAction)return;const e=this.requireInteractionId();if(!e||"legacy"!==this.manualBankAccountFormMode)return;this.bankAccountValidationAttempted=!0;const t=h$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),r=v$(t,o$);if(Object.keys(r).length>0)return this.legacyBankAccountDraft=m$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),this.legacyBankAccountDraftErrors=r,void(this.bankAccountSubmitError=void 0);let n;try{n=this.requireSourceCreateContext()}catch(e){return this.legacyBankAccountDraft=m$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),this.legacyBankAccountDraftErrors={},void(this.bankAccountSubmitError=cC(e))}this.pendingAction="save-bank-account",this.legacyBankAccountDraft=m$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),this.legacyBankAccountDraftErrors={},this.bankAccountSubmitError=void 0;try{await this.encryptChangedLegacyBankAccountFields();const t=h$(this.legacyBankAccountDraft,this.legacyBankAccountEncryption),r=v$(t,o$);if(Object.keys(r).length>0)return void(this.legacyBankAccountDraftErrors=r);const s=k$("routingNumber",this.legacyBankAccountDraft,this.legacyBankAccountEncryption),c=k$("accountNumber",this.legacyBankAccountDraft,this.legacyBankAccountEncryption),d=k$("confirmAccountNumber",this.legacyBankAccountDraft,this.legacyBankAccountEncryption),u=(i="accountNumber",o=this.legacyBankAccountEncryption,a=t,j$(o[i].normalizedValue||a[i])),l={id:"",tenderType:"BANK_ACCOUNT",productCode:"POACH",name:x$(this.legacyBankAccountDraft.accountNickname,u),bankAccount:{routingNumber:s,accountNumber:c,accountNumberReEntered:d,routingNumberEncrypted:s,accountNumberEncrypted:c,asset:{type:"CURRENCY",id:"USD"}}},h=await this.requestCommerceHubJson("/interaction/source/ach",e,{method:"POST",headers:this.createSourceCreateHeaders(e,n,{"Content-Type":"application/json"}),body:JSON.stringify(l),credentials:"include"});this.assertCurrentInteraction(e);const f=this.sourceWithVerificationResponse($j(l,u),h);kj(h,"The bank account creation response did not include a source id.");const m=this.interactionResponseWithAddedSource(e,f);this.setInteractionResponseFromSdk(m),this.emitSdkEvent(ej,f),this.resetBankFlow();const p=await this.refreshInteractionAfterMutation(e),v=this.findPaymentSourceInInteraction(p,f.id)??f;this.showAddedPaymentSourceStatus(v)}catch(t){if(this.isStaleMutationFailure(e,t))return;this.bankAccountSubmitError=cC(t)}finally{this.clearPendingMutationAction(e,"save-bank-account")}var i,o,a}async encryptChangedLegacyBankAccountFields(){for(const e of["routingNumber","accountNumber","confirmAccountNumber"]){const t=this.legacyBankAccountDraft[e],r=this.legacyBankAccountEncryption[e];if(u$(t,r))continue;const n=d$(t);if(!n)continue;"encrypted"===r.status&&r.normalizedValue===n&&Boolean(r.encryptedValue)||await this.encryptLegacyBankAccountField(e,t)}}reviewTransfer(){if("transfer"===this.pendingAction)return;this.transferValidationAttempted=!0;const e=Gj(this.interactionResponse),t=rx(this.transferDraft),r=nx(t,e);if(Object.keys(r).length>0)return this.transferDraft=t,this.transferDraftErrors=r,this.transferSubmitError=void 0,void(this.transferSubmitSuccess=!1);this.transferDraft=t,this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1,this.transferFlowScreen="confirm"}async submitTransfer(){if("transfer"===this.pendingAction)return;const e=this.requireInteractionId();if(!e)return;const t=Gj(this.interactionResponse),r=rx(this.transferDraft),n=nx(r,t);if(Object.keys(n).length>0)return this.transferDraft=r,this.transferDraftErrors=n,this.transferFlowScreen="form",this.transferSubmitError=void 0,void(this.transferSubmitSuccess=!1);this.pendingAction="transfer",this.transferDraft=r,this.transferDraftErrors={},this.transferSubmitError=void 0,this.transferSubmitSuccess=!1;try{const t=await this.requestCommerceHubJson("/interaction/source/native/transfer",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({fromSourceId:r.fromSourceId,toSourceId:r.toSourceId,amount:Number(r.amount),asset:{type:"CURRENCY",id:"USD"}}),credentials:"include"});this.transferFlowScreen="form",this.transferValidationAttempted=!1,this.transferSubmitSuccess=!0,this.emitSdkEvent(ij,t)}catch(e){this.transferSubmitError=cC(e)}finally{this.pendingAction=void 0}}async resolveBillingAddressId(e,t){if(t.billingAddressValue!==Tw)return t.billingAddressValue;const r=(e=>({id:i$(),recipientNameOrAddress:e.fullName,country:e.country,street:e.addressLine1,houseNumberOrName:e.addressLine2||void 0,city:e.city,stateOrProvince:e.state,postalCode:e.zip}))(t),n=await this.requestCommerceHubJson("/interaction/billing-address",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r),credentials:"include"}),i=n.value?.trim();if(!i)throw new Error("The billing address response did not include an id.");return i}async verifyOtp(){if("verify-otp"===this.pendingAction)return;if(this.otpValue.length<6)return;const e=this.requireInteractionId();if(e){this.pendingAction="verify-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/validate",{body:{otp:this.otpValue,channel:"EMAIL"}}),r=sC(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(r)}catch(e){this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk({...this.interactionResponse,status:"OTP_VALIDATION_FAILED"})}finally{this.pendingAction=void 0}}}async resendOtp(){if("resend-otp"===this.pendingAction)return;const e=this.requireInteractionId();if(e){this.pendingAction="resend-otp";try{const t=await this.createSdkClient(e).POST("/interaction/otp/send/email"),r=sC(t);this.otpErrorMessage=void 0,this.setInteractionResponseFromSdk(r)}catch(e){}finally{this.pendingAction=void 0}}}async attachPaymentSource(e){if("attach-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),r=this.findPaymentSourceById(e);if(t&&r&&px(r)){this.selectedPaymentSourceId=e,this.paymentSourceView="list",this.attachmentError=void 0,this.pendingAction="attach-payment-source";try{const n=await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}/attach`,t,{method:"POST",credentials:"include"});this.assertCurrentInteraction(t);const i=aC(this.interactionResponse??{interactionId:t},n,e);this.setInteractionResponseFromSdk(i);const o=await this.refreshInteractionAfterMutation(t),a=this.findPaymentSourceInInteraction(o,e)??this.findPaymentSourceInInteraction(i,e)??r;this.selectedPaymentSourceId=a.id,this.paymentSourceView="list",this.emitSdkEvent(Xx,a),this.focusAfterUpdate(".payment-method-radio:checked")}catch(e){if(this.isStaleMutationFailure(t,e))return;this.paymentSourceView="list",this.attachmentError=cC(e)||"We couldn't save this payment method. Please try again."}finally{this.clearPendingMutationAction(t,"attach-payment-source")}}}async markPaymentSourceDefault(e){if("attach-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),r=this.findPaymentSourceById(e);if(t&&r&&(e=>"VERIFIED"===e.verificationInfo?.status)(r)){this.selectedPaymentSourceId=e,this.paymentSourceView="list",this.attachmentError=void 0,this.pendingAction="attach-payment-source";try{await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}`,t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({isDefault:!0}),credentials:"include"}),this.assertCurrentInteraction(t);const n=this.interactionResponse??{interactionId:t},i=aC(n,{...n,status:"PAYMENT_SOURCE_ATTACHED"},e);this.setInteractionResponseFromSdk(i);const o=await this.refreshInteractionAfterMutation(t),a=this.findPaymentSourceInInteraction(o,e)??this.findPaymentSourceInInteraction(i,e)??r;this.selectedPaymentSourceId=a.id,this.paymentSourceView="list"}catch(e){if(this.isStaleMutationFailure(t,e))return;this.paymentSourceView="list",this.attachmentError=cC(e)||"We couldn't update the default payment method. Please try again."}finally{this.clearPendingMutationAction(t,"attach-payment-source")}}}async verifySavedPaymentSource(e){if("verify-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),r=this.findPaymentSourceById(e);if(t&&r){if(PC(r))return this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(r);if("NOT_VERIFIED"===r.verificationInfo?.status){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",this.pendingAction="verify-payment-source";try{const n=await this.verifyPaymentSourceStep1(t,{...r,id:e}),i=bC({...this.interactionResponse??{interactionId:t},selectedSource:this.interactionResponse?.selectedSource,status:uj},n);if(this.setInteractionResponseFromSdk(i),this.emitSdkEvent(tj,n),PC(n))return void this.showRequiredInfoSource(n);if("VERIFIED"===n.verificationInfo?.status)return this.pendingAction=void 0,this.selectedPaymentSourceId=px(n)?n.id?.trim()||e:void 0,void(this.paymentSourceView="list");this.savedSourceVerificationSource=n,this.savedSourceVerificationFailed=!1}catch(e){this.savedSourceVerificationSource=r,this.savedSourceVerificationFailed=!0}finally{"verify-payment-source"===this.pendingAction&&(this.pendingAction=void 0)}}}}async deletePaymentSource(e){if("delete-payment-source"===this.pendingAction)return;const t=this.requireInteractionId(),r=this.findPaymentSourceById(e);if(t&&r)if("PAYMENT_SOURCE_ATTACHED"!==this.interactionResponse?.status||this.interactionResponse.selectedSource?.id!==e)if(this.deleteConfirmationPaymentSourceId===e){this.clearDeletePaymentSourceConfirmation(),this.pendingAction="delete-payment-source";try{await this.requestCommerceHubJson(`/interaction/source/${encodeURIComponent(e)}`,t,{method:"DELETE",credentials:"include"}),await this.refreshInteractionAfterMutation(t),this.emitSdkEvent(rj,e)}catch(e){if(this.isStaleMutationFailure(t,e))return}finally{this.clearPendingMutationAction(t,"delete-payment-source")}}else this.armDeletePaymentSourceConfirmation(e);else this.clearDeletePaymentSourceConfirmation()}armDeletePaymentSourceConfirmation(e){this.clearDeletePaymentSourceConfirmation(),this.deleteConfirmationPaymentSourceId=e,this.deleteConfirmationTimeoutId=window.setTimeout(()=>{this.deleteConfirmationPaymentSourceId===e&&this.clearDeletePaymentSourceConfirmation()},1e4)}clearDeletePaymentSourceConfirmation(){void 0!==this.deleteConfirmationTimeoutId&&(window.clearTimeout(this.deleteConfirmationTimeoutId),this.deleteConfirmationTimeoutId=void 0),this.deleteConfirmationPaymentSourceId=void 0}findPaymentSourceById(e){return(this.interactionResponse?.paymentSources??[]).find(t=>t.id===e)??(this.interactionResponse?.selectedSource?.id===e?this.interactionResponse.selectedSource:void 0)}findPaymentSourceInInteraction(e,t){return(e?.selectedSource?.id===t?e.selectedSource:void 0)??e?.paymentSources?.find(e=>e.id===t)}resetSavedSourceVerification(){this.savedSourceVerificationSource=void 0,this.savedSourceVerificationFailed=!1}showPaymentSourceList({refresh:e=!0}={}){this.clearDeletePaymentSourceConfirmation(),this.openPaymentSourceMenuId=void 0,this.paymentSourceView="list",this.addLauncherActive=!1,this.resetTransferFlow(),e?this.refreshPaymentSourcesForList().finally(()=>{this.focusPaymentSourceList()}):this.focusPaymentSourceList()}focusPaymentSourceList(){this.focusAfterUpdate('[data-action="open-add-payment-source"]','[data-action="toggle-payment-source-menu"]','[data-action="add-card"]','[data-action="add-bank-account"]')}shouldOpenPaymentSourceMenuAbove(e){const t=e?.closest(".primitive-stack"),r=e?.closest(".payment-method-row");if(!t||!r)return!1;const n=t.getBoundingClientRect(),i=r.getBoundingClientRect(),o=6*(Number.parseFloat(getComputedStyle(this).fontSize)||16),a=n.bottom-i.bottom,s=i.top-n.top;return a<o&&s>a}closeAddPaymentSourceSheet(){this.addLauncherActive=!1,this.focusAfterUpdate('[data-action="open-add-payment-source"]')}async refreshPaymentSourcesForList(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}async refreshInteractionAfterMutation(e){try{return await this.fetchFreshInteraction(e)}catch(e){if(e instanceof Sw)throw e;return}}assertCurrentInteraction(e){if(this.interactionResponse?.interactionId!==e)throw new Sw(e)}isStaleMutationFailure(e,t){return this.interactionResponse?.interactionId!==e||t instanceof Sw}clearPendingMutationAction(e,t){this.interactionResponse?.interactionId===e&&this.pendingAction===t&&(this.pendingAction=void 0)}fetchFreshInteraction(e){return this.interactionRefresh.fetchFresh(e,this.interactionRefreshOptions())}interactionResponseWithAddedSource(e,t){const r=t.id?.trim(),n=Boolean(r)&&yC(t),i={...this.interactionResponse??{interactionId:e},status:uj};return n?vC(i,t):bC({...i,selectedSource:this.interactionResponse?.selectedSource},t)}showAddedPaymentSourceStatus(e){const t=e.id?.trim();return this.resetSavedSourceVerification(),this.resetRequiredInfo(),PC(e)?(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",void this.showRequiredInfoSource(e)):"VERIFIED"===e.verificationInfo?.status?(this.selectedPaymentSourceId=px(e)?t:void 0,void(this.paymentSourceView="list")):(this.selectedPaymentSourceId=void 0,this.paymentSourceView="list",BC(e)?(this.bankOutcomeSource=e,void(this.bankFlowScreen="outcome")):(this.savedSourceVerificationSource=e,void(this.savedSourceVerificationFailed=!1)))}showRequiredInfoSource(e){this.requiredInfoSource=e,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.requiredInfoValidationAttempted=!1,this.pendingRequiredInfoDocKey=void 0}resetRequiredInfo(){this.requiredInfoSource=void 0,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},this.requiredInfoSubmitError=void 0,this.requiredInfoValidationAttempted=!1,this.pendingRequiredInfoDocKey=void 0}firstRequiredInfoDocKey(){return zC(EC(this.requiredInfoSource))??SC(EC(this.requiredInfoSource)[0],0)}storeRequiredInfoValue(e,t){this.requiredInfoValues=((e,t,r)=>({...e,[t]:r}))(this.requiredInfoValues,e,t),this.requiredInfoSubmitError=void 0}storeRequiredInfoSelectedFile(e){if(!this.requiredInfoSource||!e)return void(this.pendingRequiredInfoDocKey=void 0);const t=this.pendingRequiredInfoDocKey??this.firstRequiredInfoDocKey(),r=(({files:e,fileNames:t,key:r,file:n})=>({files:{...e,[r]:n},fileNames:{...t,[r]:n.name}}))({files:this.requiredInfoFiles,fileNames:this.requiredInfoFileNames,key:t,file:e});this.requiredInfoFiles=r.files,this.requiredInfoFileNames=r.fileNames,this.requiredInfoSubmitError=void 0,this.pendingRequiredInfoDocKey=void 0}canSubmitRequiredInfo(){const e=this.requiredInfoSource;if(!e?.id?.trim())return!1;const t=EC(e),r=t.map((e,t)=>({doc:e,index:t})).filter(({doc:e})=>OC(e));return r.length>0?r.every(({doc:e,index:t})=>this.hasRequiredInfoValue(e,t)):t.some((e,t)=>this.hasRequiredInfoValue(e,t))}visibleRequiredInfoError(e,t){return this.requiredInfoValidationAttempted?this.requiredInfoValidationError(e,t):void 0}requiredInfoValidationError(e,t){return this.hasRequiredInfoValue(e,t)?"SOCIAL_SECURITY_NUMBER"===e.docType?(r=this.requiredInfoValues[SC(e,t)]??"",9===ex(r).length?void 0:"Enter a 9-digit Social Security number."):void 0:OC(e)?MC(e):void 0;var r}async submitRequiredInfo(){if("submit-required-info"===this.pendingAction)return;const e=this.requireInteractionId(),t=this.requiredInfoSource,r=t?.id?.trim();if(e&&t&&r)if(this.requiredInfoValidationAttempted=!0,EC(t).some((e,t)=>Boolean(this.requiredInfoValidationError(e,t))))this.requiredInfoSubmitError=void 0;else if(this.canSubmitRequiredInfo()){this.pendingAction="submit-required-info",this.requiredInfoSubmitError=void 0;try{const n=EC(t),i=this.providedRequiredInfoEntries(n,!0),o=this.providedRequiredInfoEntries(n,!1);let a=t;i.length>0?(await this.uploadRequiredInfoEntries(e,r,i),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,r)),this.emitSdkEvent(tj,a),PC(a)&&o.length>0&&(await this.uploadRequiredInfoEntries(e,r,o),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,r)),this.emitSdkEvent(tj,a))):(await this.uploadRequiredInfoEntries(e,r,o),a=this.sourceWithVerificationResponse(a,await this.verifyRequiredInfoStep2(e,r)),this.emitSdkEvent(tj,a));const s=bC({...this.interactionResponse??{interactionId:e},selectedSource:this.interactionResponse?.selectedSource,status:uj},a);if(this.setInteractionResponseFromSdk(s),"VERIFIED"===a.verificationInfo?.status)return this.resetRequiredInfo(),this.pendingAction=void 0,this.selectedPaymentSourceId=px(a)?a.id?.trim()||r:void 0,void this.showPaymentSourceList({refresh:!0});if(PC(a))return this.requiredInfoSource=a,this.requiredInfoValues={},this.requiredInfoFileNames={},this.requiredInfoFiles={},void(this.requiredInfoValidationAttempted=!1);this.resetRequiredInfo(),this.savedSourceVerificationSource=a,this.savedSourceVerificationFailed=!1,this.selectedPaymentSourceId=a.id,this.paymentSourceView="list"}catch(e){this.requiredInfoSubmitError=cC(e)||"We could not submit the required information. Please try again."}finally{"submit-required-info"===this.pendingAction&&(this.pendingAction=void 0)}}else this.requiredInfoSubmitError="Add required or optional information before verifying."}providedRequiredInfoEntries(e,t){return e.map((e,t)=>({doc:e,index:t})).filter(({doc:e,index:r})=>(t?OC(e):!OC(e))&&this.hasRequiredInfoValue(e,r))}hasRequiredInfoValue(e,t){const r=SC(e,t);return AC(e)?((e,t)=>Boolean(e[t]?.trim()))(this.requiredInfoValues,r):((e,t)=>Boolean(e[t]))(this.requiredInfoFiles,r)}async uploadRequiredInfoEntries(e,t,r){for(const{doc:n,index:i}of r){const r=n.docType;if(!r)continue;const o=SC(n,i);if(AC(n)){const n=this.requiredInfoValues[o]?.trim();n&&await this.uploadRequiredInfoField(e,t,r,n);continue}const a=this.requiredInfoFiles[o];a&&await this.uploadRequiredInfoDocument(e,t,r,a)}}async verifyRequiredInfoStep2(e,t){return this.showMinimumVerificationOverlay("submit-required-info"),this.requestCommerceHubJson("/interaction/verify/step2",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t}),credentials:"include"})}sourceWithVerificationResponse(e,t){const{sourceId:r,...n}=t,i=r?.trim();return{...e,id:i||e.id,verificationInfo:{...e.verificationInfo,...n}}}async uploadRequiredInfoField(e,t,r,n){await this.requestCommerceHubJson("/interaction/verify/uploadField",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({docType:r,value:t,docValue:n}),credentials:"include"})}async uploadRequiredInfoDocument(e,t,r,n){const i=new FormData;i.set("file",n),await this.requestCommerceHubJson(`/interaction/doc/upload/${encodeURIComponent(t)}/${encodeURIComponent(r)}`,e,{method:"POST",body:i,credentials:"include"})}async startPayByBankFlow(){if(this.bankLinkLoading)return;const e=this.requireInteractionId();if(!e)return;const t=++this.bankProviderRequestToken;this.bankFlowScreen="provider",this.bankOutcomeSource=void 0,this.bankLinkLoading=!0,this.ensurePayByBankProviderContainer(sj),await this.updateComplete;try{await this.launchPayByBankProvider(e,sj,t)}catch(r){if(!this.isCurrentPayByBankProviderRequest(t,e))return;console.error("CommerceHub Connect Pay by Bank failed",r),this.resetBankFlow(),this.showPaymentSourceList({refresh:!0})}finally{t===this.bankProviderRequestToken&&(this.cancelPayByBankLaunch=void 0,this.bankLinkLoading=!1)}}async startBankAccountFlow(){Dj(this.interactionResponse?.country)?await this.startPayByBankFlow():await this.showManualBankAccountScreen()}isCurrentPayByBankProviderRequest(e,t){return this.isConnected&&e===this.bankProviderRequestToken&&this.interactionResponse?.interactionId===t&&"provider"===this.bankFlowScreen}async launchPayByBankProvider(e,t,r){const n=await this.requestCommerceHubJson("/interaction/source/pbb/session",e,{method:"GET",credentials:"include"});if(!this.isCurrentPayByBankProviderRequest(r,e))return;const{aggregatorSessionId:i,accessToken:o,pToken:a,publicKey:s}=fC(n),c=Oj(this.designConfig?.payByBank);if(await HC(c.paymentSdkUrl),!this.isCurrentPayByBankProviderRequest(r,e))return;const d=window.PaymentSDK;if(!d?.init)throw new Error("PaymentSDK.js loaded but PaymentSDK.init is not available on window.");await new Promise((n,u)=>{let l=!1;this.cancelPayByBankLaunch=()=>{l=!0,n()},WC(),d.init({apiKey:c.apiKey,accessToken:o,configId:c.configId,environment:c.environment,locale:c.locale,appearance:Ij(this.designConfig),publicKey:s,pToken:a,aggregatorSessionId:i,containerId:t,onEvent:async t=>{if(!l&&mC(t)&&this.isCurrentPayByBankProviderRequest(r,e)){if(l=!0,this.bankLinkLoading=!0,WC(),"success"!==t.type)return this.resetBankFlow(),this.showPaymentSourceList({refresh:!0}),void n();try{const t=await this.finalizePayByBankSession(e,i,a);if(!this.isCurrentPayByBankProviderRequest(r,e))return void n();const o=gj(t),s=o.id?.trim();if(!s)throw new Error("Connect your bank completed but the resolved bank payment source did not include an id.");const c=this.interactionResponseWithAddedSource(e,o);this.setInteractionResponseFromSdk(c),this.emitSdkEvent(ej,o);const d=await this.refreshInteractionAfterMutation(e);if(!this.isCurrentPayByBankProviderRequest(r,e))return void n();const u=this.findPaymentSourceInInteraction(d,s)??o;this.resetBankFlow(),this.showAddedPaymentSourceStatus(u),n()}catch(t){if(!this.isCurrentPayByBankProviderRequest(r,e))return void n();u(t)}}}}),!l&&this.isCurrentPayByBankProviderRequest(r,e)&&(this.bankLinkLoading=!1)})}async refreshPaymentSourcesFromInteraction(){await this.interactionRefresh.refreshFromInteraction(this.interactionRefreshOptions())}queueNativeAccountBalanceRefresh(){this.nativeBalance.queueRefresh(()=>this.interactionResponse,e=>this.fetchNativeAccountBalances(e))}async fetchNativeAccountBalances(e){return(await this.createSdkClient(e).GET("/interaction/source/native/balances")).data??{}}async fetchInteraction(e){return this.interactionRefresh.fetch(e,this.interactionRefreshOptions())}async retryInteractionRefresh(){const e=this.interactionResponse?.interactionId;if(e)try{await this.fetchInteraction(e)}catch(e){}}interactionRefreshOptions(){return{getCurrentInteractionResponse:()=>this.interactionResponse,getSelectedPaymentSourceId:()=>this.interactionResponse?.selectedSource?.id,requestInteraction:e=>this.createSdkClient(e).GET("/interaction").then(e=>sC(e)),mergeInteractionResponse:aC,setInteractionResponse:e=>this.setInteractionResponseFromSdk(e),emitListPaymentMethods:e=>this.emitSdkEvent(nj,e)}}syncBillingAddressesFromInteractionResponse(e){if(!e.billerAddress)return;this.billingAddresses=e.billerAddress.filter(e=>Boolean(e.id?.trim())),this.cardDraft=((e,t)=>{const r=t.map(e=>e.id?.trim()).filter(e=>Boolean(e));if(!r.length)return{...e,billingAddressValue:Tw};if(r.includes(e.billingAddressValue))return e;const n=[e.country,e.addressLine1,e.addressLine2,e.city,e.state,e.zip].some(e=>e.trim());return e.billingAddressValue===Tw&&n?e:{...e,billingAddressValue:r[0]}})(this.cardDraft,this.billingAddresses),this.billingAddressSelectorExpanded=this.cardDraft.billingAddressValue===Tw,this.reconcileBankBillingAddressSelection();const t=this.bankAccountInstrumentSchemas.find(e=>e.bavSupportedCode===this.selectedBankAccountInstrumentSchemaCode);t&&"instrument-schema"===this.manualBankAccountFormMode&&this.configureManualBankAccountForm(t,!1)}async finalizePayByBankSession(e,t,r){return this.requestCommerceHubJson(`/interaction/source/pbb/session/${encodeURIComponent(t)}/${encodeURIComponent(r)}`,e,{method:"PUT",credentials:"include"})}async verifyPaymentSourceStep1(e,t){this.showMinimumVerificationOverlay("verify-payment-source");const r=await this.requestCommerceHubJson("/interaction/verify/step1",e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({value:t.id}),credentials:"include"});return this.sourceWithVerificationResponse(t,r)}async requestCommerceHubJson(e,t,r){const n=this.createInteractionHeaders(t,r.headers);n.has("Accept")||n.set("Accept","application/json");const i=new Request(`${yw(this.baseURL)}${e}`,{...r,headers:n}),o=await fetch(i),a=await(async e=>{if(204===e.status)return;const t=await e.text();return""!==t.trim()?(e=>{const t=e.split(";",1)[0].trim().toLowerCase();return"application/json"===t||t.endsWith("+json")})(e.headers.get("content-type")??"")?JSON.parse(t):t:void 0})(o);if(!o.ok)throw new Error(cC(a)||o.statusText);return a}async fetchManualBankAccountCountryConfig(e,t){return this.requestCommerceHubJson("/party/configuration-inquiry",e,{method:"POST",headers:{"Client-Id":dC(),"Content-Type":"application/json","User-Id":dC()},body:JSON.stringify({configurationType:"COUNTRY_TENDER",country:t}),credentials:"include"})}resetBankFlow(){this.bankAccountConfigRequestToken+=1,this.cancelPayByBankProvider(),this.bankFlowScreen=void 0,this.bankOutcomeSource=void 0,this.bankLinkLoading=!1,this.bankAccountInstrumentSchemas=[],this.selectedBankAccountInstrumentSchemaCode=void 0,this.selectedBankCurrencyCode="",this.selectedBankAccountType="",this.selectedBankPaymentType="",this.bankBillingAddressValue="",this.bankBillingAddressSelectorExpanded=!1,this.clearManualBankAccountForm(),this.bankAccountConfigError=void 0,this.removePayByBankProviderContainer()}cancelPayByBankProvider(){this.bankProviderRequestToken+=1,this.cancelPayByBankLaunch?.(),this.cancelPayByBankLaunch=void 0,WC()}resetCardFlow(){this.cardFlowScreen=void 0,this.cardDraft=Mw(),this.cardDraftErrors={},this.cardValidationAttempted=!1,this.cardEncryption={cardNumber:{status:"idle",normalizedValue:""},cvv:{status:"idle",normalizedValue:""}},this.cardSubmitError=void 0,this.billingAddressSelectorExpanded=!1}resetTransferFlow(){this.transferFlowActive=!1,this.transferFlowScreen="form",this.transferDraft={fromSourceId:"",toSourceId:"",amount:""},this.transferDraftErrors={},this.transferValidationAttempted=!1,this.transferSubmitError=void 0,this.transferSubmitSuccess=!1}ensurePayByBankProviderContainer(e){const t=[...this.children].find(t=>t instanceof HTMLElement&&t.id===e),r=t??document.createElement("div");return r.id=e,r.slot=e,r.className="provider-frame-container",r.replaceChildren(),t||this.appendChild(r),r}removePayByBankProviderContainer(){[...this.children].filter(e=>e instanceof HTMLElement&&e.id===sj).forEach(e=>e.remove())}requireInteractionId(){const e=this.interactionResponse?.interactionId;if(e)return e}createSdkClient(e){return ww({baseURL:this.baseURL,getHeaders:()=>this.createInteractionHeaders(e)})}createInteractionHeaders(e,t){const r=new Headers(t),n=this.interactionResponse?.oauth?.access_token?.trim();return r.set("x-interaction-id",e),n&&!r.has("Authorization")&&r.set("Authorization",`Bearer ${n}`),r}createSourceCreateHeaders(e,t,r){const n=this.createInteractionHeaders(e,r);return n.set("Api-Key",t.clientId),n.set("Auth-Token-Type",t.tokenType),n.set("x-key-id",t.keyId),n}requireSourceCreateContext(){const e=this.interactionResponse?.publicKey?.trim(),t=this.interactionResponse?.keyId?.trim(),r=this.interactionResponse?.oauth,n=r?.client_id?.trim(),i=r?.token_type?.trim(),o=r?.access_token?.trim();if(!(e&&t&&n&&i&&o))throw new Error("Payment source encryption is not configured. Try again later.");return{publicKey:e,keyId:t,clientId:n,tokenType:i,accessToken:o}}setInteractionResponseFromSdk(e){this.interactionResponse=this.interactionResponseWithPreservedGatewayOAuth(e)}interactionResponseWithPreservedGatewayOAuth(e){if(e.oauth&&e.features)return e;const t=this.interactionResponse;return!t||t.interactionId&&e.interactionId&&t.interactionId!==e.interactionId?e:{...e,oauth:e.oauth??t.oauth,features:e.features??t.features}}syncDesignConfigStyles(){for(const e of Mj)this.style.removeProperty(e);const e=this.designConfig?.colors;if(e)for(const{field:t,property:r}of Nj){const n=e[t];n&&this.style.setProperty(r,n)}const t=this.designConfig?.baseFontSize;t?this.style.fontSize=t:this.style.removeProperty("font-size");const r=this.designConfig?.baseFontWeight?.trim();r?this.style.setProperty(Rj,r):this.style.removeProperty(Rj);const n=this.designConfig?.shellPadding?.trim();n?this.style.setProperty(Tj,n):this.style.removeProperty(Tj)}};mj.styles=wx,Qx([iw({attribute:!1})],mj.prototype,"interactionResponse",void 0),Qx([iw({attribute:!1})],mj.prototype,"designConfig",void 0),Qx([iw({attribute:"base-url"})],mj.prototype,"baseURL",void 0),Qx([ow()],mj.prototype,"selectedPaymentSourceId",void 0),Qx([ow()],mj.prototype,"otpValue",void 0),Qx([ow()],mj.prototype,"pendingAction",void 0),Qx([ow()],mj.prototype,"minimumVerificationOverlayAction",void 0),Qx([ow()],mj.prototype,"otpErrorMessage",void 0),Qx([ow()],mj.prototype,"bankFlowScreen",void 0),Qx([ow()],mj.prototype,"bankLinkLoading",void 0),Qx([ow(),ow()],mj.prototype,"bankOutcomeSource",void 0),Qx([ow()],mj.prototype,"bankAccountInstrumentSchemas",void 0),Qx([ow()],mj.prototype,"manualBankAccountFormMode",void 0),Qx([ow()],mj.prototype,"selectedBankAccountInstrumentSchemaCode",void 0),Qx([ow()],mj.prototype,"selectedBankCurrencyCode",void 0),Qx([ow()],mj.prototype,"selectedBankAccountType",void 0),Qx([ow()],mj.prototype,"selectedBankPaymentType",void 0),Qx([ow()],mj.prototype,"bankAccountFormSchema",void 0),Qx([ow()],mj.prototype,"bankAccountFormUiSchema",void 0),Qx([ow()],mj.prototype,"bankAccountFormData",void 0),Qx([ow()],mj.prototype,"bankAccountFormValid",void 0),Qx([ow()],mj.prototype,"bankAccountValidationAttempted",void 0),Qx([ow()],mj.prototype,"bankBillingAddressValue",void 0),Qx([ow()],mj.prototype,"bankBillingAddressSelectorExpanded",void 0),Qx([ow()],mj.prototype,"bankAccountSubmitError",void 0),Qx([ow()],mj.prototype,"legacyBankAccountDraft",void 0),Qx([ow()],mj.prototype,"legacyBankAccountDraftErrors",void 0),Qx([ow()],mj.prototype,"legacyBankAccountEncryption",void 0),Qx([ow()],mj.prototype,"bankAccountConfigError",void 0),Qx([ow()],mj.prototype,"transferDraft",void 0),Qx([ow()],mj.prototype,"transferDraftErrors",void 0),Qx([ow()],mj.prototype,"transferValidationAttempted",void 0),Qx([ow()],mj.prototype,"transferSubmitError",void 0),Qx([ow()],mj.prototype,"transferSubmitSuccess",void 0),Qx([ow()],mj.prototype,"transferFlowActive",void 0),Qx([ow()],mj.prototype,"transferFlowScreen",void 0),Qx([ow(),ow()],mj.prototype,"cardFlowScreen",void 0),Qx([ow()],mj.prototype,"cardDraft",void 0),Qx([ow()],mj.prototype,"cardDraftErrors",void 0),Qx([ow()],mj.prototype,"cardValidationAttempted",void 0),Qx([ow()],mj.prototype,"cardEncryption",void 0),Qx([ow()],mj.prototype,"revealedCardFields",void 0),Qx([ow()],mj.prototype,"cardFieldsRevealingLastChar",void 0),Qx([ow()],mj.prototype,"cardSubmitError",void 0),Qx([ow()],mj.prototype,"billingAddresses",void 0),Qx([ow()],mj.prototype,"billingAddressSelectorExpanded",void 0),Qx([ow()],mj.prototype,"paymentSourceView",void 0),Qx([ow()],mj.prototype,"openPaymentSourceMenuId",void 0),Qx([ow()],mj.prototype,"paymentSourceMenuPlacement",void 0),Qx([ow()],mj.prototype,"addLauncherActive",void 0),Qx([ow()],mj.prototype,"attachmentError",void 0),Qx([ow()],mj.prototype,"deleteConfirmationPaymentSourceId",void 0),Qx([ow()],mj.prototype,"savedSourceVerificationSource",void 0),Qx([ow()],mj.prototype,"savedSourceVerificationFailed",void 0),Qx([ow()],mj.prototype,"requiredInfoSource",void 0),Qx([ow()],mj.prototype,"requiredInfoValues",void 0),Qx([ow()],mj.prototype,"requiredInfoFileNames",void 0),Qx([ow()],mj.prototype,"requiredInfoSubmitError",void 0),Qx([ow()],mj.prototype,"requiredInfoValidationAttempted",void 0),mj=Qx([tw("commerce-hub-connect")],mj);const pj=e=>e.composedPath().find(e=>e instanceof HTMLInputElement&&e.classList.contains("required-info-ssn-input")),vj=e=>{const t=[e.stateOrProvince,e.postalCode].filter(Boolean).join(" "),r=[e.city,t].filter(Boolean).join(", ");return[e.street,r].filter(Boolean).join(", ")||e.id||"Saved billing address"},bj=(e,t)=>{const r=Pw(t??"").slice(-4);return{...e,tenderType:"Card",card:{...e.card,...r?{cardNumber:r}:{}}}},gj=e=>({id:kj(e,"Connect your bank completed but the verification response did not include a source id."),tenderType:"BankAccount",verificationInfo:jj(e),bankAccount:{}}),yj=(e,t)=>{const r=e[t];return"string"==typeof r&&r.trim()?r.trim():void 0},wj=e=>{const t=yj(e,"bankName"),r=yj(e,"bankAccountType"),n=yj(e,"accountNumber")??yj(e,"interacAccount"),i=(e=>{const t=/-([BP])$/u.exec(e.trim())?.[1];if("B"===t)return"BUSINESS";if("P"===t)return"PERSONAL";throw new Error("The selected instrument schema does not identify a business or personal account.")})(e.bavSupportedCode);return{id:e.id,name:e.name,tenderType:"BankAccount",accountHolderType:i,bankAccount:{...t?{bankName:t}:{},...r?{accountType:r}:{},...n?{accountNumber:lC(n)}:{},asset:{type:"CURRENCY",id:e.currencyCode},country:e.countryCode}}},$j=(e,t)=>{const r=d$(t??"").slice(-4);return{...e,tenderType:"BankAccount",bankAccount:{...e.bankAccount,...r?{accountNumber:r}:{}}}},kj=(e,t)=>{const r=e.sourceId?.trim();if(!r)throw new Error(t);return r},xj=e=>{if("object"!=typeof e||null===e||Array.isArray(e))return;const t=e;return t.sourceId?.trim()?t:void 0},jj=e=>{const{sourceId:t,...r}=e;return r},Cj=e=>{const t=e?.email?.trim();if(t)return t;const r=e?.phone?.countryCode?.trim(),n=e?.phone?.phoneNumber?.trim();return[r,n].filter(Boolean).join(" ")||void 0},Ej=e=>{const t=e?.copy?.otp;return{title:t?.title??"Enter verification code",subtitle:t?.subtitle,failedMessage:t?.failedMessage??"The code does not match. Try again.",resendPrefix:t?.resendPrefix??"Didn't receive the code?",resendButton:t?.resendButton??"Resend code",resendPendingButton:t?.resendPendingButton??"Sending code...",verifyButton:t?.verifyButton??"Verify",verifyingButton:t?.verifyingButton??"Verifying...",tryAgainButton:t?.tryAgainButton??"Try again"}},Sj=e=>{const t=e?.copy?.paymentMethods;return{title:t?.title??"Payment methods",subtitle:t?.subtitle??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??"",continueButton:t?.continueButton??"Use selected method",continuingButton:t?.continuingButton??"Saving..."}},Aj=e=>{const t=e?.copy?.noSavedPaymentMethods;return{title:t?.title??"Payment methods",subtitle:t?.subtitle??"",emptyTitle:t?.emptyTitle??"",emptyMessage:t?.emptyMessage??"",addBankAccountTitle:t?.addBankAccountTitle??"Add bank account",addBankAccountSubtitle:t?.addBankAccountSubtitle??"Connect or enter an account",addCardTitle:t?.addCardTitle??"Add credit or debit card",addCardSubtitle:t?.addCardSubtitle??"Add your card details"}},Oj=e=>{const t=Object.fromEntries(Object.entries(e??{}).filter(([,e])=>void 0!==e));return{...fj,...t}},Ij=e=>{const t=e?.colors,r={};return zj(r,"backgroundColor",_j(t?.widgetBackground,t?.surface)),zj(r,"primaryColor",t?.primary),zj(r,"buttonColor",t?.primary),zj(r,"primaryTextColor",t?.text),zj(r,"secondaryTextColor",_j(t?.copy,t?.muted)),zj(r,"dangerColor",t?.danger),zj(r,"successColor",t?.success),zj(r,"borderColor",_j(t?.border,t?.widgetBorder,t?.borderBackground)),zj(r,"placeholderColor",t?.placeholder),{branding:r}},_j=(...e)=>e.map(e=>e?.trim()).find(e=>Boolean(e)),zj=(e,t,r)=>{const n=r?.trim();n&&(e[t]=n)},Nj=[{field:"primary",property:"--chc-primary"},{field:"text",property:"--chc-text"},{field:"copy",property:"--chc-copy"},{field:"muted",property:"--chc-muted"},{field:"placeholder",property:"--chc-placeholder"},{field:"surface",property:"--chc-surface"},{field:"widgetBackground",property:"--chc-widget-background"},{field:"borderBackground",property:"--chc-border"},{field:"widgetBorder",property:"--chc-border"},{field:"softSurface",property:"--chc-soft-surface"},{field:"paymentSelectionBackground",property:"--chc-payment-method-background"},{field:"paymentMethodBackground",property:"--chc-payment-method-background"},{field:"border",property:"--chc-border"},{field:"borderStrong",property:"--chc-border-strong"},{field:"success",property:"--chc-success"},{field:"successBackground",property:"--chc-success-bg"},{field:"successBorder",property:"--chc-success-border"},{field:"danger",property:"--chc-danger"},{field:"dangerBackground",property:"--chc-danger-bg"},{field:"dangerBorder",property:"--chc-danger-border"},{field:"warning",property:"--chc-warning"},{field:"warningBackground",property:"--chc-warning-bg"},{field:"warningBorder",property:"--chc-warning-border"},{field:"disabledText",property:"--chc-disabled-text"},{field:"disabledSurface",property:"--chc-disabled-surface"}],Rj="--chc-font-weight",Tj="--chc-shell-padding",Mj=[...Nj.map(({property:e})=>e),Rj,Tj],Lj=(e,t={})=>{const r=rC(e),n=r?.paymentSources;if(!n?.length){const e=eC(r);return e?[Bj(e,{...t,selected:!0,isDefault:"PAYMENT_SOURCE_ATTACHED"===r?.status})]:[]}const i="PAYMENT_SOURCE_ATTACHED"===r?.status?r.selectedSource?.id:void 0;return n.map(e=>Bj(e,{...t,isDefault:Boolean(i&&e.id===i)}))},Pj=e=>{const t=e?.allowedTenderTypes;return t?{card:t.includes("CARD"),bankAccount:t.includes("BANK_ACCOUNT"),nativeAccount:t.includes("NATIVE_ACCOUNT")}:{card:!0,bankAccount:!0,nativeAccount:!0}},Dj=e=>{const t=e?.trim().toUpperCase();return"US"===t||"USA"===t},Bj=(e,{selected:t=!1,isDefault:r=!1,nativeBalances:n={},nativeBalanceLoadingSourceIds:i=[]}={})=>{const o=Wj(e),a=VC(e)?Yj(e,n):void 0,s=void 0===a?.balance?void 0:Zj(a.balance);return{id:o,label:qj(e,{selected:t}),type:Kj(e),brand:Fj(e),accountLabel:Uj(e),balanceLabel:s,balanceLoading:VC(e)&&i.includes(o),last4:Hj(e),status:hC(e.verificationInfo?.status),showVerificationStatus:Boolean(e.verificationInfo?.status),verificationLabel:vx(e),selectionEligible:px(e),isDefault:r}},qj=(e,{selected:t=!1}={})=>{if(qC(e))return t?e.name?.trim()||e.card?.nameOnCard?.trim()||Vj(e):e.card?.nameOnCard?.trim()||e.name?.trim()||Vj(e);if(BC(e)){const t=e.bankAccount?.bankName?.trim();return t||e.name?.trim()||Vj(e)}return VC(e)?e.account?.nickName?.trim()||e.name?.trim()||Vj(e):e.name?.trim()||Vj(e)},Vj=e=>qC(e)?"Saved card":BC(e)?e.bankAccount?.bankName?.trim()||"Saved bank account":VC(e)?"Native account":"Dynamic session card",Fj=e=>qC(e)?e.card?.network??"Card":BC(e)?e.bankAccount?.bankName?.trim()||"Bank account":VC(e)?e.account?.productType??"Native account":"DSC",Uj=e=>{const t=Hj(e);if(qC(e))return`${e.card?.network?.trim()||"Card"} xx ${t}`;if(BC(e))return`${e.bankAccount?.accountType?.trim()||"Bank account"} xx ${t}`;if(VC(e)){const r=e.account?.productType?.trim();return`${r||"Native account"} xx ${t}`}return`Card xx ${t}`},Hj=e=>qC(e)?lC(e.card?.cardNumber):BC(e)?lC(e.bankAccount?.accountNumber):VC(e)?lC(e.account?.positionId??e.account?.token):lC(e.id),Wj=e=>e.id?.trim()||e.name?.trim()||e.tenderType,Kj=e=>BC(e)?"bank":VC(e)?"native":"card",Gj=e=>(rC(e)?.paymentSources??[]).filter(e=>(BC(e)||VC(e))&&"VERIFIED"===e.verificationInfo?.status&&Boolean(Wj(e))),Yj=(e,t)=>{for(const r of Jj(e)){const e=t[r];if(e)return e}},Jj=e=>[e.id,e.account?.positionId,e.account?.token].map(e=>e?.trim()).filter(e=>Boolean(e)),Zj=e=>Qj.format(e),Qj=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}),Xj=(e,t)=>{const r=rC(e),n=r?.paymentSources;if(!n?.length)return;const i=n.filter(px);if(t&&i.some(e=>e.id===t))return t;const o=r?.selectedSource?.id;return o&&i.some(e=>e.id===o)?o:i[0]?.id},eC=(e,t)=>{const r=rC(e);if(t){const e=r?.paymentSources?.find(e=>e.id===t);if(e)return e}return r?.selectedSource},tC=["VERIFIED","REQUIRE_INFO","NOT_VERIFIED"],rC=e=>{const t=(()=>{if("undefined"==typeof window)return"off";if("localhost"!==(e=window.location.hostname)&&"127.0.0.1"!==e&&"::1"!==e)return"off";var e;const t=new URLSearchParams(window.location.search),r=t.get("chc_local_non_verified_testing")?.trim().toLowerCase();return"show-all"===r||"mixed"===r?"show-all":"all"===r?"all":"1"===r||"true"===r?"single":"off"})();if(!e||"off"===t)return e;const r=e.paymentSources??[],n=new Set;let i=0;const o=r.map(e=>{if("VERIFIED"!==e.verificationInfo?.status)return e;if("single"===t&&n.size>0)return e;const r="show-all"===t?tC[i%tC.length]:"UNDER_REVIEW";return i+=1,"VERIFIED"===r?e:(n.add(Wj(e)),{...e,verificationInfo:{...e.verificationInfo,status:r}})});if(0===n.size)return e;const a=e.selectedSource&&n.has(Wj(e.selectedSource))?{...e.selectedSource,verificationInfo:{...e.selectedSource.verificationInfo,status:"UNDER_REVIEW"}}:e.selectedSource;return{...e,paymentSources:o,selectedSource:a}},nC=e=>e===uj||"PAYMENT_SOURCE_REQUESTED"===e,iC=(e,t)=>Boolean(e?.features?.includes(t)),oC=e=>Boolean(iC(e,"TRANSFER")&&!iC(e,"ADD_ACCOUNT")&&!iC(e,"SELECT")),aC=(e,t,r)=>{const n={...e,...t},i=void 0!==t.paymentSources,o=i?t.paymentSources??[]:e.paymentSources??[],a=((e,t)=>{if(t){const r=e.find(e=>e.id===t);if(r)return r}})(o,r??t.selectedSource?.id)??t.selectedSource??(i?void 0:e.selectedSource);return{...n,selectedSource:a,paymentSources:o}},sC=e=>{if(e.data)return e.data;throw new Error(cC(e.error))},cC=e=>"string"==typeof e?e:e&&"object"==typeof e&&"message"in e&&"string"==typeof e.message&&e.message.trim()?e.message:"CommerceHub API request failed.",dC=()=>{if(globalThis.crypto?.randomUUID)return globalThis.crypto.randomUUID();const e=new Uint8Array(16);globalThis.crypto?.getRandomValues(e),e[6]=15&e[6]|64,e[8]=63&e[8]|128;const t=[...e].map(e=>e.toString(16).padStart(2,"0"));return`${t.slice(0,4).join("")}-${t.slice(4,6).join("")}-${t.slice(6,8).join("")}-${t.slice(8,10).join("")}-${t.slice(10,16).join("")}`},uC=(e,t)=>{const r=e.composedPath().find(e=>e instanceof HTMLElement&&Boolean(e.dataset[t]));return r?.dataset[t]},lC=e=>e&&e.length>=4?e.slice(-4):"----",hC=e=>"VERIFIED"===e?"verified":"UNDER_REVIEW"===e?"under-review":"REQUIRE_INFO"===e?"require-info":"DECLINED"===e?"declined":"not-verified",fC=e=>{const t=e.aggregatorSessionId?.trim(),r=e.tokenID?.trim()||e.accessToken?.trim(),n=e.pToken?.trim(),i=e.publicKey?.trim();if(!(t&&r&&n&&i))throw new Error("The /interaction/source/pbb/session response is missing one or more required values.");return{aggregatorSessionId:t,accessToken:r,pToken:n,publicKey:i}},mC=e=>"success"===e.type||"cancel"===e.type||"failure"===e.type||"error"===e.type,pC=e=>e.startsWith("back-to-")||"change-payment-source"===e,vC=(e,t)=>{const r=gC(e.paymentSources??[],t);return{...e,selectedSource:t,paymentSources:r}},bC=(e,t)=>({...e,paymentSources:gC(e.paymentSources??[],t)}),gC=(e,t)=>e.some(e=>e.id===t.id)?e.map(e=>e.id===t.id?t:e):[t,...e],yC=e=>px(e),wC=({title:e,helper:t})=>Ty`
...
`,$C=e=>"verify-payment-source"===e?wC({title:"Verifying payment method",helper:"Verifying your payment method, please wait."}):"submit-required-info"===e?wC({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,kC=e=>"verify-payment-source"===e?$C(e):"delete-payment-source"===e?wC({title:"Deleting payment method",helper:"Deleting your payment method, please wait."}):"attach-payment-source"===e?wC({title:"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,xC=e=>{switch(e){case"attach-payment-source":return"Saving the selected payment method.";case"verify-payment-source":case"submit-required-info":return"Verifying the payment method.";case"delete-payment-source":return"Deleting the payment method.";case"verify-otp":return"Verifying the code.";case"resend-otp":return"Sending a new code.";case"save-card":return"Saving the card.";case"save-bank-account":return"Saving the bank account.";case"transfer":return"Submitting the transfer.";default:return""}},jC=e=>{const t=e?.verificationInfo?.status;return"VERIFIED"===t?{kind:"verified",variant:"success",title:"Bank account verified",message:"Your bank account is connected and ready to use."}:"UNDER_REVIEW"===t?{kind:"pending",variant:"warning",title:"Bank account pending review",message:"We will update this bank account after review is complete."}:"REQUIRE_INFO"===t?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:"Additional information is required before this bank account can be verified."}:"DECLINED"===t?{kind:"declined",variant:"danger",title:"Bank account verification failed",message:"This bank account could not be verified."}:{kind:"failed",variant:"danger",title:"Bank account not verified",message:"This bank account is not verified yet."}},CC=(e,t=!1)=>{const r=DC(e),n=r.toLowerCase(),i=e?.verificationInfo?.status;return t?{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} not verified`,message:`We could not verify this ${n} right now.`}:"VERIFIED"===i?{kind:"verified",variant:"success",title:"Bank account"===r?"Bank account verified":`${r} saved`,message:`This ${n} is verified and ready to use.`}:"UNDER_REVIEW"===i?{kind:"pending",variant:"warning",title:"Bank account"===r?"Bank account pending review":"Verification pending review",message:`We will update this ${n} after review is complete.`}:"REQUIRE_INFO"===i?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:`Additional information is required before this ${n} can be verified.`}:"DECLINED"===i?{kind:"declined",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} declined`,message:`This ${n} could not be verified.`}:{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account not verified":`${r} not verified`,message:`This ${n} is not verified yet.`}},EC=e=>{const t=e?.verificationInfo?.docs??[];return t.length>0?t:[{}]},SC=(e,t=0)=>`${e?.docType??"DOCUMENT"}-${t}`,AC=e=>"DRIVER_LICENSE_NUMBER"===e.docType||"SOCIAL_SECURITY_NUMBER"===e.docType,OC=e=>!1!==e.mandatory,IC=e=>OC(e)?"required":"optional",_C=e=>Ty`
  <span
    class="required-info-requirement-badge required-info-requirement-badge-${IC(e)}"
  >
    ${(e=>OC(e)?"Required":"Optional")(e)}
  </span>
`,zC=e=>{const t=e.findIndex(e=>!AC(e));return t>=0?SC(e[t],t):void 0},NC=({doc:e,key:t,value:r,error:n})=>{if("SOCIAL_SECURITY_NUMBER"===e.docType)return RC({doc:e,key:t,value:r,error:n});const i=`required-info-${t}`,o=`${i}-error`;return Ty`
    <div
  ...
  `},RC=({doc:e,key:t,value:r,error:n})=>{const i=TC(e),o=(e=>{const t=ex(e);return[t.slice(0,3),t.slice(3,5),t.slice(5,9)]})(r),a=`required-info-${t}-ssn-0`,s=`required-info-${t}-error`;return Ty`
    <div
  ...
  `},TC=e=>"BANK_STATEMENT"===e.docType?"Bank statement":"BANK_LETTER"===e.docType?"Bank letter":"BANK_CHECK"===e.docType?"Bank check":"DRIVER_LICENSE_PHOTO"===e.docType?"Driver license photo":"DRIVER_LICENSE_NUMBER"===e.docType?"Driver license number":"SOCIAL_SECURITY_NUMBER"===e.docType?"Social Security number":"Required document",MC=e=>{const t=TC(e);return"SOCIAL_SECURITY_NUMBER"===e.docType?"Enter a Social Security number.":AC(e)?`Enter a ${t.toLowerCase()}.`:`Choose a ${t.toLowerCase()}.`},LC=e=>{const t=(e=>({type:Kj(e),brand:Fj(e)}))(e),r=dx(t),n=(e=>{if(!qC(e))return;const t=e.card?.expirationMonth?.trim(),r=e.card?.expirationYear?.trim();if(!t||!r)return;return`${t.padStart(2,"0")}/${r.slice(-2)}`})(e);return Ty`
    <div
      ...
      <div class="required-info-card-top">
        <div class="required-info-card-heading">
          <span class="required-info-card-label"
            >${(e=>BC(e)?"Bank account":qC(e)?"Card":VC(e)?"Native account":"Dynamic session card")(e)}</span
          >
          <span
            class="required-info-card-field required-info-card-name"
            data-required-info-card-field="name"
            >${(e=>{if(qC(e))return e.card?.nameOnCard?.trim()||e.name?.trim()||Vj(e);if(BC(e)){const t=e.bankAccount?.bankName?.trim();return t||e.name?.trim()||Vj(e)}return VC(e)?e.account?.nickName?.trim()||e.name?.trim()||Vj(e):e.name?.trim()||Vj(e)})(e)}</span
          >
        </div>
      ...
      <div class="required-info-card-bottom">
        <div class="required-info-card-detail">
          ...
          <span class="required-info-card-status">
            ${xx(hC(e.verificationInfo?.status))}
          </span>
        </div>
        ${n?Ty`
              <div class="required-info-card-detail">
  ...
  `},PC=e=>"REQUIRE_INFO"===e.verificationInfo?.status,DC=e=>e&&BC(e)?"Bank account":e&&VC(e)?"Native account":"Payment method",BC=e=>"BankAccount"===e.tenderType||"BANK_ACCOUNT"===e.tenderType,qC=e=>"Card"===e.tenderType||"CARD"===e.tenderType,VC=e=>"NativeAccount"===e.tenderType||"NATIVE_ACCOUNT"===e.tenderType;let FC,UC;const HC=async e=>{if(!window.PaymentSDK?.init)if(FC&&UC===e)await FC;else if(UC=e,FC=new Promise((t,r)=>{const n=document.querySelector(`script[data-commerce-hub-pay-by-bank-sdk="true"][src="${e}"]`),i=n??document.createElement("script"),o=()=>{i.removeEventListener("load",a),i.removeEventListener("error",s)},a=()=>{o(),t()},s=()=>{o(),FC=void 0,UC=void 0,r(new Error(`Unable to load Connect your bank script: ${e}`))};i.addEventListener("load",a,{once:!0}),i.addEventListener("error",s,{once:!0}),n||(i.src=e,i.async=!0,i.dataset.commerceHubPayByBankSdk="true",document.head.appendChild(i))}),await FC,!window.PaymentSDK?.init)throw new Error(`Connect your bank script loaded but window.PaymentSDK.init is unavailable: ${e}`)},WC=()=>{try{window.PaymentSDK?.destroy?.()}catch{}};export{gw as COMMERCE_HUB_BASE_URLS,mj as CommerceHubConnect,bw as DEFAULT_COMMERCE_HUB_BASE_URL,ej as ON_ADD_PAYMENT_METHOD_EVENT,rj as ON_DELETE_PAYMENT_METHOD_EVENT,oj as ON_ERROR_EVENT,aj as ON_EVENT_EVENT,nj as ON_LIST_PAYMENT_METHODS_EVENT,Xx as ON_SELECT_EVENT,ij as ON_TRANSFER_EVENT,tj as ON_VERIFY_PAYMENT_METHOD_EVENT,ww as createCommerceHubClient,kw as createCommerceHubConfigClient,$w as createCommerceHubMerchantClient,yw as resolveCommerceHubBaseURL};

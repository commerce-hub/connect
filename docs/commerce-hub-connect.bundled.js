...
`,xx=({methods:e,allowedTenderOptions:t,canAddPaymentSources:r,canSelectPaymentSources:n,editing:i,actionPending:o,selectedPaymentSourceId:a,deleteConfirmationPaymentSourceId:s,copy:c,showTransferAction:u=!1})=>{const d=r&&(t.card||t.bankAccount);return Ry`
  ...
  `},jx=({allowedTenderOptions:e,canAddPaymentSources:t,deletePending:r=!1,copy:n,showTransferAction:i=!1})=>{const o=Boolean(n.emptyTitle||n.emptyMessage),a=t&&(e.card||e.bankAccount);return Ry`
    <div class="payment-flow">
        ...
        <div class="required-info-flow">
          ...
          <div class="required-info-documents">
            ...
            <div class="primitive-stack">
              ${t.map((e,t)=>{const r=Jj(e,t),i=Yj(e)?this.requiredInfoValues[r]:this.requiredInfoFileNames[r];return Yj(e)?tE({doc:e,key:r,value:i??""}):Ry`
                  <div
                    class="required-info-document required-document-text-row"
                    data-required-info-doc-key=${r}
                    data-required-info-requirement=${Qj(e)}
                  >
...
`)({label:"Required document",requirements:nE(e),actionLabel:"Choose file",fileName:i,action:"open-required-info-file-picker",disabled:n})}
                  </div>
                `})}
            </div>
          </div>
      ...
      `})}renderNoSavedPaymentMethods(){const e=Qx(this.designConfig),t="delete-payment-source"===this.pendingAction,r=cj(this.interactionResponse),n=Sj(this.interactionResponse,"ADD_ACCOUNT"),i=r.bankAccount&&Cj(this.interactionResponse);return this.renderWidgetShell({title:e.title,subtitle:e.subtitle,showClose:!1,showDivider:!1,content:jx({allowedTenderOptions:r,canAddPaymentSources:n,deletePending:t,copy:e,showTransferAction:i})})}shouldRenderTransferScreen(){const e=this.interactionResponse;return(this.transferFlowActive||Aj(e))&&Ej(e?.status)}renderTransferScreen(){const e=gj(this.interactionResponse),t="transfer"===this.pendingAction,r=this.transferFlowActive?vx({label:"Back",action:"back-to-payment-methods",disabled:t}):void 0;if(e.length<2)return this.renderWidgetShell({title:"Transfer funds",headerAction:r,showClose:!1,showDivider:!1,content:Ry`
          <div class="payment-flow">
            ${cx({title:"Transfer unavailable",message:"At least two verified bank or native accounts are required to transfer funds."})}
          </div>
        `});const n=[{value:"",label:"Select account"},...e.map(e=>({value:vj(e),label:lj(e)}))],i=qk(this.transferDraft),o=e.find(e=>vj(e)===i.fromSourceId),a=e.find(e=>vj(e)===i.toSourceId);return"confirm"===this.transferFlowScreen&&o&&a&&Lk(i,e)?this.renderTransferConfirmationScreen(o,a,i,t):this.renderWidgetShell({title:"Transfer funds",headerAction:r,showClose:!1,showDivider:!1,busy:t,overlay:t?Uj({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ry`
        <div class="payment-flow card-form-screen">
          ...
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
              ${ix({label:t?"Transferring":"Transfer",action:"transfer",loading:t,disabled:t||!Lk(this.transferDraft,e)})}
            </div>
          </div>
        </div>
      `})}renderTransferConfirmationScreen(e,t,r,n){return this.renderWidgetShell({title:"Confirm transfer",headerAction:vx({label:"Back",action:"edit-transfer",disabled:n}),showClose:!1,showDivider:!1,busy:n,overlay:n?Uj({title:"Initiating transfer",helper:"Submitting your transfer, please wait."}):void 0,content:Ry`
        <div class="payment-flow card-form-screen">
          ${this.transferSubmitError?sx({variant:"danger",message:this.transferSubmitError}):""}
          ${fx([{label:"From",value:lj(e)},{label:"To",value:lj(t)},{label:"Amount",value:Vk(r)}])}
          <div class="primitive-footer card-form-primary">
            <div class="card-form-primary">
      ...
      `})}renderManualBankAccountConfigLoadingScreen(){return this.renderWidgetShell({title:"Select an instrument schema",headerAction:vx({label:"Back",action:this.manualBankAccountExitAction(),disabled:!0}),showClose:!1,showDivider:!1,busy:!0,overlay:Uj({title:"Loading instrument schemas",helper:"Loading the available bank account options, please wait."}),content:Ry`<div class="payment-flow card-form-screen"></div>`})}renderManualBankAccountConfigErrorScreen(){return this.renderWidgetShell({title:"Select an instrument schema",headerAction:vx({label:"Back",action:this.manualBankAccountExitAction()}),showClose:!1,showDivider:!1,content:Ry`
        <div class="payment-flow card-form-screen">
      ...
      `})}renderManualBankAccountSchemaSelectionScreen(){return this.renderWidgetShell({title:"Select an instrument schema",headerAction:vx({label:"Back",action:this.manualBankAccountExitAction()}),showClose:!1,showDivider:!1,content:Ry`
      ...
      `})}renderManualBankAccountScreen(){if("legacy"===this.manualBankAccountFormMode)return this.renderLegacyManualBankAccountScreen();const e=this.bankAccountFormSchema,t=this.bankAccountFormUiSchema;if(!e||!t)return this.renderManualBankAccountConfigErrorScreen();const r="save-bank-account"===this.pendingAction;return this.renderWidgetShell({title:"Enter bank details",headerAction:vx({label:"Back",action:this.bankAccountInstrumentSchemas.length>1?"back-to-instrument-schema-selection":this.manualBankAccountExitAction()}),showClose:!1,showDivider:!1,content:Ry`
        <div class="payment-flow card-form-screen">
      ...
      `})}renderBankOutcomeScreen(){const e=Wj(this.bankOutcomeSource),t="declined"===e.kind||"pending"===e.kind;return this.renderWidgetShell({title:e.title,headerAction:t?vx({label:"Done",action:"done-bank-outcome"}):void 0,showClose:!1,showDivider:!1,content:Ry`
        <div class="verification-outcome-flow">
          ${sx({variant:e.variant,message:e.message})}
          ${this.bankOutcomeSource?iE(this.bankOutcomeSource):""}
          ${t?"":Ry`
                <div class="primitive-footer">
...
`,Fj=e=>"verify-payment-source"===e?Uj({title:"Verifying payment method",helper:"Verifying your payment method, please wait."}):"submit-required-info"===e?Uj({title:"Verifying account",helper:"Reviewing your verification information, please wait."}):void 0,Hj=e=>"verify-payment-source"===e?Fj(e):"delete-payment-source"===e?Uj({title:"Deleting payment method",helper:"Deleting your payment method, please wait."}):"attach-payment-source"===e?Uj({title:"Saving payment method",helper:"Saving your payment method, please wait."}):void 0,Wj=e=>{const t=e?.verificationInfo?.status;return"VERIFIED"===t?{kind:"verified",variant:"success",title:"Bank account verified",message:"Your bank account is connected and ready to use."}:"UNDER_REVIEW"===t?{kind:"pending",variant:"warning",title:"Bank account pending review",message:"We will update this bank account after review is complete."}:"REQUIRE_INFO"===t?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:"Additional information is required before this bank account can be verified."}:"DECLINED"===t?{kind:"declined",variant:"danger",title:"Bank account verification failed",message:"This bank account could not be verified."}:{kind:"failed",variant:"danger",title:"Bank account not verified",message:"This bank account is not verified yet."}},Kj=(e,t=!1)=>{const r=aE(e),n=r.toLowerCase(),i=e?.verificationInfo?.status;return t?{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} not verified`,message:`We could not verify this ${n} right now.`}:"VERIFIED"===i?{kind:"verified",variant:"success",title:"Bank account"===r?"Bank account verified":`${r} saved`,message:`This ${n} is verified and ready to use.`}:"UNDER_REVIEW"===i?{kind:"pending",variant:"warning",title:"Bank account"===r?"Bank account pending review":"Verification pending review",message:`We will update this ${n} after review is complete.`}:"REQUIRE_INFO"===i?{kind:"requires-info",variant:"warning",title:"Complete account verification",message:`Additional information is required before this ${n} can be verified.`}:"DECLINED"===i?{kind:"declined",variant:"danger",title:"Bank account"===r?"Bank account verification failed":`${r} declined`,message:`This ${n} could not be verified.`}:{kind:"failed",variant:"danger",title:"Bank account"===r?"Bank account not verified":`${r} not verified`,message:`This ${n} is not verified yet.`}},Gj=e=>{const t=e?.verificationInfo?.docs??[];return t.length>0?t:[{}]},Jj=(e,t=0)=>`${e?.docType??"DOCUMENT"}-${t}`,Yj=e=>"DRIVER_LICENSE_NUMBER"===e.docType||"SOCIAL_SECURITY_NUMBER"===e.docType,Zj=e=>!1!==e.mandatory,Qj=e=>Zj(e)?"required":"optional",Xj=e=>Ry`
  <span
    class="required-info-requirement-badge required-info-requirement-badge-${Qj(e)}"
  >
    ${(e=>Zj(e)?"Required":"Optional")(e)}
  </span>
`,eE=e=>{const t=e.findIndex(e=>!Yj(e));return t>=0?Jj(e[t],t):void 0},tE=({doc:e,key:t,value:r})=>{if("SOCIAL_SECURITY_NUMBER"===e.docType)return rE({doc:e,key:t,value:r});const n=`required-info-${t}`;return Ry`
    <div
  ...
  `},rE=({doc:e,key:t,value:r})=>{const n=nE(e),i=(e=>{const t=Rk(e);return[t.slice(0,3),t.slice(3,5),t.slice(5,9)]})(r),o=`required-info-${t}-ssn-0`;return Ry`
    <div
  ...
  `},nE=e=>"BANK_STATEMENT"===e.docType?"Bank statement":"BANK_LETTER"===e.docType?"Bank letter":"BANK_CHECK"===e.docType?"Bank check":"DRIVER_LICENSE_PHOTO"===e.docType?"Driver license photo":"DRIVER_LICENSE_NUMBER"===e.docType?"Driver license number":"SOCIAL_SECURITY_NUMBER"===e.docType?"Social Security number":"Required document",iE=e=>{const t=(e=>({type:bj(e),brand:fj(e)}))(e),r=Wk(t),n=(e=>{if(!cE(e))return;const t=e.card?.expirationMonth?.trim(),r=e.card?.expirationYear?.trim();if(!t||!r)return;return`${t.padStart(2,"0")}/${r.slice(-2)}`})(e);return Ry`
    <div
      ...
      <div class="required-info-card-top">
        <div class="required-info-card-heading">
          <span class="required-info-card-label"
            >${(e=>sE(e)?"Bank account":cE(e)?"Card":uE(e)?"Native account":"Dynamic session card")(e)}</span
          >
          <span
            class="required-info-card-field required-info-card-name"
            data-required-info-card-field="name"
            >${(e=>cE(e)?e.card?.nameOnCard?.trim()||e.name?.trim()||hj(e):sE(e)?e.name?.trim()||e.bankAccount?.bankName?.trim()||hj(e):uE(e)?e.account?.nickName?.trim()||e.name?.trim()||hj(e):e.name?.trim()||hj(e))(e)}</span
          >
        </div>
      ...
      <div class="required-info-card-bottom">
        <div class="required-info-card-detail">
          ...
          <span class="required-info-card-status">
            ${ex(Mj(e.verificationInfo?.status))}
          </span>
        </div>
        ${n?Ry`
              <div class="required-info-card-detail">
  ...
  `},oE=e=>"REQUIRE_INFO"===e.verificationInfo?.status,aE=e=>e&&sE(e)?"Bank account":e&&uE(e)?"Native account":"Payment method",sE=e=>"BankAccount"===e.tenderType||"BANK_ACCOUNT"===e.tenderType,cE=e=>"Card"===e.tenderType||"CARD"===e.tenderType,uE=e=>"NativeAccount"===e.tenderType||"NATIVE_ACCOUNT"===e.tenderType;let dE,lE;const hE=async e=>{if(!window.PaymentSDK?.init)if(dE&&lE===e)await dE;else if(lE=e,dE=new Promise((t,r)=>{const n=document.querySelector(`script[data-commerce-hub-pay-by-bank-sdk="true"][src="${e}"]`),i=n??document.createElement("script"),o=()=>{i.removeEventListener("load",a),i.removeEventListener("error",s)},a=()=>{o(),t()},s=()=>{o(),dE=void 0,lE=void 0,r(new Error(`Unable to load Connect your bank script: ${e}`))};i.addEventListener("load",a,{once:!0}),i.addEventListener("error",s,{once:!0}),n||(i.src=e,i.async=!0,i.dataset.commerceHubPayByBankSdk="true",document.head.appendChild(i))}),await dE,!window.PaymentSDK?.init)throw new Error(`Connect your bank script loaded but window.PaymentSDK.init is unavailable: ${e}`)},fE=()=>{try{window.PaymentSDK?.destroy?.()}catch{}};export{bw as COMMERCE_HUB_BASE_URLS,Bx as CommerceHubConnect,vw as DEFAULT_COMMERCE_HUB_BASE_URL,Ax as ON_ADD_PAYMENT_METHOD_EVENT,Ox as ON_DELETE_PAYMENT_METHOD_EVENT,Nx as ON_ERROR_EVENT,Ix as ON_LIST_PAYMENT_METHODS_EVENT,Sx as ON_SELECT_EVENT,_x as ON_TRANSFER_EVENT,Cx as ON_VERIFY_PAYMENT_METHOD_EVENT,yw as createCommerceHubClient,$w as createCommerceHubConfigClient,ww as createCommerceHubMerchantClient,gw as resolveCommerceHubBaseURL};
